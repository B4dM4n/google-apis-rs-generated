...
pub mod schemas {
    ...
    impl crate::GetNextPageToken for GoogleCloudDocumentaiV1ListProcessorVersionsResponse {
    ...
    impl crate::GetNextPageToken for GoogleCloudDocumentaiV1ListProcessorsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
            ...
            pub mod processors {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn stream_processors_with_default_fields(
                        ...
                        Item = Result<
                            crate::schemas::GoogleCloudDocumentaiV1Processor,
                            crate::Error,
                        >,
                    > + 'a {
                ...
                pub mod processor_versions {
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        #[doc = r" repeated until no page token is returned."]
                        #[doc = r""]
                        #[doc = r" Requests the default set of fields from the server."]                        pub fn stream_with_default_fields (self) -> impl :: futures :: Stream < Item = Result < crate :: schemas :: GoogleCloudDocumentaiV1ListProcessorVersionsResponse , crate :: Error >> + 'a{
                            self.stream_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                        #[doc = r" `nextPageToken`, the request is executed again with the new token. This process is"]
                        #[doc = r" repeated until no page token is returned."]
                        #[doc = r""]
                        #[doc = r" Requests all fields from the server."]                        pub fn stream_with_all_fields (self) -> impl :: futures :: Stream < Item = Result < crate :: schemas :: GoogleCloudDocumentaiV1ListProcessorVersionsResponse , crate :: Error >> + 'a{
                            self.stream_with_fields(Some("*"))
                        }
                        #[doc = r" Execute the request and yield the returned value. If [`next_page_token`] returns a value,"]
                        #[doc = r" the request is executed again with the new token. This process is repeated until no page"]
