...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for CustomApp {
...
pub mod resources {
    pub mod accounts {
        ...
        impl<'a> AccountsActions<'a> {
            ...
            pub fn custom_apps(
                &self,
            ) -> crate::resources::accounts::custom_apps::CustomAppsActions {
                crate::resources::accounts::custom_apps::CustomAppsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
        ...
        pub mod custom_apps {
            pub mod params {}
            pub struct CustomAppsActions<'a> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            }
            impl<'a> CustomAppsActions<'a> {
                fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                    self.auth
                }
                #[doc = "Creates a new custom app."]
                pub fn create(
                    &self,
            ...
            #[doc = "Created via [CustomAppsActions::create()](struct.CustomAppsActions.html#method.create)"]
            #[derive(Debug, Clone)]
            ...
            impl<'a> CreateRequestBuilder<'a> {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::CustomApp, crate::Error> {
