...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        let mut locations0 = SubCommand::with_name("locations")
            .setting(AppSettings::ColoredHelp)
            .about("sub-resources: workforce_pools");
        ...
        {
            let mcmd = SubCommand::with_name("query_testable_permissions").about("Lists every permission that you can test on a resource. A permission is testable if you can check whether a principal has that permission on the resource.");
        ...
        let mut workforce_pools1 = SubCommand::with_name("workforce_pools")
            .setting(AppSettings::ColoredHelp)
            .about("sub-resources: operations, providers and subjects");
        ...
        {
            let mcmd = SubCommand::with_name("update").about("**Note:** We are in the process of deprecating this method. Use PatchServiceAccount instead. Updates a ServiceAccount. You can update only the `display_name` field.");
            service_accounts1 = service_accounts1.subcommand(mcmd);
        }
        ...
        let mut providers2 = SubCommand::with_name("providers")
            .setting(AppSettings::ColoredHelp)
            .about("sub-resources: keys and operations");
        let mut subjects2 = SubCommand::with_name("subjects")
            .setting(AppSettings::ColoredHelp)
        ...
        let mut keys2 = SubCommand::with_name("keys")
            .setting(AppSettings::ColoredHelp)
            .about("methods: create, delete, disable, enable, get, list and upload");
        {
        ...
        {
            let mcmd = SubCommand::with_name("disable").about("Disable a ServiceAccountKey. A disabled service account key can be enabled through EnableServiceAccountKey.");
            keys2 = keys2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("enable").about("Enable a ServiceAccountKey.");
            keys2 = keys2.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("upload").about("Uploads the public key portion of a key pair that you manage, and associates the public key with a ServiceAccount. After you upload the public key, you can use the private key from the key pair as a service account key.");
            keys2 = keys2.subcommand(mcmd);
        }
        ...
        let mut keys4 = SubCommand::with_name("keys")
            .setting(AppSettings::ColoredHelp)
            .about("sub-resources: operations");
        let mut operations4 = SubCommand::with_name("operations")
            .setting(AppSettings::ColoredHelp)
        ...
        keys4 = keys4.subcommand(operations5);
        providers3 = providers3.subcommand(operations4);
        providers3 = providers3.subcommand(keys4);
        keys3 = keys3.subcommand(operations4);
        ...
        subjects2 = subjects2.subcommand(operations3);
        providers2 = providers2.subcommand(operations3);
        providers2 = providers2.subcommand(keys3);
        service_accounts1 = service_accounts1.subcommand(keys2);
        locations1 = locations1.subcommand(workload_identity_pools2);
        workforce_pools1 = workforce_pools1.subcommand(subjects2);
        workforce_pools1 = workforce_pools1.subcommand(providers2);
        workforce_pools1 = workforce_pools1.subcommand(operations2);
        ...
        locations0 = locations0.subcommand(workforce_pools1);
