    ...
    pub mod documents {
        ...
        impl<'a> AnalyzeEntitiesRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str("v1/documents:analyzeEntities");
                output
            }
            async fn _request(
                &self,
        ...
        impl<'a> AnalyzeEntitySentimentRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://language.googleapis.com/".to_owned();
                output.push_str("v1/documents:analyzeEntitySentiment");
                output
            }
            async fn _request(
                &self,
        ...
        impl<'a> AnalyzeSentimentRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://language.googleapis.com/".to_owned();
                output.push_str("v1/documents:analyzeSentiment");
                output
            }
            async fn _request(
                &self,
        ...
        impl<'a> AnalyzeSyntaxRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://language.googleapis.com/".to_owned();
                output.push_str("v1/documents:analyzeSyntax");
                output
            }
            async fn _request(
                &self,
        ...
        impl<'a> AnnotateTextRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://language.googleapis.com/".to_owned();
                output.push_str("v1/documents:annotateText");
                output
            }
            async fn _request(
                &self,
        ...
        impl<'a> ClassifyTextRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://language.googleapis.com/".to_owned();
                output.push_str("v1/documents:classifyText");
                output
            }
            async fn _request(
                &self,
