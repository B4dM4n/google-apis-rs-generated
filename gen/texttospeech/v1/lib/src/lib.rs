...
pub mod schemas {
    ...
    pub struct GoogleCloudTexttospeechV1SynthesizeLongAudioMetadata {
        #[doc = "The progress of the most recent processing update in percentage, ie. 70.0%."]
        #[serde(
    ...
    impl ::google_field_selector::FieldSelector
        for GoogleCloudTexttospeechV1SynthesizeLongAudioMetadata
    {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudTexttospeechV1SynthesizeLongAudioMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for SynthesizeLongAudioMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SynthesizeLongAudioMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SynthesizeLongAudioRequest {
        ...
        #[doc = "Specifies a Cloud Storage URI for the synthesis results. Must be specified in the format: `gs://bucket_name/object_name`, and the bucket must already exist."]
        #[serde(
            rename = "outputGcsUri",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub output_gcs_uri: ::std::option::Option<String>,
        #[doc = "The desired voice of the synthesized audio."]
        #[serde(
            rename = "voice",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for SynthesizeLongAudioRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SynthesizeLongAudioRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                pub fn synthesize_long_audio(
                    &self,
                    request: crate::schemas::SynthesizeLongAudioRequest,
                    parent: impl Into<String>,
                ) -> SynthesizeLongAudioRequestBuilder {
                    SynthesizeLongAudioRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                        request,
            ...
            #[doc = "Created via [LocationsActions::synthesize_long_audio()](struct.LocationsActions.html#method.synthesize_long_audio)"]
            #[derive(Debug, Clone)]
            pub struct SynthesizeLongAudioRequestBuilder<'a> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                request: crate::schemas::SynthesizeLongAudioRequest,
                parent: String,
            ...
            impl<'a> SynthesizeLongAudioRequestBuilder<'a> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
                ...
                fn _path(&self) -> String {
                    ...
                    output.push_str(":synthesizeLongAudio");
                    output
                }
                async fn _request(
                    &self,
