...
pub mod schemas {
    ...
    impl AudioConfigAudioEncoding {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                AudioConfigAudioEncoding::Mp364Kbps => "MP3_64_KBPS",
    ...
    impl ::std::str::FromStr for AudioConfigAudioEncoding {
        ...
        fn from_str(s: &str) -> ::std::result::Result<AudioConfigAudioEncoding, ()> {
            Ok(match s {
                ...
                "MP3_64_KBPS" => AudioConfigAudioEncoding::Mp364Kbps,
    ...
    pub struct SynthesizeSpeechRequest {
        ...
        #[serde(
            rename = "enableTimePointing",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub enable_time_pointing: ::std::option::Option<
            Vec<crate::schemas::SynthesizeSpeechRequestEnableTimePointingItems>,
        >,
    ...
    impl SynthesizeSpeechRequestEnableTimePointingItems {
        pub fn as_str(self) -> &'static str {
            match self {
                SynthesizeSpeechRequestEnableTimePointingItems::SsmlMark => "SSML_MARK",
                SynthesizeSpeechRequestEnableTimePointingItems::TimepointTypeUnspecified => {
                    "TIMEPOINT_TYPE_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for SynthesizeSpeechRequestEnableTimePointingItems {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for SynthesizeSpeechRequestEnableTimePointingItems {
        type Err = ();
        fn from_str(
            s: &str,
        ) -> ::std::result::Result<SynthesizeSpeechRequestEnableTimePointingItems, ()> {
            Ok(match s {
                "SSML_MARK" => SynthesizeSpeechRequestEnableTimePointingItems::SsmlMark,
                "TIMEPOINT_TYPE_UNSPECIFIED" => {
                    SynthesizeSpeechRequestEnableTimePointingItems::TimepointTypeUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for SynthesizeSpeechRequestEnableTimePointingItems {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for SynthesizeSpeechRequestEnableTimePointingItems {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for SynthesizeSpeechRequestEnableTimePointingItems {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for SynthesizeSpeechRequestEnableTimePointingItems {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SynthesizeSpeechRequestEnableTimePointingItems {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SynthesizeSpeechResponse {
        ...
        pub timepoints: ::std::option::Option<Vec<crate::schemas::Timepoint>>,
    }
    ...
    pub struct Timepoint {
        ...
        pub mark_name: ::std::option::Option<String>,
        ...
        pub time_seconds: ::std::option::Option<f64>,
    }
    impl ::google_field_selector::FieldSelector for Timepoint {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for Timepoint {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
