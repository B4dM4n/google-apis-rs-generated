...
pub mod schemas {
    ...
    pub struct AutoscalingLimits {
        #[doc = "Required. Maximum number of nodes to scale up to."]
        #[serde(
            rename = "maxServeNodes",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub max_serve_nodes: ::std::option::Option<i32>,
        #[doc = "Required. Minimum number of nodes to scale down to."]
        #[serde(
            rename = "minServeNodes",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub min_serve_nodes: ::std::option::Option<i32>,
    }
    impl ::google_field_selector::FieldSelector for AutoscalingLimits {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AutoscalingLimits {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct AutoscalingTargets {
        #[doc = "The cpu utilization that the Autoscaler should be trying to achieve. This number is on a scale from 0 (no utilization) to 100 (total utilization), and is limited between 10 and 80, otherwise it will return INVALID_ARGUMENT error."]
        #[serde(
            rename = "cpuUtilizationPercent",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub cpu_utilization_percent: ::std::option::Option<i32>,
        #[doc = "The storage utilization that the Autoscaler should be trying to achieve. This number is limited between 2560 (2.5TiB) and 5120 (5TiB) for a SSD cluster and between 8192 (8TiB) and 16384 (16TiB) for an HDD cluster, otherwise it will return INVALID_ARGUMENT error. If this value is set to 0, it will be treated as if it were set to the default value: 2560 for SSD, 8192 for HDD."]
        #[serde(
            rename = "storageUtilizationGibPerNode",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub storage_utilization_gib_per_node: ::std::option::Option<i32>,
    }
    impl ::google_field_selector::FieldSelector for AutoscalingTargets {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AutoscalingTargets {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Backup {
        ...
        #[doc = "Output only. Name of the backup from which this backup was copied. If a backup is not created by copying a backup, this field will be empty. Values are of the form: projects//instances//backups/."]
        #[serde(
            rename = "sourceBackup",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct Cluster {
        #[doc = "Configuration for this cluster."]
        #[serde(
            rename = "clusterConfig",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub cluster_config: ::std::option::Option<crate::schemas::ClusterConfig>,
        ...
        #[doc = "Immutable. The encryption configuration for CMEK-protected clusters."]
        #[serde(
        ...
        pub name: ::std::option::Option<String>,
        #[doc = "The number of nodes allocated to this cluster. More nodes enable higher throughput and more consistent performance."]
        #[serde(
            rename = "serveNodes",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct ClusterAutoscalingConfig {
        #[doc = "Required. Autoscaling limits for this cluster."]
        #[serde(
            rename = "autoscalingLimits",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub autoscaling_limits: ::std::option::Option<crate::schemas::AutoscalingLimits>,
        #[doc = "Required. Autoscaling targets for this cluster."]
        #[serde(
            rename = "autoscalingTargets",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub autoscaling_targets: ::std::option::Option<crate::schemas::AutoscalingTargets>,
    }
    impl ::google_field_selector::FieldSelector for ClusterAutoscalingConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ClusterAutoscalingConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ClusterConfig {
        #[doc = "Autoscaling configuration for this cluster."]
        #[serde(
            rename = "clusterAutoscalingConfig",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub cluster_autoscaling_config:
            ::std::option::Option<crate::schemas::ClusterAutoscalingConfig>,
    }
    ...
    impl ClusterStateReplicationState {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                ClusterStateReplicationState::ReadyOptimizing => "READY_OPTIMIZING",
    ...
    impl ::std::str::FromStr for ClusterStateReplicationState {
        ...
        fn from_str(s: &str) -> ::std::result::Result<ClusterStateReplicationState, ()> {
            Ok(match s {
                ...
                "READY_OPTIMIZING" => ClusterStateReplicationState::ReadyOptimizing,
    ...
    pub struct ColumnFamily {
        ...
        #[doc = "Only available with STATS_VIEW, this includes summary statistics about column family contents. For statistics over an entire table, see TableStats above."]
        #[serde(
            rename = "stats",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub stats: ::std::option::Option<crate::schemas::ColumnFamilyStats>,
    }
    ...
    pub struct ColumnFamilyStats {
        ...
        #[serde(
            rename = "averageColumnsPerRow",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub average_columns_per_row: ::std::option::Option<f64>,
        #[doc = "How much space the data in the column family occupies. This is roughly how many bytes would be needed to read the contents of the entire column family (e.g. by streaming all contents out)."]
        #[serde(
            rename = "logicalDataBytes",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        #[serde(with = "crate::parsed_string")]
        pub logical_data_bytes: ::std::option::Option<i64>,
    }
    impl ::google_field_selector::FieldSelector for ColumnFamilyStats {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ColumnFamilyStats {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct CopyBackupMetadata {
        #[doc = "The name of the backup being created through the copy operation. Values are of the form `projects//instances//clusters//backups/`."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Information about the source backup that is being copied from."]
        #[serde(
            rename = "sourceBackupInfo",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub source_backup_info: ::std::option::Option<crate::schemas::BackupInfo>,
    }
    ...
    pub struct CopyBackupRequest {
        ...
        #[doc = "Required. Required. The expiration time of the copied backup with microsecond granularity that must be at least 6 hours and at most 30 days from the time the request is received. Once the `expire_time` has passed, Cloud Bigtable will delete the backup and free the resources used by the backup."]
        #[serde(
            rename = "expireTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub expire_time: ::std::option::Option<String>,
        #[doc = "Required. The source backup to be copied from. The source backup needs to be in READY state for it to be copied. Copying a copied backup is not allowed. Once CopyBackup is in progress, the source backup cannot be deleted or cleaned up on expiration until CopyBackup is finished. Values are of the form: `projects//instances//clusters//backups/`."]
        #[serde(
            rename = "sourceBackup",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct CreateInstanceRequest {
        #[doc = "Required. The clusters to be created within the instance, mapped by desired cluster ID, e.g., just `mycluster` rather than `projects/myproject/instances/myinstance/clusters/mycluster`. Fields marked `OutputOnly` must be left blank."]
        #[serde(
            rename = "clusters",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct EncryptionInfo {
        #[doc = "Output only. The status of encrypt/decrypt calls on underlying data for this resource. Regardless of status, the existing data is always encrypted at rest."]
        #[serde(
        ...
        #[doc = "Output only. The type of encryption used to protect this resource."]
        #[serde(
        ...
        #[doc = "Output only. The version of the Cloud KMS key specified in the parent cluster that is in use for the data underlying this table."]
        #[serde(
    ...
    pub enum EncryptionInfoEncryptionType {
        ...
        #[doc = "The data backing this resource is encrypted at rest with a key that is fully managed by Google. No key version or status will be populated. This is the default state."]
    ...
    impl EncryptionInfoEncryptionType {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                EncryptionInfoEncryptionType::EncryptionTypeUnspecified => {
    ...
    pub struct HotTablet {
        #[doc = "Tablet End Key (inclusive)."]
        #[serde(
            rename = "endKey",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub end_key: ::std::option::Option<String>,
        #[doc = "Output only. The end time of the hot tablet."]
        #[serde(
            rename = "endTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub end_time: ::std::option::Option<String>,
        #[doc = "The unique name of the hot tablet. Values are of the form `projects/{project}/instances/{instance}/clusters/{cluster}/hotTablets/[a-zA-Z0-9_-]*`."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub name: ::std::option::Option<String>,
        #[doc = "Output only. The average CPU usage spent by a node on this tablet over the start_time to end_time time range. The percentage is the amount of CPU used by the node to serve the tablet, from 0% (tablet was not interacted with) to 100% (the node spent all cycles serving the hot tablet)."]
        #[serde(
            rename = "nodeCpuUsagePercent",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub node_cpu_usage_percent: ::std::option::Option<f32>,
        #[doc = "Tablet Start Key (inclusive)."]
        #[serde(
            rename = "startKey",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub start_key: ::std::option::Option<String>,
        #[doc = "Output only. The start time of the hot tablet."]
        #[serde(
            rename = "startTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub start_time: ::std::option::Option<String>,
        #[doc = "Name of the table that contains the tablet. Values are of the form `projects/{project}/instances/{instance}/tables/_a-zA-Z0-9*`."]
        #[serde(
            rename = "tableName",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for HotTablet {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for HotTablet {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Instance {
        #[doc = "Output only. A commit timestamp representing when this Instance was created. For instances created before this field was added (August 2021), this value is `seconds: 0, nanos: 1`."]
        #[serde(
            rename = "createTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl crate::GetNextPageToken<String> for ListAppProfilesResponse {
    ...
    impl crate::GetNextPageToken<String> for ListClustersResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct ListHotTabletsResponse {
        #[doc = "List of hot tablets in the tables of the requested cluster that fall within the requested time range. Hot tablets are ordered by node cpu usage percent. If there are multiple hot tablets that correspond to the same tablet within a 15-minute interval, only the hot tablet with the highest node cpu usage will be included in the response."]
        #[serde(
            rename = "hotTablets",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub hot_tablets: ::std::option::Option<Vec<crate::schemas::HotTablet>>,
        #[doc = "Set if not all hot tablets could be returned in a single response. Pass this value to `page_token` in another request to get the next page of results."]
        #[serde(
            rename = "nextPageToken",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for ListHotTabletsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListHotTabletsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListHotTabletsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for ListTablesResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct MultiClusterRoutingUseAny {
        #[doc = "The set of clusters to route to. The order is ignored; clusters will be tried in order of distance. If left empty, all clusters are eligible."]
        #[serde(
            rename = "clusterIds",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub cluster_ids: ::std::option::Option<Vec<String>>,
    }
    ...
    pub struct PartialUpdateClusterMetadata {
        ...
        pub finish_time: ::std::option::Option<String>,
        #[doc = "The original request for PartialUpdateCluster."]
        #[serde(
            rename = "originalRequest",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub original_request: ::std::option::Option<crate::schemas::PartialUpdateClusterRequest>,
        #[doc = "The time at which the original request was received."]
        #[serde(
            rename = "requestTime",
            default,
    ...
    impl ::google_field_selector::FieldSelector for PartialUpdateClusterMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PartialUpdateClusterMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct PartialUpdateClusterRequest {
        #[doc = "Required. The Cluster which contains the partial updates to be applied, subject to the update_mask."]
        #[serde(
            rename = "cluster",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub cluster: ::std::option::Option<crate::schemas::Cluster>,
        #[doc = "Required. The subset of Cluster fields which should be replaced."]
        #[serde(
            rename = "updateMask",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for PartialUpdateClusterRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PartialUpdateClusterRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl RestoreInfoSourceType {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                RestoreInfoSourceType::RestoreSourceTypeUnspecified => {
    ...
    impl ::google_field_selector::FieldSelector for RestoreTableRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for RestoreTableRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq, Default, :: serde :: Deserialize, :: serde :: Serialize)]
    pub struct Table {
        #[doc = "Output only. Map from cluster ID to per-cluster table state. If it could not be determined whether or not the table has data in a particular cluster (for example, if its zone is unavailable), then there will be an entry for the cluster with UNKNOWN `replication_status`. Views: `REPLICATION_VIEW`, `ENCRYPTION_VIEW`, `FULL`"]
        #[serde(
        ...
        >,
        #[doc = "The column families configured for this table, mapped by column family ID. Views: `SCHEMA_VIEW`, `STATS_VIEW`, `FULL`"]
        #[serde(
        ...
        >,
        #[doc = "Set to true to make the table protected against data loss. i.e. deleting the following resources through Admin APIs are prohibited: * The table. * The column families in the table. * The instance containing the table. Note one can still delete the data stored in the table through Data APIs."]
        #[serde(
        ...
        #[doc = "The unique name of the table. Values are of the form `projects/{project}/instances/{instance}/tables/_a-zA-Z0-9*`. Views: `NAME_ONLY`, `SCHEMA_VIEW`, `REPLICATION_VIEW`, `STATS_VIEW`, `FULL`"]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Only available with STATS_VIEW, this includes summary statistics about the entire table contents. For statistics about a specific column family, see ColumnFamilyStats in the mapped ColumnFamily collection above."]
        #[serde(
            rename = "stats",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub stats: ::std::option::Option<crate::schemas::TableStats>,
    }
    ...
    pub struct TableStats {
        #[doc = "How many cells are present per column (column family, column qualifier) combinations, averaged over all columns in all rows in the table. e.g. A table with 2 rows: * A row with 3 cells in “family:col” and 1 cell in “other:col” (4 cells / 2 columns) * A row with 1 cell in “family:col”, 7 cells in “family:other_col”, and 7 cells in “other:data” (15 cells / 3 columns) would report (4 + 15)/(2 + 3) = 3.8 in this field."]
        #[serde(
            rename = "averageCellsPerColumn",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub average_columns_per_row: ::std::option::Option<f64>,
        #[doc = "This is roughly how many bytes would be needed to read the entire table (e.g. by streaming all contents out)."]
        #[serde(
            rename = "logicalDataBytes",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[serde(with = "crate::parsed_string")]
        pub logical_data_bytes: ::std::option::Option<i64>,
        #[doc = "How many rows are in the table."]
        #[serde(
            rename = "rowCount",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for TableStats {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for TableStats {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct UndeleteTableMetadata {
        ...
        pub end_time: ::std::option::Option<String>,
        #[doc = "The name of the table being restored."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for UndeleteTableMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for UndeleteTableMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for UndeleteTableRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for UndeleteTableRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct UpdateTableMetadata {
        #[doc = "If set, the time at which this operation finished or was canceled."]
        #[serde(
            rename = "endTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub end_time: ::std::option::Option<String>,
        #[doc = "The name of the table being updated."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for UpdateTableMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for UpdateTableMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub mod projects {
        ...
        pub mod instances {
            ...
            impl<'a> InstancesActions<'a> {
                ...
                #[doc = "Create an instance within a project. Note that exactly one of Cluster.serve_nodes and Cluster.cluster_config.cluster_autoscaling_config can be set. If serve_nodes is set to non-zero, then the cluster is manually scaled. If cluster_config.cluster_autoscaling_config is non-empty, then autoscaling is enabled."]
                pub fn create(
                    &self,
                ...
                #[doc = "Gets the access control policy for an instance resource. Returns an empty policy if an instance exists but does not have a policy set."]
                ...
                #[doc = "Partially updates an instance within a project. This method can modify all fields of an Instance and is the preferred way to update an Instance."]
                ...
                #[doc = "Sets the access control policy on an instance resource. Replaces any existing policy."]
                ...
                #[doc = "Updates an instance within a project. This method updates only the display name and type for an Instance. To update other Instance properties, such as labels, use PartialUpdateInstance."]
                pub fn update(
                    &self,
                    request: crate::schemas::Instance,
                    name: impl Into<String>,
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `failedLocations` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_failed_locations<T>(
                    self,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_failed_locations_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `failedLocations` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_failed_locations_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<String, crate::Error>> + 'a
                {
                    self.stream_failed_locations_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `failedLocations` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_failed_locations_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<String, crate::Error>> + 'a
                {
                    self.stream_failed_locations_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `failedLocations` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_failed_locations_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
            ...
            pub mod app_profiles {
                ...
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::AppProfile,
                    parent: String,
                    app_profile_id: ::std::option::Option<String>,
                    ignore_warnings: ::std::option::Option<bool>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    async fn _request(
                        ...
                        let mut req = self.reqwest.request(::reqwest::Method::POST, path);
                        req = req.query(&[("appProfileId", &self.app_profile_id)]);
                        req = req.query(&[("ignoreWarnings", &self.ignore_warnings)]);
                        req = req.query(&[("access_token", &self.access_token)]);
                        req = req.query(&[("alt", &self.alt)]);
                        req = req.query(&[("callback", &self.callback)]);
                        req = req.query(&[("fields", &self.fields)]);
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `appProfiles` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_app_profiles<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_app_profiles_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `appProfiles` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_app_profiles_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::AppProfile, crate::Error>,
                    > + 'a {
                        self.stream_app_profiles_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `appProfiles` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_app_profiles_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::AppProfile, crate::Error>,
                    > + 'a {
                        self.stream_app_profiles_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `appProfiles` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_app_profiles_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListAppProfilesResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
            ...
            pub mod clusters {
                ...
                impl<'a> ClustersActions<'a> {
                    ...
                    #[doc = "Updates a cluster within an instance. Note that UpdateCluster does not support updating cluster_config.cluster_autoscaling_config. In order to update it, you must use PartialUpdateCluster."]
                    pub fn update(
                        &self,
                        request: crate::schemas::Cluster,
                        name: impl Into<String>,
                    ...
                    #[doc = "Actions that can be performed on the hot_tablets resource"]                    pub fn hot_tablets (& self) -> crate :: resources :: projects :: instances :: clusters :: hot_tablets :: HotTabletsActions{
                        crate :: resources :: projects :: instances :: clusters :: hot_tablets :: HotTabletsActions { reqwest : & self . reqwest , auth : self . auth_ref () , }
                    }
                }
                ...
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::Cluster,
                    parent: String,
                    cluster_id: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `clusters` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_clusters<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_clusters_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `clusters` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_clusters_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Cluster, crate::Error>> + 'a
                    {
                        self.stream_clusters_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `clusters` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_clusters_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Cluster, crate::Error>> + 'a
                    {
                        self.stream_clusters_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `clusters` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_clusters_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListClustersResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                ...
                #[doc = "Created via [ClustersActions::partial_update_cluster()](struct.ClustersActions.html#method.partial_update_cluster)"]
                #[derive(Debug, Clone)]
                pub struct PartialUpdateClusterRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    request: crate::schemas::Cluster,
                    name: String,
                ...
                impl<'a> PartialUpdateClusterRequestBuilder<'a> {
                    #[doc = "Required. The subset of Cluster fields which should be replaced."]
                    pub fn update_mask(mut self, value: impl Into<String>) -> Self {
                        self.update_mask = Some(value.into());
                        self
                ...
                pub mod backups {
                    ...
                    impl<'a> BackupsActions<'a> {
                        ...
                        #[doc = "Copy a Cloud Bigtable backup to a new backup in the destination cluster located in the destination instance and project."]
                        pub fn copy(
                            &self,
                        ...
                        #[doc = "Gets the access control policy for a Table resource. Returns an empty policy if the resource exists but does not have a policy set."]
                        pub fn get_iam_policy(
                            &self,
                            request: crate::schemas::GetIamPolicyRequest,
                            resource: impl Into<String>,
                        ...
                        #[doc = "Lists Cloud Bigtable backups. Returns both completed and pending backups."]
                        pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                            ListRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                        ...
                        #[doc = "Sets the access control policy on a Table resource. Replaces any existing policy."]
                        pub fn set_iam_policy(
                            &self,
                            request: crate::schemas::SetIamPolicyRequest,
                            resource: impl Into<String>,
                ...
                pub mod hot_tablets {
                    pub mod params {}
                    pub struct HotTabletsActions<'a> {
                        pub(crate) reqwest: &'a reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    }
                    impl<'a> HotTabletsActions<'a> {
                        fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                            self.auth
                        }
                        #[doc = "Lists hot tablets in a cluster, within the time range provided. Hot tablets are ordered based on CPU usage."]
                        pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                            ListRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                    ...
                    #[doc = "Created via [HotTabletsActions::list()](struct.HotTabletsActions.html#method.list)"]
                    #[derive(Debug, Clone)]
                    pub struct ListRequestBuilder<'a> {
                        pub(crate) reqwest: &'a ::reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        #[doc = "The end time to list hot tablets."]
                        pub fn end_time(mut self, value: impl Into<String>) -> Self {
                            self.end_time = Some(value.into());
                            self
                        }
                        #[doc = "Maximum number of results per page. A page_size that is empty or zero lets the server choose the number of items to return. A page_size which is strictly positive will return at most that many items. A negative page_size will cause an error. Following the first request, subsequent paginated calls do not need a page_size field. If a page_size is set in subsequent calls, it must match the page_size given in the first request."]
                        pub fn page_size(mut self, value: i32) -> Self {
                            self.page_size = Some(value);
                            self
                        }
                        ...
                        #[doc = "The start time to list hot tablets. The hot tablets in the response will have start times between the requested start time and end time. Start time defaults to Now if it is unset, and end time defaults to Now - 24 hours if it is unset. The start time should be less than the end time, and the maximum allowed time range between start time and end time is 48 hours. Start time and end time should have values between Now and Now - 14 days."]
                        ...
                        #[doc = "\nExecute the request and yield each item in the `hotTablets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                        pub fn stream_hot_tablets<T>(
                            self,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                            T: ::serde::de::DeserializeOwned
                                ...
                                + 'a,
                        {
                            ...
                            self.stream_hot_tablets_with_fields(fields)
                        }
                        #[doc = "\nExecute the request and yield each item in the `hotTablets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                        pub fn stream_hot_tablets_with_default_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::HotTablet, crate::Error>,
                        > + 'a {
                            self.stream_hot_tablets_with_fields(None::<String>)
                        }
                        #[doc = "\nExecute the request and yield each item in the `hotTablets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                        pub fn stream_hot_tablets_with_all_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::HotTablet, crate::Error>,
                        > + 'a {
                            self.stream_hot_tablets_with_fields(Some("*"))
                        }
                        #[doc = "\nExecute the request and yield each item in the `hotTablets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                        pub fn stream_hot_tablets_with_fields<T, F>(
                            mut self,
                            fields: ::std::option::Option<F>,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                            ...
                            F: AsRef<str>,
                        {
                            ...
                            self.fields = Some({
                                let mut selector =
                                    concat!("nextPageToken,", "hotTablets").to_owned();
                                let items_fields =
                                    fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                                if !items_fields.is_empty() {
                                    selector.push_str("(");
                        ...
                        pub fn stream_with_default_fields(
                            ...
                            Item = Result<crate::schemas::ListHotTabletsResponse, crate::Error>,
                        > + 'a {
                            self.stream_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                        ...
                        pub async fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::ListHotTabletsResponse, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>).await
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            pub mod tables {
                pub mod params {
                    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
                    pub enum GetView {
                        #[doc = "Only populates `name` and fields related to the table’s encryption state."]
                        EncryptionView,
                        #[doc = "Populates all fields except for stats. See STATS_VIEW to request stats."]
                        Full,
                        ...
                        SchemaView,
                        #[doc = "Only populates `name` and fields related to the table’s stats (e.g. TableStats and ColumnFamilyStats)."]
                        StatsView,
                ...
                impl<'a> TablesActions<'a> {
                    ...
                    #[doc = "Checks replication consistency based on a consistency token, that is, if replication has caught up based on the conditions specified in the token and the check request."]
                    ...
                    #[doc = "Creates a new table in the specified instance. The table can be created with a full set of initial column families, specified in the request."]
                    pub fn create(
                        &self,
                    ...
                    #[doc = "Permanently drop/delete a row range from a specified table. The request can specify whether to delete all rows in a table, or only those that match a particular prefix."]
                    ...
                    #[doc = "Generates a consistency token for a Table, which can be used in CheckConsistency to check whether mutations to the table that finished before this call started have been replicated. The tokens will be available for 90 days."]
                    ...
                    #[doc = "Performs a series of column family modifications on the specified table. Either all or none of the modifications will occur before this method returns, but data requests received prior to that point may see a table where only some modifications have taken effect."]
                    ...
                    #[doc = "Create a new table by restoring from a completed backup. The returned table long-running operation can be used to track the progress of the operation, and to cancel it. The metadata field type is RestoreTableMetadata. The response type is Table, if successful."]
                    pub fn restore(
                        &self,
                        request: crate::schemas::RestoreTableRequest,
                        parent: impl Into<String>,
                    ...
                    pub fn undelete(
                        &self,
                        request: crate::schemas::UndeleteTableRequest,
                        name: impl Into<String>,
                ...
                pub struct GetRequestBuilder<'a> {
                    ...
                    view: ::std::option::Option<
                        crate::resources::projects::instances::tables::params::GetView,
                    >,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                ...
                pub struct ListRequestBuilder<'a> {
                    ...
                    page_token: ::std::option::Option<String>,
                    view: ::std::option::Option<
                        crate::resources::projects::instances::tables::params::ListView,
                    >,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "The view to be applied to the returned tables’ fields. Only NAME_ONLY view (default), REPLICATION_VIEW and ENCRYPTION_VIEW are supported."]
                    pub fn view(
                        mut self,
                    ...
                    pub fn stream_tables_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Table, crate::Error>> + 'a
                    {
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListTablesResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                ...
                #[doc = "Created via [TablesActions::restore()](struct.TablesActions.html#method.restore)"]
                #[derive(Debug, Clone)]
                ...
                impl<'a> RestoreRequestBuilder<'a> {
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str("/tables:restore");
                        output
                    }
                    async fn _request(
                        &self,
                ...
                #[doc = "Created via [TablesActions::undelete()](struct.TablesActions.html#method.undelete)"]
                #[derive(Debug, Clone)]
