...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for ListEventsResponse {
    ...
    impl crate::GetNextPageToken<String> for ListGroupStatsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub mod projects {
        ...
        pub mod events {
            ...
            pub struct ListRequestBuilder<'a> {
                ...
                service_filter_resource_type: ::std::option::Option<String>,
                service_filter_service: ::std::option::Option<String>,
                service_filter_version: ::std::option::Option<String>,
                time_range_period: ::std::option::Option<
                    crate::resources::projects::events::params::ListTimeRangePeriod,
                >,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `errorEvents` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_error_events<T>(
                    self,
                    ...
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_error_events_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `errorEvents` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_error_events_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::ErrorEvent, crate::Error>> + 'a
                {
                    self.stream_error_events_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `errorEvents` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_error_events_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::ErrorEvent, crate::Error>> + 'a
                {
                    self.stream_error_events_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `errorEvents` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_error_events_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListEventsResponse, crate::Error>,
                > + 'a {
        ...
        pub mod group_stats {
            ...
            pub struct ListRequestBuilder<'a> {
                ...
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                project_name: String,
                alignment: ::std::option::Option<
                    crate::resources::projects::group_stats::params::ListAlignment,
                >,
                alignment_time: ::std::option::Option<String>,
                group_id: ::std::option::Option<Vec<String>>,
                order: ::std::option::Option<
                    crate::resources::projects::group_stats::params::ListOrder,
                >,
                page_size: ::std::option::Option<i32>,
                page_token: ::std::option::Option<String>,
                service_filter_resource_type: ::std::option::Option<String>,
                ...
                service_filter_version: ::std::option::Option<String>,
                time_range_period: ::std::option::Option<
                    crate::resources::projects::group_stats::params::ListTimeRangePeriod,
                >,
                timed_count_duration: ::std::option::Option<String>,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
                fields: ::std::option::Option<String>,
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `errorGroupStats` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_error_group_stats<T>(
                    self,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_error_group_stats_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `errorGroupStats` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_error_group_stats_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<
                    Item = Result<crate::schemas::ErrorGroupStats, crate::Error>,
                > + 'a {
                    self.stream_error_group_stats_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `errorGroupStats` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_error_group_stats_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<
                    Item = Result<crate::schemas::ErrorGroupStats, crate::Error>,
                > + 'a {
                    self.stream_error_group_stats_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `errorGroupStats` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_error_group_stats_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListGroupStatsResponse, crate::Error>,
                > + 'a {
                    self.stream_with_fields(None::<&str>)
                }
                #[doc = r" Execute the request and yield the returned value. If the response contains a"]
