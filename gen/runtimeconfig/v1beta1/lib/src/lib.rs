...
pub mod scopes {
    ...
    #[doc = "Manage your Google Cloud Platform services' runtime configuration\n\n`https://www.googleapis.com/auth/cloudruntimeconfig`"]
    pub const CLOUDRUNTIMECONFIG: &str = "https://www.googleapis.com/auth/cloudruntimeconfig";
}
pub mod schemas {
    #[derive(
        Debug,
    ...
    impl ::google_field_selector::ToFieldType for Cardinality {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for EndCondition {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for ListConfigsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListConfigsResponse {
    ...
    impl ::google_field_selector::ToFieldType for ListWaitersResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListWaitersResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl ::serde::Serialize for VariableState {
    ...
    impl<'de> ::serde::Deserialize<'de> for VariableState {
    ...
    impl ::google_field_selector::FieldSelector for VariableState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for VariableState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for Waiter {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for WatchVariableRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    pub mod projects {
        ...
        impl<'a> ProjectsActions<'a> {
            ...
            pub fn configs(&self) -> crate::resources::projects::configs::ConfigsActions {
                crate::resources::projects::configs::ConfigsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
        ...
        pub mod configs {
            ...
            impl<'a> ConfigsActions<'a> {
                ...
                #[doc = "Creates a new RuntimeConfig resource. The configuration name must be unique within project."]
                pub fn create(
                    &self,
                    request: crate::schemas::RuntimeConfig,
                ...
                pub fn operations(
                    &self,
                ) -> crate::resources::projects::configs::operations::OperationsActions
                {
                    crate::resources::projects::configs::operations::OperationsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                ...
                pub fn variables(
                    &self,
                ) -> crate::resources::projects::configs::variables::VariablesActions
                {
                    crate::resources::projects::configs::variables::VariablesActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                ...
                #[doc = "Actions that can be performed on the waiters resource"]
                pub fn waiters(
                    &self,
                ) -> crate::resources::projects::configs::waiters::WaitersActions {
                    crate::resources::projects::configs::waiters::WaitersActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                    }
            ...
            impl<'a> CreateRequestBuilder<'a> {
                ...
                fn _path(&self) -> String {
                    let mut output = "https://runtimeconfig.googleapis.com/".to_owned();
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `configs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_configs<T>(
                    self,
                    ...
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_configs_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `configs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_configs_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::RuntimeConfig, crate::Error>>
                       + 'a {
                    self.stream_configs_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `configs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_configs_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::RuntimeConfig, crate::Error>>
                       + 'a {
                    self.stream_configs_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `configs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_configs_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                    ...
                    F: AsRef<str>,
                {
                    ...
                    self.fields = Some({
                        let mut selector = concat!("nextPageToken,", "configs").to_owned();
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListConfigsResponse, crate::Error>,
                > + 'a {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::ListConfigsResponse, crate::Error> {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            pub mod variables {
                ...
                impl<'a> VariablesActions<'a> {
                    ...
                    #[doc = "Creates a variable within the given configuration. You cannot create a variable with a name that is a prefix of an existing variable name, or a name that has an existing variable name as a prefix. To learn more about creating a variable, read the [Setting and Getting Data](/deployment-manager/runtime-configurator/set-and-get-variables) documentation."]
                    pub fn create(
                        &self,
                    ...
                    #[doc = "Deletes a variable or multiple variables. If you specify a variable name, then that variable is deleted. If you specify a prefix and `recursive` is true, then all variables with that prefix are deleted. You must set a `recursive` to true if you delete variables by prefix."]
                    pub fn delete(&self, name: impl Into<String>) -> DeleteRequestBuilder {
                        DeleteRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    #[doc = "Lists variables within given a configuration, matching any provided filters. This only lists variable names, not the values, unless `return_values` is true, in which case only variables that user has IAM permission to GetVariable will be returned."]
                    pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                        ListRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    #[doc = "Watches a specific variable and waits for a change in the variable’s value. When there is a change, this method returns the new value or times out. If a variable is deleted while being watched, the `variableState` state is set to `DELETED` and the method returns the last known variable `value`. If you set the deadline for watching to a larger value than internal timeout (60 seconds), the current variable value is returned and the `variableState` will be `VARIABLE_STATE_UNSPECIFIED`. To learn more about creating a watcher, read the [Watching a Variable for Changes](/deployment-manager/runtime-configurator/watching-a-variable) documentation."]
                    pub fn watch(
                        &self,
                        request: crate::schemas::WatchVariableRequest,
                        name: impl Into<String>,
                    ) -> WatchRequestBuilder {
                        WatchRequestBuilder {
                            reqwest: &self.reqwest,
                ...
                pub struct ListRequestBuilder<'a> {
                    ...
                    page_size: ::std::option::Option<i32>,
                    page_token: ::std::option::Option<String>,
                    return_values: ::std::option::Option<bool>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn return_values(mut self, value: bool) -> Self {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `variables` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_variables<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_variables_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `variables` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_variables_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Variable, crate::Error>> + 'a
                    {
                        self.stream_variables_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `variables` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_variables_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Variable, crate::Error>> + 'a
                    {
                        self.stream_variables_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `variables` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_variables_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        self.fields = Some({
                            let mut selector = concat!("nextPageToken,", "variables").to_owned();
                            let items_fields = fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                            if !items_fields.is_empty() {
                                selector.push_str("(");
                                selector.push_str(items_fields);
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListVariablesResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                    ...
                    async fn _request(
                        ...
                        req = req.query(&[("pageSize", &self.page_size)]);
                        req = req.query(&[("pageToken", &self.page_token)]);
                        req = req.query(&[("returnValues", &self.return_values)]);
                        req = req.query(&[("access_token", &self.access_token)]);
                        req = req.query(&[("alt", &self.alt)]);
                        req = req.query(&[("callback", &self.callback)]);
                        req = req.query(&[("fields", &self.fields)]);
            ...
            pub mod waiters {
                pub mod params {}
                pub struct WaitersActions<'a> {
                    pub(crate) reqwest: &'a reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                }
                impl<'a> WaitersActions<'a> {
                    fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                        self.auth
                    }
                    #[doc = "Creates a Waiter resource. This operation returns a long-running Operation resource which can be polled for completion. However, a waiter with the given name will exist (and can be retrieved) prior to the operation completing. If the operation fails, the failed Waiter resource will still exist and must be deleted prior to subsequent creation attempts."]
                    pub fn create(
                        &self,
                        request: crate::schemas::Waiter,
                        parent: impl Into<String>,
                    ) -> CreateRequestBuilder {
                        CreateRequestBuilder {
                            reqwest: &self.reqwest,
                ...
                impl<'a> GetRequestBuilder<'a> {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::Waiter, crate::Error> {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    #[doc = r" selector of `*`. This will include every attribute of the"]
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `waiters` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_waiters<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_waiters_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `waiters` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_waiters_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Waiter, crate::Error>> + 'a
                    {
                        self.stream_waiters_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `waiters` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_waiters_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Waiter, crate::Error>> + 'a
                    {
                        self.stream_waiters_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `waiters` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_waiters_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        self.fields = Some({
                            let mut selector = concat!("nextPageToken,", "waiters").to_owned();
                            let items_fields = fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                            if !items_fields.is_empty() {
                                selector.push_str("(");
                                selector.push_str(items_fields);
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListWaitersResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ListWaitersResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
