...
pub mod schemas {
    ...
    pub struct DataSourceParameter {
        ...
        #[doc = "For integer and double values specifies maximum allowed value."]
        #[serde(
            rename = "maxValue",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl crate::GetNextPageToken<String> for ListDataSourcesResponse {
    ...
    impl crate::GetNextPageToken<String> for ListTransferConfigsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for ListTransferLogsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for ListTransferRunsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct TransferConfig {
        ...
        #[doc = "Data source ID. This cannot be changed once data transfer is created. The full list of available data source IDs can be returned through an API call: https://cloud.google.com/bigquery-transfer/docs/reference/datatransfer/rest/v1/projects.locations.dataSources/list"]
        #[serde(
            rename = "dataSourceId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub mod projects {
        ...
        pub mod data_sources {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `dataSources` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_data_sources<T>(
                    self,
                    ...
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_data_sources_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `dataSources` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_data_sources_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::DataSource, crate::Error>> + 'a
                {
                    self.stream_data_sources_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `dataSources` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_data_sources_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::DataSource, crate::Error>> + 'a
                {
                    self.stream_data_sources_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `dataSources` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_data_sources_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListDataSourcesResponse, crate::Error>,
                > + 'a {
        ...
        pub mod locations {
            ...
            pub mod data_sources {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn stream_data_sources_with_default_fields(
                        ...
                        Item = Result<crate::schemas::DataSource, crate::Error>,
                    > + 'a {
                        self.stream_data_sources_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `dataSources` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            ...
            pub mod transfer_configs {
                ...
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::TransferConfig,
                    parent: String,
                    authorization_code: ::std::option::Option<String>,
                    service_account_name: ::std::option::Option<String>,
                    version_info: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                pub struct ListRequestBuilder<'a> {
                    ...
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    parent: String,
                    data_source_ids: ::std::option::Option<Vec<String>>,
                    page_size: ::std::option::Option<i32>,
                    page_token: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `transferConfigs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_transfer_configs<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_transfer_configs_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `transferConfigs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_transfer_configs_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::TransferConfig, crate::Error>,
                    > + 'a {
                        self.stream_transfer_configs_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `transferConfigs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_transfer_configs_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::TransferConfig, crate::Error>,
                    > + 'a {
                        self.stream_transfer_configs_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `transferConfigs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_transfer_configs_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListTransferConfigsResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                ...
                pub mod runs {
                    ...
                    #[derive(Debug, Clone)]
                    pub struct ListRequestBuilder < 'a > { pub (crate) reqwest : & 'a :: reqwest :: Client , pub (crate) auth : & 'a dyn :: google_api_auth :: GetAccessToken , parent : String , page_size : :: std :: option :: Option < i32 > , page_token : :: std :: option :: Option < String > , run_attempt : :: std :: option :: Option < crate :: resources :: projects :: locations :: transfer_configs :: runs :: params :: ListRunAttempt > , states : :: std :: option :: Option < Vec < crate :: resources :: projects :: locations :: transfer_configs :: runs :: params :: ListStatesItems > > , access_token : :: std :: option :: Option < String > , alt : :: std :: option :: Option < crate :: params :: Alt > , callback : :: std :: option :: Option < String > , fields : :: std :: option :: Option < String > , key : :: std :: option :: Option < String > , oauth_token : :: std :: option :: Option < String > , pretty_print : :: std :: option :: Option < bool > , quota_user : :: std :: option :: Option < String > , upload_protocol : :: std :: option :: Option < String > , upload_type : :: std :: option :: Option < String > , xgafv : :: std :: option :: Option < crate :: params :: Xgafv > , }
                    impl<'a> ListRequestBuilder<'a> {
                        #[doc = "Page size. The default page size is the maximum value of 1000 results."]
                        pub fn page_size(mut self, value: i32) -> Self {
                            self.page_size = Some(value);
                        ...
                        #[doc = "\nExecute the request and yield each item in the `transferRuns` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                        pub fn stream_transfer_runs<T>(
                            self,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                            T: ::serde::de::DeserializeOwned
                                ...
                                + 'a,
                        {
                            ...
                            self.stream_transfer_runs_with_fields(fields)
                        }
                        #[doc = "\nExecute the request and yield each item in the `transferRuns` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                        pub fn stream_transfer_runs_with_default_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::TransferRun, crate::Error>,
                        > + 'a {
                            self.stream_transfer_runs_with_fields(None::<String>)
                        }
                        #[doc = "\nExecute the request and yield each item in the `transferRuns` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                        pub fn stream_transfer_runs_with_all_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::TransferRun, crate::Error>,
                        > + 'a {
                            self.stream_transfer_runs_with_fields(Some("*"))
                        }
                        #[doc = "\nExecute the request and yield each item in the `transferRuns` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                        pub fn stream_transfer_runs_with_fields<T, F>(
                            mut self,
                            fields: ::std::option::Option<F>,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                        ...
                        pub fn stream_with_default_fields(
                            ...
                            Item = Result<crate::schemas::ListTransferRunsResponse, crate::Error>,
                        > + 'a {
                            self.stream_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                    ...
                    pub mod transfer_logs {
                        ...
                        #[derive(Debug, Clone)]
                        pub struct ListRequestBuilder < 'a > { pub (crate) reqwest : & 'a :: reqwest :: Client , pub (crate) auth : & 'a dyn :: google_api_auth :: GetAccessToken , parent : String , message_types : :: std :: option :: Option < Vec < crate :: resources :: projects :: locations :: transfer_configs :: runs :: transfer_logs :: params :: ListMessageTypesItems > > , page_size : :: std :: option :: Option < i32 > , page_token : :: std :: option :: Option < String > , access_token : :: std :: option :: Option < String > , alt : :: std :: option :: Option < crate :: params :: Alt > , callback : :: std :: option :: Option < String > , fields : :: std :: option :: Option < String > , key : :: std :: option :: Option < String > , oauth_token : :: std :: option :: Option < String > , pretty_print : :: std :: option :: Option < bool > , quota_user : :: std :: option :: Option < String > , upload_protocol : :: std :: option :: Option < String > , upload_type : :: std :: option :: Option < String > , xgafv : :: std :: option :: Option < crate :: params :: Xgafv > , }
                        impl<'a> ListRequestBuilder<'a> {
                            ...
                            #[doc = "\nExecute the request and yield each item in the `transferMessages` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                            pub fn stream_transfer_messages<T>(
                                self,
                            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                            where
                                T: ::serde::de::DeserializeOwned
                                    ...
                                    + 'a,
                            {
                                ...
                                self.stream_transfer_messages_with_fields(fields)
                            }
                            #[doc = "\nExecute the request and yield each item in the `transferMessages` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                            pub fn stream_transfer_messages_with_default_fields(
                                self,
                            ) -> impl ::futures::Stream<
                                Item = Result<crate::schemas::TransferMessage, crate::Error>,
                            > + 'a {
                                self.stream_transfer_messages_with_fields(None::<String>)
                            }
                            #[doc = "\nExecute the request and yield each item in the `transferMessages` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                            pub fn stream_transfer_messages_with_all_fields(
                                self,
                            ) -> impl ::futures::Stream<
                                Item = Result<crate::schemas::TransferMessage, crate::Error>,
                            > + 'a {
                                self.stream_transfer_messages_with_fields(Some("*"))
                            }
                            #[doc = "\nExecute the request and yield each item in the `transferMessages` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                            pub fn stream_transfer_messages_with_fields<T, F>(
                                mut self,
                                fields: ::std::option::Option<F>,
                            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                            where
        ...
        pub mod transfer_configs {
            ...
            pub mod runs {
                ...
                #[doc = "Created via [RunsActions::list()](struct.RunsActions.html#method.list)"]
                #[derive(Debug, Clone)]
                pub struct ListRequestBuilder < 'a > { pub (crate) reqwest : & 'a :: reqwest :: Client , pub (crate) auth : & 'a dyn :: google_api_auth :: GetAccessToken , parent : String , page_size : :: std :: option :: Option < i32 > , page_token : :: std :: option :: Option < String > , run_attempt : :: std :: option :: Option < crate :: resources :: projects :: transfer_configs :: runs :: params :: ListRunAttempt > , states : :: std :: option :: Option < Vec < crate :: resources :: projects :: transfer_configs :: runs :: params :: ListStatesItems > > , access_token : :: std :: option :: Option < String > , alt : :: std :: option :: Option < crate :: params :: Alt > , callback : :: std :: option :: Option < String > , fields : :: std :: option :: Option < String > , key : :: std :: option :: Option < String > , oauth_token : :: std :: option :: Option < String > , pretty_print : :: std :: option :: Option < bool > , quota_user : :: std :: option :: Option < String > , upload_protocol : :: std :: option :: Option < String > , upload_type : :: std :: option :: Option < String > , xgafv : :: std :: option :: Option < crate :: params :: Xgafv > , }
                impl<'a> ListRequestBuilder<'a> {
                    #[doc = "Page size. The default page size is the maximum value of 1000 results."]
                    pub fn page_size(mut self, value: i32) -> Self {
                        self.page_size = Some(value);
                ...
                pub mod transfer_logs {
                    ...
                    #[doc = "Created via [TransferLogsActions::list()](struct.TransferLogsActions.html#method.list)"]
                    #[derive(Debug, Clone)]
                    pub struct ListRequestBuilder < 'a > { pub (crate) reqwest : & 'a :: reqwest :: Client , pub (crate) auth : & 'a dyn :: google_api_auth :: GetAccessToken , parent : String , message_types : :: std :: option :: Option < Vec < crate :: resources :: projects :: transfer_configs :: runs :: transfer_logs :: params :: ListMessageTypesItems > > , page_size : :: std :: option :: Option < i32 > , page_token : :: std :: option :: Option < String > , access_token : :: std :: option :: Option < String > , alt : :: std :: option :: Option < crate :: params :: Alt > , callback : :: std :: option :: Option < String > , fields : :: std :: option :: Option < String > , key : :: std :: option :: Option < String > , oauth_token : :: std :: option :: Option < String > , pretty_print : :: std :: option :: Option < bool > , quota_user : :: std :: option :: Option < String > , upload_protocol : :: std :: option :: Option < String > , upload_type : :: std :: option :: Option < String > , xgafv : :: std :: option :: Option < crate :: params :: Xgafv > , }
                    impl<'a> ListRequestBuilder<'a> {
                        #[doc = "Message types to return. If not populated - INFO, WARNING and ERROR messages are returned."]
                        pub fn message_types(
                            mut self,
                        ...
                        pub fn stream_with_default_fields(
                            ...
                            Item = Result<crate::schemas::ListTransferLogsResponse, crate::Error>,
                        > + 'a {
                            self.stream_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the request and yield the returned value. If the response contains a"]
