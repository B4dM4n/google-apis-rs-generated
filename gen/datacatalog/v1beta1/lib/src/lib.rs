...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for GoogleCloudDatacatalogV1Beta1ListEntriesResponse {
    ...
    impl crate::GetNextPageToken<String> for GoogleCloudDatacatalogV1Beta1ListEntryGroupsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for GoogleCloudDatacatalogV1Beta1ListPolicyTagsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for GoogleCloudDatacatalogV1Beta1ListTagsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for GoogleCloudDatacatalogV1Beta1ListTaxonomiesResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl ::google_field_selector::FieldSelector
        for GoogleCloudDatacatalogV1Beta1RenameTagTemplateFieldEnumValueRequest
    {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    ...
    impl crate::GetNextPageToken<String> for GoogleCloudDatacatalogV1Beta1SearchCatalogResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct GoogleCloudDatacatalogV1Beta1Taxonomy {
        ...
        #[doc = "Output only. Identity of the service which owns the Taxonomy. This field is only populated when the taxonomy is created by a GCP service. Currently only ‘DATAPLEX’ is supported."]
        #[serde(
            rename = "service",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub service:
            ::std::option::Option<crate::schemas::GoogleCloudDatacatalogV1Beta1TaxonomyService>,
    ...
    pub struct GoogleCloudDatacatalogV1Beta1TaxonomyService {
        #[doc = "P4SA Identity of the service."]
        #[serde(
            rename = "identity",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub name:
            ::std::option::Option<crate::schemas::GoogleCloudDatacatalogV1Beta1TaxonomyServiceName>,
    }
    impl ::google_field_selector::FieldSelector for GoogleCloudDatacatalogV1Beta1TaxonomyService {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudDatacatalogV1Beta1TaxonomyService {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum GoogleCloudDatacatalogV1Beta1TaxonomyServiceName {
        #[doc = "Dataplex."]
    ...
    impl GoogleCloudDatacatalogV1Beta1TaxonomyServiceName {
        pub fn as_str(self) -> &'static str {
            match self {
                GoogleCloudDatacatalogV1Beta1TaxonomyServiceName::ManagingSystemDataplex => {
                    "MANAGING_SYSTEM_DATAPLEX"
                }
                GoogleCloudDatacatalogV1Beta1TaxonomyServiceName::ManagingSystemOther => {
                    "MANAGING_SYSTEM_OTHER"
                }
                GoogleCloudDatacatalogV1Beta1TaxonomyServiceName::ManagingSystemUnspecified => {
                    "MANAGING_SYSTEM_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for GoogleCloudDatacatalogV1Beta1TaxonomyServiceName {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for GoogleCloudDatacatalogV1Beta1TaxonomyServiceName {
        type Err = ();
        fn from_str(
            s: &str,
        ) -> ::std::result::Result<GoogleCloudDatacatalogV1Beta1TaxonomyServiceName, ()> {
            Ok(match s {
                "MANAGING_SYSTEM_DATAPLEX" => {
                    GoogleCloudDatacatalogV1Beta1TaxonomyServiceName::ManagingSystemDataplex
                }
    ...
    impl ::std::fmt::Display for GoogleCloudDatacatalogV1Beta1TaxonomyServiceName {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for GoogleCloudDatacatalogV1Beta1TaxonomyServiceName {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for GoogleCloudDatacatalogV1Beta1TaxonomyServiceName {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudDatacatalogV1Beta1TaxonomyServiceName {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudDatacatalogV1Beta1TaxonomyServiceName {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudDatacatalogV1ImportEntriesMetadata {
        #[doc = "Partial errors that are encountered during the ImportEntries operation. There is no guarantee that all the encountered errors are reported. However, if no errors are reported, it means that no errors were encountered."]
        #[serde(
            rename = "errors",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "State of the import operation."]
        #[serde(
            rename = "state",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub state: ::std::option::Option<
            crate::schemas::GoogleCloudDatacatalogV1ImportEntriesMetadataState,
        >,
    }
    impl ::google_field_selector::FieldSelector for GoogleCloudDatacatalogV1ImportEntriesMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudDatacatalogV1ImportEntriesMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum GoogleCloudDatacatalogV1ImportEntriesMetadataState {
        #[doc = "The import of entries has been finished."]
        ImportDone,
        #[doc = "The import of entries is in progress."]
        ImportInProgress,
        #[doc = "The import of entries has been abandoned in favor of a newer request."]
        ImportObsolete,
        #[doc = "The dump with entries has been queued for import."]
        ImportQueued,
        #[doc = "Default value. This value is unused."]
        ImportStateUnspecified,
    }
    impl GoogleCloudDatacatalogV1ImportEntriesMetadataState {
        pub fn as_str(self) -> &'static str {
            match self {
                GoogleCloudDatacatalogV1ImportEntriesMetadataState::ImportDone => "IMPORT_DONE",
                GoogleCloudDatacatalogV1ImportEntriesMetadataState::ImportInProgress => {
                    "IMPORT_IN_PROGRESS"
                }
                GoogleCloudDatacatalogV1ImportEntriesMetadataState::ImportObsolete => {
                    "IMPORT_OBSOLETE"
                }
                GoogleCloudDatacatalogV1ImportEntriesMetadataState::ImportQueued => "IMPORT_QUEUED",
                GoogleCloudDatacatalogV1ImportEntriesMetadataState::ImportStateUnspecified => {
                    "IMPORT_STATE_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for GoogleCloudDatacatalogV1ImportEntriesMetadataState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for GoogleCloudDatacatalogV1ImportEntriesMetadataState {
        type Err = ();
        fn from_str(
            s: &str,
        ) -> ::std::result::Result<GoogleCloudDatacatalogV1ImportEntriesMetadataState, ()> {
            Ok(match s {
                "IMPORT_DONE" => GoogleCloudDatacatalogV1ImportEntriesMetadataState::ImportDone,
                "IMPORT_IN_PROGRESS" => {
                    GoogleCloudDatacatalogV1ImportEntriesMetadataState::ImportInProgress
                }
                "IMPORT_OBSOLETE" => {
                ...
                "IMPORT_QUEUED" => GoogleCloudDatacatalogV1ImportEntriesMetadataState::ImportQueued,
                "IMPORT_STATE_UNSPECIFIED" => {
                    GoogleCloudDatacatalogV1ImportEntriesMetadataState::ImportStateUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for GoogleCloudDatacatalogV1ImportEntriesMetadataState {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for GoogleCloudDatacatalogV1ImportEntriesMetadataState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for GoogleCloudDatacatalogV1ImportEntriesMetadataState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudDatacatalogV1ImportEntriesMetadataState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudDatacatalogV1ImportEntriesMetadataState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudDatacatalogV1ImportEntriesResponse {
        #[doc = "Number of entries deleted as a result of import operation."]
        #[serde(
            rename = "deletedEntriesCount",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        #[serde(with = "crate::parsed_string")]
        pub deleted_entries_count: ::std::option::Option<i64>,
        #[doc = "Cumulative number of entries created and entries updated as a result of import operation."]
        #[serde(
            rename = "upsertedEntriesCount",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        #[serde(with = "crate::parsed_string")]
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudDatacatalogV1ImportEntriesResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudDatacatalogV1ImportEntriesResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    ...
    pub mod entries {
        ...
        pub struct LookupRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            linked_resource: ::std::option::Option<String>,
            sql_resource: ::std::option::Option<String>,
            access_token: ::std::option::Option<String>,
            alt: ::std::option::Option<crate::params::Alt>,
            callback: ::std::option::Option<String>,
            fields: ::std::option::Option<String>,
        ...
        pub mod locations {
            ...
            pub mod entry_groups {
                ...
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::GoogleCloudDatacatalogV1Beta1EntryGroup,
                    parent: String,
                    entry_group_id: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `entryGroups` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_entry_groups<T>(
                        self,
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_entry_groups_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `entryGroups` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_entry_groups_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<
                        ...
                        >,
                    > + 'a {
                        self.stream_entry_groups_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `entryGroups` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_entry_groups_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<
                            crate::schemas::GoogleCloudDatacatalogV1Beta1EntryGroup,
                        ...
                        >,
                    > + 'a {
                        self.stream_entry_groups_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `entryGroups` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_entry_groups_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                ...
                pub mod entries {
                    ...
                    pub struct CreateRequestBuilder<'a> {
                        ...
                        request: crate::schemas::GoogleCloudDatacatalogV1Beta1Entry,
                        parent: String,
                        entry_id: ::std::option::Option<String>,
                        access_token: ::std::option::Option<String>,
                        alt: ::std::option::Option<crate::params::Alt>,
                        callback: ::std::option::Option<String>,
                        fields: ::std::option::Option<String>,
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        #[doc = "\nExecute the request and yield each item in the `entries` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                        pub fn stream_entries<T>(
                            self,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                            T: ::serde::de::DeserializeOwned
                                ...
                                + 'a,
                        {
                            ...
                            self.stream_entries_with_fields(fields)
                        }
                        #[doc = "\nExecute the request and yield each item in the `entries` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                        pub fn stream_entries_with_default_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<
                            ...
                            >,
                        > + 'a {
                            self.stream_entries_with_fields(None::<String>)
                        }
                        #[doc = "\nExecute the request and yield each item in the `entries` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                        pub fn stream_entries_with_all_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<
                                crate::schemas::GoogleCloudDatacatalogV1Beta1Entry,
                            ...
                            >,
                        > + 'a {
                            self.stream_entries_with_fields(Some("*"))
                        }
                        #[doc = "\nExecute the request and yield each item in the `entries` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                        pub fn stream_entries_with_fields<T, F>(
                            mut self,
                            fields: ::std::option::Option<F>,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
            ...
            pub mod tag_templates {
                ...
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::GoogleCloudDatacatalogV1Beta1TagTemplate,
                    parent: String,
                    tag_template_id: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                pub mod fields {
                    ...
                    pub struct CreateRequestBuilder<'a> {
                        ...
                        request: crate::schemas::GoogleCloudDatacatalogV1Beta1TagTemplateField,
                        parent: String,
                        tag_template_field_id: ::std::option::Option<String>,
                        access_token: ::std::option::Option<String>,
                        alt: ::std::option::Option<crate::params::Alt>,
                        callback: ::std::option::Option<String>,
                        fields: ::std::option::Option<String>,
                    ...
                    pub mod enum_values {
                        ...
                        #[derive(Debug, Clone)]
                        pub struct RenameRequestBuilder < 'a > { pub (crate) reqwest : & 'a :: reqwest :: Client , pub (crate) auth : & 'a dyn :: google_api_auth :: GetAccessToken , request : crate :: schemas :: GoogleCloudDatacatalogV1Beta1RenameTagTemplateFieldEnumValueRequest , name : String , access_token : :: std :: option :: Option < String > , alt : :: std :: option :: Option < crate :: params :: Alt > , callback : :: std :: option :: Option < String > , fields : :: std :: option :: Option < String > , key : :: std :: option :: Option < String > , oauth_token : :: std :: option :: Option < String > , pretty_print : :: std :: option :: Option < bool > , quota_user : :: std :: option :: Option < String > , upload_protocol : :: std :: option :: Option < String > , upload_type : :: std :: option :: Option < String > , xgafv : :: std :: option :: Option < crate :: params :: Xgafv > , }
                        impl<'a> RenameRequestBuilder<'a> {
                            #[doc = "OAuth access token."]
                            pub fn access_token(mut self, value: impl Into<String>) -> Self {
                                self.access_token = Some(value.into());
            ...
            pub mod taxonomies {
                ...
                pub struct ExportRequestBuilder<'a> {
                    ...
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    parent: String,
                    serialized_taxonomies: ::std::option::Option<bool>,
                    taxonomies: ::std::option::Option<Vec<String>>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    #[doc = "Supported field for filter is ‘service’ and value is ‘dataplex’. Eg: service=dataplex."]
                    ...
                    #[doc = "\nExecute the request and yield each item in the `taxonomies` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_taxonomies<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_taxonomies_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `taxonomies` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_taxonomies_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<
                        ...
                        >,
                    > + 'a {
                        self.stream_taxonomies_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `taxonomies` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_taxonomies_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<
                            crate::schemas::GoogleCloudDatacatalogV1Beta1Taxonomy,
                        ...
                        >,
                    > + 'a {
                        self.stream_taxonomies_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `taxonomies` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_taxonomies_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                ...
                pub mod policy_tags {
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        #[doc = "\nExecute the request and yield each item in the `policyTags` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                        pub fn stream_policy_tags<T>(
                            self,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                            T: ::serde::de::DeserializeOwned
                                ...
                                + 'a,
                        {
                            ...
                            self.stream_policy_tags_with_fields(fields)
                        }
                        #[doc = "\nExecute the request and yield each item in the `policyTags` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                        pub fn stream_policy_tags_with_default_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<
                                crate::schemas::GoogleCloudDatacatalogV1Beta1PolicyTag,
                            ...
                            >,
                        > + 'a {
                            self.stream_policy_tags_with_fields(None::<String>)
                        }
                        #[doc = "\nExecute the request and yield each item in the `policyTags` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                        pub fn stream_policy_tags_with_all_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<
                                crate::schemas::GoogleCloudDatacatalogV1Beta1PolicyTag,
                            ...
                            >,
                        > + 'a {
                            self.stream_policy_tags_with_fields(Some("*"))
                        }
                        #[doc = "\nExecute the request and yield each item in the `policyTags` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                        pub fn stream_policy_tags_with_fields<T, F>(
                            mut self,
                            fields: ::std::option::Option<F>,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
