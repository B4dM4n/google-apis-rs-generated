...
pub mod schemas {
    ...
    pub struct AnalyzePackagesRequestV1 {
        #[doc = "\\[DEPRECATED\\] Whether to include OSV data in the scan. For backwards compatibility reasons, this field can be neither removed nor renamed."]
        #[serde(
            rename = "includeOsvData",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub include_osv_data: ::std::option::Option<bool>,
    ...
    impl ::google_field_selector::FieldSelector for AnalyzePackagesRequestV1 {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AnalyzePackagesRequestV1 {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for ListVulnerabilitiesResponseV1 {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListVulnerabilitiesResponseV1 {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
            ...
            pub mod scans {
                ...
                impl<'a> ScansActions<'a> {
                    ...
                    pub fn analyze_packages(
                        &self,
                        request: crate::schemas::AnalyzePackagesRequestV1,
                ...
                pub mod vulnerabilities {
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        pub fn stream_with_default_fields(
                            ...
                            Item = Result<
                                crate::schemas::ListVulnerabilitiesResponseV1,
                                crate::Error,
                            >,
                        > + 'a {
                            self.stream_with_fields(None::<&str>)
                        ...
                        pub async fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::ListVulnerabilitiesResponseV1, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>).await
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
