...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("beyondcorp1_alpha")
        ...
        let mut locations1 = SubCommand::with_name("locations")
            .setting(AppSettings::ColoredHelp)
            .about("sub-resources: insights and subscriptions");
        let mut locations1 = SubCommand::with_name("locations")
            .setting(AppSettings::ColoredHelp)
        ...
        let mut insights2 = SubCommand::with_name("insights")
            .setting(AppSettings::ColoredHelp)
            .about("methods: configured_insight, get and list");
        {
            let mcmd = SubCommand::with_name("configured_insight").about("Gets the value for a selected particular insight based on the provided filters. Use the organization level path for fetching at org level and project level path for fetching the insight value specific to a particular project.");
            insights2 = insights2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get").about("Gets the value for a selected particular insight with default configuration. The default aggregation level is 'DAILY' and no grouping will be applied or default grouping if applicable. The data will be returned for recent 7 days starting the day before. The insight data size will be limited to 50 rows. Use the organization level path for fetching at org level and project level path for fetching the insight value specific to a particular project. Setting the `view` to `BASIC` will only return the metadata for the insight.");
            insights2 = insights2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Lists for all the available insights that could be fetched from the system. Allows to filter using category. Setting the `view` to `BASIC` will let you iterate over the list of insight metadatas.");
            insights2 = insights2.subcommand(mcmd);
        }
        ...
        {
            let mcmd = SubCommand::with_name("create").about("Creates a new BeyondCorp Enterprise Subscription in a given organization. Location will always be global as BeyondCorp subscriptions are per organization.");
            subscriptions2 = subscriptions2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get").about("Gets details of a single Subscription.");
            subscriptions2 = subscriptions2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list")
                .about("Lists Subscriptions in a given organization and location.");
            subscriptions2 = subscriptions2.subcommand(mcmd);
        }
        ...
        let mut applications2 = SubCommand::with_name("applications")
            .setting(AppSettings::ColoredHelp)
            .about("methods: get_iam_policy, set_iam_policy and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("get_iam_policy").about("Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.");
            applications2 = applications2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.");
            applications2 = applications2.subcommand(mcmd);
        ...
        {
            let mcmd = SubCommand::with_name("resolve").about("Resolves connections details for a given connector. An internal method called by a connector to find connections to connect to.");
            connections2 = connections2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.");
        ...
        let mut connectors2 = SubCommand::with_name("connectors")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: create, delete, get, get_iam_policy, list, patch, report_status, resolve_instance_config, set_iam_policy and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("create")
                .about("Creates a new Connector in a given project and location.");
            connectors2 = connectors2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes a single Connector.");
            connectors2 = connectors2.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("patch")
                .about("Updates the parameters of a single Connector.");
            connectors2 = connectors2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("report_status")
        ...
        {
            let mcmd = SubCommand::with_name("resolve_instance_config").about("Gets instance configuration for a given connector. An internal method called by a connector to get its container config.");
            connectors2 = connectors2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.");
        ...
        let mut net_connections2 = SubCommand::with_name("net_connections")
            .setting(AppSettings::ColoredHelp)
            .about("methods: get_iam_policy, set_iam_policy and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("get_iam_policy").about("Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.");
            net_connections2 = net_connections2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.");
            net_connections2 = net_connections2.subcommand(mcmd);
        ...
        locations1 = locations1.subcommand(net_connections2);
        locations1 = locations1.subcommand(insights2);
        locations1 = locations1.subcommand(connectors2);
        ...
        locations1 = locations1.subcommand(applications2);
        ...
        locations1 = locations1.subcommand(subscriptions2);
        locations1 = locations1.subcommand(insights2);
...
use google_beyondcorp1_alpha as api;
