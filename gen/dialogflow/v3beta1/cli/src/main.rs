...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("dialogflow3_beta1")
        ...
        {
            let mcmd = SubCommand::with_name("create").about("Creates an agent in the specified location. Note: You should always train a flow prior to sending it queries. See the [training documentation](https://cloud.google.com/dialogflow/cx/docs/concept/training).");
        ...
        {
            let mcmd = SubCommand::with_name("patch").about("Updates the specified agent. Note: You should always train a flow prior to sending it queries. See the [training documentation](https://cloud.google.com/dialogflow/cx/docs/concept/training).");
            agents2 = agents2.subcommand(mcmd);
        }
        {
...
use google_dialogflow3_beta1 as api;
