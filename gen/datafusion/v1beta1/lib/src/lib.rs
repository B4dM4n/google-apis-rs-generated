...
pub mod schemas {
    ...
    pub struct Accelerator {
        ...
        pub state: ::std::option::Option<crate::schemas::AcceleratorState>,
    }
    ...
    impl AcceleratorState {
        pub fn as_str(self) -> &'static str {
            match self {
                AcceleratorState::Disabled => "DISABLED",
                AcceleratorState::Enabled => "ENABLED",
                AcceleratorState::StateUnspecified => "STATE_UNSPECIFIED",
                AcceleratorState::Unknown => "UNKNOWN",
            }
        }
    }
    impl ::std::convert::AsRef<str> for AcceleratorState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for AcceleratorState {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<AcceleratorState, ()> {
            Ok(match s {
                "DISABLED" => AcceleratorState::Disabled,
                "ENABLED" => AcceleratorState::Enabled,
                "STATE_UNSPECIFIED" => AcceleratorState::StateUnspecified,
                "UNKNOWN" => AcceleratorState::Unknown,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for AcceleratorState {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for AcceleratorState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for AcceleratorState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for AcceleratorState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AcceleratorState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct DnsPeering {
        #[doc = "Optional. Optional description of the dns zone."]
        #[serde(
            rename = "description",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Required. The dns name suffix of the zone."]
        #[serde(
            rename = "domain",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Required. The resource name of the dns peering zone. Format: projects/{project}/locations/{location}/instances/{instance}/dnsPeerings/{dns_peering}"]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Optional. Optional target network to which dns peering should happen."]
        #[serde(
            rename = "targetNetwork",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub target_network: ::std::option::Option<String>,
        #[doc = "Optional. Optional target project to which dns peering should happen."]
        #[serde(
    ...
    impl ::google_field_selector::FieldSelector for DnsPeering {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DnsPeering {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct EventPublishConfig {
        #[doc = "Required. Option to enable Event Publishing."]
        #[serde(
            rename = "enabled",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Required. The resource name of the Pub/Sub topic. Format: projects/{project_id}/topics/{topic_id}"]
        #[serde(
            rename = "topic",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for EventPublishConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for EventPublishConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Iampolicy {
        #[doc = "Policy definition if IAM policy fetching is successful, otherwise empty."]
        #[serde(
            rename = "policy",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Status of iam policy fetching."]
        #[serde(
            rename = "status",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct Instance {
        ...
        pub dataproc_service_account: ::std::option::Option<String>,
        ...
        #[doc = "Option to enable zone separation."]
        #[serde(
            rename = "enableZoneSeparation",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub enable_zone_separation: ::std::option::Option<bool>,
        #[doc = "Option to enable and pass metadata for event publishing."]
        #[serde(
            rename = "eventPublishConfig",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub event_publish_config: ::std::option::Option<crate::schemas::EventPublishConfig>,
    ...
    pub struct ListAvailableVersionsResponse {
        ...
        pub available_versions: ::std::option::Option<Vec<crate::schemas::Version>>,
    ...
    impl ::google_field_selector::FieldSelector for ListAvailableVersionsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListAvailableVersionsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListAvailableVersionsResponse {
    ...
    pub struct ListDnsPeeringsResponse {
        #[doc = "List of dns peering."]
        #[serde(
            rename = "dnsPeerings",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub dns_peerings: ::std::option::Option<Vec<crate::schemas::DnsPeering>>,
    ...
    impl ::google_field_selector::FieldSelector for ListDnsPeeringsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListDnsPeeringsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListDnsPeeringsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for ListNamespacesResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct Namespace {
        #[doc = "IAM policy associated with this namespace."]
        #[serde(
            rename = "iamPolicy",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Name of the given namespace."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct OperationMetadata {
        ...
        pub additional_status: ::std::option::Option<::std::collections::BTreeMap<String, String>>,
    ...
    pub struct Version {
        ...
        #[serde(
            rename = "availableFeatures",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub available_features: ::std::option::Option<Vec<String>>,
    ...
    pub enum VersionType {
        #[doc = "Version is available for public use Version is under development and not considered stable"]
    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                pub fn versions(
                    &self,
                ) -> crate::resources::projects::locations::versions::VersionsActions
                {
                    crate::resources::projects::locations::versions::VersionsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            #[doc = "Created via [LocationsActions::remove_iam_policy()](struct.LocationsActions.html#method.remove_iam_policy)"]
            #[derive(Debug, Clone)]
            ...
            pub mod instances {
                ...
                impl<'a> InstancesActions<'a> {
                    ...
                    #[doc = "Restart a single Data Fusion instance. At the end of an operation instance is fully restarted."]
                    pub fn restart(
                        &self,
                    ...
                    #[doc = "Upgrade a single Data Fusion instance. At the end of an operation instance is fully upgraded."]
                    pub fn upgrade(
                        &self,
                    ...
                    #[doc = "Actions that can be performed on the dns_peerings resource"]                    pub fn dns_peerings (& self) -> crate :: resources :: projects :: locations :: instances :: dns_peerings :: DnsPeeringsActions{
                        crate :: resources :: projects :: locations :: instances :: dns_peerings :: DnsPeeringsActions { reqwest : & self . reqwest , auth : self . auth_ref () , }
                    }
                    #[doc = "Actions that can be performed on the namespaces resource"]                    pub fn namespaces (& self) -> crate :: resources :: projects :: locations :: instances :: namespaces :: NamespacesActions{
                        crate :: resources :: projects :: locations :: instances :: namespaces :: NamespacesActions { reqwest : & self . reqwest , auth : self . auth_ref () , }
                    }
                }
                ...
                pub mod dns_peerings {
                    pub mod params {}
                    pub struct DnsPeeringsActions<'a> {
                        pub(crate) reqwest: &'a reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    }
                    impl<'a> DnsPeeringsActions<'a> {
                        fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                            self.auth
                        }
                        #[doc = "Creates DNS peering on the given resource."]
                        pub fn create(
                            &self,
                            request: crate::schemas::DnsPeering,
                            parent: impl Into<String>,
                        ) -> CreateRequestBuilder {
                            CreateRequestBuilder {
                                reqwest: &self.reqwest,
                        ...
                        #[doc = "Deletes DNS peering on the given resource."]
                        pub fn delete(&self, name: impl Into<String>) -> DeleteRequestBuilder {
                            DeleteRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                        ...
                        #[doc = "Lists DNS peerings for a given resource."]
                        pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                            ListRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                    ...
                    #[doc = "Created via [DnsPeeringsActions::create()](struct.DnsPeeringsActions.html#method.create)"]
                    #[derive(Debug, Clone)]
                    pub struct CreateRequestBuilder<'a> {
                        pub(crate) reqwest: &'a ::reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                        request: crate::schemas::DnsPeering,
                        parent: String,
                        dns_peering_id: ::std::option::Option<String>,
                        access_token: ::std::option::Option<String>,
                        alt: ::std::option::Option<crate::params::Alt>,
                        callback: ::std::option::Option<String>,
                        fields: ::std::option::Option<String>,
                    ...
                    impl<'a> CreateRequestBuilder<'a> {
                        #[doc = "Required. The name of the peering to create."]
                        pub fn dns_peering_id(mut self, value: impl Into<String>) -> Self {
                            self.dns_peering_id = Some(value.into());
                            self
                        }
                        #[doc = "OAuth access token."]
                        pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        ...
                        pub async fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::DnsPeering, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>).await
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
                        ...
                        {
                            let mut req = self.reqwest.request(::reqwest::Method::POST, path);
                            req = req.query(&[("dnsPeeringId", &self.dns_peering_id)]);
                            req = req.query(&[("access_token", &self.access_token)]);
                            req = req.query(&[("alt", &self.alt)]);
                            req = req.query(&[("callback", &self.callback)]);
                            req = req.query(&[("fields", &self.fields)]);
                    ...
                    #[doc = "Created via [DnsPeeringsActions::delete()](struct.DnsPeeringsActions.html#method.delete)"]
                    #[derive(Debug, Clone)]
                    pub struct DeleteRequestBuilder<'a> {
                        pub(crate) reqwest: &'a ::reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    ...
                    #[doc = "Created via [DnsPeeringsActions::list()](struct.DnsPeeringsActions.html#method.list)"]
                    #[derive(Debug, Clone)]
                    pub struct ListRequestBuilder<'a> {
                        pub(crate) reqwest: &'a ::reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        #[doc = "The maximum number of dns peerings to return. The service may return fewer than this value. If unspecified, at most 50 dns peerings will be returned. The maximum value is 200; values above 200 will be coerced to 200."]
                        pub fn page_size(mut self, value: i32) -> Self {
                            self.page_size = Some(value);
                            self
                        }
                        #[doc = "A page token, received from a previous `ListDnsPeerings` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListDnsPeerings` must match the call that provided the page token."]
                        pub fn page_token(mut self, value: impl Into<String>) -> Self {
                            self.page_token = Some(value.into());
                            self
                        }
                        ...
                        #[doc = "\nExecute the request and yield each item in the `dnsPeerings` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                        pub fn stream_dns_peerings<T>(
                            self,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                            T: ::serde::de::DeserializeOwned
                                ...
                                + 'a,
                        {
                            ...
                            self.stream_dns_peerings_with_fields(fields)
                        }
                        #[doc = "\nExecute the request and yield each item in the `dnsPeerings` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                        pub fn stream_dns_peerings_with_default_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::DnsPeering, crate::Error>,
                        > + 'a {
                            self.stream_dns_peerings_with_fields(None::<String>)
                        }
                        #[doc = "\nExecute the request and yield each item in the `dnsPeerings` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                        pub fn stream_dns_peerings_with_all_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::DnsPeering, crate::Error>,
                        > + 'a {
                            self.stream_dns_peerings_with_fields(Some("*"))
                        }
                        #[doc = "\nExecute the request and yield each item in the `dnsPeerings` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                        pub fn stream_dns_peerings_with_fields<T, F>(
                            mut self,
                            fields: ::std::option::Option<F>,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                            ...
                            F: AsRef<str>,
                        {
                            ...
                            self.fields = Some({
                                let mut selector =
                                    concat!("nextPageToken,", "dnsPeerings").to_owned();
                                let items_fields =
                        ...
                        pub fn stream_with_default_fields(
                            ...
                            Item = Result<crate::schemas::ListDnsPeeringsResponse, crate::Error>,
                        > + 'a {
                            self.stream_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                        ...
                        pub async fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::ListDnsPeeringsResponse, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>).await
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                pub mod namespaces {
                    pub mod params {
                        #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
                        pub enum ListView {
                            #[doc = "Show the most basic metadata of a namespace"]
                            NamespaceViewBasic,
                            #[doc = "Returns all metadata of a namespace"]
                            NamespaceViewFull,
                            #[doc = "Default/unset value, which will use BASIC view."]
                            NamespaceViewUnspecified,
                        }
                        impl ListView {
                            pub fn as_str(self) -> &'static str {
                                match self {
                                    ListView::NamespaceViewBasic => "NAMESPACE_VIEW_BASIC",
                                    ListView::NamespaceViewFull => "NAMESPACE_VIEW_FULL",
                                    ListView::NamespaceViewUnspecified => {
                        ...
                        impl ::std::str::FromStr for ListView {
                            ...
                            fn from_str(s: &str) -> ::std::result::Result<ListView, ()> {
                                Ok(match s {
                                    "NAMESPACE_VIEW_BASIC" => ListView::NamespaceViewBasic,
                                    "NAMESPACE_VIEW_FULL" => ListView::NamespaceViewFull,
                                    "NAMESPACE_VIEW_UNSPECIFIED" => {
                                        ListView::NamespaceViewUnspecified
                                    }
                                    _ => return Err(()),
                    ...
                    #[derive(Debug, Clone)]
                    pub struct ListRequestBuilder < 'a > { pub (crate) reqwest : & 'a :: reqwest :: Client , pub (crate) auth : & 'a dyn :: google_api_auth :: GetAccessToken , parent : String , page_size : :: std :: option :: Option < i32 > , page_token : :: std :: option :: Option < String > , view : :: std :: option :: Option < crate :: resources :: projects :: locations :: instances :: namespaces :: params :: ListView > , access_token : :: std :: option :: Option < String > , alt : :: std :: option :: Option < crate :: params :: Alt > , callback : :: std :: option :: Option < String > , fields : :: std :: option :: Option < String > , key : :: std :: option :: Option < String > , oauth_token : :: std :: option :: Option < String > , pretty_print : :: std :: option :: Option < bool > , quota_user : :: std :: option :: Option < String > , upload_protocol : :: std :: option :: Option < String > , upload_type : :: std :: option :: Option < String > , xgafv : :: std :: option :: Option < crate :: params :: Xgafv > , }
                    impl<'a> ListRequestBuilder<'a> {
                        #[doc = "The maximum number of items to return."]
                        pub fn page_size(mut self, value: i32) -> Self {
                            self.page_size = Some(value);
                        ...
                        #[doc = "By default, only basic information about a namespace is returned (e.g. name). When `NAMESPACE_VIEW_FULL` is specified, additional information associated with a namespace gets returned (e.g. IAM policy set on the namespace)"]
                        pub fn view(
                            mut self,
                            value : crate :: resources :: projects :: locations :: instances :: namespaces :: params :: ListView,
                        ) -> Self {
                        ...
                        pub fn stream_namespaces_with_default_fields(
                            ...
                            Item = Result<crate::schemas::Namespace, crate::Error>,
                        > + 'a {
                            ...
                            F: AsRef<str>,
                        {
                            ...
                            self.fields = Some({
                                let mut selector =
                                    concat!("nextPageToken,", "namespaces").to_owned();
                                let items_fields =
                                    fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                                if !items_fields.is_empty() {
                                    selector.push_str("(");
            ...
            pub mod versions {
                ...
                impl<'a> VersionsActions<'a> {
                    ...
                    #[doc = "Lists possible versions for Data Fusion instances in the specified project and location."]
                    pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                        ListRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                ...
                pub struct ListRequestBuilder<'a> {
                    ...
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    parent: String,
                    latest_patch_only: ::std::option::Option<bool>,
                    page_size: ::std::option::Option<i32>,
                    page_token: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn latest_patch_only(mut self, value: bool) -> Self {
                        self.latest_patch_only = Some(value);
                        self
                    }
                    #[doc = "The maximum number of items to return."]
                    pub fn page_size(mut self, value: i32) -> Self {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `availableVersions` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_available_versions<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_available_versions_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `availableVersions` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_available_versions_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Version, crate::Error>> + 'a
                    {
                        self.stream_available_versions_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `availableVersions` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_available_versions_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Version, crate::Error>> + 'a
                    {
                        self.stream_available_versions_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `availableVersions` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_available_versions_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        self.fields = Some({
                            let mut selector =
                                concat!("nextPageToken,", "availableVersions").to_owned();
                            let items_fields = fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                            if !items_fields.is_empty() {
                                selector.push_str("(");
                                selector.push_str(items_fields);
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListAvailableVersionsResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ListAvailableVersionsResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    ...
                    async fn _request(
                        ...
                        let mut req = self.reqwest.request(::reqwest::Method::GET, path);
                        req = req.query(&[("latestPatchOnly", &self.latest_patch_only)]);
                        req = req.query(&[("pageSize", &self.page_size)]);
                        req = req.query(&[("pageToken", &self.page_token)]);
                        req = req.query(&[("access_token", &self.access_token)]);
                        req = req.query(&[("alt", &self.alt)]);
