...
pub mod schemas {
    ...
    impl crate::GetNextPageToken for ListDeploymentsResponse {
    ...
    impl crate::GetNextPageToken for ListScriptProcessesResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken for ListUserProcessesResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
