...
impl Client {
    ...
    pub fn entities(&self) -> crate::resources::entities::EntitiesActions {
        crate::resources::entities::EntitiesActions {
...
pub mod resources {
    pub mod entities {
        ...
        pub struct SearchRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            ids: ::std::option::Option<Vec<String>>,
            indent: ::std::option::Option<bool>,
            languages: ::std::option::Option<Vec<String>>,
            limit: ::std::option::Option<i32>,
            prefix: ::std::option::Option<bool>,
            query: ::std::option::Option<String>,
            types: ::std::option::Option<Vec<String>>,
        ...
        impl<'a> SearchRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://kgsearch.googleapis.com/".to_owned();
