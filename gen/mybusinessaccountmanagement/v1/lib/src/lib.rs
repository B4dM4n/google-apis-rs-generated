...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for AcceptInvitationRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AcceptInvitationRequest {
    ...
    pub struct Account {
        ...
        pub organization_info: ::std::option::Option<crate::schemas::OrganizationInfo>,
        ...
        pub primary_owner: ::std::option::Option<String>,
        ...
        pub r#type: ::std::option::Option<crate::schemas::AccountType>,
        ...
        pub role: ::std::option::Option<crate::schemas::AccountRole>,
        ...
        pub verification_state: ::std::option::Option<crate::schemas::AccountVerificationState>,
        ...
        pub vetted_state: ::std::option::Option<crate::schemas::AccountVettedState>,
    }
    ...
    impl AccountPermissionLevel {
        pub fn as_str(self) -> &'static str {
            match self {
                AccountPermissionLevel::MemberLevel => "MEMBER_LEVEL",
                AccountPermissionLevel::OwnerLevel => "OWNER_LEVEL",
                AccountPermissionLevel::PermissionLevelUnspecified => {
    ...
    impl ::std::str::FromStr for AccountPermissionLevel {
        ...
        fn from_str(s: &str) -> ::std::result::Result<AccountPermissionLevel, ()> {
            Ok(match s {
                "MEMBER_LEVEL" => AccountPermissionLevel::MemberLevel,
                "OWNER_LEVEL" => AccountPermissionLevel::OwnerLevel,
                "PERMISSION_LEVEL_UNSPECIFIED" => {
                    AccountPermissionLevel::PermissionLevelUnspecified
                }
                _ => return Err(()),
    ...
    impl AccountType {
        pub fn as_str(self) -> &'static str {
            match self {
                AccountType::AccountTypeUnspecified => "ACCOUNT_TYPE_UNSPECIFIED",
                AccountType::LocationGroup => "LOCATION_GROUP",
                AccountType::Organization => "ORGANIZATION",
                AccountType::Personal => "PERSONAL",
                AccountType::UserGroup => "USER_GROUP",
            }
        }
    }
    ...
    impl ::std::str::FromStr for AccountType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<AccountType, ()> {
            Ok(match s {
                "ACCOUNT_TYPE_UNSPECIFIED" => AccountType::AccountTypeUnspecified,
                "LOCATION_GROUP" => AccountType::LocationGroup,
                "ORGANIZATION" => AccountType::Organization,
                "PERSONAL" => AccountType::Personal,
                "USER_GROUP" => AccountType::UserGroup,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for AccountType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AccountType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl AccountRole {
        pub fn as_str(self) -> &'static str {
            match self {
                AccountRole::AccountRoleUnspecified => "ACCOUNT_ROLE_UNSPECIFIED",
                AccountRole::Manager => "MANAGER",
                AccountRole::Owner => "OWNER",
                AccountRole::PrimaryOwner => "PRIMARY_OWNER",
                AccountRole::SiteManager => "SITE_MANAGER",
            }
        }
    }
    impl ::std::convert::AsRef<str> for AccountRole {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for AccountRole {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<AccountRole, ()> {
            Ok(match s {
                "ACCOUNT_ROLE_UNSPECIFIED" => AccountRole::AccountRoleUnspecified,
                "MANAGER" => AccountRole::Manager,
                "OWNER" => AccountRole::Owner,
                "PRIMARY_OWNER" => AccountRole::PrimaryOwner,
                "SITE_MANAGER" => AccountRole::SiteManager,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::serde::Serialize for AccountRole {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for AccountRole {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for AccountRole {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AccountRole {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl AccountVerificationState {
        pub fn as_str(self) -> &'static str {
            match self {
                AccountVerificationState::Unverified => "UNVERIFIED",
                AccountVerificationState::VerificationRequested => "VERIFICATION_REQUESTED",
                AccountVerificationState::VerificationStateUnspecified => {
                    "VERIFICATION_STATE_UNSPECIFIED"
                }
                AccountVerificationState::Verified => "VERIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for AccountVerificationState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for AccountVerificationState {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<AccountVerificationState, ()> {
            Ok(match s {
                "UNVERIFIED" => AccountVerificationState::Unverified,
                "VERIFICATION_REQUESTED" => AccountVerificationState::VerificationRequested,
                "VERIFICATION_STATE_UNSPECIFIED" => {
                    AccountVerificationState::VerificationStateUnspecified
                }
                "VERIFIED" => AccountVerificationState::Verified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for AccountVerificationState {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for AccountVerificationState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for AccountVerificationState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for AccountVerificationState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AccountVerificationState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum AccountVettedState {
    ...
    impl AccountVettedState {
        pub fn as_str(self) -> &'static str {
            match self {
                AccountVettedState::Invalid => "INVALID",
                AccountVettedState::NotVetted => "NOT_VETTED",
                AccountVettedState::Vetted => "VETTED",
                AccountVettedState::VettedStateUnspecified => "VETTED_STATE_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for AccountVettedState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for AccountVettedState {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<AccountVettedState, ()> {
            Ok(match s {
                "INVALID" => AccountVettedState::Invalid,
                "NOT_VETTED" => AccountVettedState::NotVetted,
                "VETTED" => AccountVettedState::Vetted,
                "VETTED_STATE_UNSPECIFIED" => AccountVettedState::VettedStateUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for AccountVettedState {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for AccountVettedState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for AccountVettedState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for AccountVettedState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AccountVettedState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Admin {
        ...
        #[serde(
            rename = "pendingInvitation",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub pending_invitation: ::std::option::Option<bool>,
        ...
        pub role: ::std::option::Option<crate::schemas::AdminRole>,
    }
    impl ::google_field_selector::FieldSelector for Admin {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for Admin {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl AdminRole {
        pub fn as_str(self) -> &'static str {
            match self {
                AdminRole::AdminRoleUnspecified => "ADMIN_ROLE_UNSPECIFIED",
                AdminRole::Manager => "MANAGER",
                AdminRole::Owner => "OWNER",
                AdminRole::PrimaryOwner => "PRIMARY_OWNER",
                AdminRole::SiteManager => "SITE_MANAGER",
            }
        }
    }
    impl ::std::convert::AsRef<str> for AdminRole {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for AdminRole {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<AdminRole, ()> {
            Ok(match s {
                "ADMIN_ROLE_UNSPECIFIED" => AdminRole::AdminRoleUnspecified,
                "MANAGER" => AdminRole::Manager,
                "OWNER" => AdminRole::Owner,
                "PRIMARY_OWNER" => AdminRole::PrimaryOwner,
                "SITE_MANAGER" => AdminRole::SiteManager,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::serde::Serialize for AdminRole {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for AdminRole {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for AdminRole {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AdminRole {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for DeclineInvitationRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DeclineInvitationRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Invitation {
        ...
        #[serde(
            rename = "targetAccount",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub target_account: ::std::option::Option<crate::schemas::Account>,
        ...
        pub target_location: ::std::option::Option<crate::schemas::TargetLocation>,
        ...
        pub target_type: ::std::option::Option<crate::schemas::InvitationTargetType>,
    }
    ...
    impl InvitationRole {
        pub fn as_str(self) -> &'static str {
            match self {
                InvitationRole::AdminRoleUnspecified => "ADMIN_ROLE_UNSPECIFIED",
                InvitationRole::Manager => "MANAGER",
                InvitationRole::Owner => "OWNER",
                InvitationRole::PrimaryOwner => "PRIMARY_OWNER",
                InvitationRole::SiteManager => "SITE_MANAGER",
            }
        }
    }
    ...
    impl ::std::str::FromStr for InvitationRole {
        ...
        fn from_str(s: &str) -> ::std::result::Result<InvitationRole, ()> {
            Ok(match s {
                "ADMIN_ROLE_UNSPECIFIED" => InvitationRole::AdminRoleUnspecified,
                "MANAGER" => InvitationRole::Manager,
                "OWNER" => InvitationRole::Owner,
                "PRIMARY_OWNER" => InvitationRole::PrimaryOwner,
                "SITE_MANAGER" => InvitationRole::SiteManager,
                _ => return Err(()),
            })
        }
    }
    ...
    impl InvitationTargetType {
        pub fn as_str(self) -> &'static str {
            match self {
                InvitationTargetType::AccountsOnly => "ACCOUNTS_ONLY",
                InvitationTargetType::LocationsOnly => "LOCATIONS_ONLY",
                InvitationTargetType::TargetTypeUnspecified => "TARGET_TYPE_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for InvitationTargetType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for InvitationTargetType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<InvitationTargetType, ()> {
            Ok(match s {
                "ACCOUNTS_ONLY" => InvitationTargetType::AccountsOnly,
                "LOCATIONS_ONLY" => InvitationTargetType::LocationsOnly,
                "TARGET_TYPE_UNSPECIFIED" => InvitationTargetType::TargetTypeUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for InvitationTargetType {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for InvitationTargetType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for InvitationTargetType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for InvitationTargetType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for InvitationTargetType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ListAccountAdminsResponse {
        ...
        #[serde(
            rename = "accountAdmins",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub account_admins: ::std::option::Option<Vec<crate::schemas::Admin>>,
    }
    impl ::google_field_selector::FieldSelector for ListAccountAdminsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListAccountAdminsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ListLocationAdminsResponse {
        ...
        pub admins: ::std::option::Option<Vec<crate::schemas::Admin>>,
    }
    impl ::google_field_selector::FieldSelector for ListLocationAdminsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListLocationAdminsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct OrganizationInfo {
        ...
        #[serde(
            rename = "registeredDomain",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub registered_domain: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for OrganizationInfo {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for OrganizationInfo {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for TargetLocation {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for TargetLocation {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct TransferLocationRequest {
        #[doc = "Required. Name of the account resource to transfer the location to (for example, \"accounts/{account}\")."]
        #[serde(
            rename = "destinationAccount",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub destination_account: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for TransferLocationRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for TransferLocationRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    pub mod accounts {
        ...
        impl<'a> AccountsActions<'a> {
            ...
            #[doc = "Creates an account with the specified name and type under the given parent. - Personal accounts and Organizations cannot be created. - User Groups cannot be created with a Personal account as primary owner. - Location Groups cannot be created with a primary owner of a Personal account if the Personal account is in an Organization. - Location Groups cannot own Location Groups."]
            pub fn create(&self, request: crate::schemas::Account) -> CreateRequestBuilder {
            ...
            #[doc = "Gets the specified account. Returns `NOT_FOUND` if the account does not exist or if the caller does not have access rights to it."]
            ...
            #[doc = "Lists all of the accounts for the authenticated user. This includes all accounts that the user owns, as well as any accounts for which the user has management rights."]
            ...
            #[doc = "Updates the specified business account. Personal accounts cannot be updated using this method."]
            pub fn patch(
                &self,
            ...
            #[doc = "Actions that can be performed on the admins resource"]
            pub fn admins(&self) -> crate::resources::accounts::admins::AdminsActions {
                crate::resources::accounts::admins::AdminsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
            ...
            pub fn invitations(
                &self,
            ) -> crate::resources::accounts::invitations::InvitationsActions {
                crate::resources::accounts::invitations::InvitationsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
        ...
        impl<'a> CreateRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://mybusinessaccountmanagement.googleapis.com/".to_owned();
        ...
        pub struct ListRequestBuilder<'a> {
            ...
            parent_account: ::std::option::Option<String>,
            access_token: ::std::option::Option<String>,
            alt: ::std::option::Option<crate::params::Alt>,
            callback: ::std::option::Option<String>,
            fields: ::std::option::Option<String>,
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn parent_account(mut self, value: impl Into<String>) -> Self {
                self.parent_account = Some(value.into());
                self
            }
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
            ...
            async fn _request(
                ...
                req = req.query(&[("parentAccount", &self.parent_account)]);
                req = req.query(&[("access_token", &self.access_token)]);
                req = req.query(&[("alt", &self.alt)]);
                req = req.query(&[("callback", &self.callback)]);
                req = req.query(&[("fields", &self.fields)]);
        ...
        pub mod admins {
            pub mod params {}
            pub struct AdminsActions<'a> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            }
            impl<'a> AdminsActions<'a> {
                fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                    self.auth
                }
                #[doc = "Invites the specified user to become an administrator for the specified account. The invitee must accept the invitation in order to be granted access to the account. See AcceptInvitation to programmatically accept an invitation."]
                pub fn create(
                    &self,
                    request: crate::schemas::Admin,
                ...
                #[doc = "Removes the specified admin from the specified account."]
                ...
                #[doc = "Lists the admins for the specified account."]
                ...
                #[doc = "Updates the Admin for the specified Account Admin."]
                pub fn patch(
                    &self,
                    request: crate::schemas::Admin,
                    name: impl Into<String>,
            ...
            #[doc = "Created via [AdminsActions::create()](struct.AdminsActions.html#method.create)"]
            #[derive(Debug, Clone)]
            pub struct CreateRequestBuilder<'a> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            ...
            impl<'a> CreateRequestBuilder<'a> {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::Admin, crate::Error> {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
                ...
                fn _path(&self) -> String {
                    let mut output =
                        "https://mybusinessaccountmanagement.googleapis.com/".to_owned();
                    output.push_str("v1/");
                    {
            ...
            #[doc = "Created via [AdminsActions::delete()](struct.AdminsActions.html#method.delete)"]
            #[derive(Debug, Clone)]
            ...
            #[doc = "Created via [AdminsActions::list()](struct.AdminsActions.html#method.list)"]
            #[derive(Debug, Clone)]
            pub struct ListRequestBuilder<'a> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::ListAccountAdminsResponse, crate::Error>
                {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            #[doc = "Created via [AdminsActions::patch()](struct.AdminsActions.html#method.patch)"]
            #[derive(Debug, Clone)]
            pub struct PatchRequestBuilder<'a> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
        ...
        pub mod invitations {
            ...
            impl<'a> InvitationsActions<'a> {
                ...
                #[doc = "Accepts the specified invitation."]
                pub fn accept(
                    &self,
                    request: crate::schemas::AcceptInvitationRequest,
                    name: impl Into<String>,
                ...
                #[doc = "Declines the specified invitation."]
                pub fn decline(
                    &self,
                    request: crate::schemas::DeclineInvitationRequest,
                    name: impl Into<String>,
                ...
                #[doc = "Lists pending invitations for the specified account."]
                pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                    ListRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            #[doc = "Created via [InvitationsActions::decline()](struct.InvitationsActions.html#method.decline)"]
            #[derive(Debug, Clone)]
    ...
    pub mod locations {
        ...
        impl<'a> LocationsActions<'a> {
            ...
            #[doc = "Moves a location from an account that the user owns to another account that the same user administers. The user must be an owner of the account the location is currently associated with and must also be at least a manager of the destination account."]
            pub fn transfer(
                &self,
                request: crate::schemas::TransferLocationRequest,
                name: impl Into<String>,
            ...
            #[doc = "Actions that can be performed on the admins resource"]
            pub fn admins(&self) -> crate::resources::locations::admins::AdminsActions {
                crate::resources::locations::admins::AdminsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
        }
        #[doc = "Created via [LocationsActions::transfer()](struct.LocationsActions.html#method.transfer)"]
        #[derive(Debug, Clone)]
        ...
        pub mod admins {
            ...
            impl<'a> AdminsActions<'a> {
                ...
                #[doc = "Invites the specified user to become an administrator for the specified location. The invitee must accept the invitation in order to be granted access to the location. See AcceptInvitation to programmatically accept an invitation."]
                pub fn create(
                    &self,
                    request: crate::schemas::Admin,
                    parent: impl Into<String>,
                ...
                #[doc = "Removes the specified admin as a manager of the specified location."]
                pub fn delete(&self, name: impl Into<String>) -> DeleteRequestBuilder {
                    DeleteRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                ...
                #[doc = "Lists all of the admins for the specified location."]
                pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                    ListRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                ...
                #[doc = "Updates the Admin for the specified location. Only the AdminRole of the Admin can be updated."]
                pub fn patch(
                    &self,
                    request: crate::schemas::Admin,
                    name: impl Into<String>,
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::ListLocationAdminsResponse, crate::Error>
                {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
