...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("apigateway1_beta")
                        ...
                        .about("methods: create, delete, get, get_iam_policy, list, patch, set_iam_policy and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("create")
                .about("Creates a new Api in a given project and location.");
            apis2 = apis2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes a single Api.");
            apis2 = apis2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get").about("Gets details of a single Api.");
            apis2 = apis2.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd =
                SubCommand::with_name("list").about("Lists Apis in a given project and location.");
            apis2 = apis2.subcommand(mcmd);
        }
        {
            let mcmd =
                SubCommand::with_name("patch").about("Updates the parameters of a single Api.");
            apis2 = apis2.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("create")
                .about("Creates a new ApiConfig in a given project and location.");
            configs3 = configs3.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes a single ApiConfig.");
            configs3 = configs3.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get").about("Gets details of a single ApiConfig.");
            configs3 = configs3.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get_iam_policy").about("Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.");
        ...
        {
            let mcmd = SubCommand::with_name("list")
                .about("Lists ApiConfigs in a given project and location.");
            configs3 = configs3.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("patch")
                .about("Updates the parameters of a single ApiConfig.");
            configs3 = configs3.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.");
        ...
        apis2 = apis2.subcommand(configs3);
...
use google_apigateway1_beta as api;
