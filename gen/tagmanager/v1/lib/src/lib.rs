        ...
        pub mod containers {
            ...
            pub mod move_folders {
                ...
                pub struct UpdateRequestBuilder<'a> {
                    ...
                    container_id: String,
                    folder_id: String,
                    tag_id: ::std::option::Option<Vec<String>>,
                    trigger_id: ::std::option::Option<Vec<String>>,
                    variable_id: ::std::option::Option<Vec<String>>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> UpdateRequestBuilder<'a> {
                    ...
                    async fn _request(
                        ...
                        let mut req = self.reqwest.request(::reqwest::Method::PUT, path);
                        for value in self.tag_id.iter().flatten() {
                            req = req.query(&[("tagId", value)]);
                        }
                        for value in self.trigger_id.iter().flatten() {
                            req = req.query(&[("triggerId", value)]);
                        }
                        for value in self.variable_id.iter().flatten() {
                            req = req.query(&[("variableId", value)]);
                        }
                        req = req.query(&[("access_token", &self.access_token)]);
                        req = req.query(&[("alt", &self.alt)]);
                        req = req.query(&[("callback", &self.callback)]);
            ...
            pub mod versions {
                ...
                pub struct ListRequestBuilder<'a> {
                    ...
                    account_id: String,
                    container_id: String,
                    headers: ::std::option::Option<bool>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    async fn _request(
                        ...
                        let mut req = self.reqwest.request(::reqwest::Method::GET, path);
                        req = req.query(&[("headers", &self.headers)]);
