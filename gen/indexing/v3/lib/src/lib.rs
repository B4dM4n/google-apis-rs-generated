...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for PublishUrlNotificationResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PublishUrlNotificationResponse {
    ...
    pub struct UrlNotification {
        #[doc = "Creation timestamp for this notification. Users should *not* specify it, the field is ignored at the request time."]
        #[serde(
            rename = "notifyTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "The object of this notification. The URL must be owned by the publisher of this notification and, in case of `URL_UPDATED` notifications, it *must* be crawlable by Google."]
        #[serde(
            rename = "url",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::ToFieldType for UrlNotification {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl UrlNotificationType {
        pub fn as_str(self) -> &'static str {
            match self {
                UrlNotificationType::UrlDeleted => "URL_DELETED",
    ...
    impl ::serde::Serialize for UrlNotificationType {
    ...
    impl<'de> ::serde::Deserialize<'de> for UrlNotificationType {
    ...
    impl ::google_field_selector::FieldSelector for UrlNotificationType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for UrlNotificationType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for UrlNotificationMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
impl Client {
    ...
    #[doc = "Actions that can be performed on the url_notifications resource"]
    pub fn url_notifications(
        &self,
    ) -> crate::resources::url_notifications::UrlNotificationsActions {
        crate::resources::url_notifications::UrlNotificationsActions {
...
pub mod resources {
    pub mod url_notifications {
        ...
        impl<'a> UrlNotificationsActions<'a> {
            ...
            #[doc = "Gets metadata about a Web Document. This method can *only* be used to query URLs that were previously seen in successful Indexing API notifications. Includes the latest `UrlNotification` received via this API."]
            pub fn get_metadata(&self) -> GetMetadataRequestBuilder {
            ...
            #[doc = "Notifies that a URL has been updated or deleted."]
            pub fn publish(
                &self,
        ...
        impl<'a> GetMetadataRequestBuilder<'a> {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::UrlNotificationMetadata, crate::Error> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://indexing.googleapis.com/".to_owned();
        ...
        impl<'a> PublishRequestBuilder<'a> {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::PublishUrlNotificationResponse, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
