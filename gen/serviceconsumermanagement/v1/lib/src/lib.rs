...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for ListTenancyUnitsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for SearchTenancyUnitsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct TenantProjectConfig {
        ...
        #[doc = "Describes ownership and policies for the new tenant project."]
        #[serde(
    ...
    pub struct TenantProjectPolicy {
        #[doc = "Policy bindings to be applied to the tenant project, in addition to the ‘roles/owner’ role granted to the Service Consumer Management service account."]
        #[serde(
...
pub mod resources {
    ...
    pub mod services {
        ...
        impl<'a> SearchRequestBuilder<'a> {
            ...
            #[doc = "\nExecute the request and yield each item in the `tenancyUnits` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
            pub fn stream_tenancy_units<T>(
                self,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
            {
                ...
                self.stream_tenancy_units_with_fields(fields)
            }
            #[doc = "\nExecute the request and yield each item in the `tenancyUnits` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
            pub fn stream_tenancy_units_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::TenancyUnit, crate::Error>> + 'a
            {
                self.stream_tenancy_units_with_fields(None::<String>)
            }
            #[doc = "\nExecute the request and yield each item in the `tenancyUnits` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            pub fn stream_tenancy_units_with_all_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::TenancyUnit, crate::Error>> + 'a
            {
                self.stream_tenancy_units_with_fields(Some("*"))
            }
            #[doc = "\nExecute the request and yield each item in the `tenancyUnits` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
            pub fn stream_tenancy_units_with_fields<T, F>(
                mut self,
                fields: ::std::option::Option<F>,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
            ...
            pub fn stream_with_default_fields(
                ...
                Item = Result<crate::schemas::SearchTenancyUnitsResponse, crate::Error>,
            > + 'a {
                self.stream_with_fields(None::<&str>)
            }
            #[doc = r" Execute the request and yield the returned value. If the response contains a"]
        ...
        pub mod tenancy_units {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListTenancyUnitsResponse, crate::Error>,
                > + 'a {
                    self.stream_with_fields(None::<&str>)
                }
                #[doc = r" Execute the request and yield the returned value. If the response contains a"]
