...
pub mod schemas {
    ...
    impl ResponsePolicyRuleBehavior {
        pub fn as_str(self) -> &'static str {
            match self {
                ResponsePolicyRuleBehavior::BehaviorUnspecified => "BEHAVIOR_UNSPECIFIED",
                ResponsePolicyRuleBehavior::BypassResponsePolicy => "BYPASS_RESPONSE_POLICY",
            }
        }
    }
    ...
    impl ::std::str::FromStr for ResponsePolicyRuleBehavior {
        ...
        fn from_str(s: &str) -> ::std::result::Result<ResponsePolicyRuleBehavior, ()> {
            Ok(match s {
                "BEHAVIOR_UNSPECIFIED" => ResponsePolicyRuleBehavior::BehaviorUnspecified,
                "BYPASS_RESPONSE_POLICY" => ResponsePolicyRuleBehavior::BypassResponsePolicy,
                _ => return Err(()),
            })
        }
    }
    ...
    pub mod changes {
        ...
        impl<'a> CreateRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str("dns/v2/projects/");
                {
