...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for ListExportsResponse {
    ...
    impl crate::GetNextPageToken<String> for ListHoldsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for ListMattersResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
