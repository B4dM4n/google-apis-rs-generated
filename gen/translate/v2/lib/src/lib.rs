...
pub mod resources {
    pub mod detections {
        ...
        pub struct DetectRequestBuilder<'a> {
            ...
            bearer_token: ::std::option::Option<String>,
            callback: ::std::option::Option<String>,
            fields: ::std::option::Option<String>,
            key: ::std::option::Option<String>,
            oauth_token: ::std::option::Option<String>,
            pp: ::std::option::Option<bool>,
        ...
        impl<'a> DetectRequestBuilder<'a> {
            ...
            async fn _request(
                ...
                req = req.query(&[("bearer_token", &self.bearer_token)]);
                req = req.query(&[("callback", &self.callback)]);
                req = req.query(&[("fields", &self.fields)]);
                req = req.query(&[("key", &self.key)]);
                req = req.query(&[("oauth_token", &self.oauth_token)]);
                req = req.query(&[("pp", &self.pp)]);
    ...
    pub mod languages {
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            async fn _request(
                ...
                req = req.query(&[("target", &self.target)]);
                req = req.query(&[("access_token", &self.access_token)]);
                req = req.query(&[("alt", &self.alt)]);
                req = req.query(&[("bearer_token", &self.bearer_token)]);
                req = req.query(&[("callback", &self.callback)]);
    ...
    pub mod translations {
        ...
        pub struct ListRequestBuilder<'a> {
            ...
            q: Vec<String>,
            target: String,
            cid: ::std::option::Option<Vec<String>>,
            format: ::std::option::Option<crate::resources::translations::params::ListFormat>,
            model: ::std::option::Option<String>,
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            async fn _request(
                ...
                req = req.query(&[("target", &self.target)]);
                for value in self.cid.iter().flatten() {
                    req = req.query(&[("cid", value)]);
                }
