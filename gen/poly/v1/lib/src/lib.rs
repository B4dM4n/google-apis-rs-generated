...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for ListLikedAssetsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for ListUserAssetsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
...
pub mod resources {
    pub mod assets {
        ...
        pub struct ListRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            category: ::std::option::Option<String>,
            curated: ::std::option::Option<bool>,
            format: ::std::option::Option<String>,
            keywords: ::std::option::Option<String>,
            max_complexity:
                ::std::option::Option<crate::resources::assets::params::ListMaxComplexity>,
    ...
    pub mod users {
        ...
        pub mod assets {
            ...
            pub struct ListRequestBuilder<'a> {
                ...
                page_token: ::std::option::Option<String>,
                visibility:
                    ::std::option::Option<crate::resources::users::assets::params::ListVisibility>,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
                fields: ::std::option::Option<String>,
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `userAssets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_user_assets<T>(
                    self,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_user_assets_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `userAssets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_user_assets_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::UserAsset, crate::Error>> + 'a
                {
                    self.stream_user_assets_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `userAssets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_user_assets_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::UserAsset, crate::Error>> + 'a
                {
                    self.stream_user_assets_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `userAssets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_user_assets_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListUserAssetsResponse, crate::Error>,
                > + 'a {
                    self.stream_with_fields(None::<&str>)
                }
                #[doc = r" Execute the request and yield the returned value. If the response contains a"]
        ...
        pub mod likedassets {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListLikedAssetsResponse, crate::Error>,
                > + 'a {
                    self.stream_with_fields(None::<&str>)
                }
                #[doc = r" Execute the request and yield the returned value. If the response contains a"]
