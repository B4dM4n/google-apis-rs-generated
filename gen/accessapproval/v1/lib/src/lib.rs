...
pub mod schemas {
    ...
    pub struct ApproveDecision {
        ...
        pub expire_time: ::std::option::Option<String>,
        #[doc = "If set, denotes the timestamp at which the approval is invalidated."]
        #[serde(
            rename = "invalidateTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub invalidate_time: ::std::option::Option<String>,
    ...
    impl ::google_field_selector::FieldSelector for InvalidateApprovalRequestMessage {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for InvalidateApprovalRequestMessage {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl crate::GetNextPageToken<String> for ListApprovalRequestsResponse {
    ...
    pub mod folders {
        ...
        pub mod approval_requests {
            ...
            impl<'a> ApprovalRequestsActions<'a> {
                ...
                #[doc = "Invalidates an existing ApprovalRequest. Returns the updated ApprovalRequest. NOTE: This does not deny access to the resource if another request has been made and approved. It only invalidates a single approval. Returns FAILED_PRECONDITION if the request exists but is not in an approved state."]
                pub fn invalidate(
                    &self,
                    request: crate::schemas::InvalidateApprovalRequestMessage,
                    name: impl Into<String>,
                ) -> InvalidateRequestBuilder {
                    InvalidateRequestBuilder {
                        reqwest: &self.reqwest,
            ...
            #[doc = "Created via [ApprovalRequestsActions::invalidate()](struct.ApprovalRequestsActions.html#method.invalidate)"]
            #[derive(Debug, Clone)]
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `approvalRequests` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_approval_requests<T>(
                    self,
                    ...
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_approval_requests_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `approvalRequests` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_approval_requests_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<
                    Item = Result<crate::schemas::ApprovalRequest, crate::Error>,
                > + 'a {
                    self.stream_approval_requests_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `approvalRequests` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_approval_requests_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<
                    Item = Result<crate::schemas::ApprovalRequest, crate::Error>,
                > + 'a {
                    self.stream_approval_requests_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `approvalRequests` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_approval_requests_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                    ...
                    F: AsRef<str>,
                {
                    ...
                    self.fields = Some({
                        let mut selector = concat!("nextPageToken,", "approvalRequests").to_owned();
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListApprovalRequestsResponse, crate::Error>,
                > + 'a {
