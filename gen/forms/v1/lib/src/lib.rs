...
pub mod schemas {
    ...
    pub struct ListFormResponsesResponse {
        ...
        #[doc = "The returned form responses. Note: The `formId` field is not returned in the `FormResponse` object for list requests."]
        #[serde(
            rename = "responses",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl crate::GetNextPageToken<String> for ListFormResponsesResponse {
...
pub mod resources {
    pub mod forms {
        ...
        impl<'a> CreateRequestBuilder<'a> {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::Form, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
        ...
        pub mod responses {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `responses` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_responses<T>(
                    self,
                    ...
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_responses_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `responses` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_responses_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::FormResponse, crate::Error>> + 'a
                {
                    self.stream_responses_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `responses` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_responses_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::FormResponse, crate::Error>> + 'a
                {
                    self.stream_responses_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `responses` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_responses_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListFormResponsesResponse, crate::Error>,
                > + 'a {
