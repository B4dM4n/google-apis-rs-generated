...
pub mod schemas {
    ...
    pub struct Channel {
        ...
        #[doc = "The time at which the channel will be automatically deleted. If null, the channel will not be automatically deleted. This field is present in the output whether it’s set directly or via the `ttl` field."]
        #[serde(
            rename = "expireTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "The fully-qualified resource name for the channel, in the format: sites/ SITE_ID/channels/CHANNEL_ID"]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[serde(
            rename = "retainedReleaseCount",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub retained_release_count: ::std::option::Option<i32>,
        ...
        #[doc = "Output only. The URL at which the content of this channel’s current release can be viewed. This URL is a Firebase-provided subdomain of `web.app`. The content of this channel’s current release can also be viewed at the Firebase-provided subdomain of `firebaseapp.com`. If this channel is the `live` channel for the Hosting site, then the content of this channel’s current release can also be viewed at any connected custom domains."]
        #[serde(
            rename = "url",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct CloneVersionRequest {
        #[doc = "If provided, only paths that do not match any of the RegEx values in this list will be included in the new version."]
        #[serde(
            rename = "exclude",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub exclude: ::std::option::Option<crate::schemas::PathFilter>,
        #[doc = "If true, the call to `CloneVersion` immediately finalizes the version after cloning is complete. If false, the cloned version will have a status of `CREATED`. Use [`UpdateVersion`](patch) to set the status of the version to `FINALIZED`."]
        #[serde(
            rename = "finalize",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub finalize: ::std::option::Option<bool>,
        #[doc = "If provided, only paths that match one or more RegEx values in this list will be included in the new version."]
        #[serde(
            rename = "include",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub include: ::std::option::Option<crate::schemas::PathFilter>,
        #[doc = "Required. The unique identifier for the version to be cloned, in the format: sites/SITE_ID/versions/VERSION_ID"]
        #[serde(
            rename = "sourceVersion",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub source_version: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for CloneVersionRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloneVersionRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for I18Nconfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for I18Nconfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ListChannelsResponse {
        ...
        #[doc = "The pagination token, if more results exist beyond the ones in this response. Include this token in your next call to `ListChannels`. Page tokens are short-lived and should not be stored."]
        #[serde(
    ...
    pub struct ListSitesResponse {
        #[doc = "The pagination token, if more results exist beyond the ones in this response. Include this token in your next call to `ListSites`. Page tokens are short-lived and should not be stored."]
        #[serde(
            rename = "nextPageToken",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub next_page_token: ::std::option::Option<String>,
        #[doc = "A list of Site objects associated with the specified Firebase project."]
        #[serde(
            rename = "sites",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl crate::GetNextPageToken<String> for ListVersionFilesResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct ListVersionsResponse {
        #[doc = "The pagination token, if more results exist beyond the ones in this response. Include this token in your next call to `ListVersions`. Page tokens are short-lived and should not be stored."]
        #[serde(
            rename = "nextPageToken",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct PathFilter {
        #[doc = "An array of RegEx values by which to filter."]
        #[serde(
            rename = "regexes",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct PopulateVersionFilesResponse {
        ...
        #[doc = "The URL to which the files should be uploaded, in the format: “https://upload-firebasehosting.googleapis.com/upload/sites/SITE_ID /versions/VERSION_ID/files” Perform a multipart `POST` of the Gzipped file contents to the URL using a forward slash and the hash of the file appended to the end."]
        #[serde(
            rename = "uploadUrl",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct Release {
        ...
        #[doc = "Output only. The unique identifier for the release, in either of the following formats: - sites/SITE_ID/releases/RELEASE_ID - sites/SITE_ID/channels/CHANNEL_ID/releases/RELEASE_ID This name is provided in the response body when you call [`releases.create`](sites.releases/create) or [`channels.releases.create`](sites.channels.releases/create)."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct Rewrite {
        ...
        #[doc = "Optional. Specify a Cloud region for rewritten Functions invocations. If not provided, defaults to us-central1."]
        #[serde(
            rename = "functionRegion",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub function_region: ::std::option::Option<String>,
        #[doc = "The user-supplied [glob](https://firebase.google.com/docs/hosting/full-config#glob_pattern_matching) to match against the request URL path."]
        #[serde(
            rename = "glob",
            default,
    ...
    pub struct ServingConfig {
        ...
        pub i_1_8n: ::std::option::Option<crate::schemas::I18Nconfig>,
    ...
    pub enum ServingConfigTrailingSlashBehavior {
        #[doc = "Trailing slashes are *added* to directory indexes as well as to any URL path not ending in a file extension."]
        Add,
        #[doc = "Trailing slashes are *removed* from directory indexes as well as from any URL path not ending in a file extension."]
        Remove,
    ...
    pub struct Site {
        #[doc = "Optional. The [ID of a Web App](https://firebase.google.com/docs/reference/firebase-management/rest/v1beta1/projects.webApps#WebApp.FIELDS.app_id) associated with the Hosting site."]
        #[serde(
            rename = "appId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. The default URL for the Hosting site."]
        #[serde(
            rename = "defaultUrl",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub default_url: ::std::option::Option<String>,
        #[doc = "Optional. User-specified labels for the Hosting site."]
        #[serde(
            rename = "labels",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub name: ::std::option::Option<String>,
        #[doc = "Output only. The type of Hosting site. Every Firebase project has a `DEFAULT_SITE`, which is created when Hosting is provisioned for the project. All additional sites are `USER_SITE`."]
        #[serde(
            rename = "type",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub r#type: ::std::option::Option<crate::schemas::SiteType>,
    }
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum SiteType {
        #[doc = "The default Hosting site that is provisioned when a Firebase project is created."]
        DefaultSite,
        #[doc = "Unknown state, likely the result of an error on the backend."]
        TypeUnspecified,
        #[doc = "A Hosting site that the user created."]
        UserSite,
    }
    impl SiteType {
        pub fn as_str(self) -> &'static str {
            match self {
                SiteType::DefaultSite => "DEFAULT_SITE",
                SiteType::TypeUnspecified => "TYPE_UNSPECIFIED",
                SiteType::UserSite => "USER_SITE",
            }
        }
    }
    impl ::std::convert::AsRef<str> for SiteType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for SiteType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<SiteType, ()> {
            Ok(match s {
                "DEFAULT_SITE" => SiteType::DefaultSite,
                "TYPE_UNSPECIFIED" => SiteType::TypeUnspecified,
                "USER_SITE" => SiteType::UserSite,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for SiteType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SiteType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Version {
        ...
        pub labels: ::std::option::Option<::std::collections::BTreeMap<String, String>>,
        #[doc = "The fully-qualified resource name for the version, in the format: sites/ SITE_ID/versions/VERSION_ID This name is provided in the response body when you call [`CreateVersion`](sites.versions/create)."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub mod projects {
        ...
        pub mod sites {
            ...
            impl<'a> SitesActions<'a> {
                ...
                #[doc = "Creates a new Hosting Site in the specified parent Firebase project. Note that Hosting sites can take several minutes to propagate through Firebase systems."]
                pub fn create(
                    &self,
                ...
                #[doc = "Deletes the specified Hosting Site from the specified parent Firebase project."]
                ...
                #[doc = "Gets the specified Hosting Site."]
                pub fn get(&self, name: impl Into<String>) -> GetRequestBuilder {
                    GetRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                ...
                #[doc = "Lists each Hosting Site associated with the specified parent Firebase project."]
                ...
                #[doc = "Updates attributes of the specified Hosting Site."]
                pub fn patch(
                    &self,
                    request: crate::schemas::Site,
            ...
            pub struct CreateRequestBuilder<'a> {
                ...
                request: crate::schemas::Site,
                parent: String,
                site_id: ::std::option::Option<String>,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
                fields: ::std::option::Option<String>,
            ...
            impl<'a> CreateRequestBuilder<'a> {
                #[doc = "Required. Immutable. A globally unique identifier for the Hosting site. This identifier is used to construct the Firebase-provisioned subdomains for the site, so it must also be a valid domain name label."]
                ...
                async fn _request(
                    ...
                    req = req.query(&[("siteId", &self.site_id)]);
                    req = req.query(&[("access_token", &self.access_token)]);
                    req = req.query(&[("alt", &self.alt)]);
                    req = req.query(&[("callback", &self.callback)]);
                    req = req.query(&[("fields", &self.fields)]);
            ...
            impl<'a> ListRequestBuilder<'a> {
                #[doc = "Optional. The maximum number of sites to return. The service may return a lower number if fewer sites exist than this maximum number. If unspecified, defaults to 40."]
                pub fn page_size(mut self, value: i32) -> Self {
                    self.page_size = Some(value);
                    self
                }
                #[doc = "Optional. A token from a previous call to `ListSites` that tells the server where to resume listing."]
            ...
            impl<'a> PatchRequestBuilder<'a> {
                #[doc = "A set of field names from your Site that you want to update."]
            ...
            pub mod channels {
                ...
                impl<'a> ChannelsActions<'a> {
                    ...
                    #[doc = "Creates a new channel in the specified site."]
                    pub fn create(
                        &self,
                    ...
                    #[doc = "Deletes the specified channel of the specified site. The `live` channel cannot be deleted."]
                    pub fn delete(&self, name: impl Into<String>) -> DeleteRequestBuilder {
                        DeleteRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    #[doc = "Retrieves information for the specified channel of the specified site."]
                    pub fn get(&self, name: impl Into<String>) -> GetRequestBuilder {
                        GetRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    #[doc = "Lists the channels for the specified site. All sites have a default `live` channel."]
                    pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                        ListRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    #[doc = "Updates information for the specified channel of the specified site. Implicitly creates the channel if it doesn’t already exist."]
                    pub fn patch(
                        &self,
                        request: crate::schemas::Channel,
                        name: impl Into<String>,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    #[doc = "Required. Immutable. A unique ID within the site that identifies the channel."]
                ...
                impl<'a> ListRequestBuilder<'a> {
                    #[doc = "The maximum number of channels to return. The service may return a lower number if fewer channels exist than this maximum number. If unspecified, defaults to 10. The maximum value is 100; values above 100 will be coerced to 100."]
                    pub fn page_size(mut self, value: i32) -> Self {
                        self.page_size = Some(value);
                        self
                    }
                    #[doc = "A token from a previous call to `ListChannels` that tells the server where to resume listing."]
                    pub fn page_token(mut self, value: impl Into<String>) -> Self {
                        self.page_token = Some(value.into());
                        self
                    }
                ...
                pub mod releases {
                    ...
                    impl<'a> ReleasesActions<'a> {
                        ...
                        #[doc = "Creates a new release, which makes the content of the specified version actively display on the appropriate URL(s)."]
                        pub fn create(
                            &self,
                        ...
                        #[doc = "Lists the releases that have been created for the specified site or channel. When used to list releases for a site, this list includes releases for both the default `live` channel and any active preview channels for the specified site."]
                        pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                            ListRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                    ...
                    pub struct CreateRequestBuilder<'a> {
                        ...
                        request: crate::schemas::Release,
                        parent: String,
                        version_name: ::std::option::Option<String>,
                        access_token: ::std::option::Option<String>,
                        alt: ::std::option::Option<crate::params::Alt>,
                        callback: ::std::option::Option<String>,
                        fields: ::std::option::Option<String>,
                    ...
                    impl<'a> CreateRequestBuilder<'a> {
                        #[doc = "The unique identifier for a version, in the format: sites/SITE_ID/versions/ VERSION_ID The SITE_ID in this version identifier must match the SITE_ID in the `parent` parameter. This query parameter must be empty if the `type` field in the request body is `SITE_DISABLE`."]
                        ...
                        {
                            let mut req = self.reqwest.request(::reqwest::Method::POST, path);
                            req = req.query(&[("versionName", &self.version_name)]);
                            req = req.query(&[("access_token", &self.access_token)]);
                            req = req.query(&[("alt", &self.alt)]);
                            req = req.query(&[("callback", &self.callback)]);
                            req = req.query(&[("fields", &self.fields)]);
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        #[doc = "A token from a previous call to `releases.list` or `channels.releases.list` that tells the server where to resume listing."]
                        pub fn page_token(mut self, value: impl Into<String>) -> Self {
                            self.page_token = Some(value.into());
                            self
                        }
            ...
            pub mod domains {
                ...
                impl<'a> DomainsActions<'a> {
                    ...
                    #[doc = "Updates the specified domain mapping, creating the mapping as if it does not exist."]
                    pub fn update(
                        &self,
                        request: crate::schemas::Domain,
                        name: impl Into<String>,
            ...
            pub mod releases {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn stream_releases_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Release, crate::Error>> + 'a
                    {
                        self.stream_releases_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `releases` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            ...
            pub mod versions {
                ...
                impl<'a> VersionsActions<'a> {
                    ...
                    #[doc = "Creates a new version on the specified target site using the content of the specified version."]
                    pub fn clone(
                        &self,
                        request: crate::schemas::CloneVersionRequest,
                        parent: impl Into<String>,
                    ) -> CloneRequestBuilder {
                        CloneRequestBuilder {
                            reqwest: &self.reqwest,
                    ...
                    #[doc = "Creates a new version for the specified site."]
                    pub fn create(
                        &self,
                    ...
                    #[doc = "Lists the versions that have been created for the specified site. This list includes versions for both the default `live` channel and any active preview channels for the specified site."]
                    pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                        ListRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    #[doc = "Updates the specified metadata for the specified version. This method will fail with `FAILED_PRECONDITION` in the event of an invalid state transition. The supported [state](../sites.versions#versionstatus) transitions for a version are from `CREATED` to `FINALIZED`. Use [`DeleteVersion`](delete) to set the status of a version to `DELETED`."]
                    pub fn patch(
                        &self,
                        request: crate::schemas::Version,
                        name: impl Into<String>,
                    ...
                    #[doc = "Adds content files to the specified version. Each file must be under 2 GB."]
                ...
                #[doc = "Created via [VersionsActions::clone()](struct.VersionsActions.html#method.clone)"]
                #[derive(Debug, Clone)]
                ...
                impl<'a> CloneRequestBuilder<'a> {
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str("/versions:clone");
                        output
                    }
                    async fn _request(
                        &self,
                ...
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::Version,
                    parent: String,
                    size_bytes: ::std::option::Option<i64>,
                    version_id: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    async fn _request(
                        ...
                        let mut req = self.reqwest.request(::reqwest::Method::POST, path);
                        req = req.query(&[("sizeBytes", &self.size_bytes)]);
                        req = req.query(&[("versionId", &self.version_id)]);
                        req = req.query(&[("access_token", &self.access_token)]);
                        req = req.query(&[("alt", &self.alt)]);
                        req = req.query(&[("callback", &self.callback)]);
                        req = req.query(&[("fields", &self.fields)]);
                ...
                impl<'a> ListRequestBuilder<'a> {
                    #[doc = "A filter string used to return a subset of versions in the response. The currently supported fields for filtering are: `name`, `status`, and `create_time`. Learn more about filtering in Google’s [AIP 160 standard](https://google.aip.dev/160)."]
                    pub fn filter(mut self, value: impl Into<String>) -> Self {
                        self.filter = Some(value.into());
                        self
                    }
                    #[doc = "The maximum number of versions to return. The service may return a lower number if fewer versions exist than this maximum number. If unspecified, defaults to 25. The maximum value is 100; values above 100 will be coerced to 100."]
                    pub fn page_size(mut self, value: i32) -> Self {
                        self.page_size = Some(value);
                        self
                    }
                    #[doc = "A token from a previous call to `ListVersions` that tells the server where to resume listing."]
                    pub fn page_token(mut self, value: impl Into<String>) -> Self {
                        self.page_token = Some(value.into());
                        self
                    }
                ...
                pub mod files {
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        pub fn stream_files_with_default_fields(
                            ...
                            Item = Result<crate::schemas::VersionFile, crate::Error>,
                        > + 'a {
                        ...
                        pub fn stream_with_default_fields(
                            ...
                            Item = Result<crate::schemas::ListVersionFilesResponse, crate::Error>,
                        > + 'a {
                            self.stream_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the request and yield the returned value. If the response contains a"]
        ...
        pub mod versions {
            ...
            pub mod files {
                ...
                pub struct ListRequestBuilder<'a> {
                    ...
                    page_token: ::std::option::Option<String>,
                    status: ::std::option::Option<
                        crate::resources::sites::versions::files::params::ListStatus,
                    >,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
