    ...
    pub mod customers {
        ...
        impl<'a> GetRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://prod-tt-sasportal.googleapis.com/".to_owned();
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn iter_customers_with_default_fields(
                self,
            ) -> crate::iter::PageItemIter<Self, crate::schemas::SasPortalCustomer> {
            ...
            pub fn iter_with_default_fields(
                self,
            ) -> crate::iter::PageIter<Self, crate::schemas::SasPortalListCustomersResponse>
            {
        ...
        pub mod deployments {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn iter_deployments_with_default_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::SasPortalDeployment>
                {
                ...
                pub fn iter_with_default_fields(
                    self,
                ) -> crate::iter::PageIter<Self, crate::schemas::SasPortalListDeploymentsResponse>
                {
                    self.iter_with_fields(None::<&str>)
                }
                pub fn iter_with_all_fields(
            ...
            pub mod devices {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn iter_devices_with_default_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::SasPortalDevice>
                    {
                    ...
                    pub fn iter_with_default_fields(
                        self,
                    ) -> crate::iter::PageIter<Self, crate::schemas::SasPortalListDevicesResponse>
                    {
                        self.iter_with_fields(None::<&str>)
                    }
                    pub fn iter_with_all_fields(
        ...
        pub mod nodes {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn iter_nodes_with_default_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::SasPortalNode>
                {
                ...
                pub fn iter_with_default_fields(
                    self,
                ) -> crate::iter::PageIter<Self, crate::schemas::SasPortalListNodesResponse>
                {
                    self.iter_with_fields(None::<&str>)
                }
                pub fn iter_with_all_fields(
