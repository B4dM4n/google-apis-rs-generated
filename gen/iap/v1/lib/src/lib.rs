...
pub mod schemas {
    ...
    pub struct AccessDeniedPageSettings {
        ...
        #[doc = "Whether to generate a troubleshooting URL on access denied events to this application."]
        #[serde(
            rename = "generateTroubleshootingUri",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
    ...
    pub struct AccessSettings {
        ...
        #[doc = "Settings to configure reauthentication policies in IAP."]
        #[serde(
            rename = "reauthSettings",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub reauth_settings: ::std::option::Option<crate::schemas::ReauthSettings>,
    }
    ...
    pub struct ListTunnelDestGroupsResponse {
        #[doc = "A token that you can send as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages."]
        #[serde(
            rename = "nextPageToken",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub next_page_token: ::std::option::Option<String>,
        #[doc = "TunnelDestGroup existing in the project."]
        #[serde(
            rename = "tunnelDestGroups",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub tunnel_dest_groups: ::std::option::Option<Vec<crate::schemas::TunnelDestGroup>>,
    }
    impl ::google_field_selector::FieldSelector for ListTunnelDestGroupsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListTunnelDestGroupsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct PolicyName {
        #[doc = "Identifies an instance of the type. ID format varies by type. The ID format is defined in the IAM .service file that defines the type, either in path_mapping or in a comment."]
        #[serde(
            rename = "id",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Resource type. Types are defined in IAM’s .service files. Valid values for type might be ‘gce’, ‘gcs’, ‘project’, ‘account’ etc."]
        #[serde(
            rename = "type",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct ReauthSettings {
        ...
        pub method: ::std::option::Option<crate::schemas::ReauthSettingsMethod>,
        #[doc = "How IAP determines the effective policy in cases of hierarchial policies. Policies are merged from higher in the hierarchy to lower in the hierarchy."]
        #[serde(
            rename = "policyType",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub policy_type: ::std::option::Option<crate::schemas::ReauthSettingsPolicyType>,
    }
    impl ::google_field_selector::FieldSelector for ReauthSettings {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ReauthSettings {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ReauthSettingsMethod {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                ReauthSettingsMethod::SecureKey => "SECURE_KEY",
            }
        }
    }
    impl ::std::convert::AsRef<str> for ReauthSettingsMethod {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for ReauthSettingsMethod {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<ReauthSettingsMethod, ()> {
            Ok(match s {
                ...
                "SECURE_KEY" => ReauthSettingsMethod::SecureKey,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for ReauthSettingsMethod {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for ReauthSettingsMethod {
    ...
    impl<'de> ::serde::Deserialize<'de> for ReauthSettingsMethod {
    ...
    impl ::google_field_selector::FieldSelector for ReauthSettingsMethod {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ReauthSettingsMethod {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum ReauthSettingsPolicyType {
        #[doc = "This policy acts as a default if no other reauth policy is set."]
        Default,
        #[doc = "This policy acts as a minimum to other policies, lower in the hierarchy. Effective policy may only be the same or stricter."]
        Minimum,
        #[doc = "Default value. This value is unused."]
        PolicyTypeUnspecified,
    }
    impl ReauthSettingsPolicyType {
        pub fn as_str(self) -> &'static str {
            match self {
                ReauthSettingsPolicyType::Default => "DEFAULT",
                ReauthSettingsPolicyType::Minimum => "MINIMUM",
                ReauthSettingsPolicyType::PolicyTypeUnspecified => "POLICY_TYPE_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for ReauthSettingsPolicyType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for ReauthSettingsPolicyType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<ReauthSettingsPolicyType, ()> {
            Ok(match s {
                "DEFAULT" => ReauthSettingsPolicyType::Default,
                "MINIMUM" => ReauthSettingsPolicyType::Minimum,
                "POLICY_TYPE_UNSPECIFIED" => ReauthSettingsPolicyType::PolicyTypeUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for ReauthSettingsPolicyType {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for ReauthSettingsPolicyType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ReauthSettingsPolicyType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ReauthSettingsPolicyType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ReauthSettingsPolicyType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for TunnelDestGroup {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for TunnelDestGroup {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    pub mod projects {
        ...
        impl<'a> ProjectsActions<'a> {
            ...
            #[doc = "Actions that can be performed on the iap_tunnel resource"]
            pub fn iap_tunnel(&self) -> crate::resources::projects::iap_tunnel::IapTunnelActions {
                crate::resources::projects::iap_tunnel::IapTunnelActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
        ...
        pub mod brands {
            ...
            impl<'a> BrandsActions<'a> {
                ...
                #[doc = "Constructs a new OAuth brand for the project if one does not exist. The created brand is “internal only”, meaning that OAuth clients created under it only accept requests from users who belong to the same Google Workspace organization as the project. The brand is created in an un-reviewed status. NOTE: The “internal only” status can be manually changed in the Google Cloud Console. Requires that a brand does not already exist for the project, and that the specified support email is owned by the caller."]
                pub fn create(
                    &self,
            ...
            pub mod identity_aware_proxy_clients {
                ...
                impl<'a> IdentityAwareProxyClientsActions<'a> {
                    ...
                    #[doc = "Creates an Identity Aware Proxy (IAP) OAuth client. The client is owned by IAP. Requires that the brand for the project exists and that it is set for internal-only use."]
                    pub fn create(
                        &self,
                    ...
                    #[doc = "Deletes an Identity Aware Proxy (IAP) OAuth client. Useful for removing obsolete clients, managing the number of clients in a given project, and cleaning up after tests. Requires that the client is owned by IAP."]
                    ...
                    #[doc = "Retrieves an Identity Aware Proxy (IAP) OAuth client. Requires that the client is owned by IAP."]
                    pub fn get(&self, name: impl Into<String>) -> GetRequestBuilder {
                        GetRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    #[doc = "Resets an Identity Aware Proxy (IAP) OAuth client secret. Useful if the secret was compromised. Requires that the client is owned by IAP."]
                    pub fn reset_secret(
                        &self,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `identityAwareProxyClients` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_identity_aware_proxy_clients<T>(
                        self,
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_identity_aware_proxy_clients_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `identityAwareProxyClients` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_identity_aware_proxy_clients_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::IdentityAwareProxyClient, crate::Error>,
                    > + 'a {
                        self.stream_identity_aware_proxy_clients_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `identityAwareProxyClients` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_identity_aware_proxy_clients_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::IdentityAwareProxyClient, crate::Error>,
                    > + 'a {
                        self.stream_identity_aware_proxy_clients_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `identityAwareProxyClients` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_identity_aware_proxy_clients_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
        ...
        pub mod iap_tunnel {
            pub mod params {}
            pub struct IapTunnelActions<'a> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            }
            impl<'a> IapTunnelActions<'a> {
                fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                    self.auth
                }
                ...
                pub fn locations(
                    &self,
                ) -> crate::resources::projects::iap_tunnel::locations::LocationsActions
                {
                    crate::resources::projects::iap_tunnel::locations::LocationsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            pub mod locations {
                ...
                impl<'a> LocationsActions<'a> {
                    ...
                    #[doc = "Actions that can be performed on the dest_groups resource"]                    pub fn dest_groups (& self) -> crate :: resources :: projects :: iap_tunnel :: locations :: dest_groups :: DestGroupsActions{
                        crate :: resources :: projects :: iap_tunnel :: locations :: dest_groups :: DestGroupsActions { reqwest : & self . reqwest , auth : self . auth_ref () , }
                    }
                }
                pub mod dest_groups {
                    pub mod params {}
                    pub struct DestGroupsActions<'a> {
                        pub(crate) reqwest: &'a reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    }
                    impl<'a> DestGroupsActions<'a> {
                        fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                            self.auth
                        }
                        ...
                        pub fn create(
                            &self,
                            request: crate::schemas::TunnelDestGroup,
                            parent: impl Into<String>,
                        ) -> CreateRequestBuilder {
                            CreateRequestBuilder {
                                reqwest: &self.reqwest,
                        ...
                        #[doc = "Lists the existing TunnelDestGroups. To group across all locations, use a `-` as the location ID. For example: `/v1/projects/123/iap_tunnel/locations/-/destGroups`"]
                        pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                            ListRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                    ...
                    #[doc = "Created via [DestGroupsActions::create()](struct.DestGroupsActions.html#method.create)"]
                    #[derive(Debug, Clone)]
                    pub struct CreateRequestBuilder<'a> {
                        pub(crate) reqwest: &'a ::reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                        request: crate::schemas::TunnelDestGroup,
                        parent: String,
                        tunnel_dest_group_id: ::std::option::Option<String>,
                        access_token: ::std::option::Option<String>,
                        alt: ::std::option::Option<crate::params::Alt>,
                        callback: ::std::option::Option<String>,
                        fields: ::std::option::Option<String>,
                    ...
                    impl<'a> CreateRequestBuilder<'a> {
                        ...
                        pub async fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::TunnelDestGroup, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>).await
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
                        ...
                        {
                            let mut req = self.reqwest.request(::reqwest::Method::POST, path);
                            req = req.query(&[("tunnelDestGroupId", &self.tunnel_dest_group_id)]);
                            req = req.query(&[("access_token", &self.access_token)]);
                            req = req.query(&[("alt", &self.alt)]);
                            req = req.query(&[("callback", &self.callback)]);
                            req = req.query(&[("fields", &self.fields)]);
                    ...
                    #[doc = "Created via [DestGroupsActions::delete()](struct.DestGroupsActions.html#method.delete)"]
                    #[derive(Debug, Clone)]
                    pub struct DeleteRequestBuilder<'a> {
                        pub(crate) reqwest: &'a ::reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    ...
                    #[doc = "Created via [DestGroupsActions::get()](struct.DestGroupsActions.html#method.get)"]
                    #[derive(Debug, Clone)]
                    pub struct GetRequestBuilder<'a> {
                        pub(crate) reqwest: &'a ::reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    ...
                    #[doc = "Created via [DestGroupsActions::list()](struct.DestGroupsActions.html#method.list)"]
                    #[derive(Debug, Clone)]
                    pub struct ListRequestBuilder<'a> {
                        pub(crate) reqwest: &'a ::reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        #[doc = "The maximum number of groups to return. The service might return fewer than this value. If unspecified, at most 100 groups are returned. The maximum value is 1000; values above 1000 are coerced to 1000."]
                        pub fn page_size(mut self, value: i32) -> Self {
                            self.page_size = Some(value);
                            self
                        }
                        #[doc = "A page token, received from a previous `ListTunnelDestGroups` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListTunnelDestGroups` must match the call that provided the page token."]
                        pub fn page_token(mut self, value: impl Into<String>) -> Self {
                            self.page_token = Some(value.into());
                            self
                        }
                        ...
                        #[doc = "\nExecute the request and yield each item in the `tunnelDestGroups` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                        pub fn stream_tunnel_dest_groups<T>(
                            self,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                            T: ::serde::de::DeserializeOwned
                                ...
                                + 'a,
                        {
                            ...
                            self.stream_tunnel_dest_groups_with_fields(fields)
                        }
                        #[doc = "\nExecute the request and yield each item in the `tunnelDestGroups` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                        pub fn stream_tunnel_dest_groups_with_default_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::TunnelDestGroup, crate::Error>,
                        > + 'a {
                            self.stream_tunnel_dest_groups_with_fields(None::<String>)
                        }
                        #[doc = "\nExecute the request and yield each item in the `tunnelDestGroups` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                        pub fn stream_tunnel_dest_groups_with_all_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::TunnelDestGroup, crate::Error>,
                        > + 'a {
                            self.stream_tunnel_dest_groups_with_fields(Some("*"))
                        }
                        #[doc = "\nExecute the request and yield each item in the `tunnelDestGroups` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                        pub fn stream_tunnel_dest_groups_with_fields<T, F>(
                            mut self,
                            fields: ::std::option::Option<F>,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                            ...
                            F: AsRef<str>,
                        {
                            ...
                            self.fields = Some({
                                let mut selector =
                                    concat!("nextPageToken,", "tunnelDestGroups").to_owned();
                                let items_fields =
                        ...
                        pub fn stream_with_default_fields(
                            ...
                            Item = Result<
                                crate::schemas::ListTunnelDestGroupsResponse,
                                crate::Error,
                            >,
                        > + 'a {
                            self.stream_with_fields(None::<&str>)
                        ...
                        pub async fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::ListTunnelDestGroupsResponse, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>).await
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
                    ...
                    #[doc = "Created via [DestGroupsActions::patch()](struct.DestGroupsActions.html#method.patch)"]
                    #[derive(Debug, Clone)]
                    ...
                    impl<'a> PatchRequestBuilder<'a> {
                        #[doc = "A field mask that specifies which IAP settings to update. If omitted, then all of the settings are updated. See https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask"]
    ...
    pub mod v_1 {
        ...
        impl<'a> V1Actions<'a> {
            ...
            #[doc = "Gets the access control policy for an Identity-Aware Proxy protected resource. More information about managing access via IAP can be found at: https://cloud.google.com/iap/docs/managing-access#managing_access_via_the_api"]
            ...
            #[doc = "Sets the access control policy for an Identity-Aware Proxy protected resource. Replaces any existing policy. More information about managing access via IAP can be found at: https://cloud.google.com/iap/docs/managing-access#managing_access_via_the_api"]
            ...
            #[doc = "Returns permissions that a caller has on the Identity-Aware Proxy protected resource. More information about managing access via IAP can be found at: https://cloud.google.com/iap/docs/managing-access#managing_access_via_the_api"]
            ...
            #[doc = "Updates the IAP settings on a particular IAP protected resource. It replaces all fields unless the `update_mask` is set."]
