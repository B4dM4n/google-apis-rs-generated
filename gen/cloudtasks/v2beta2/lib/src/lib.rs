...
pub mod schemas {
    ...
    pub struct BufferTaskRequest {
        #[doc = "Optional. Body of the HTTP request. The body can take any generic value. The value is written to the HttpRequest of the \\[Task\\]."]
        #[serde(
            rename = "body",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub body: ::std::option::Option<crate::schemas::HttpBody>,
    }
    impl ::google_field_selector::FieldSelector for BufferTaskRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BufferTaskRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for BufferTaskResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BufferTaskResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct HeaderOverride {
        #[doc = "header embodying a key and a value."]
        #[serde(
            rename = "header",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub header: ::std::option::Option<crate::schemas::Header>,
    }
    impl ::google_field_selector::FieldSelector for HeaderOverride {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for HeaderOverride {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct HttpTarget {
        ...
        pub oidc_token: ::std::option::Option<crate::schemas::OidcToken>,
        #[doc = "Uri override. When specified, modifies the execution Uri for all the tasks in the queue."]
        #[serde(
            rename = "uriOverride",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub uri_override: ::std::option::Option<crate::schemas::UriOverride>,
    }
    ...
    impl crate::GetNextPageToken<String> for ListQueuesResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for ListTasksResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct PathOverride {
        #[doc = "The URI path (e.g., a/b/c). Default is Empty string."]
        #[serde(
            rename = "path",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for PathOverride {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PathOverride {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct QueryOverride {
        #[doc = "The query parameters (e.g., qparam1=123&qparam2=456). Default is Empty string."]
        #[serde(
            rename = "queryParams",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub query_params: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for QueryOverride {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for QueryOverride {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Queue {
        ...
        #[doc = "An http_target is used to override the target values for HTTP tasks."]
        #[serde(
            rename = "httpTarget",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub stats: ::std::option::Option<crate::schemas::QueueStats>,
        ...
        pub task_ttl: ::std::option::Option<String>,
        ...
        pub tombstone_ttl: ::std::option::Option<String>,
    }
    ...
    pub struct QueueStats {
        ...
        #[serde(
            rename = "concurrentDispatchesCount",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        #[serde(with = "crate::parsed_string")]
        pub concurrent_dispatches_count: ::std::option::Option<i64>,
        ...
        #[serde(
            rename = "effectiveExecutionRate",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub effective_execution_rate: ::std::option::Option<f64>,
        ...
        #[serde(
            rename = "executedLastMinuteCount",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        #[serde(with = "crate::parsed_string")]
        pub executed_last_minute_count: ::std::option::Option<i64>,
        #[doc = "Output only. An estimation of the nearest time in the future where a task in the queue is scheduled to be executed."]
        #[serde(
            rename = "oldestEstimatedArrivalTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub oldest_estimated_arrival_time: ::std::option::Option<String>,
        ...
        #[serde(with = "crate::parsed_string")]
        pub tasks_count: ::std::option::Option<i64>,
    }
    impl ::google_field_selector::FieldSelector for QueueStats {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for QueueStats {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct UriOverride {
        #[doc = "Host override. When specified, will replace the host part of the task URL. For example, if the task URL is “https://www.google.com”, and host value is set to “example.net”, the overridden URI will be changed to “https://example.net”. Host value cannot be an empty string."]
        #[serde(
            rename = "host",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub host: ::std::option::Option<String>,
        #[doc = "URI path. When specified, will replace the existing path of the task URL. Setting the path value to an empty string clears the URI path segment."]
        #[serde(
            rename = "pathOverride",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub path_override: ::std::option::Option<crate::schemas::PathOverride>,
        #[doc = "Port override. When specified, will replace the port part of the task URI. For instance, for a URI http://www.google.com/foo and port=123, the overridden URI becomes http://www.google.com:123/foo. Note that the port value must be a positive integer. Setting the port to 0 (Zero) clears the URI port."]
        #[serde(
            rename = "port",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "URI Query. When specified, will replace the query part of the task URI. Setting the query value to an empty string clears the URI query segment."]
        #[serde(
            rename = "queryOverride",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub query_override: ::std::option::Option<crate::schemas::QueryOverride>,
        #[doc = "Scheme override. When specified, the task URI scheme is replaced by the provided value (HTTP or HTTPS)."]
        #[serde(
            rename = "scheme",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub scheme: ::std::option::Option<crate::schemas::UriOverrideScheme>,
        #[doc = "URI Override Enforce Mode When specified, determines the Target UriOverride mode. If not specified, it defaults to ALWAYS."]
        #[serde(
            rename = "uriOverrideEnforceMode",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub uri_override_enforce_mode:
            ::std::option::Option<crate::schemas::UriOverrideUriOverrideEnforceMode>,
    }
    impl ::google_field_selector::FieldSelector for UriOverride {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for UriOverride {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum UriOverrideScheme {
        #[doc = "Convert the scheme to HTTP, e.g., https://www.google.ca will change to http://www.google.ca."]
        Http,
        #[doc = "Convert the scheme to HTTPS, e.g., http://www.google.ca will change to https://www.google.ca."]
        Https,
        #[doc = "Scheme unspecified. Defaults to HTTPS."]
        SchemeUnspecified,
    }
    impl UriOverrideScheme {
        pub fn as_str(self) -> &'static str {
            match self {
                UriOverrideScheme::Http => "HTTP",
                UriOverrideScheme::Https => "HTTPS",
                UriOverrideScheme::SchemeUnspecified => "SCHEME_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for UriOverrideScheme {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for UriOverrideScheme {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<UriOverrideScheme, ()> {
            Ok(match s {
                "HTTP" => UriOverrideScheme::Http,
                "HTTPS" => UriOverrideScheme::Https,
                "SCHEME_UNSPECIFIED" => UriOverrideScheme::SchemeUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for UriOverrideScheme {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for UriOverrideScheme {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for UriOverrideScheme {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for UriOverrideScheme {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for UriOverrideScheme {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum UriOverrideUriOverrideEnforceMode {
        #[doc = "In the ALWAYS mode, queue-level configuration overrides all task-level configuration"]
        Always,
        #[doc = "In the IF_NOT_EXISTS mode, queue-level configuration is only applied where task-level configuration does not exist."]
        IfNotExists,
        #[doc = "OverrideMode Unspecified. Defaults to ALWAYS."]
        UriOverrideEnforceModeUnspecified,
    }
    impl UriOverrideUriOverrideEnforceMode {
        pub fn as_str(self) -> &'static str {
            match self {
                UriOverrideUriOverrideEnforceMode::Always => "ALWAYS",
                UriOverrideUriOverrideEnforceMode::IfNotExists => "IF_NOT_EXISTS",
                UriOverrideUriOverrideEnforceMode::UriOverrideEnforceModeUnspecified => {
                    "URI_OVERRIDE_ENFORCE_MODE_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for UriOverrideUriOverrideEnforceMode {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for UriOverrideUriOverrideEnforceMode {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<UriOverrideUriOverrideEnforceMode, ()> {
            Ok(match s {
                "ALWAYS" => UriOverrideUriOverrideEnforceMode::Always,
                "IF_NOT_EXISTS" => UriOverrideUriOverrideEnforceMode::IfNotExists,
                "URI_OVERRIDE_ENFORCE_MODE_UNSPECIFIED" => {
                    UriOverrideUriOverrideEnforceMode::UriOverrideEnforceModeUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for UriOverrideUriOverrideEnforceMode {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for UriOverrideUriOverrideEnforceMode {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for UriOverrideUriOverrideEnforceMode {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for UriOverrideUriOverrideEnforceMode {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for UriOverrideUriOverrideEnforceMode {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    pub mod api {
        ...
        impl<'a> ApiActions<'a> {
            ...
            #[doc = "Actions that can be performed on the queue resource"]
            pub fn queue(&self) -> crate::resources::api::queue::QueueActions {
                crate::resources::api::queue::QueueActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
        ...
        pub mod queue {
            pub mod params {}
            pub struct QueueActions<'a> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            }
            impl<'a> QueueActions<'a> {
                fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                    self.auth
                }
                #[doc = "Update queue list by uploading a queue.yaml file. The queue.yaml file is supplied in the request body as a YAML encoded string. This method was added to support gcloud clients versions before 322.0.0. New clients should use CreateQueue instead of this method."]
                pub fn update(&self, request: crate::schemas::HttpBody) -> UpdateRequestBuilder {
            ...
            #[doc = "Created via [QueueActions::update()](struct.QueueActions.html#method.update)"]
            #[derive(Debug, Clone)]
            ...
            impl<'a> UpdateRequestBuilder<'a> {
                #[doc = "Required. The App ID is supplied as an HTTP parameter. Unlike internal usage of App ID, it does not include a region prefix. Rather, the App ID represents the Project ID against which to make the request."]
                ...
                fn _path(&self) -> String {
                    ...
                    output.push_str("api/queue/update");
                    output
                }
                async fn _request(
                    &self,
        ...
        pub mod locations {
            ...
            pub mod queues {
                ...
                impl<'a> QueuesActions<'a> {
                    ...
                    #[doc = "Creates a queue. Queues created with this method allow tasks to live for a maximum of 31 days. After a task is 31 days old, the task will be deleted regardless of whether it was dispatched or not. WARNING: Using this method may have unintended side effects if you are using an App Engine `queue.yaml` or `queue.xml` file to manage your queues. Read [Overview of Queue Management and queue.yaml](https://cloud.google.com/tasks/docs/queue-yaml) before using this method."]
                    pub fn create(
                        &self,
                    ...
                    #[doc = "Gets the access control policy for a Queue. Returns an empty policy if the resource exists and does not have a policy set. Authorization requires the following [Google IAM](https://cloud.google.com/iam) permission on the specified resource parent: * `cloudtasks.queues.getIamPolicy`"]
                    ...
                    #[doc = "Lists queues. Queues are returned in lexicographical order."]
                    ...
                    #[doc = "Updates a queue. This method creates the queue if it does not exist and updates the queue if it does exist. Queues created with this method allow tasks to live for a maximum of 31 days. After a task is 31 days old, the task will be deleted regardless of whether it was dispatched or not. WARNING: Using this method may have unintended side effects if you are using an App Engine `queue.yaml` or `queue.xml` file to manage your queues. Read [Overview of Queue Management and queue.yaml](https://cloud.google.com/tasks/docs/queue-yaml) before using this method."]
                    pub fn patch(
                        &self,
                        request: crate::schemas::Queue,
                    ...
                    #[doc = "Pauses the queue. If a queue is paused then the system will stop dispatching tasks until the queue is resumed via ResumeQueue. Tasks can still be added when the queue is paused. A queue is paused if its state is PAUSED."]
                    pub fn pause(
                        &self,
                    ...
                    #[doc = "Purges a queue by deleting all of its tasks. All tasks created before this method is called are permanently deleted. Purge operations can take up to one minute to take effect. Tasks might be dispatched before the purge takes effect. A purge is irreversible."]
                    pub fn purge(
                        &self,
                    ...
                    #[doc = "Resume a queue. This method resumes a queue after it has been PAUSED or DISABLED. The state of a queue is stored in the queue’s state; after calling this method it will be set to RUNNING. WARNING: Resuming many high-QPS queues at the same time can lead to target overloading. If you are resuming high-QPS queues, follow the 500/50/5 pattern described in [Managing Cloud Tasks Scaling Risks](https://cloud.google.com/tasks/docs/manage-cloud-task-scaling)."]
                    pub fn resume(
                        &self,
                    ...
                    #[doc = "Returns permissions that a caller has on a Queue. If the resource does not exist, this will return an empty set of permissions, not a NOT_FOUND error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may “fail open” without warning."]
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `queues` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_queues<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_queues_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `queues` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_queues_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Queue, crate::Error>> + 'a
                    {
                        self.stream_queues_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `queues` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_queues_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Queue, crate::Error>> + 'a
                    {
                        self.stream_queues_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `queues` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_queues_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListQueuesResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                ...
                pub mod tasks {
                    ...
                    impl<'a> TasksActions<'a> {
                        ...
                        #[doc = "Creates and buffers a new task without the need to explicitly define a Task message. The queue must have HTTP target. To create the task with a custom ID, use the following format and set TASK_ID to your desired ID: projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID:buffer To create the task with an automatically generated ID, use the following format: projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks:buffer. Note: This feature is in its experimental stage. You must request access to the API through the [Cloud Tasks BufferTask Experiment Signup form](https://forms.gle/X8Zr5hiXH5tTGFqh8)."]
                        pub fn buffer(
                            &self,
                            request: crate::schemas::BufferTaskRequest,
                            queue: impl Into<String>,
                            task_id: impl Into<String>,
                        ) -> BufferRequestBuilder {
                            BufferRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                                request,
                        ...
                        #[doc = "Cancel a pull task’s lease. The worker can use this method to cancel a task’s lease by setting its schedule_time to now. This will make the task available to be leased to the next caller of LeaseTasks."]
                        pub fn cancel_lease(
                            &self,
                        ...
                        #[doc = "Creates a task and adds it to a queue. Tasks cannot be updated after creation; there is no UpdateTask command. * For App Engine queues, the maximum task size is 100KB. * For pull queues, the maximum task size is 1MB."]
                        pub fn create(
                            &self,
                        ...
                        #[doc = "Deletes a task. A task can be deleted if it is scheduled or dispatched. A task cannot be deleted if it has completed successfully or permanently failed."]
                        pub fn delete(&self, name: impl Into<String>) -> DeleteRequestBuilder {
                            DeleteRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                        ...
                        #[doc = "Lists the tasks in a queue. By default, only the BASIC view is retrieved due to performance considerations; response_view controls the subset of information which is returned. The tasks may be returned in any order. The ordering may change at any time."]
                        pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                            ListRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                        ...
                        #[doc = "Renew the current lease of a pull task. The worker can use this method to extend the lease by a new duration, starting from now. The new task lease will be returned in the task’s schedule_time."]
                        pub fn renew_lease(
                            &self,
                    ...
                    #[doc = "Created via [TasksActions::buffer()](struct.TasksActions.html#method.buffer)"]
                    #[derive(Debug, Clone)]
                    pub struct BufferRequestBuilder<'a> {
                        pub(crate) reqwest: &'a ::reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                        request: crate::schemas::BufferTaskRequest,
                        queue: String,
                    ...
                    impl<'a> BufferRequestBuilder<'a> {
                        ...
                        pub async fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::BufferTaskResponse, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>).await
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
                    ...
                    #[derive(Debug, Clone)]
                    pub struct GetRequestBuilder < 'a > { pub (crate) reqwest : & 'a :: reqwest :: Client , pub (crate) auth : & 'a dyn :: google_api_auth :: GetAccessToken , name : String , response_view : :: std :: option :: Option < crate :: resources :: projects :: locations :: queues :: tasks :: params :: GetResponseView > , access_token : :: std :: option :: Option < String > , alt : :: std :: option :: Option < crate :: params :: Alt > , callback : :: std :: option :: Option < String > , fields : :: std :: option :: Option < String > , key : :: std :: option :: Option < String > , oauth_token : :: std :: option :: Option < String > , pretty_print : :: std :: option :: Option < bool > , quota_user : :: std :: option :: Option < String > , upload_protocol : :: std :: option :: Option < String > , upload_type : :: std :: option :: Option < String > , xgafv : :: std :: option :: Option < crate :: params :: Xgafv > , }
                    impl<'a> GetRequestBuilder<'a> {
                        #[doc = "The response_view specifies which subset of the Task will be returned. By default response_view is BASIC; not all information is retrieved by default because some data, such as payloads, might be desirable to return only when needed because of its large size or because of the sensitivity of data that it contains. Authorization for FULL requires `cloudtasks.tasks.fullView` [Google IAM](https://cloud.google.com/iam/) permission on the Task resource."]
                        ...
                        {
                            let mut req = self.reqwest.request(::reqwest::Method::GET, path);
                            req = req.query(&[("responseView", &self.response_view)]);
                            req = req.query(&[("access_token", &self.access_token)]);
                            req = req.query(&[("alt", &self.alt)]);
                            req = req.query(&[("callback", &self.callback)]);
                            req = req.query(&[("fields", &self.fields)]);
                    ...
                    #[derive(Debug, Clone)]
                    pub struct ListRequestBuilder < 'a > { pub (crate) reqwest : & 'a :: reqwest :: Client , pub (crate) auth : & 'a dyn :: google_api_auth :: GetAccessToken , parent : String , page_size : :: std :: option :: Option < i32 > , page_token : :: std :: option :: Option < String > , response_view : :: std :: option :: Option < crate :: resources :: projects :: locations :: queues :: tasks :: params :: ListResponseView > , access_token : :: std :: option :: Option < String > , alt : :: std :: option :: Option < crate :: params :: Alt > , callback : :: std :: option :: Option < String > , fields : :: std :: option :: Option < String > , key : :: std :: option :: Option < String > , oauth_token : :: std :: option :: Option < String > , pretty_print : :: std :: option :: Option < bool > , quota_user : :: std :: option :: Option < String > , upload_protocol : :: std :: option :: Option < String > , upload_type : :: std :: option :: Option < String > , xgafv : :: std :: option :: Option < crate :: params :: Xgafv > , }
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        pub fn stream_tasks_with_default_fields(
                            self,
                        ) -> impl ::futures::Stream<Item = Result<crate::schemas::Task, crate::Error>> + 'a
                        {
                        ...
                        pub fn stream_with_default_fields(
                            ...
                            Item = Result<crate::schemas::ListTasksResponse, crate::Error>,
                        > + 'a {
                            self.stream_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the request and yield the returned value. If the response contains a"]
