...
pub mod schemas {
    ...
    pub struct Queue {
        ...
        #[doc = "Modifies HTTP target for HTTP tasks."]
        #[serde(
            rename = "httpTarget",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub r#type: ::std::option::Option<crate::schemas::QueueType>,
    ...
    impl QueueType {
        pub fn as_str(self) -> &'static str {
            match self {
                QueueType::Pull => "PULL",
                QueueType::Push => "PUSH",
                QueueType::TypeUnspecified => "TYPE_UNSPECIFIED",
            }
        }
    }
    ...
    impl ::std::str::FromStr for QueueType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<QueueType, ()> {
            Ok(match s {
                "PULL" => QueueType::Pull,
                "PUSH" => QueueType::Push,
                "TYPE_UNSPECIFIED" => QueueType::TypeUnspecified,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::serde::Serialize for QueueType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for QueueType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for QueueType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for QueueType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
            ...
            pub mod queues {
                ...
                pub mod tasks {
                    ...
                    impl<'a> TasksActions<'a> {
                        ...
                        #[doc = "Creates a task and adds it to a queue. Tasks cannot be updated after creation; there is no UpdateTask command. * The maximum task size is 100KB."]
                        pub fn create(
                            &self,
                        ...
                        #[doc = "Deletes a task. A task can be deleted if it is scheduled or dispatched. A task cannot be deleted if it has executed successfully or permanently failed."]
                        pub fn delete(&self, name: impl Into<String>) -> DeleteRequestBuilder {
                            DeleteRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
