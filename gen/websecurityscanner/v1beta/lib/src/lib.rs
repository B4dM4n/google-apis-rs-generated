...
pub mod schemas {
    ...
    pub struct Finding {
        ...
        #[doc = "An addon containing information reported for an XXE, if any."]
        #[serde(
            rename = "xxe",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl crate::GetNextPageToken<String> for ListCrawledUrlsResponse {
    ...
    impl crate::GetNextPageToken<String> for ListScanRunsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub enum ScanConfigTargetPlatformsItems {
        ...
        AppEngine,
        #[doc = "Google Cloud Function service."]
        CloudFunctions,
        #[doc = "Google Cloud Run service."]
        CloudRun,
    ...
    impl ScanConfigTargetPlatformsItems {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                ScanConfigTargetPlatformsItems::CloudFunctions => "CLOUD_FUNCTIONS",
                ScanConfigTargetPlatformsItems::CloudRun => "CLOUD_RUN",
    ...
    impl ::std::str::FromStr for ScanConfigTargetPlatformsItems {
        ...
        fn from_str(s: &str) -> ::std::result::Result<ScanConfigTargetPlatformsItems, ()> {
            Ok(match s {
                ...
                "CLOUD_FUNCTIONS" => ScanConfigTargetPlatformsItems::CloudFunctions,
                "CLOUD_RUN" => ScanConfigTargetPlatformsItems::CloudRun,
    ...
    pub enum ScanRunErrorTraceCode {
        ...
        ScanConfigIssue,
        #[doc = "Indicates that some of the starting web urls returned HTTP errors during the scan."]
    ...
    impl ScanRunErrorTraceCode {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                ScanRunErrorTraceCode::StartingUrlsCrawlHttpErrors => {
        ...
        pub mod scan_configs {
            ...
            pub mod scan_runs {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `scanRuns` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_scan_runs<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_scan_runs_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `scanRuns` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_scan_runs_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::ScanRun, crate::Error>> + 'a
                    {
                        self.stream_scan_runs_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `scanRuns` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_scan_runs_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::ScanRun, crate::Error>> + 'a
                    {
                        self.stream_scan_runs_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `scanRuns` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_scan_runs_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListScanRunsResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                ...
                pub mod crawled_urls {
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        #[doc = "\nExecute the request and yield each item in the `crawledUrls` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                        pub fn stream_crawled_urls<T>(
                            self,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                            T: ::serde::de::DeserializeOwned
                                ...
                                + 'a,
                        {
                            ...
                            self.stream_crawled_urls_with_fields(fields)
                        }
                        #[doc = "\nExecute the request and yield each item in the `crawledUrls` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                        pub fn stream_crawled_urls_with_default_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::CrawledUrl, crate::Error>,
                        > + 'a {
                            self.stream_crawled_urls_with_fields(None::<String>)
                        }
                        #[doc = "\nExecute the request and yield each item in the `crawledUrls` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                        pub fn stream_crawled_urls_with_all_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::CrawledUrl, crate::Error>,
                        > + 'a {
                            self.stream_crawled_urls_with_fields(Some("*"))
                        }
                        #[doc = "\nExecute the request and yield each item in the `crawledUrls` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                        pub fn stream_crawled_urls_with_fields<T, F>(
                            mut self,
                            fields: ::std::option::Option<F>,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                        ...
                        pub fn stream_with_default_fields(
                            ...
                            Item = Result<crate::schemas::ListCrawledUrlsResponse, crate::Error>,
                        > + 'a {
                            self.stream_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                ...
                pub mod findings {
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        pub fn stream_findings_with_default_fields(
                            ...
                            Item = Result<crate::schemas::Finding, crate::Error>,
                        > + 'a {
