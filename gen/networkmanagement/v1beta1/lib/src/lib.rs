...
pub mod schemas {
    ...
    pub enum DeliverInfoTarget {
        ...
        Internet,
        #[doc = "Target is all Google APIs using [Private Service Connect](https://cloud.google.com/vpc/docs/configure-private-service-connect-apis)."]
        PscGoogleApi,
        #[doc = "Target is a published service using [Private Service Connect](https://cloud.google.com/vpc/docs/configure-private-service-connect-services)."]
        PscPublishedService,
        #[doc = "Target is VPC-SC using [Private Service Connect](https://cloud.google.com/vpc/docs/configure-private-service-connect-apis)."]
        PscVpcSc,
    ...
    pub enum DropInfoCause {
        ...
        #[doc = "Privte Service Connect (PSC) connection is not in accepted state."]
    ...
    pub struct EdgeLocation {
        #[doc = "Name of the metropolitan area."]
        #[serde(
            rename = "metropolitanArea",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub metropolitan_area: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for EdgeLocation {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for EdgeLocation {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct EndpointInfo {
        ...
        pub protocol: ::std::option::Option<String>,
        #[doc = "URI of the source telemetry agent this packet originates from."]
        #[serde(
            rename = "sourceAgentUri",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub source_agent_uri: ::std::option::Option<String>,
    ...
    impl crate::GetNextPageToken for ListConnectivityTestsResponse {
    ...
    pub struct ProbingDetails {
        #[doc = "The reason probing was aborted."]
        #[serde(
            rename = "abortCause",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "The EdgeLocation from which a packet destined for/originating from the internet will egress/ingress the Google network. This will only be populated for a connectivity test which has an internet destination/source address. The absence of this field *must not* be used as an indication that the destination/source is part of the Google network."]
        #[serde(
            rename = "destinationEgressLocation",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub destination_egress_location: ::std::option::Option<crate::schemas::EdgeLocation>,
        #[doc = "The source and destination endpoints derived from the test input and used for active probing."]
        #[serde(
            rename = "endpointInfo",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Details about an internal failure or the cancellation of active probing."]
        #[serde(
            rename = "error",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub error: ::std::option::Option<crate::schemas::Status>,
        #[doc = "Latency as measured by active probing in one direction: from the source to the destination endpoint."]
        #[serde(
        ...
        #[doc = "The overall result of active probing."]
        #[serde(
            rename = "result",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Number of probes that reached the destination."]
        #[serde(
        ...
        #[doc = "The time that reachability was assessed through active probing."]
        #[serde(
            rename = "verifyTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub enum ProbingDetailsAbortCause {
        #[doc = "No valid source endpoint could be derived from the request."]
        NoSourceLocation,
        #[doc = "The user lacks permission to access some of the network resources required to run the test."]
        PermissionDenied,
        #[doc = "No reason was specified."]
    ...
    pub enum ProbingDetailsResult {
        ...
        #[doc = "Less than 95% of packets reached the destination."]
        ReachabilityInconsistent,
        #[doc = "At least 95% of packets reached the destination."]
        Reachable,
        #[doc = "Reachability could not be determined. Possible reasons are: * The user lacks permission to access some of the network resources required to run the test. * No valid source endpoint could be derived from the request. * An internal error occurred."]
        Undetermined,
        #[doc = "No packets reached the destination."]
        Unreachable,
    }
    ...
    pub struct Step {
        ...
        #[serde(
            rename = "appEngineVersionInfo",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub app_engine_version_info: ::std::option::Option<crate::schemas::AppEngineVersionInfo>,
