...
pub mod schemas {
    ...
    pub struct DownloadModelResponse {
        ...
        pub model_format: ::std::option::Option<crate::schemas::DownloadModelResponseModelFormat>,
    ...
    impl ::google_field_selector::FieldSelector for DownloadModelResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DownloadModelResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum DownloadModelResponseModelFormat {
        #[doc = "Unknown format"]
        ModelFormatUnspecified,
        #[doc = "TFLite model"]
        Tflite,
    }
    impl DownloadModelResponseModelFormat {
        pub fn as_str(self) -> &'static str {
            match self {
                DownloadModelResponseModelFormat::ModelFormatUnspecified => {
                    "MODEL_FORMAT_UNSPECIFIED"
                }
                DownloadModelResponseModelFormat::Tflite => "TFLITE",
            }
        }
    }
    impl ::std::convert::AsRef<str> for DownloadModelResponseModelFormat {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for DownloadModelResponseModelFormat {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<DownloadModelResponseModelFormat, ()> {
            Ok(match s {
                "MODEL_FORMAT_UNSPECIFIED" => {
                    DownloadModelResponseModelFormat::ModelFormatUnspecified
                }
                "TFLITE" => DownloadModelResponseModelFormat::Tflite,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for DownloadModelResponseModelFormat {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for DownloadModelResponseModelFormat {
    ...
    impl<'de> ::serde::Deserialize<'de> for DownloadModelResponseModelFormat {
    ...
    impl ::google_field_selector::FieldSelector for DownloadModelResponseModelFormat {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DownloadModelResponseModelFormat {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Model {
        ...
        #[serde(
            rename = "activeOperations",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub active_operations: ::std::option::Option<Vec<crate::schemas::Operation>>,
        ...
        pub model_hash: ::std::option::Option<String>,
        ...
        pub state: ::std::option::Option<crate::schemas::ModelState>,
        ...
        pub tflite_model: ::std::option::Option<crate::schemas::TfLiteModel>,
    ...
    pub struct ModelOperationMetadata {
        #[serde(
            rename = "basicOperationStatus",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub basic_operation_status:
            ::std::option::Option<crate::schemas::ModelOperationMetadataBasicOperationStatus>,
    ...
    impl ::google_field_selector::FieldSelector for ModelOperationMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ModelOperationMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum ModelOperationMetadataBasicOperationStatus {
    ...
    impl ModelOperationMetadataBasicOperationStatus {
        pub fn as_str(self) -> &'static str {
            match self {
                ModelOperationMetadataBasicOperationStatus::BasicOperationStatusUnspecified => {
                    "BASIC_OPERATION_STATUS_UNSPECIFIED"
                }
                ModelOperationMetadataBasicOperationStatus::BasicOperationStatusUploading => {
                    "BASIC_OPERATION_STATUS_UPLOADING"
                }
                ModelOperationMetadataBasicOperationStatus::BasicOperationStatusVerifying => {
                    "BASIC_OPERATION_STATUS_VERIFYING"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for ModelOperationMetadataBasicOperationStatus {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for ModelOperationMetadataBasicOperationStatus {
        type Err = ();
        fn from_str(
            s: &str,
        ) -> ::std::result::Result<ModelOperationMetadataBasicOperationStatus, ()> {
            Ok(match s {
                "BASIC_OPERATION_STATUS_UNSPECIFIED" => {
                    ModelOperationMetadataBasicOperationStatus::BasicOperationStatusUnspecified
                }
    ...
    impl ::std::fmt::Display for ModelOperationMetadataBasicOperationStatus {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for ModelOperationMetadataBasicOperationStatus {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ModelOperationMetadataBasicOperationStatus {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ModelOperationMetadataBasicOperationStatus {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ModelOperationMetadataBasicOperationStatus {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ModelState {
        ...
        pub validation_error: ::std::option::Option<crate::schemas::Status>,
    }
    impl ::google_field_selector::FieldSelector for ModelState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ModelState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct TfLiteModel {
        ...
        pub gcs_tflite_uri: ::std::option::Option<String>,
        ...
        pub size_bytes: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for TfLiteModel {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for TfLiteModel {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub mod projects {
        ...
        pub mod models {
            ...
            impl<'a> ModelsActions<'a> {
                ...
                #[doc = "Creates a model in Firebase ML. The longrunning operation will eventually return a Model"]
                pub fn create(
                    &self,
                ...
                #[doc = "Gets Download information for a model. This is meant for downloading model resources onto devices. It gives very limited information about the model."]
                ...
                #[doc = "Updates a model. The longrunning operation will eventually return a Model."]
                pub fn patch(
                    &self,
                    request: crate::schemas::Model,
            ...
            impl<'a> CreateRequestBuilder<'a> {
                ...
                fn _path(&self) -> String {
                    let mut output = "https://firebaseml.googleapis.com/".to_owned();
            ...
            #[doc = "Created via [ModelsActions::download()](struct.ModelsActions.html#method.download)"]
            #[derive(Debug, Clone)]
            ...
            impl<'a> DownloadRequestBuilder<'a> {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::DownloadModelResponse, crate::Error> {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
