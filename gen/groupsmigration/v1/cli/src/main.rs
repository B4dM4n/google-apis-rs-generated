    ...
    fn default() -> Self {
        let mut app = App::new("groupsmigration1")
            ...
            .arg(Arg::with_name("debug")
                ...
                .multiple(false)
                .takes_value(false));
        let mut archive0 = SubCommand::with_name("archive")
            .setting(AppSettings::ColoredHelp)
            .about("methods: insert");
        {
            let mcmd = SubCommand::with_name("insert")
                .about("Inserts a new mail into the archive of the Google group.");
            archive0 = archive0.subcommand(mcmd);
        }
        app = app.subcommand(archive0);

        Self { app }
    }
}
use google_groupsmigration1 as api;
