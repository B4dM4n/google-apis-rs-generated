        ...
        pub mod locations {
            ...
            pub mod job_templates {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn iter_job_templates<T>(self) -> crate::iter::PageItemIter<Self, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                    {
                        let fields = ::google_field_selector::to_string::<T>();
                        ...
                        self.iter_job_templates_with_fields(fields)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_job_templates_with_default_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::JobTemplate>
                    {
                        self.iter_job_templates_with_fields(None::<String>)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    ...
                    #[doc = r" resources."]
                    pub fn iter_job_templates_with_all_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::JobTemplate>
                    {
                        self.iter_job_templates_with_fields(Some("*"))
                    }
                    pub fn iter_job_templates_with_fields<T, F>(
                        mut self,
                        fields: Option<F>,
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        crate::iter::PageItemIter::new(self, "jobTemplates")
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are chosen by the caller of this"]
                    #[doc = r" method and must implement `Deserialize` and `FieldSelector`. The"]
                    ...
                    pub fn iter_with_default_fields(
                        self,
                    ) -> crate::iter::PageIter<Self, crate::schemas::ListJobTemplatesResponse>
                    {
