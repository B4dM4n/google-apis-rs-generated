...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for ChangePlanRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ChangePlanRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Customer {
        ...
        #[doc = "Identifies the type of the customer. Acceptable values include: * `domain`: Implies a domain-verified customer (default). * `team`: Implies an email-verified customer. For more information, see [managed teams](https://support.google.com/a/users/answer/9939479)."]
        #[serde(
            rename = "customerType",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub customer_type: ::std::option::Option<crate::schemas::CustomerCustomerType>,
        ...
        #[doc = "The first admin details of the customer, present in case of TEAM customer."]
        #[serde(
            rename = "primaryAdmin",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub primary_admin: ::std::option::Option<crate::schemas::PrimaryAdmin>,
    ...
    pub enum CustomerCustomerType {
        #[doc = "Customer type not known"]
        CustomerTypeUnspecified,
        #[doc = "Domained or domain-owning customers"]
        Domain,
        #[doc = "Domainless or email-verified customers"]
        Team,
    }
    impl CustomerCustomerType {
        pub fn as_str(self) -> &'static str {
            match self {
                CustomerCustomerType::CustomerTypeUnspecified => "customerTypeUnspecified",
                CustomerCustomerType::Domain => "domain",
                CustomerCustomerType::Team => "team",
            }
        }
    }
    impl ::std::convert::AsRef<str> for CustomerCustomerType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for CustomerCustomerType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<CustomerCustomerType, ()> {
            Ok(match s {
                "customerTypeUnspecified" => CustomerCustomerType::CustomerTypeUnspecified,
                "domain" => CustomerCustomerType::Domain,
                "team" => CustomerCustomerType::Team,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for CustomerCustomerType {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for CustomerCustomerType {
    ...
    impl<'de> ::serde::Deserialize<'de> for CustomerCustomerType {
    ...
    impl ::google_field_selector::FieldSelector for CustomerCustomerType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CustomerCustomerType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for PrimaryAdmin {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PrimaryAdmin {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for RenewalSettings {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for RenewalSettings {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ResellernotifyGetwatchdetailsResponse {
        ...
        #[serde(
            rename = "serviceAccountEmailAddresses",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
    ...
    impl ::google_field_selector::FieldSelector for ResellernotifyGetwatchdetailsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ResellernotifyGetwatchdetailsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for ResellernotifyResource {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ResellernotifyResource {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Seats {
        ...
        #[serde(
            rename = "numberOfSeats",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub number_of_seats: ::std::option::Option<i32>,
    }
    impl ::google_field_selector::FieldSelector for Seats {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for Seats {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for SubscriptionPlan {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SubscriptionPlan {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for SubscriptionPlanCommitmentInterval {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SubscriptionPlanCommitmentInterval {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SubscriptionTransferInfo {
        #[doc = "The `skuId` of the current resold subscription. This is populated only when the customer has a subscription with a legacy SKU and the subscription resource is populated with the `skuId` of the SKU recommended for the transfer."]
        #[serde(
            rename = "currentLegacySkuId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub current_legacy_sku_id: ::std::option::Option<String>,
        ...
        #[serde(
            rename = "minimumTransferableSeats",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        ...
        #[serde(
            rename = "transferabilityExpirationTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        #[serde(with = "crate::parsed_string")]
    ...
    impl ::google_field_selector::FieldSelector for SubscriptionTransferInfo {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SubscriptionTransferInfo {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for SubscriptionTrialSettings {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SubscriptionTrialSettings {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for Subscriptions {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for Subscriptions {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for Subscriptions {
...
impl Client {
    ...
    #[doc = "Actions that can be performed on the resellernotify resource"]
    pub fn resellernotify(&self) -> crate::resources::resellernotify::ResellernotifyActions {
        crate::resources::resellernotify::ResellernotifyActions {
            reqwest: &self.reqwest,
            auth: self.auth_ref(),
        }
    }
...
pub mod resources {
    pub mod customers {
        ...
        impl<'a> CustomersActions<'a> {
            ...
            #[doc = "Gets a customer account. Use this operation to see a customer account already in your reseller management, or to see the minimal account information for an existing customer that you do not manage. For more information about the API response for existing customers, see [retrieving a customer account](/admin-sdk/reseller/v1/how-tos/manage_customers#get_customer)."]
            pub fn get(&self, customer_id: impl Into<String>) -> GetRequestBuilder {
                GetRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    access_token: None,
            ...
            #[doc = "Orders a new customer’s account. Before ordering a new customer account, establish whether the customer account already exists using the [`customers.get`](/admin-sdk/reseller/v1/reference/customers/get) If the customer account exists as a direct Google account or as a resold customer account from another reseller, use the `customerAuthToken\\` as described in [order a resold account for an existing customer](/admin-sdk/reseller/v1/how-tos/manage_customers#create_existing_customer). For more information about ordering a new customer account, see [order a new customer account](/admin-sdk/reseller/v1/how-tos/manage_customers#create_customer). After creating a new customer account, you must provision a user as an administrator. The customer’s administrator is required to sign in to the Admin console and sign the G Suite via Reseller agreement to activate the account. Resellers are prohibited from signing the G Suite via Reseller agreement on the customer’s behalf. For more information, see [order a new customer account](/admin-sdk/reseller/v1/how-tos/manage_customers#tos)."]
            pub fn insert(&self, request: crate::schemas::Customer) -> InsertRequestBuilder {
                InsertRequestBuilder {
                    ...
                    upload_type: None,
                    xgafv: None,
                    customer_auth_token: None,
                }
            }
            #[doc = "Updates a customer account’s settings. This method supports patch semantics. You cannot update `customerType` via the Reseller API, but a `\"team\"` customer can verify their domain and become `customerType = \"domain\"`. For more information, see [Verify your domain to unlock Essentials features](https://support.google.com/a/answer/9122284)."]
            pub fn patch(
                &self,
            ...
            #[doc = "Updates a customer account’s settings. You cannot update `customerType` via the Reseller API, but a `\"team\"` customer can verify their domain and become `customerType = \"domain\"`. For more information, see [update a customer’s settings](/admin-sdk/reseller/v1/how-tos/manage_customers#update_customer)."]
            pub fn update(
                &self,
                request: crate::schemas::Customer,
                customer_id: impl Into<String>,
        ...
        impl<'a> GetRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://reseller.googleapis.com/".to_owned();
                output.push_str("apps/reseller/v1/customers/");
                {
        ...
        pub struct InsertRequestBuilder<'a> {
            ...
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            request: crate::schemas::Customer,
            customer_auth_token: ::std::option::Option<String>,
            access_token: ::std::option::Option<String>,
            alt: ::std::option::Option<crate::params::Alt>,
            callback: ::std::option::Option<String>,
            fields: ::std::option::Option<String>,
        ...
        impl<'a> InsertRequestBuilder<'a> {
            ...
            pub fn customer_auth_token(mut self, value: impl Into<String>) -> Self {
                self.customer_auth_token = Some(value.into());
                self
            }
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
            ...
            async fn _request(
                ...
                req = req.query(&[("customerAuthToken", &self.customer_auth_token)]);
                req = req.query(&[("access_token", &self.access_token)]);
                req = req.query(&[("alt", &self.alt)]);
                req = req.query(&[("callback", &self.callback)]);
                req = req.query(&[("fields", &self.fields)]);
    ...
    pub mod resellernotify {
        ...
        impl<'a> ResellernotifyActions<'a> {
            ...
            #[doc = "Returns all the details of the watch corresponding to the reseller."]
            pub fn getwatchdetails(&self) -> GetwatchdetailsRequestBuilder {
                GetwatchdetailsRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    access_token: None,
                    alt: None,
            ...
            #[doc = "Registers a Reseller for receiving notifications."]
            pub fn register(&self) -> RegisterRequestBuilder {
            ...
            #[doc = "Unregisters a Reseller for receiving notifications."]
            pub fn unregister(&self) -> UnregisterRequestBuilder {
        ...
        impl<'a> GetwatchdetailsRequestBuilder<'a> {
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
                self.access_token = Some(value.into());
                self
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::ResellernotifyGetwatchdetailsResponse, crate::Error>
            {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            fn _path(&self) -> String {
                let mut output = "https://reseller.googleapis.com/".to_owned();
                output.push_str("apps/reseller/v1/resellernotify/getwatchdetails");
                output
            }
            async fn _request(
                &self,
        ...
        pub struct RegisterRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            service_account_email_address: ::std::option::Option<String>,
            access_token: ::std::option::Option<String>,
            alt: ::std::option::Option<crate::params::Alt>,
            callback: ::std::option::Option<String>,
            fields: ::std::option::Option<String>,
        ...
        impl<'a> RegisterRequestBuilder<'a> {
            ...
            pub fn service_account_email_address(mut self, value: impl Into<String>) -> Self {
                self.service_account_email_address = Some(value.into());
                self
            }
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::ResellernotifyResource, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            fn _path(&self) -> String {
                let mut output = "https://reseller.googleapis.com/".to_owned();
                output.push_str("apps/reseller/v1/resellernotify/register");
                output
            }
            async fn _request(
                &self,
        ...
        impl<'a> UnregisterRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://reseller.googleapis.com/".to_owned();
                output.push_str("apps/reseller/v1/resellernotify/unregister");
                output
            }
            async fn _request(
                &self,
    ...
    pub mod subscriptions {
        pub mod params {
            ...
            impl DeleteDeletionType {
                pub fn as_str(self) -> &'static str {
                    match self {
                        DeleteDeletionType::Cancel => "cancel",
                        DeleteDeletionType::DeletionTypeUndefined => "deletion_type_undefined",
                        DeleteDeletionType::TransferToDirect => "transfer_to_direct",
                    }
                }
            }
            impl ::std::convert::AsRef<str> for DeleteDeletionType {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
            impl ::std::str::FromStr for DeleteDeletionType {
                type Err = ();
                fn from_str(s: &str) -> ::std::result::Result<DeleteDeletionType, ()> {
                    Ok(match s {
                        "cancel" => DeleteDeletionType::Cancel,
                        "deletion_type_undefined" => DeleteDeletionType::DeletionTypeUndefined,
                        "transfer_to_direct" => DeleteDeletionType::TransferToDirect,
                        _ => return Err(()),
                    })
                }
            }
            impl ::std::fmt::Display for DeleteDeletionType {
                fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                    f.write_str(self.as_str())
                }
            }
            impl ::serde::Serialize for DeleteDeletionType {
                fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
                where
                    S: ::serde::ser::Serializer,
                {
            ...
            impl<'de> ::serde::Deserialize<'de> for DeleteDeletionType {
                fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
                where
                    D: ::serde::de::Deserializer<'de>,
                {
            ...
            impl ::google_field_selector::FieldSelector for DeleteDeletionType {
                fn fields() -> Vec<::google_field_selector::Field> {
                    Vec::new()
                }
            }
            impl ::google_field_selector::ToFieldType for DeleteDeletionType {
                fn field_type() -> ::google_field_selector::FieldType {
                    ::google_field_selector::FieldType::Leaf
                }
            }
        ...
        impl<'a> SubscriptionsActions<'a> {
            ...
            #[doc = "Activates a subscription previously suspended by the reseller. If you did not suspend the customer subscription and it is suspended for any other reason, such as for abuse or a pending ToS acceptance, this call will not reactivate the customer subscription."]
            pub fn activate(
                &self,
                customer_id: impl Into<String>,
            ...
            #[doc = "Updates a subscription plan. Use this method to update a plan for a 30-day trial or a flexible plan subscription to an annual commitment plan with monthly or yearly payments. How a plan is updated differs depending on the plan and the products. For more information, see the description in [manage subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions#update_subscription_plan)."]
            pub fn change_plan(
                &self,
                request: crate::schemas::ChangePlanRequest,
                customer_id: impl Into<String>,
                subscription_id: impl Into<String>,
            ) -> ChangePlanRequestBuilder {
                ChangePlanRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    request,
            ...
            #[doc = "Updates a user license’s renewal settings. This is applicable for accounts with annual commitment plans only. For more information, see the description in [manage subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions#update_renewal)."]
            ...
            #[doc = "Updates a subscription’s user license settings. For more information about updating an annual commitment plan or a flexible plan subscription’s licenses, see [Manage Subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions#update_subscription_seat)."]
            pub fn change_seats(
                &self,
                request: crate::schemas::Seats,
                customer_id: impl Into<String>,
                subscription_id: impl Into<String>,
            ) -> ChangeSeatsRequestBuilder {
                ChangeSeatsRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    request,
            ...
            #[doc = "Cancels, suspends, or transfers a subscription to direct."]
            pub fn delete(
                &self,
                customer_id: impl Into<String>,
                subscription_id: impl Into<String>,
                deletion_type: crate::resources::subscriptions::params::DeleteDeletionType,
            ...
            #[doc = "Gets a specific subscription. The `subscriptionId` can be found using the [Retrieve all reseller subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions#get_all_subscriptions) method. For more information about retrieving a specific subscription, see the information descrived in [manage subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions#get_subscription)."]
            pub fn get(
                &self,
                customer_id: impl Into<String>,
                subscription_id: impl Into<String>,
            ...
            #[doc = "Lists of subscriptions managed by the reseller. The list can be all subscriptions, all of a customer’s subscriptions, or all of a customer’s transferable subscriptions. Optionally, this method can filter the response by a `customerNamePrefix`. For more information, see [manage subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions)."]
            pub fn list(&self) -> ListRequestBuilder {
                ListRequestBuilder {
                    ...
                    customer_auth_token: None,
                    customer_id: None,
                    customer_name_prefix: None,
                    max_results: None,
                    page_token: None,
                }
            }
            #[doc = "Immediately move a 30-day free trial subscription to a paid service subscription. This method is only applicable if a payment plan has already been set up for the 30-day trial subscription. For more information, see [manage subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions#paid_service)."]
        ...
        impl<'a> ChangePlanRequestBuilder<'a> {
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
                self.access_token = Some(value.into());
                self
        ...
        impl<'a> ChangeSeatsRequestBuilder<'a> {
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
                self.access_token = Some(value.into());
                self
        ...
        impl<'a> DeleteRequestBuilder<'a> {
            ...
            async fn _request(
                ...
                req = req.query(&[("deletionType", &self.deletion_type)]);
                req = req.query(&[("access_token", &self.access_token)]);
                req = req.query(&[("alt", &self.alt)]);
                req = req.query(&[("callback", &self.callback)]);
                req = req.query(&[("fields", &self.fields)]);
        ...
        pub struct ListRequestBuilder<'a> {
            ...
            customer_name_prefix: ::std::option::Option<String>,
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            #[doc = "This can be either the customer’s primary domain name or the customer’s unique identifier. If the domain name for a customer changes, the old domain name cannot be used to access the customer, but the customer’s unique identifier (as returned by the API) can always be used. We recommend storing the unique identifier in your systems where applicable."]
            ...
            pub fn customer_name_prefix(mut self, value: impl Into<String>) -> Self {
            ...
            pub fn stream_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::Subscriptions, crate::Error>> + 'a
            {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::Subscriptions, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            fn _path(&self) -> String {
                let mut output = "https://reseller.googleapis.com/".to_owned();
                output.push_str("apps/reseller/v1/subscriptions");
                output
            }
            async fn _request(
                &self,
                ...
                req = req.query(&[("customerNamePrefix", &self.customer_name_prefix)]);
