...
pub mod schemas {
    ...
    pub struct GoogleCloudWebriskV1ComputeThreatListDiffResponse {
        ...
        pub additions:
            ::std::option::Option<crate::schemas::GoogleCloudWebriskV1ThreatEntryAdditions>,
        ...
        pub checksum: ::std::option::Option<
            crate::schemas::GoogleCloudWebriskV1ComputeThreatListDiffResponseChecksum,
        >,
        ...
        #[serde(
            rename = "newVersionToken",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub new_version_token: ::std::option::Option<::google_api_bytes::Bytes>,
        ...
        #[serde(
            rename = "recommendedNextDiff",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub recommended_next_diff: ::std::option::Option<String>,
        ...
        pub removals:
            ::std::option::Option<crate::schemas::GoogleCloudWebriskV1ThreatEntryRemovals>,
        ...
        pub response_type: ::std::option::Option<
            crate::schemas::GoogleCloudWebriskV1ComputeThreatListDiffResponseResponseType,
        >,
    }
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1ComputeThreatListDiffResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1ComputeThreatListDiffResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum GoogleCloudWebriskV1ComputeThreatListDiffResponseResponseType {
    ...
    impl GoogleCloudWebriskV1ComputeThreatListDiffResponseResponseType {
        pub fn as_str(self) -> &'static str {
            match self { GoogleCloudWebriskV1ComputeThreatListDiffResponseResponseType :: Diff => "DIFF" , GoogleCloudWebriskV1ComputeThreatListDiffResponseResponseType :: Reset => "RESET" , GoogleCloudWebriskV1ComputeThreatListDiffResponseResponseType :: ResponseTypeUnspecified => "RESPONSE_TYPE_UNSPECIFIED" , }
        }
    }
    impl ::std::convert::AsRef<str> for GoogleCloudWebriskV1ComputeThreatListDiffResponseResponseType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for GoogleCloudWebriskV1ComputeThreatListDiffResponseResponseType {
        type Err = ();
        fn from_str(
            s: &str,
    ...
    impl ::serde::Serialize for GoogleCloudWebriskV1ComputeThreatListDiffResponseResponseType {
    ...
    impl<'de> ::serde::Deserialize<'de>
        for GoogleCloudWebriskV1ComputeThreatListDiffResponseResponseType
    {
    ...
    impl ::google_field_selector::FieldSelector
        for GoogleCloudWebriskV1ComputeThreatListDiffResponseChecksum
    {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1RawHashes {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1RawHashes {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1RawIndices {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1RawIndices {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1RiceDeltaEncoding {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1RiceDeltaEncoding {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudWebriskV1SearchHashesResponse {
        ...
        #[serde(
            rename = "negativeExpireTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub negative_expire_time: ::std::option::Option<String>,
        ...
        pub threats: ::std::option::Option<
            Vec<crate::schemas::GoogleCloudWebriskV1SearchHashesResponseThreatHash>,
        >,
    }
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1SearchHashesResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1SearchHashesResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudWebriskV1SearchHashesResponseThreatHash {
        ...
        pub threat_types: ::std::option::Option<
            Vec<crate::schemas::GoogleCloudWebriskV1SearchHashesResponseThreatHashThreatTypesItems>,
        >,
    }
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1SearchHashesResponseThreatHash {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1SearchHashesResponseThreatHash {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum GoogleCloudWebriskV1SearchHashesResponseThreatHashThreatTypesItems {
    ...
    impl ::std::convert::AsRef<str>
        for GoogleCloudWebriskV1SearchHashesResponseThreatHashThreatTypesItems
    {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for GoogleCloudWebriskV1SearchHashesResponseThreatHashThreatTypesItems {
        type Err = ();
        fn from_str(
            s: &str,
        ) -> ::std::result::Result<
    ...
    impl ::serde::Serialize for GoogleCloudWebriskV1SearchHashesResponseThreatHashThreatTypesItems {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    pub struct GoogleCloudWebriskV1SearchUrisResponse {
        ...
        pub threat:
            ::std::option::Option<crate::schemas::GoogleCloudWebriskV1SearchUrisResponseThreatUri>,
    }
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1SearchUrisResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1SearchUrisResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudWebriskV1SearchUrisResponseThreatUri {
        ...
        pub threat_types: ::std::option::Option<
            Vec<crate::schemas::GoogleCloudWebriskV1SearchUrisResponseThreatUriThreatTypesItems>,
        >,
    }
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1SearchUrisResponseThreatUri {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1SearchUrisResponseThreatUri {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum GoogleCloudWebriskV1SearchUrisResponseThreatUriThreatTypesItems {
        #[doc = "Malware targeting any platform."]
        Malware,
        #[doc = "Social engineering targeting any platform."]
        SocialEngineering,
    ...
    impl ::std::convert::AsRef<str>
        for GoogleCloudWebriskV1SearchUrisResponseThreatUriThreatTypesItems
    {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for GoogleCloudWebriskV1SearchUrisResponseThreatUriThreatTypesItems {
        type Err = ();
        fn from_str(
            s: &str,
        ) -> ::std::result::Result<
    ...
    impl ::serde::Serialize for GoogleCloudWebriskV1SearchUrisResponseThreatUriThreatTypesItems {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    pub struct GoogleCloudWebriskV1Submission {
        ...
        pub threat_types: ::std::option::Option<
            Vec<crate::schemas::GoogleCloudWebriskV1SubmissionThreatTypesItems>,
        >,
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1Submission {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1Submission {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum GoogleCloudWebriskV1SubmissionThreatTypesItems {
        #[doc = "Malware targeting any platform."]
        Malware,
        #[doc = "Social engineering targeting any platform."]
        SocialEngineering,
    ...
    impl ::std::str::FromStr for GoogleCloudWebriskV1SubmissionThreatTypesItems {
        type Err = ();
        fn from_str(
            s: &str,
    ...
    impl ::serde::Serialize for GoogleCloudWebriskV1SubmissionThreatTypesItems {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for GoogleCloudWebriskV1SubmissionThreatTypesItems {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1SubmissionThreatTypesItems {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudWebriskV1SubmitUriMetadata {
        #[doc = "Creation time of the operation."]
        #[serde(
            rename = "createTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub state:
            ::std::option::Option<crate::schemas::GoogleCloudWebriskV1SubmitUriMetadataState>,
        #[doc = "Latest update time of the operation."]
        #[serde(
            rename = "updateTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1SubmitUriMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1SubmitUriMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub enum GoogleCloudWebriskV1SubmitUriMetadataState {
        ...
        StateUnspecified,
        #[doc = "The operation finished with a success status."]
        Succeeded,
    }
    impl GoogleCloudWebriskV1SubmitUriMetadataState {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                GoogleCloudWebriskV1SubmitUriMetadataState::Succeeded => "SUCCEEDED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for GoogleCloudWebriskV1SubmitUriMetadataState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for GoogleCloudWebriskV1SubmitUriMetadataState {
        type Err = ();
        fn from_str(
            s: &str,
            ...
            Ok(match s {
                ...
                "SUCCEEDED" => GoogleCloudWebriskV1SubmitUriMetadataState::Succeeded,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for GoogleCloudWebriskV1SubmitUriMetadataState {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for GoogleCloudWebriskV1SubmitUriMetadataState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for GoogleCloudWebriskV1SubmitUriMetadataState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1SubmitUriMetadataState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1SubmitUriMetadataState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudWebriskV1SubmitUriRequest {
        ...
        pub submission: ::std::option::Option<crate::schemas::GoogleCloudWebriskV1Submission>,
    }
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1SubmitUriRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1SubmitUriRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudWebriskV1ThreatEntryAdditions {
        ...
        pub raw_hashes: ::std::option::Option<Vec<crate::schemas::GoogleCloudWebriskV1RawHashes>>,
        ...
        pub rice_hashes:
            ::std::option::Option<crate::schemas::GoogleCloudWebriskV1RiceDeltaEncoding>,
    }
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1ThreatEntryAdditions {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1ThreatEntryAdditions {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudWebriskV1ThreatEntryRemovals {
        ...
        pub raw_indices: ::std::option::Option<crate::schemas::GoogleCloudWebriskV1RawIndices>,
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudWebriskV1ThreatEntryRemovals {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudWebriskV1ThreatEntryRemovals {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
impl Client {
    ...
    #[doc = "Actions that can be performed on the hashes resource"]
    pub fn hashes(&self) -> crate::resources::hashes::HashesActions {
        crate::resources::hashes::HashesActions {
    ...
    #[doc = "Actions that can be performed on the uris resource"]
    pub fn uris(&self) -> crate::resources::uris::UrisActions {
        crate::resources::uris::UrisActions {
            reqwest: &self.reqwest,
            auth: self.auth_ref(),
        }
    }
...
pub mod resources {
    pub mod hashes {
        pub mod params {
            #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
            pub enum SearchThreatTypesItems {
                #[doc = "Malware targeting any platform."]
                Malware,
                #[doc = "Social engineering targeting any platform."]
                SocialEngineering,
            ...
            impl ::std::convert::AsRef<str> for SearchThreatTypesItems {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
            impl ::std::str::FromStr for SearchThreatTypesItems {
                type Err = ();
                fn from_str(s: &str) -> ::std::result::Result<SearchThreatTypesItems, ()> {
                    Ok(match s {
            ...
            impl ::std::fmt::Display for SearchThreatTypesItems {
                fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                    f.write_str(self.as_str())
                }
            }
            impl ::serde::Serialize for SearchThreatTypesItems {
                fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
                where
                    S: ::serde::ser::Serializer,
                {
            ...
            impl<'de> ::serde::Deserialize<'de> for SearchThreatTypesItems {
                fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
                where
                    D: ::serde::de::Deserializer<'de>,
                {
            ...
            impl ::google_field_selector::FieldSelector for SearchThreatTypesItems {
                fn fields() -> Vec<::google_field_selector::Field> {
                    Vec::new()
                }
            }
            impl ::google_field_selector::ToFieldType for SearchThreatTypesItems {
                fn field_type() -> ::google_field_selector::FieldType {
                    ::google_field_selector::FieldType::Leaf
                }
            }
        }
        pub struct HashesActions<'a> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
        }
        impl<'a> HashesActions<'a> {
            fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                self.auth
            }
            #[doc = "Gets the full hashes that match the requested hash prefix. This is used after a hash prefix is looked up in a threatList and there is a match. The client side threatList only holds partial hashes so the client must query this method to determine if there is a full hash match of a threat."]
        ...
        #[doc = "Created via [HashesActions::search()](struct.HashesActions.html#method.search)"]
        #[derive(Debug, Clone)]
        ...
        impl<'a> SearchRequestBuilder<'a> {
            ...
            pub fn hash_prefix(mut self, value: impl Into<Vec<u8>>) -> Self {
                let v: Vec<u8> = value.into();
                self.hash_prefix = Some(v.into());
                self
            }
            #[doc = "Required. The ThreatLists to search in. Multiple ThreatLists may be specified."]
            pub fn threat_types(
                mut self,
                value: impl Into<Vec<crate::resources::hashes::params::SearchThreatTypesItems>>,
            ) -> Self {
                self.threat_types = Some(value.into());
                self
            }
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::GoogleCloudWebriskV1SearchHashesResponse, crate::Error>
            {
            ...
            fn _path(&self) -> String {
                let mut output = "https://webrisk.googleapis.com/".to_owned();
                output.push_str("v1/hashes:search");
                output
            }
            async fn _request(
                &self,
                ...
                req = req.query(&[("hashPrefix", &self.hash_prefix)]);
                for value in self.threat_types.iter().flatten() {
                    req = req.query(&[("threatTypes", value)]);
                }
    ...
    pub mod projects {
        ...
        impl<'a> ProjectsActions<'a> {
            ...
            #[doc = "Actions that can be performed on the submissions resource"]
            pub fn submissions(
                &self,
            ) -> crate::resources::projects::submissions::SubmissionsActions {
                crate::resources::projects::submissions::SubmissionsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            ...
            #[doc = "Actions that can be performed on the uris resource"]
            pub fn uris(&self) -> crate::resources::projects::uris::UrisActions {
                crate::resources::projects::uris::UrisActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
        ...
        pub mod submissions {
            pub mod params {}
            pub struct SubmissionsActions<'a> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            }
            impl<'a> SubmissionsActions<'a> {
                fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                    self.auth
                }
                #[doc = "Creates a Submission of a URI suspected of containing phishing content to be reviewed. If the result verifies the existence of malicious phishing content, the site will be added to the [Google's Social Engineering lists](https://support.google.com/webmasters/answer/6350487/) in order to protect users that could get exposed to this threat in the future. Only allowlisted projects can use this method during Early Access. Please reach out to Sales or your customer engineer to obtain access."]
                pub fn create(
                    &self,
            ...
            #[doc = "Created via [SubmissionsActions::create()](struct.SubmissionsActions.html#method.create)"]
            #[derive(Debug, Clone)]
            ...
            impl<'a> CreateRequestBuilder<'a> {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::GoogleCloudWebriskV1Submission, crate::Error>
                {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
        ...
        pub mod uris {
            ...
            #[doc = "Created via [UrisActions::submit()](struct.UrisActions.html#method.submit)"]
            #[derive(Debug, Clone)]
    ...
    pub mod threat_lists {
        pub mod params {
            #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
            pub enum ComputeDiffConstraintsSupportedCompressionsItems {
                #[doc = "Unknown."]
            ...
            impl ComputeDiffConstraintsSupportedCompressionsItems {
                pub fn as_str(self) -> &'static str {
                    match self { ComputeDiffConstraintsSupportedCompressionsItems :: CompressionTypeUnspecified => "COMPRESSION_TYPE_UNSPECIFIED" , ComputeDiffConstraintsSupportedCompressionsItems :: Raw => "RAW" , ComputeDiffConstraintsSupportedCompressionsItems :: Rice => "RICE" , }
                }
            }
            impl ::std::convert::AsRef<str> for ComputeDiffConstraintsSupportedCompressionsItems {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
            impl ::std::str::FromStr for ComputeDiffConstraintsSupportedCompressionsItems {
                type Err = ();
                fn from_str(
                    s: &str,
            ...
            impl ::serde::Serialize for ComputeDiffConstraintsSupportedCompressionsItems {
                fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
                where
                    S: ::serde::ser::Serializer,
                {
            ...
            impl<'de> ::serde::Deserialize<'de> for ComputeDiffConstraintsSupportedCompressionsItems {
                fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
                where
                    D: ::serde::de::Deserializer<'de>,
                {
            ...
            impl ::google_field_selector::ToFieldType for ComputeDiffConstraintsSupportedCompressionsItems {
                fn field_type() -> ::google_field_selector::FieldType {
                    ::google_field_selector::FieldType::Leaf
                }
            }
            #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
            pub enum ComputeDiffThreatType {
                #[doc = "Malware targeting any platform."]
                Malware,
                #[doc = "Social engineering targeting any platform."]
                SocialEngineering,
            ...
            impl ::std::convert::AsRef<str> for ComputeDiffThreatType {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
            impl ::std::str::FromStr for ComputeDiffThreatType {
                type Err = ();
                fn from_str(s: &str) -> ::std::result::Result<ComputeDiffThreatType, ()> {
                    Ok(match s {
            ...
            impl ::std::fmt::Display for ComputeDiffThreatType {
                fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                    f.write_str(self.as_str())
                }
            }
            impl ::serde::Serialize for ComputeDiffThreatType {
                fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
                where
                    S: ::serde::ser::Serializer,
                {
            ...
            impl<'de> ::serde::Deserialize<'de> for ComputeDiffThreatType {
                fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
                where
                    D: ::serde::de::Deserializer<'de>,
                {
            ...
            impl ::google_field_selector::FieldSelector for ComputeDiffThreatType {
                fn fields() -> Vec<::google_field_selector::Field> {
                    Vec::new()
                }
            }
            impl ::google_field_selector::ToFieldType for ComputeDiffThreatType {
                fn field_type() -> ::google_field_selector::FieldType {
                    ::google_field_selector::FieldType::Leaf
                }
            }
        ...
        impl<'a> ThreatListsActions<'a> {
            ...
            #[doc = "Gets the most recent threat list diffs. These diffs should be applied to a local database of hashes to keep it up-to-date. If the local database is empty or excessively out-of-date, a complete snapshot of the database will be returned. This Method only updates a single ThreatList at a time. To update multiple ThreatList databases, this method needs to be called once for each list."]
            pub fn compute_diff(&self) -> ComputeDiffRequestBuilder {
                ComputeDiffRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    access_token: None,
                    alt: None,
                    ...
                    upload_type: None,
                    xgafv: None,
                    constraints_max_database_entries: None,
                    constraints_max_diff_entries: None,
                    constraints_supported_compressions: None,
                    threat_type: None,
                    version_token: None,
                }
            }
        ...
        impl<'a> ComputeDiffRequestBuilder<'a> {
            ...
            pub fn constraints_max_database_entries(mut self, value: i32) -> Self {
                self.constraints_max_database_entries = Some(value);
                self
            }
            ...
            pub fn constraints_max_diff_entries(mut self, value: i32) -> Self {
                self.constraints_max_diff_entries = Some(value);
                self
            }
            #[doc = "The compression types supported by the client."]
            pub fn constraints_supported_compressions(
                mut self,
                value : impl Into < Vec < crate :: resources :: threat_lists :: params :: ComputeDiffConstraintsSupportedCompressionsItems > >,
            ) -> Self {
                self.constraints_supported_compressions = Some(value.into());
                self
            }
            ...
            pub fn threat_type(
                mut self,
                value: crate::resources::threat_lists::params::ComputeDiffThreatType,
            ) -> Self {
                self.threat_type = Some(value);
                self
            }
            ...
            pub fn version_token(mut self, value: impl Into<Vec<u8>>) -> Self {
                let v: Vec<u8> = value.into();
                self.version_token = Some(v.into());
                self
            }
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
            ...
            pub async fn execute_with_default_fields(
                ...
                crate::schemas::GoogleCloudWebriskV1ComputeThreatListDiffResponse,
                crate::Error,
            > {
                self.execute_with_fields(None::<&str>).await
            }
            ...
            fn _path(&self) -> String {
                let mut output = "https://webrisk.googleapis.com/".to_owned();
                output.push_str("v1/threatLists:computeDiff");
                output
            }
            async fn _request(
                &self,
                ...
                req = req.query(&[(
                    ...
                    &self.constraints_max_database_entries,
                )]);
                req = req.query(&[(
                    "constraints.maxDiffEntries",
                    &self.constraints_max_diff_entries,
                )]);
                for value in self.constraints_supported_compressions.iter().flatten() {
                    req = req.query(&[("constraints.supportedCompressions", value)]);
                }
                req = req.query(&[("threatType", &self.threat_type)]);
                req = req.query(&[("versionToken", &self.version_token)]);
                req = req.query(&[("access_token", &self.access_token)]);
                req = req.query(&[("alt", &self.alt)]);
                req = req.query(&[("callback", &self.callback)]);
                req = req.query(&[("fields", &self.fields)]);
    ...
    pub mod uris {
        ...
        impl<'a> UrisActions<'a> {
            ...
            #[doc = "This method is used to check whether a URI is on a given threatList. Multiple threatLists may be searched in a single query. The response will list all requested threatLists the URI was found to match. If the URI is not found on any of the requested ThreatList an empty response will be returned."]
            pub fn search(&self) -> SearchRequestBuilder {
                SearchRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
        ...
        #[doc = "Created via [UrisActions::search()](struct.UrisActions.html#method.search)"]
        #[derive(Debug, Clone)]
        pub struct SearchRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
        ...
        impl<'a> SearchRequestBuilder<'a> {
            ...
            pub fn threat_types(
                mut self,
                value: impl Into<Vec<crate::resources::uris::params::SearchThreatTypesItems>>,
            ) -> Self {
                self.threat_types = Some(value.into());
                self
            }
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::GoogleCloudWebriskV1SearchUrisResponse, crate::Error>
            {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            fn _path(&self) -> String {
                let mut output = "https://webrisk.googleapis.com/".to_owned();
                output.push_str("v1/uris:search");
                output
            }
            async fn _request(
                &self,
