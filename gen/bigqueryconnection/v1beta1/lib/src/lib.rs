...
#![doc = "# Resources and Methods\n* [projects](resources/projects/struct.ProjectsActions.html)\n  * [locations](resources/projects/locations/struct.LocationsActions.html)\n    * [connections](resources/projects/locations/connections/struct.ConnectionsActions.html)\n      * [*create*](resources/projects/locations/connections/struct.CreateRequestBuilder.html), [*delete*](resources/projects/locations/connections/struct.DeleteRequestBuilder.html), [*get*](resources/projects/locations/connections/struct.GetRequestBuilder.html), [*getIamPolicy*](resources/projects/locations/connections/struct.GetIamPolicyRequestBuilder.html), [*list*](resources/projects/locations/connections/struct.ListRequestBuilder.html), [*patch*](resources/projects/locations/connections/struct.PatchRequestBuilder.html), [*setIamPolicy*](resources/projects/locations/connections/struct.SetIamPolicyRequestBuilder.html), [*testIamPermissions*](resources/projects/locations/connections/struct.TestIamPermissionsRequestBuilder.html), [*updateCredential*](resources/projects/locations/connections/struct.UpdateCredentialRequestBuilder.html)\n"]
pub mod scopes {
...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for CloudSqlCredential {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudSqlCredential {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct CloudSqlProperties {
        ...
        pub credential: ::std::option::Option<crate::schemas::CloudSqlCredential>,
        #[doc = "Database name."]
        #[serde(
            rename = "database",
            default,
        ...
        pub r#type: ::std::option::Option<crate::schemas::CloudSqlPropertiesType>,
        #[doc = "Output only. The account ID of the service used for the purpose of this connection. When the connection is used in the context of an operation in BigQuery, this service account will serve as the identity being used for connecting to the CloudSQL instance specified in this connection."]
        #[serde(
            rename = "serviceAccountId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub service_account_id: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for CloudSqlProperties {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudSqlProperties {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum CloudSqlPropertiesType {
    ...
    impl CloudSqlPropertiesType {
        pub fn as_str(self) -> &'static str {
            match self {
                CloudSqlPropertiesType::DatabaseTypeUnspecified => "DATABASE_TYPE_UNSPECIFIED",
                CloudSqlPropertiesType::Mysql => "MYSQL",
                CloudSqlPropertiesType::Postgres => "POSTGRES",
            }
        }
    }
    impl ::std::convert::AsRef<str> for CloudSqlPropertiesType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for CloudSqlPropertiesType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<CloudSqlPropertiesType, ()> {
            Ok(match s {
                "DATABASE_TYPE_UNSPECIFIED" => CloudSqlPropertiesType::DatabaseTypeUnspecified,
                "MYSQL" => CloudSqlPropertiesType::Mysql,
                "POSTGRES" => CloudSqlPropertiesType::Postgres,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for CloudSqlPropertiesType {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for CloudSqlPropertiesType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for CloudSqlPropertiesType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for CloudSqlPropertiesType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudSqlPropertiesType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Connection {
        ...
        pub cloud_sql: ::std::option::Option<crate::schemas::CloudSqlProperties>,
    ...
    pub struct ConnectionCredential {
        ...
        pub cloud_sql: ::std::option::Option<crate::schemas::CloudSqlCredential>,
    }
    impl ::google_field_selector::FieldSelector for ConnectionCredential {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ConnectionCredential {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
        ...
        pub mod locations {
            ...
            pub mod connections {
                ...
                impl<'a> ConnectionsActions<'a> {
                    ...
                    #[doc = "Updates the specified connection. For security reasons, also resets credential if connection properties are in the update field mask."]
                    pub fn patch(
                        &self,
                        request: crate::schemas::Connection,
                    ...
                    pub fn update_credential(
                        &self,
                        request: crate::schemas::ConnectionCredential,
                        name: impl Into<String>,
                    ) -> UpdateCredentialRequestBuilder {
                        UpdateCredentialRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                            request,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    fn _path(&self) -> String {
                        let mut output = "https://bigqueryconnection.googleapis.com/".to_owned();
                ...
                #[doc = "Created via [ConnectionsActions::update_credential()](struct.ConnectionsActions.html#method.update_credential)"]
                #[derive(Debug, Clone)]
                pub struct UpdateCredentialRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    request: crate::schemas::ConnectionCredential,
                    name: String,
                ...
                impl<'a> UpdateCredentialRequestBuilder<'a> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
