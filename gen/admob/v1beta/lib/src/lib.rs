...
pub mod schemas {
    ...
    impl crate::GetNextPageToken for ListAdSourcesResponse {
...
pub mod resources {
    pub mod accounts {
        ...
        pub mod ad_sources {
            ...
            impl<'a> ListRequestBuilder<'a> {
                #[doc = "The maximum number of ad sources to return. If unspecified or 0, at most 1000 ad sources will be returned. The maximum value is 10,000; values above 10,000 will be coerced to 10,000."]
                pub fn page_size(mut self, value: i32) -> Self {
                    self.page_size = Some(value);
                    self
                }
