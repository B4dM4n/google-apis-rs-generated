...
pub mod schemas {
    ...
    impl crate::GetNextPageToken for ListBillingAccountsResponse {
    ...
    impl crate::GetNextPageToken for ListProjectBillingInfoResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken for ListSkusResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
