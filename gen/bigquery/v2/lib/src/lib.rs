...
pub mod scopes {
    ...
    pub const CLOUD_PLATFORM_READ_ONLY: &str =
        "https://www.googleapis.com/auth/cloud-platform.read-only";
    #[doc = "Manage your data and permissions in Cloud Storage and see the email address for your Google Account\n\n`https://www.googleapis.com/auth/devstorage.full_control`"]
    ...
    #[doc = "Manage your data in Cloud Storage and see the email address of your Google Account\n\n`https://www.googleapis.com/auth/devstorage.read_write`"]
...
pub mod schemas {
    ...
    pub enum ArimaForecastingMetricsSeasonalPeriodsItems {
        ...
        Quarterly,
        #[doc = "Unspecified seasonal period."]
    ...
    pub struct ArimaModelInfo {
        ...
        #[doc = "If true, holiday_effect is a part of time series decomposition result."]
        #[serde(
            rename = "hasHolidayEffect",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub has_holiday_effect: ::std::option::Option<bool>,
        #[doc = "If true, spikes_and_dips is a part of time series decomposition result."]
        #[serde(
            rename = "hasSpikesAndDips",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub has_spikes_and_dips: ::std::option::Option<bool>,
        #[doc = "If true, step_changes is a part of time series decomposition result."]
        #[serde(
            rename = "hasStepChanges",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub has_step_changes: ::std::option::Option<bool>,
        #[doc = "Non-seasonal order."]
        #[serde(
            rename = "nonSeasonalOrder",
            default,
        ...
        #[doc = "The tuple of time_series_ids identifying this time series. It will be one of the unique tuples of values present in the time_series_id_columns specified during ARIMA model training. Only present when time_series_id_columns training option was used and the order of values here are same as the order of time_series_id_columns."]
        #[serde(
            rename = "timeSeriesIds",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub time_series_ids: ::std::option::Option<Vec<String>>,
    }
    ...
    impl ::google_field_selector::FieldSelector for AvroOptions {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AvroOptions {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for BiEngineReason {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BiEngineReason {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct BiEngineStatistics {
        ...
        #[serde(
            rename = "accelerationMode",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub acceleration_mode: ::std::option::Option<String>,
        #[doc = "\\[Output-only\\] Specifies which mode of BI Engine acceleration was performed (if any)."]
        #[serde(
            rename = "biEngineMode",
            default,
        ...
        pub bi_engine_mode: ::std::option::Option<String>,
        #[doc = "In case of DISABLED or PARTIAL bi_engine_mode, these contain the explanatory reasons as to why BI Engine could not accelerate. In case the full query was accelerated, this field is not populated."]
        #[serde(
            rename = "biEngineReasons",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub bi_engine_reasons: ::std::option::Option<Vec<crate::schemas::BiEngineReason>>,
    }
    impl ::google_field_selector::FieldSelector for BiEngineStatistics {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BiEngineStatistics {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct CloneDefinition {
        ...
        pub clone_time: ::std::option::Option<::chrono::DateTime<chrono::offset::Utc>>,
    }
    impl ::google_field_selector::FieldSelector for CloneDefinition {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloneDefinition {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct DataSplitResult {
        ...
        #[doc = "Table reference of the test data after split."]
        #[serde(
            rename = "testTable",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub test_table: ::std::option::Option<crate::schemas::TableReference>,
    ...
    pub struct Dataset {
        ...
        #[doc = "\\[Optional\\] Storage billing model to be used for all tables in the dataset. Can be set to PHYSICAL. Default is LOGICAL."]
        #[serde(
            rename = "storageBillingModel",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub storage_billing_model: ::std::option::Option<String>,
        ...
        pub tags: ::std::option::Option<Vec<crate::schemas::DatasetTagsItems>>,
    }
    ...
    pub struct DatasetTagsItems {
        ...
        pub tag_value: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for DatasetTagsItems {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DatasetTagsItems {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum DatasetAccessEntryTargetTypesItems {
        #[doc = "This entry applies to routines in the dataset."]
        Routines,
        #[doc = "Do not use. You must set a target type explicitly."]
        TargetTypeUnspecified,
        #[doc = "This entry applies to views in the dataset."]
        Views,
    }
    impl DatasetAccessEntryTargetTypesItems {
        pub fn as_str(self) -> &'static str {
            match self {
                DatasetAccessEntryTargetTypesItems::Routines => "ROUTINES",
                DatasetAccessEntryTargetTypesItems::TargetTypeUnspecified => {
                    "TARGET_TYPE_UNSPECIFIED"
                }
                DatasetAccessEntryTargetTypesItems::Views => "VIEWS",
            }
        }
    }
    impl ::std::convert::AsRef<str> for DatasetAccessEntryTargetTypesItems {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for DatasetAccessEntryTargetTypesItems {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<DatasetAccessEntryTargetTypesItems, ()> {
            Ok(match s {
                "ROUTINES" => DatasetAccessEntryTargetTypesItems::Routines,
                "TARGET_TYPE_UNSPECIFIED" => {
                    DatasetAccessEntryTargetTypesItems::TargetTypeUnspecified
                }
                "VIEWS" => DatasetAccessEntryTargetTypesItems::Views,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for DatasetAccessEntryTargetTypesItems {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for DatasetAccessEntryTargetTypesItems {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for DatasetAccessEntryTargetTypesItems {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl crate::GetNextPageToken<String> for DatasetList {
    ...
    pub struct DmlStatistics {
        #[doc = "Number of deleted Rows. populated by DML DELETE, MERGE and TRUNCATE statements."]
        #[serde(
            rename = "deletedRowCount",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        #[serde(with = "crate::parsed_string")]
        pub deleted_row_count: ::std::option::Option<i64>,
        #[doc = "Number of inserted Rows. Populated by DML INSERT and MERGE statements."]
        #[serde(
            rename = "insertedRowCount",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        #[serde(with = "crate::parsed_string")]
        pub inserted_row_count: ::std::option::Option<i64>,
        #[doc = "Number of updated Rows. Populated by DML UPDATE and MERGE statements."]
        #[serde(
            rename = "updatedRowCount",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        #[serde(with = "crate::parsed_string")]
        pub updated_row_count: ::std::option::Option<i64>,
    }
    impl ::google_field_selector::FieldSelector for DmlStatistics {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DmlStatistics {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct DoubleCandidates {
        #[doc = "Candidates for the double parameter in increasing order."]
        #[serde(
            rename = "candidates",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub candidates: ::std::option::Option<Vec<f64>>,
    }
    impl ::google_field_selector::FieldSelector for DoubleCandidates {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DoubleCandidates {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct DoubleHparamSearchSpace {
        #[doc = "Candidates of the double hyperparameter."]
        #[serde(
            rename = "candidates",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub candidates: ::std::option::Option<crate::schemas::DoubleCandidates>,
        #[doc = "Range of the double hyperparameter."]
        #[serde(
            rename = "range",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for DoubleHparamSearchSpace {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DoubleHparamSearchSpace {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct DoubleRange {
        #[doc = "Max value of the double parameter."]
        #[serde(
            rename = "max",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Min value of the double parameter."]
        #[serde(
            rename = "min",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct Explanation {
        ...
        #[doc = "The full feature name. For non-numerical features, will be formatted like `.`. Overall size of feature name will always be truncated to first 120 characters."]
        #[serde(
            rename = "featureName",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct ExternalDataConfiguration {
        ...
        #[doc = "Additional properties to set if sourceFormat is set to Avro."]
        #[serde(
            rename = "avroOptions",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "\\[Optional\\] Metadata Cache Mode for the table. Set this to enable caching of metadata from external data source."]
        #[serde(
            rename = "metadataCacheMode",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub metadata_cache_mode: ::std::option::Option<String>,
        #[doc = "ObjectMetadata is used to create Object Tables. Object Tables contain a listing of objects (with their metadata) found at the source_uris. If ObjectMetadata is set, source_format should be omitted. Currently SIMPLE is the only supported Object Metadata type."]
        #[serde(
            rename = "objectMetadata",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub object_metadata: ::std::option::Option<String>,
        ...
        #[doc = "\\[Optional\\] Provide a referencing file with the expected table schema. Enabled for the format: AVRO, PARQUET, ORC."]
        #[serde(
            rename = "referenceFileSchemaUri",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub reference_file_schema_uri: ::std::option::Option<String>,
    ...
    pub struct HparamSearchSpaces {
        #[doc = "Activation functions of neural network models."]
        #[serde(
            rename = "activationFn",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub activation_fn: ::std::option::Option<crate::schemas::StringHparamSearchSpace>,
        #[doc = "Mini batch sample size."]
        #[serde(
            rename = "batchSize",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub batch_size: ::std::option::Option<crate::schemas::IntHparamSearchSpace>,
        #[doc = "Booster type for boosted tree models."]
        #[serde(
            rename = "boosterType",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub booster_type: ::std::option::Option<crate::schemas::StringHparamSearchSpace>,
        #[doc = "Subsample ratio of columns for each level for boosted tree models."]
        #[serde(
            rename = "colsampleBylevel",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub colsample_bylevel: ::std::option::Option<crate::schemas::DoubleHparamSearchSpace>,
        #[doc = "Subsample ratio of columns for each node(split) for boosted tree models."]
        #[serde(
            rename = "colsampleBynode",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub colsample_bynode: ::std::option::Option<crate::schemas::DoubleHparamSearchSpace>,
        #[doc = "Subsample ratio of columns when constructing each tree for boosted tree models."]
        #[serde(
            rename = "colsampleBytree",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub colsample_bytree: ::std::option::Option<crate::schemas::DoubleHparamSearchSpace>,
        #[doc = "Dart normalization type for boosted tree models."]
        #[serde(
            rename = "dartNormalizeType",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub dart_normalize_type: ::std::option::Option<crate::schemas::StringHparamSearchSpace>,
        #[doc = "Dropout probability for dnn model training and boosted tree models using dart booster."]
        #[serde(
            rename = "dropout",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub dropout: ::std::option::Option<crate::schemas::DoubleHparamSearchSpace>,
        #[doc = "Hidden units for neural network models."]
        #[serde(
            rename = "hiddenUnits",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub hidden_units: ::std::option::Option<crate::schemas::IntArrayHparamSearchSpace>,
        ...
        pub l_1_reg: ::std::option::Option<crate::schemas::DoubleHparamSearchSpace>,
        ...
        pub l_2_reg: ::std::option::Option<crate::schemas::DoubleHparamSearchSpace>,
        #[doc = "Learning rate of training jobs."]
        #[serde(
            rename = "learnRate",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub learn_rate: ::std::option::Option<crate::schemas::DoubleHparamSearchSpace>,
        ...
        pub max_tree_depth: ::std::option::Option<crate::schemas::IntHparamSearchSpace>,
        ...
        pub min_split_loss: ::std::option::Option<crate::schemas::DoubleHparamSearchSpace>,
        #[doc = "Minimum sum of instance weight needed in a child for boosted tree models."]
        #[serde(
            rename = "minTreeChildWeight",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub min_tree_child_weight: ::std::option::Option<crate::schemas::IntHparamSearchSpace>,
        #[doc = "Number of clusters for k-means."]
        #[serde(
            rename = "numClusters",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub num_clusters: ::std::option::Option<crate::schemas::IntHparamSearchSpace>,
        #[doc = "Number of latent factors to train on."]
        #[serde(
            rename = "numFactors",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub num_factors: ::std::option::Option<crate::schemas::IntHparamSearchSpace>,
        #[doc = "Number of parallel trees for boosted tree models."]
        #[serde(
            rename = "numParallelTree",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub num_parallel_tree: ::std::option::Option<crate::schemas::IntHparamSearchSpace>,
        #[doc = "Optimizer of TF models."]
        #[serde(
            rename = "optimizer",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub optimizer: ::std::option::Option<crate::schemas::StringHparamSearchSpace>,
        #[doc = "Subsample the training data to grow tree to prevent overfitting for boosted tree models."]
        #[serde(
            rename = "subsample",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub subsample: ::std::option::Option<crate::schemas::DoubleHparamSearchSpace>,
        #[doc = "Tree construction algorithm for boosted tree models."]
        #[serde(
            rename = "treeMethod",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub tree_method: ::std::option::Option<crate::schemas::StringHparamSearchSpace>,
        ...
        pub wals_alpha: ::std::option::Option<crate::schemas::DoubleHparamSearchSpace>,
    }
    impl ::google_field_selector::FieldSelector for HparamSearchSpaces {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for HparamSearchSpaces {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct HparamTuningTrial {
        ...
        #[doc = "Error message for FAILED and INFEASIBLE trial."]
        #[serde(
            rename = "errorMessage",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Loss computed on the eval data at the end of trial."]
        #[serde(
            rename = "evalLoss",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub eval_loss: ::std::option::Option<f64>,
        #[doc = "Evaluation metrics of this trial calculated on the test data. Empty in Job API."]
        #[serde(
        ...
        #[doc = "Hyperparameter tuning evaluation metrics of this trial calculated on the eval data. Unlike evaluation_metrics, only the fields corresponding to the hparam_tuning_objectives are set."]
        #[serde(
        ...
        pub hparam_tuning_evaluation_metrics:
            ::std::option::Option<crate::schemas::EvaluationMetrics>,
        #[doc = "The hyperprameters selected for this trial."]
        #[serde(
            rename = "hparams",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub hparams: ::std::option::Option<crate::schemas::TrainingOptions>,
        #[doc = "Starting time of the trial."]
        #[serde(
            rename = "startTimeMs",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "The status of the trial."]
        #[serde(
            rename = "status",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub status: ::std::option::Option<crate::schemas::HparamTuningTrialStatus>,
        #[doc = "Loss computed on the training data at the end of trial."]
        #[serde(
            rename = "trainingLoss",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub training_loss: ::std::option::Option<f64>,
        #[doc = "1-based index of the trial."]
        #[serde(
            rename = "trialId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[serde(with = "crate::parsed_string")]
        pub trial_id: ::std::option::Option<i64>,
    }
    impl ::google_field_selector::FieldSelector for HparamTuningTrial {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for HparamTuningTrial {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum HparamTuningTrialStatus {
        #[doc = "The trial failed."]
        Failed,
        #[doc = "The trial is infeasible due to the invalid params."]
        Infeasible,
        #[doc = "Scheduled but not started."]
        NotStarted,
        #[doc = "Running state."]
        Running,
    ...
    impl HparamTuningTrialStatus {
        pub fn as_str(self) -> &'static str {
            match self {
                HparamTuningTrialStatus::Failed => "FAILED",
                HparamTuningTrialStatus::Infeasible => "INFEASIBLE",
                HparamTuningTrialStatus::NotStarted => "NOT_STARTED",
                HparamTuningTrialStatus::Running => "RUNNING",
                HparamTuningTrialStatus::StoppedEarly => "STOPPED_EARLY",
                HparamTuningTrialStatus::Succeeded => "SUCCEEDED",
                HparamTuningTrialStatus::TrialStatusUnspecified => "TRIAL_STATUS_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for HparamTuningTrialStatus {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for HparamTuningTrialStatus {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<HparamTuningTrialStatus, ()> {
            Ok(match s {
                "FAILED" => HparamTuningTrialStatus::Failed,
                "INFEASIBLE" => HparamTuningTrialStatus::Infeasible,
                "NOT_STARTED" => HparamTuningTrialStatus::NotStarted,
                "RUNNING" => HparamTuningTrialStatus::Running,
                "STOPPED_EARLY" => HparamTuningTrialStatus::StoppedEarly,
                "SUCCEEDED" => HparamTuningTrialStatus::Succeeded,
                "TRIAL_STATUS_UNSPECIFIED" => HparamTuningTrialStatus::TrialStatusUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for HparamTuningTrialStatus {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for HparamTuningTrialStatus {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for HparamTuningTrialStatus {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for HparamTuningTrialStatus {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for HparamTuningTrialStatus {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct IndexUnusedReason {
        #[doc = "\\[Output-only\\] Specifies the base table involved in the reason that no search index was used."]
        #[serde(
            rename = "base_table",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub base_table: ::std::option::Option<crate::schemas::TableReference>,
        #[doc = "\\[Output-only\\] Specifies the high-level reason for the scenario when no search index was used."]
        #[serde(
            rename = "code",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub code: ::std::option::Option<String>,
        #[doc = "\\[Output-only\\] Specifies the name of the unused search index, if available."]
        #[serde(
            rename = "index_name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub index_name: ::std::option::Option<String>,
        #[doc = "\\[Output-only\\] Free form human-readable reason for the scenario when no search index was used."]
        #[serde(
            rename = "message",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for IndexUnusedReason {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for IndexUnusedReason {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct IntArray {
        #[doc = "Elements in the int array."]
        #[serde(
            rename = "elements",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub elements: ::std::option::Option<Vec<i64>>,
    }
    impl ::google_field_selector::FieldSelector for IntArray {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for IntArray {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct IntArrayHparamSearchSpace {
        #[doc = "Candidates for the int array parameter."]
        #[serde(
            rename = "candidates",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub candidates: ::std::option::Option<Vec<crate::schemas::IntArray>>,
    }
    impl ::google_field_selector::FieldSelector for IntArrayHparamSearchSpace {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for IntArrayHparamSearchSpace {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct IntCandidates {
        #[doc = "Candidates for the int parameter in increasing order."]
        #[serde(
            rename = "candidates",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub candidates: ::std::option::Option<Vec<i64>>,
    }
    impl ::google_field_selector::FieldSelector for IntCandidates {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for IntCandidates {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct IntHparamSearchSpace {
        #[doc = "Candidates of the int hyperparameter."]
        #[serde(
            rename = "candidates",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub candidates: ::std::option::Option<crate::schemas::IntCandidates>,
        #[doc = "Range of the int hyperparameter."]
        #[serde(
            rename = "range",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub range: ::std::option::Option<crate::schemas::IntRange>,
    }
    impl ::google_field_selector::FieldSelector for IntHparamSearchSpace {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for IntHparamSearchSpace {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct IntRange {
        #[doc = "Max value of the int parameter."]
        #[serde(
            rename = "max",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Min value of the int parameter."]
        #[serde(
            rename = "min",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for IntRange {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for IntRange {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct JobConfigurationLoad {
        ...
        #[doc = "If true, creates a new session, where session id will be a server generated random id. If false, runs query with an existing session_id passed in ConnectionProperty, otherwise runs the load job in non-session mode."]
        #[serde(
        ...
        #[doc = "User provided referencing file with the expected reader schema, Available for the format: AVRO, PARQUET, ORC."]
        #[serde(
            rename = "referenceFileSchemaUri",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl crate::GetNextPageToken<String> for JobList {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct JobStatistics {
        ...
        #[serde(with = "crate::parsed_string")]
        pub creation_time: ::std::option::Option<i64>,
        #[doc = "\\[Output-only\\] Statistics for data masking. Present only for query and extract jobs."]
        #[serde(
            rename = "dataMaskingStatistics",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub data_masking_statistics: ::std::option::Option<crate::schemas::DataMaskingStatistics>,
        ...
        pub transaction_info: ::std::option::Option<crate::schemas::TransactionInfo>,
    }
    ...
    pub struct JobStatistics2 {
        ...
        pub schema: ::std::option::Option<crate::schemas::TableSchema>,
        #[doc = "\\[Output only\\] Search query specific statistics."]
        #[serde(
            rename = "searchStatistics",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub search_statistics: ::std::option::Option<crate::schemas::SearchStatistics>,
        #[doc = "\\[Output only\\] Statistics of a Spark procedure job."]
        #[serde(
            rename = "sparkStatistics",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub spark_statistics: ::std::option::Option<crate::schemas::SparkStatistics>,
        ...
        #[serde(with = "crate::parsed_string")]
        pub total_slot_ms: ::std::option::Option<i64>,
        #[doc = "\\[Output-only\\] Total bytes transferred for cross-cloud queries such as Cross Cloud Transfer and CREATE TABLE AS SELECT (CTAS)."]
        #[serde(
            rename = "transferredBytes",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        #[serde(with = "crate::parsed_string")]
    ...
    impl ::google_field_selector::FieldSelector for JobStatistics5 {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for JobStatistics5 {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl crate::GetNextPageToken<String> for ListModelsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct ListRoutinesResponse {
        ...
        pub next_page_token: ::std::option::Option<String>,
        #[doc = "Routines in the requested dataset. Unless read_mask is set in the request, only the following fields are populated: etag, project_id, dataset_id, routine_id, routine_type, creation_time, last_modified_time, language, and remote_function_options."]
        #[serde(
            rename = "routines",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl crate::GetNextPageToken<String> for ListRoutinesResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for ListRowAccessPoliciesResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct MaterializedViewDefinition {
        #[doc = "\\[Optional\\] Allow non incremental materialized view definition. The default value is “false”."]
        #[serde(
            rename = "allow_non_incremental_definition",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        ...
        #[doc = "\\[Optional\\] Max staleness of data that could be returned when materizlized view is queried (formatted as Google SQL Interval type)."]
        #[serde(
            rename = "maxStaleness",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub max_staleness: ::std::option::Option<::google_api_bytes::Bytes>,
    ...
    pub struct MlStatistics {
        #[doc = "Results for all completed iterations."]
        #[serde(
            rename = "iterationResults",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for MlStatistics {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MlStatistics {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Model {
        ...
        #[serde(with = "crate::parsed_string")]
        pub creation_time: ::std::option::Option<i64>,
        #[doc = "Output only. The default trial_id to use in TVFs when the trial_id is not passed in. For single-objective [hyperparameter tuning](/bigquery-ml/docs/reference/standard-sql/bigqueryml-syntax-hp-tuning-overview) models, this is the best trial ID. For multi-objective [hyperparameter tuning](/bigquery-ml/docs/reference/standard-sql/bigqueryml-syntax-hp-tuning-overview) models, this is the smallest trial ID among all Pareto optimal trials."]
        #[serde(
            rename = "defaultTrialId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        #[serde(with = "crate::parsed_string")]
        pub default_trial_id: ::std::option::Option<i64>,
        ...
        pub friendly_name: ::std::option::Option<String>,
        #[doc = "Output only. All hyperparameter search spaces in this model."]
        #[serde(
            rename = "hparamSearchSpaces",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub hparam_search_spaces: ::std::option::Option<crate::schemas::HparamSearchSpaces>,
        #[doc = "Output only. Trials of a [hyperparameter tuning](/bigquery-ml/docs/reference/standard-sql/bigqueryml-syntax-hp-tuning-overview) model sorted by trial_id."]
        #[serde(
            rename = "hparamTrials",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. For single-objective [hyperparameter tuning](/bigquery-ml/docs/reference/standard-sql/bigqueryml-syntax-hp-tuning-overview) models, it only contains the best trial. For multi-objective [hyperparameter tuning](/bigquery-ml/docs/reference/standard-sql/bigqueryml-syntax-hp-tuning-overview) models, it contains all Pareto optimal trials sorted by trial_id."]
        #[serde(
            rename = "optimalTrialIds",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub optimal_trial_ids: ::std::option::Option<Vec<i64>>,
        #[doc = "Information for all training runs in increasing order of start_time."]
        #[serde(
            rename = "trainingRuns",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub enum ModelModelType {
        #[doc = "ARIMA model."]
        Arima,
        #[doc = "New name for the ARIMA model."]
        ArimaPlus,
        #[doc = "Autoencoder model."]
        Autoencoder,
        ...
        DnnClassifier,
        #[doc = "Wide-and-deep classifier model."]
        DnnLinearCombinedClassifier,
        #[doc = "Wide-and-deep regressor model."]
        ...
        #[doc = "Prinpical Component Analysis model."]
        Pca,
        #[doc = "Random Forest classifier model."]
        RandomForestClassifier,
        #[doc = "Random Forest regressor model."]
    ...
    impl ModelModelType {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                ModelModelType::ArimaPlus => "ARIMA_PLUS",
                ModelModelType::Autoencoder => "AUTOENCODER",
                ...
                ModelModelType::DnnLinearCombinedClassifier => "DNN_LINEAR_COMBINED_CLASSIFIER",
                ModelModelType::DnnLinearCombinedRegressor => "DNN_LINEAR_COMBINED_REGRESSOR",
                ...
                ModelModelType::Pca => "PCA",
                ModelModelType::RandomForestClassifier => "RANDOM_FOREST_CLASSIFIER",
                ModelModelType::RandomForestRegressor => "RANDOM_FOREST_REGRESSOR",
    ...
    impl ::std::str::FromStr for ModelModelType {
        ...
        fn from_str(s: &str) -> ::std::result::Result<ModelModelType, ()> {
            Ok(match s {
                ...
                "ARIMA_PLUS" => ModelModelType::ArimaPlus,
                "AUTOENCODER" => ModelModelType::Autoencoder,
                ...
                "DNN_LINEAR_COMBINED_CLASSIFIER" => ModelModelType::DnnLinearCombinedClassifier,
                "DNN_LINEAR_COMBINED_REGRESSOR" => ModelModelType::DnnLinearCombinedRegressor,
                ...
                "PCA" => ModelModelType::Pca,
                "RANDOM_FOREST_CLASSIFIER" => ModelModelType::RandomForestClassifier,
                "RANDOM_FOREST_REGRESSOR" => ModelModelType::RandomForestRegressor,
    ...
    impl crate::GetNextPageToken<String> for ProjectList {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct QueryTimelineSample {
        ...
        #[doc = "Units of work that can be scheduled immediately. Providing additional slots for these units of work will speed up the query, provided no other query in the reservation needs additional slots."]
        #[serde(
        ...
        #[serde(with = "crate::parsed_string")]
        pub estimated_runnable_units: ::std::option::Option<i64>,
        #[doc = "Total units of work remaining for the query. This number can be revised (increased or decreased) while the query is running."]
        #[serde(
            rename = "pendingUnits",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct RemoteFunctionOptions {
        #[doc = "Fully qualified name of the user-provided connection object which holds the authentication information to send requests to the remote service. Format: `\"projects/{projectId}/locations/{locationId}/connections/{connectionId}\"`"]
        #[serde(
            rename = "connection",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub connection: ::std::option::Option<String>,
        #[doc = "Endpoint of the user-provided remote service, e.g. `https://us-east1-my_gcf_project.cloudfunctions.net/remote_add`"]
        #[serde(
            rename = "endpoint",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Max number of rows in each batch sent to the remote service. If absent or if 0, BigQuery dynamically decides the number of rows in a batch."]
        #[serde(
            rename = "maxBatchingRows",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        #[serde(with = "crate::parsed_string")]
        pub max_batching_rows: ::std::option::Option<i64>,
        #[doc = "User-defined context as a set of key/value pairs, which will be sent as function invocation context together with batched arguments in the requests to the remote service. The total number of bytes of keys and values must be less than 8KB."]
        #[serde(
            rename = "userDefinedContext",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
    ...
    impl ::google_field_selector::FieldSelector for RemoteFunctionOptions {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for RemoteFunctionOptions {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Routine {
        ...
        #[doc = "Optional. The description of the routine, if defined."]
        #[serde(
            rename = "description",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub description: ::std::option::Option<String>,
        #[doc = "Optional. The determinism level of the JavaScript UDF, if defined."]
        #[serde(
        ...
        #[doc = "Optional. Defaults to “SQL” if remote_function_options field is absent, not set otherwise."]
        #[serde(
            rename = "language",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[serde(with = "crate::parsed_string")]
        pub last_modified_time: ::std::option::Option<i64>,
        #[doc = "Optional. Remote function specific options."]
        #[serde(
            rename = "remoteFunctionOptions",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub remote_function_options: ::std::option::Option<crate::schemas::RemoteFunctionOptions>,
        ...
        #[doc = "Optional. Spark specific options."]
        #[serde(
            rename = "sparkOptions",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub spark_options: ::std::option::Option<crate::schemas::SparkOptions>,
        #[doc = "Optional. Can be set for procedures only. If true (default), the definition body will be validated in the creation and the updates of the procedure. For procedures with an argument of ANY TYPE, the definition body validtion is not supported at creation/update time, and thus this field must be set to false explicitly."]
        #[serde(
            rename = "strictMode",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct SearchStatistics {
        #[doc = "When index_usage_mode is UNUSED or PARTIALLY_USED, this field explains why index was not used in all or part of the search query. If index_usage_mode is FULLLY_USED, this field is not populated."]
        #[serde(
            rename = "indexUnusedReason",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub index_unused_reason: ::std::option::Option<Vec<crate::schemas::IndexUnusedReason>>,
        #[doc = "Specifies index usage mode for the query."]
        #[serde(
            rename = "indexUsageMode",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub index_usage_mode: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for SearchStatistics {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SearchStatistics {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for SessionInfo {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SessionInfo {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SparkLoggingInfo {
        #[doc = "\\[Output-only\\] Project ID used for logging"]
        #[serde(
            rename = "project_id",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub project_id: ::std::option::Option<String>,
        #[doc = "\\[Output-only\\] Resource type used for logging"]
        #[serde(
    ...
    impl ::google_field_selector::FieldSelector for SparkLoggingInfo {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SparkLoggingInfo {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SparkOptions {
        #[doc = "Archive files to be extracted into the working directory of each executor. For more information about Apache Spark, see [Apache Spark](https://spark.apache.org/docs/latest/index.html)."]
        #[serde(
            rename = "archiveUris",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Fully qualified name of the user-provided Spark connection object. Format: `\"projects/{project_id}/locations/{location_id}/connections/{connection_id}\"`"]
        #[serde(
            rename = "connection",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub connection: ::std::option::Option<String>,
        #[doc = "Custom container image for the runtime environment."]
        #[serde(
        ...
        #[doc = "Files to be placed in the working directory of each executor. For more information about Apache Spark, see [Apache Spark](https://spark.apache.org/docs/latest/index.html)."]
        #[serde(
            rename = "fileUris",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "JARs to include on the driver and executor CLASSPATH. For more information about Apache Spark, see [Apache Spark](https://spark.apache.org/docs/latest/index.html)."]
        #[serde(
            rename = "jarUris",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub jar_uris: ::std::option::Option<Vec<String>>,
        #[doc = "The main file/jar URI of the Spark application. Exactly one of the definition_body field and the main_file_uri field must be set for Python. Exactly one of main_class and main_file_uri field should be set for Java/Scala language type."]
        #[serde(
            rename = "mainFileUri",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub main_file_uri: ::std::option::Option<String>,
        #[doc = "Configuration properties as a set of key/value pairs, which will be passed on to the Spark application. For more information, see [Apache Spark](https://spark.apache.org/docs/latest/index.html)."]
        #[serde(
            rename = "properties",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Python files to be placed on the PYTHONPATH for PySpark application. Supported file types: `.py`, `.egg`, and `.zip`. For more information about Apache Spark, see [Apache Spark](https://spark.apache.org/docs/latest/index.html)."]
        #[serde(
            rename = "pyFileUris",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub py_file_uris: ::std::option::Option<Vec<String>>,
        #[doc = "Runtime version. If not specified, the default runtime version is used."]
        #[serde(
    ...
    impl ::google_field_selector::FieldSelector for SparkOptions {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SparkOptions {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SparkStatistics {
        #[doc = "\\[Output-only\\] Endpoints generated for the Spark job."]
        #[serde(
            rename = "endpoints",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "\\[Output-only\\] Logging info is used to generate a link to Cloud Logging."]
        #[serde(
            rename = "logging_info",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub logging_info: ::std::option::Option<crate::schemas::SparkLoggingInfo>,
        #[doc = "\\[Output-only\\] Spark job id if a Spark job is created successfully."]
        #[serde(
            rename = "spark_job_id",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub spark_job_id: ::std::option::Option<String>,
        #[doc = "\\[Output-only\\] Location where the Spark job is executed."]
        #[serde(
            rename = "spark_job_location",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub spark_job_location: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for SparkStatistics {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SparkStatistics {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub enum StandardSqlDataTypeTypeKind {
        ...
        Int64,
        #[doc = "Encoded as fully qualified 3 part: 0-5 15 2:30:45.6"]
        Interval,
        #[doc = "Encoded as a string."]
        Json,
        #[doc = "Encoded as a decimal string."]
        Numeric,
    ...
    impl StandardSqlDataTypeTypeKind {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                StandardSqlDataTypeTypeKind::Interval => "INTERVAL",
                StandardSqlDataTypeTypeKind::Json => "JSON",
    ...
    impl ::std::str::FromStr for StandardSqlDataTypeTypeKind {
        ...
        fn from_str(s: &str) -> ::std::result::Result<StandardSqlDataTypeTypeKind, ()> {
            Ok(match s {
                ...
                "INTERVAL" => StandardSqlDataTypeTypeKind::Interval,
                "JSON" => StandardSqlDataTypeTypeKind::Json,
    ...
    pub struct StringHparamSearchSpace {
        #[doc = "Canididates for the string or enum parameter in lower case."]
        #[serde(
            rename = "candidates",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub candidates: ::std::option::Option<Vec<String>>,
    }
    impl ::google_field_selector::FieldSelector for StringHparamSearchSpace {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for StringHparamSearchSpace {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Table {
        ...
        #[doc = "\\[Optional\\] Max staleness of data that could be returned when table or materialized view is queried (formatted as Google SQL Interval type)."]
        #[serde(
            rename = "maxStaleness",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct TableFieldSchema {
        ...
        #[doc = "Optional. Collation specification of the field. It only can be set on string type field."]
        #[serde(
            rename = "collation",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl crate::GetNextPageToken<String> for TableList {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct TrainingOptions {
        #[doc = "If true, detect step changes and make data adjustment in the input time series."]
        #[serde(
            rename = "adjustStepChanges",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub adjust_step_changes: ::std::option::Option<bool>,
        ...
        pub booster_type: ::std::option::Option<crate::schemas::TrainingOptionsBoosterType>,
        #[doc = "Whether or not p-value test should be computed for this model. Only available for linear and logistic regression models."]
        #[serde(
            rename = "calculatePValues",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub calculate_p_values: ::std::option::Option<bool>,
        #[doc = "If true, clean spikes and dips in the input time series."]
        #[serde(
            rename = "cleanSpikesAndDips",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub clean_spikes_and_dips: ::std::option::Option<bool>,
        #[doc = "Enums for color space, used for processing images in Object Table. See more details at https://www.tensorflow.org/io/tutorials/colorspace."]
        #[serde(
            rename = "colorSpace",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub color_space: ::std::option::Option<crate::schemas::TrainingOptionsColorSpace>,
        #[doc = "Subsample ratio of columns for each level for boosted tree models."]
        #[serde(
            rename = "colsampleBylevel",
            default,
        ...
        pub colsample_bylevel: ::std::option::Option<f64>,
        #[doc = "Subsample ratio of columns for each node(split) for boosted tree models."]
        #[serde(
            rename = "colsampleBynode",
            default,
        ...
        pub colsample_bynode: ::std::option::Option<f64>,
        #[doc = "Subsample ratio of columns when constructing each tree for boosted tree models."]
        #[serde(
            rename = "colsampleBytree",
            default,
        ...
        pub colsample_bytree: ::std::option::Option<f64>,
        #[doc = "Type of normalization algorithm for boosted tree models using dart booster."]
        #[serde(
            rename = "dartNormalizeType",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub dart_normalize_type:
            ::std::option::Option<crate::schemas::TrainingOptionsDartNormalizeType>,
        ...
        #[doc = "If true, perform decompose time series and save the results."]
        #[serde(
            rename = "decomposeTimeSeries",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub decompose_time_series: ::std::option::Option<bool>,
        ...
        pub early_stop: ::std::option::Option<bool>,
        #[doc = "If true, enable global explanation during training."]
        #[serde(
            rename = "enableGlobalExplain",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub enable_global_explain: ::std::option::Option<bool>,
        ...
        #[doc = "The target evaluation metrics to optimize the hyperparameters for."]
        #[serde(
        ...
        pub hparam_tuning_objectives:
            ::std::option::Option<Vec<crate::schemas::TrainingOptionsHparamTuningObjectivesItems>>,
        ...
        #[doc = "Number of integral steps for the integrated gradients explain method."]
        #[serde(
        ...
        #[serde(with = "crate::parsed_string")]
        pub integrated_gradients_num_steps: ::std::option::Option<i64>,
        ...
        #[serde(with = "crate::parsed_string")]
        pub max_iterations: ::std::option::Option<i64>,
        #[doc = "Maximum number of trials to run in parallel."]
        #[serde(
        ...
        #[serde(with = "crate::parsed_string")]
        pub max_parallel_trials: ::std::option::Option<i64>,
        #[doc = "Get truncated length by last n points in time series. Use separately from time_series_length_fraction and min_time_series_length."]
        #[serde(
        ...
        #[serde(with = "crate::parsed_string")]
        pub max_time_series_length: ::std::option::Option<i64>,
        #[doc = "Maximum depth of a tree for boosted tree models."]
        #[serde(
            rename = "maxTreeDepth",
            default,
        ...
        #[doc = "Set fast trend ARIMA_PLUS model minimum training length. Use in pair with time_series_length_fraction."]
        #[serde(
        ...
        #[serde(with = "crate::parsed_string")]
        pub min_time_series_length: ::std::option::Option<i64>,
        #[doc = "Minimum sum of instance weight needed in a child for boosted tree models."]
        #[serde(
            rename = "minTreeChildWeight",
            default,
        ...
        #[serde(with = "crate::parsed_string")]
        pub min_tree_child_weight: ::std::option::Option<i64>,
        ...
        #[doc = "Number of parallel trees constructed during each iteration for boosted tree models."]
        #[serde(
            rename = "numParallelTree",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[serde(with = "crate::parsed_string")]
        pub num_parallel_tree: ::std::option::Option<i64>,
        #[doc = "Number of trials to run this hyperparameter tuning job."]
        #[serde(
            rename = "numTrials",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[serde(with = "crate::parsed_string")]
        pub num_trials: ::std::option::Option<i64>,
        ...
        #[doc = "Number of paths for the sampled Shapley explain method."]
        #[serde(
        ...
        #[serde(with = "crate::parsed_string")]
        pub sampled_shapley_num_paths: ::std::option::Option<i64>,
        ...
        #[doc = "The time series id columns that were used during ARIMA model training."]
        #[serde(
            rename = "timeSeriesIdColumns",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub time_series_id_columns: ::std::option::Option<Vec<String>>,
        #[doc = "Get truncated length by fraction in time series."]
        #[serde(
            rename = "timeSeriesLengthFraction",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub time_series_length_fraction: ::std::option::Option<f64>,
        ...
        pub tree_method: ::std::option::Option<crate::schemas::TrainingOptionsTreeMethod>,
        #[doc = "The smoothing window size for the trend component of the time series."]
        #[serde(
        ...
        #[serde(with = "crate::parsed_string")]
        pub trend_smoothing_window_size: ::std::option::Option<i64>,
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum TrainingOptionsBoosterType {
        #[doc = "Unspecified booster type."]
    ...
    impl TrainingOptionsBoosterType {
        pub fn as_str(self) -> &'static str {
            match self {
                TrainingOptionsBoosterType::BoosterTypeUnspecified => "BOOSTER_TYPE_UNSPECIFIED",
                TrainingOptionsBoosterType::Dart => "DART",
                TrainingOptionsBoosterType::Gbtree => "GBTREE",
            }
        }
    }
    impl ::std::convert::AsRef<str> for TrainingOptionsBoosterType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for TrainingOptionsBoosterType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<TrainingOptionsBoosterType, ()> {
            Ok(match s {
                "BOOSTER_TYPE_UNSPECIFIED" => TrainingOptionsBoosterType::BoosterTypeUnspecified,
                "DART" => TrainingOptionsBoosterType::Dart,
                "GBTREE" => TrainingOptionsBoosterType::Gbtree,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for TrainingOptionsBoosterType {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for TrainingOptionsBoosterType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for TrainingOptionsBoosterType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for TrainingOptionsBoosterType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for TrainingOptionsBoosterType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum TrainingOptionsColorSpace {
        #[doc = "Unspecified color space"]
    ...
    impl TrainingOptionsColorSpace {
        pub fn as_str(self) -> &'static str {
            match self {
                TrainingOptionsColorSpace::ColorSpaceUnspecified => "COLOR_SPACE_UNSPECIFIED",
                TrainingOptionsColorSpace::Grayscale => "GRAYSCALE",
                TrainingOptionsColorSpace::Hsv => "HSV",
                TrainingOptionsColorSpace::Rgb => "RGB",
                TrainingOptionsColorSpace::Yiq => "YIQ",
                TrainingOptionsColorSpace::Yuv => "YUV",
            }
        }
    }
    impl ::std::convert::AsRef<str> for TrainingOptionsColorSpace {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for TrainingOptionsColorSpace {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<TrainingOptionsColorSpace, ()> {
            Ok(match s {
                "COLOR_SPACE_UNSPECIFIED" => TrainingOptionsColorSpace::ColorSpaceUnspecified,
                "GRAYSCALE" => TrainingOptionsColorSpace::Grayscale,
                "HSV" => TrainingOptionsColorSpace::Hsv,
                "RGB" => TrainingOptionsColorSpace::Rgb,
                "YIQ" => TrainingOptionsColorSpace::Yiq,
                "YUV" => TrainingOptionsColorSpace::Yuv,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for TrainingOptionsColorSpace {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for TrainingOptionsColorSpace {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for TrainingOptionsColorSpace {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for TrainingOptionsColorSpace {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for TrainingOptionsColorSpace {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum TrainingOptionsDartNormalizeType {
        #[doc = "Unspecified dart normalize type."]
        DartNormalizeTypeUnspecified,
        #[doc = "New trees have the same weight of sum of dropped trees."]
        Forest,
        #[doc = "New trees have the same weight of each of dropped trees."]
        Tree,
    }
    impl TrainingOptionsDartNormalizeType {
        pub fn as_str(self) -> &'static str {
            match self {
                TrainingOptionsDartNormalizeType::DartNormalizeTypeUnspecified => {
                    "DART_NORMALIZE_TYPE_UNSPECIFIED"
                }
                TrainingOptionsDartNormalizeType::Forest => "FOREST",
                TrainingOptionsDartNormalizeType::Tree => "TREE",
            }
        }
    }
    impl ::std::convert::AsRef<str> for TrainingOptionsDartNormalizeType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for TrainingOptionsDartNormalizeType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<TrainingOptionsDartNormalizeType, ()> {
            Ok(match s {
                "DART_NORMALIZE_TYPE_UNSPECIFIED" => {
                    TrainingOptionsDartNormalizeType::DartNormalizeTypeUnspecified
                }
                "FOREST" => TrainingOptionsDartNormalizeType::Forest,
                "TREE" => TrainingOptionsDartNormalizeType::Tree,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for TrainingOptionsDartNormalizeType {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for TrainingOptionsDartNormalizeType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for TrainingOptionsDartNormalizeType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for TrainingOptionsDartNormalizeType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for TrainingOptionsDartNormalizeType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum TrainingOptionsHparamTuningObjectivesItems {
        #[doc = "Accuracy is the fraction of predictions given the correct label. For multiclass this is a globally micro-averaged metric."]
        Accuracy,
        #[doc = "Average Rank."]
        AverageRank,
        #[doc = "Davies-Bouldin Index."]
        DaviesBouldinIndex,
        #[doc = "Explained variance. explained_variance = 1 - VAR_POP(label_error)/VAR_POP(label)"]
        ExplainedVariance,
        #[doc = "The F1 score is an average of recall and precision. For multiclass this is a macro-averaged metric."]
        F1Score,
        #[doc = "Unspecified evaluation metric."]
        HparamTuningObjectiveUnspecified,
        #[doc = "Logorithmic Loss. For multiclass this is a macro-averaged metric."]
        LogLoss,
        #[doc = "Mean absolute error. mean_absolute_error = AVG(ABS(label - predicted))"]
        MeanAbsoluteError,
        #[doc = "Mean Average Precision."]
        MeanAveragePrecision,
        #[doc = "Mean squared error. mean_squared_error = AVG(POW(label - predicted, 2))"]
        MeanSquaredError,
        ...
        #[doc = "Recall is the fraction of actual positive labels that were given a positive prediction. For multiclass this is a macro-averaged metric."]
        Recall,
        #[doc = "Area Under an ROC Curve. For multiclass this is a macro-averaged metric."]
        RocAuc,
    }
    impl TrainingOptionsHparamTuningObjectivesItems {
        pub fn as_str(self) -> &'static str {
            match self {
                TrainingOptionsHparamTuningObjectivesItems::Accuracy => "ACCURACY",
                TrainingOptionsHparamTuningObjectivesItems::AverageRank => "AVERAGE_RANK",
                TrainingOptionsHparamTuningObjectivesItems::DaviesBouldinIndex => {
                    "DAVIES_BOULDIN_INDEX"
                }
                TrainingOptionsHparamTuningObjectivesItems::ExplainedVariance => {
                    "EXPLAINED_VARIANCE"
                }
                TrainingOptionsHparamTuningObjectivesItems::F1Score => "F1_SCORE",
                TrainingOptionsHparamTuningObjectivesItems::HparamTuningObjectiveUnspecified => {
                    "HPARAM_TUNING_OBJECTIVE_UNSPECIFIED"
                }
                TrainingOptionsHparamTuningObjectivesItems::LogLoss => "LOG_LOSS",
                TrainingOptionsHparamTuningObjectivesItems::MeanAbsoluteError => {
                    "MEAN_ABSOLUTE_ERROR"
                }
                TrainingOptionsHparamTuningObjectivesItems::MeanAveragePrecision => {
                    "MEAN_AVERAGE_PRECISION"
                }
                TrainingOptionsHparamTuningObjectivesItems::MeanSquaredError => {
                    "MEAN_SQUARED_ERROR"
                }
                TrainingOptionsHparamTuningObjectivesItems::MeanSquaredLogError => {
                    "MEAN_SQUARED_LOG_ERROR"
                }
                TrainingOptionsHparamTuningObjectivesItems::MedianAbsoluteError => {
                    "MEDIAN_ABSOLUTE_ERROR"
                }
                TrainingOptionsHparamTuningObjectivesItems::NormalizedDiscountedCumulativeGain => {
                    "NORMALIZED_DISCOUNTED_CUMULATIVE_GAIN"
                }
                TrainingOptionsHparamTuningObjectivesItems::Precision => "PRECISION",
                TrainingOptionsHparamTuningObjectivesItems::RSquared => "R_SQUARED",
                TrainingOptionsHparamTuningObjectivesItems::Recall => "RECALL",
                TrainingOptionsHparamTuningObjectivesItems::RocAuc => "ROC_AUC",
            }
        }
    }
    impl ::std::convert::AsRef<str> for TrainingOptionsHparamTuningObjectivesItems {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for TrainingOptionsHparamTuningObjectivesItems {
        type Err = ();
        fn from_str(
            s: &str,
        ) -> ::std::result::Result<TrainingOptionsHparamTuningObjectivesItems, ()> {
            Ok(match s {
                "ACCURACY" => TrainingOptionsHparamTuningObjectivesItems::Accuracy,
                "AVERAGE_RANK" => TrainingOptionsHparamTuningObjectivesItems::AverageRank,
                "DAVIES_BOULDIN_INDEX" => {
                    TrainingOptionsHparamTuningObjectivesItems::DaviesBouldinIndex
                }
                "EXPLAINED_VARIANCE" => {
                ...
                "F1_SCORE" => TrainingOptionsHparamTuningObjectivesItems::F1Score,
                "HPARAM_TUNING_OBJECTIVE_UNSPECIFIED" => {
                    TrainingOptionsHparamTuningObjectivesItems::HparamTuningObjectiveUnspecified
                }
                "LOG_LOSS" => TrainingOptionsHparamTuningObjectivesItems::LogLoss,
                "MEAN_ABSOLUTE_ERROR" => {
                    TrainingOptionsHparamTuningObjectivesItems::MeanAbsoluteError
                }
                "MEAN_AVERAGE_PRECISION" => {
                ...
                "PRECISION" => TrainingOptionsHparamTuningObjectivesItems::Precision,
                "R_SQUARED" => TrainingOptionsHparamTuningObjectivesItems::RSquared,
                "RECALL" => TrainingOptionsHparamTuningObjectivesItems::Recall,
                "ROC_AUC" => TrainingOptionsHparamTuningObjectivesItems::RocAuc,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for TrainingOptionsHparamTuningObjectivesItems {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for TrainingOptionsHparamTuningObjectivesItems {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for TrainingOptionsHparamTuningObjectivesItems {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for TrainingOptionsHparamTuningObjectivesItems {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for TrainingOptionsHparamTuningObjectivesItems {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum TrainingOptionsTreeMethod {
        #[doc = "Approximate greedy algorithm using quantile sketch and gradient histogram."]
        Approx,
        #[doc = "Use heuristic to choose the fastest method."]
        Auto,
        #[doc = "Exact greedy algorithm."]
        Exact,
        #[doc = "Fast histogram optimized approximate greedy algorithm."]
        Hist,
        #[doc = "Unspecified tree method."]
        TreeMethodUnspecified,
    }
    impl TrainingOptionsTreeMethod {
        pub fn as_str(self) -> &'static str {
            match self {
                TrainingOptionsTreeMethod::Approx => "APPROX",
                TrainingOptionsTreeMethod::Auto => "AUTO",
                TrainingOptionsTreeMethod::Exact => "EXACT",
                TrainingOptionsTreeMethod::Hist => "HIST",
                TrainingOptionsTreeMethod::TreeMethodUnspecified => "TREE_METHOD_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for TrainingOptionsTreeMethod {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for TrainingOptionsTreeMethod {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<TrainingOptionsTreeMethod, ()> {
            Ok(match s {
                "APPROX" => TrainingOptionsTreeMethod::Approx,
                "AUTO" => TrainingOptionsTreeMethod::Auto,
                "EXACT" => TrainingOptionsTreeMethod::Exact,
                "HIST" => TrainingOptionsTreeMethod::Hist,
                "TREE_METHOD_UNSPECIFIED" => TrainingOptionsTreeMethod::TreeMethodUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for TrainingOptionsTreeMethod {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for TrainingOptionsTreeMethod {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for TrainingOptionsTreeMethod {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for TrainingOptionsTreeMethod {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for TrainingOptionsTreeMethod {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct TrainingRun {
        #[doc = "Output only. Global explanation contains the explanation of top features on the class level. Applies to classification models only."]
        #[serde(
        ...
        pub class_level_global_explanations:
            ::std::option::Option<Vec<crate::schemas::GlobalExplanation>>,
        #[doc = "Output only. Data split result of the training run. Only set when the input data is actually split."]
        #[serde(
        ...
        #[doc = "Output only. The evaluation metrics over training/eval data that were computed at the end of training."]
        #[serde(
            rename = "evaluationMetrics",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub evaluation_metrics: ::std::option::Option<crate::schemas::EvaluationMetrics>,
        #[doc = "Output only. Global explanation contains the explanation of top features on the model level. Applies to both regression and classification models."]
        #[serde(
        ...
        #[doc = "Output only. Output of each iteration run, results.size() \\<= max_iterations."]
        #[serde(
            rename = "results",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. The start time of this training run."]
        #[serde(
            rename = "startTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. Options that were used for this training run, includes user specified and default options that were used."]
        #[serde(
            rename = "trainingOptions",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. The start time of this training run, in milliseconds since epoch."]
        #[serde(
        ...
        #[serde(with = "crate::parsed_string")]
        pub training_start_time: ::std::option::Option<i64>,
        #[doc = "The model id in the [Vertex AI Model Registry](https://cloud.google.com/vertex-ai/docs/model-registry/introduction) for this training run."]
        #[serde(
            rename = "vertexAiModelId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub vertex_ai_model_id: ::std::option::Option<String>,
        #[doc = "Output only. The model version in the [Vertex AI Model Registry](https://cloud.google.com/vertex-ai/docs/model-registry/introduction) for this training run."]
        #[serde(
            rename = "vertexAiModelVersion",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub vertex_ai_model_version: ::std::option::Option<String>,
    }
...
pub mod resources {
    pub mod datasets {
        ...
        pub struct DeleteRequestBuilder<'a> {
            ...
            project_id: String,
            dataset_id: String,
            delete_contents: ::std::option::Option<bool>,
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            #[doc = "\nExecute the request and yield each item in the `datasets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
            pub fn stream_datasets<T>(
                self,
                ...
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
            {
                ...
                self.stream_datasets_with_fields(fields)
            }
            #[doc = "\nExecute the request and yield each item in the `datasets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
            pub fn stream_datasets_with_default_fields(
                self,
            ) -> impl ::futures::Stream<
                Item = Result<crate::schemas::DatasetListDatasetsItems, crate::Error>,
            > + 'a {
                self.stream_datasets_with_fields(None::<String>)
            }
            #[doc = "\nExecute the request and yield each item in the `datasets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            pub fn stream_datasets_with_all_fields(
                self,
            ) -> impl ::futures::Stream<
                Item = Result<crate::schemas::DatasetListDatasetsItems, crate::Error>,
            > + 'a {
                self.stream_datasets_with_fields(Some("*"))
            }
            #[doc = "\nExecute the request and yield each item in the `datasets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
            pub fn stream_datasets_with_fields<T, F>(
                mut self,
                fields: ::std::option::Option<F>,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
            ...
            pub fn stream_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::DatasetList, crate::Error>> + 'a
            {
    ...
    pub mod jobs {
        ...
        impl<'a> DeleteRequestBuilder<'a> {
            #[doc = "The geographic location of the job. Required. See details at: https://cloud.google.com/bigquery/docs/locations#specifying_your_location."]
            pub fn location(mut self, value: impl Into<String>) -> Self {
                self.location = Some(value.into());
                self
            }
        ...
        pub struct GetQueryResultsRequestBuilder<'a> {
            ...
            max_results: ::std::option::Option<u32>,
            page_token: ::std::option::Option<String>,
            start_index: ::std::option::Option<u64>,
        ...
        pub struct ListRequestBuilder<'a> {
            ...
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            project_id: String,
            all_users: ::std::option::Option<bool>,
            max_creation_time: ::std::option::Option<u64>,
            max_results: ::std::option::Option<u32>,
            min_creation_time: ::std::option::Option<u64>,
            page_token: ::std::option::Option<String>,
            parent_job_id: ::std::option::Option<String>,
            projection: ::std::option::Option<crate::resources::jobs::params::ListProjection>,
            state_filter:
                ::std::option::Option<Vec<crate::resources::jobs::params::ListStateFilterItems>>,
            alt: ::std::option::Option<crate::params::Alt>,
            fields: ::std::option::Option<String>,
            key: ::std::option::Option<String>,
            oauth_token: ::std::option::Option<String>,
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn stream_jobs_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::JobListJobsItems, crate::Error>> + 'a
            {
            ...
            pub fn stream_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::JobList, crate::Error>> + 'a
            {
                self.stream_with_fields(None::<&str>)
            }
            #[doc = r" Execute the request and yield the returned value. If the response contains a"]
    ...
    pub mod models {
        ...
        impl<'a> ModelsActions<'a> {
            ...
            #[doc = "Lists all models in the specified dataset. Requires the READER dataset role. After retrieving the list of models, you can get information about a particular model by calling the models.get method."]
            pub fn list(
                &self,
                project_id: impl Into<String>,
                dataset_id: impl Into<String>,
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn stream_models_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::Model, crate::Error>> + 'a
            {
            ...
            pub fn stream_with_default_fields(
                ...
                Item = Result<crate::schemas::ListModelsResponse, crate::Error>,
            > + 'a {
                self.stream_with_fields(None::<&str>)
            }
            #[doc = r" Execute the request and yield the returned value. If the response contains a"]
    ...
    pub mod projects {
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn stream_projects_with_default_fields(
                ...
                Item = Result<crate::schemas::ProjectListProjectsItems, crate::Error>,
            > + 'a {
            ...
            pub fn stream_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::ProjectList, crate::Error>> + 'a
            {
                self.stream_with_fields(None::<&str>)
            }
            #[doc = r" Execute the request and yield the returned value. If the response contains a"]
    ...
    pub mod routines {
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            #[doc = "\nExecute the request and yield each item in the `routines` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
            pub fn stream_routines<T>(
                self,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
            {
                ...
                self.stream_routines_with_fields(fields)
            }
            #[doc = "\nExecute the request and yield each item in the `routines` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
            pub fn stream_routines_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::Routine, crate::Error>> + 'a
            {
                self.stream_routines_with_fields(None::<String>)
            }
            #[doc = "\nExecute the request and yield each item in the `routines` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            pub fn stream_routines_with_all_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::Routine, crate::Error>> + 'a
            {
                self.stream_routines_with_fields(Some("*"))
            }
            #[doc = "\nExecute the request and yield each item in the `routines` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
            pub fn stream_routines_with_fields<T, F>(
                mut self,
                fields: ::std::option::Option<F>,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
            ...
            pub fn stream_with_default_fields(
                ...
                Item = Result<crate::schemas::ListRoutinesResponse, crate::Error>,
            > + 'a {
                self.stream_with_fields(None::<&str>)
            }
            #[doc = r" Execute the request and yield the returned value. If the response contains a"]
    ...
    pub mod row_access_policies {
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            #[doc = "\nExecute the request and yield each item in the `rowAccessPolicies` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
            pub fn stream_row_access_policies<T>(
                self,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
            {
                ...
                self.stream_row_access_policies_with_fields(fields)
            }
            #[doc = "\nExecute the request and yield each item in the `rowAccessPolicies` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
            pub fn stream_row_access_policies_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::RowAccessPolicy, crate::Error>> + 'a
            {
                self.stream_row_access_policies_with_fields(None::<String>)
            }
            #[doc = "\nExecute the request and yield each item in the `rowAccessPolicies` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            pub fn stream_row_access_policies_with_all_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::RowAccessPolicy, crate::Error>> + 'a
            {
                self.stream_row_access_policies_with_fields(Some("*"))
            }
            #[doc = "\nExecute the request and yield each item in the `rowAccessPolicies` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
            pub fn stream_row_access_policies_with_fields<T, F>(
                mut self,
                fields: ::std::option::Option<F>,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
            ...
            pub fn stream_with_default_fields(
                ...
                Item = Result<crate::schemas::ListRowAccessPoliciesResponse, crate::Error>,
            > + 'a {
                self.stream_with_fields(None::<&str>)
            }
            #[doc = r" Execute the request and yield the returned value. If the response contains a"]
    ...
    pub mod tabledata {
        ...
        pub struct ListRequestBuilder<'a> {
            ...
            max_results: ::std::option::Option<u32>,
            page_token: ::std::option::Option<String>,
            selected_fields: ::std::option::Option<String>,
            start_index: ::std::option::Option<u64>,
            alt: ::std::option::Option<crate::params::Alt>,
            fields: ::std::option::Option<String>,
            key: ::std::option::Option<String>,
    ...
    pub mod tables {
        pub mod params {
            #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
            pub enum GetView {
                #[doc = "Includes basic table information including schema and partitioning specification. This view does not include storage statistics such as numRows or numBytes. This view is significantly more efficient and should be used to support high query rates."]
                Basic,
                #[doc = "Includes all table information, including storage statistics. It returns same information as STORAGE_STATS view, but may contain additional information in the future."]
                Full,
                #[doc = "Includes all information in the BASIC view as well as storage statistics (numBytes, numLongTermBytes, numRows and lastModifiedTime)."]
                StorageStats,
                #[doc = "The default value. Default to the STORAGE_STATS view."]
            ...
            impl GetView {
                pub fn as_str(self) -> &'static str {
                    match self {
                        GetView::Basic => "BASIC",
                        GetView::Full => "FULL",
                        GetView::StorageStats => "STORAGE_STATS",
                        GetView::TableMetadataViewUnspecified => "TABLE_METADATA_VIEW_UNSPECIFIED",
                    }
                }
            }
            ...
            impl ::std::str::FromStr for GetView {
                ...
                fn from_str(s: &str) -> ::std::result::Result<GetView, ()> {
                    Ok(match s {
                        "BASIC" => GetView::Basic,
                        "FULL" => GetView::Full,
                        "STORAGE_STATS" => GetView::StorageStats,
                        "TABLE_METADATA_VIEW_UNSPECIFIED" => GetView::TableMetadataViewUnspecified,
                        _ => return Err(()),
                    })
                }
            }
        ...
        pub struct GetRequestBuilder<'a> {
            ...
            table_id: String,
            selected_fields: ::std::option::Option<String>,
            view: ::std::option::Option<crate::resources::tables::params::GetView>,
            alt: ::std::option::Option<crate::params::Alt>,
            fields: ::std::option::Option<String>,
            key: ::std::option::Option<String>,
            oauth_token: ::std::option::Option<String>,
        ...
        impl<'a> GetRequestBuilder<'a> {
            ...
            #[doc = "Specifies the view that determines which table information is returned. By default, basic table information and storage statistics (STORAGE_STATS) are returned."]
            pub fn view(mut self, value: crate::resources::tables::params::GetView) -> Self {
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            #[doc = "\nExecute the request and yield each item in the `tables` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
            pub fn stream_tables<T>(
                self,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
            {
                ...
                self.stream_tables_with_fields(fields)
            }
            #[doc = "\nExecute the request and yield each item in the `tables` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
            pub fn stream_tables_with_default_fields(
                self,
            ) -> impl ::futures::Stream<
                Item = Result<crate::schemas::TableListTablesItems, crate::Error>,
            > + 'a {
                self.stream_tables_with_fields(None::<String>)
            }
            #[doc = "\nExecute the request and yield each item in the `tables` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            pub fn stream_tables_with_all_fields(
                self,
            ) -> impl ::futures::Stream<
                Item = Result<crate::schemas::TableListTablesItems, crate::Error>,
            > + 'a {
                self.stream_tables_with_fields(Some("*"))
            }
            #[doc = "\nExecute the request and yield each item in the `tables` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
            pub fn stream_tables_with_fields<T, F>(
                mut self,
                fields: ::std::option::Option<F>,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
            ...
            pub fn stream_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::TableList, crate::Error>> + 'a
            {
                self.stream_with_fields(None::<&str>)
            }
            #[doc = r" Execute the request and yield the returned value. If the response contains a"]
        ...
        pub struct PatchRequestBuilder<'a> {
            ...
            dataset_id: String,
            table_id: String,
            autodetect_schema: ::std::option::Option<bool>,
            alt: ::std::option::Option<crate::params::Alt>,
            fields: ::std::option::Option<String>,
            key: ::std::option::Option<String>,
            oauth_token: ::std::option::Option<String>,
        ...
        impl<'a> PatchRequestBuilder<'a> {
            #[doc = "When true will autodetect schema, else will keep original schema"]
            pub fn autodetect_schema(mut self, value: bool) -> Self {
                self.autodetect_schema = Some(value);
                self
            }
            #[doc = "API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token."]
            pub fn key(mut self, value: impl Into<String>) -> Self {
            ...
            async fn _request(
                ...
                let mut req = self.reqwest.request(::reqwest::Method::PATCH, path);
                req = req.query(&[("autodetect_schema", &self.autodetect_schema)]);
                req = req.query(&[("alt", &self.alt)]);
                req = req.query(&[("fields", &self.fields)]);
                req = req.query(&[("key", &self.key)]);
                req = req.query(&[("oauth_token", &self.oauth_token)]);
