...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("dfareporting4")
        ...
        let mut advertiser_invoices0 = SubCommand::with_name("advertiser_invoices")
            .setting(AppSettings::ColoredHelp)
            .about("methods: list");
        {
            let mcmd = SubCommand::with_name("list").about("Retrieves a list of invoices for a particular issue month. The api only works if the billing profile invoice level is set to either advertiser or campaign non-consolidated invoice level.");
            advertiser_invoices0 = advertiser_invoices0.subcommand(mcmd);
        }
        ...
        let mut billing_assignments0 = SubCommand::with_name("billing_assignments")
            .setting(AppSettings::ColoredHelp)
            .about("methods: insert and list");
        {
            let mcmd = SubCommand::with_name("insert").about("Inserts a new billing assignment and returns the new assignment. Only one of advertiser_id or campaign_id is support per request. If the new assignment has no effect (assigning a campaign to the parent advertiser billing profile or assigning an advertiser to the account billing profile), no assignment will be returned.");
            billing_assignments0 = billing_assignments0.subcommand(mcmd);
        }
        {
            let mcmd =
                SubCommand::with_name("list").about("Retrieves a list of billing assignments.");
            billing_assignments0 = billing_assignments0.subcommand(mcmd);
        }
        let mut billing_profiles0 = SubCommand::with_name("billing_profiles")
            .setting(AppSettings::ColoredHelp)
            .about("methods: get, list and update");
        {
            let mcmd = SubCommand::with_name("get").about("Gets one billing profile by ID.");
            billing_profiles0 = billing_profiles0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Retrieves a list of billing profiles, possibly filtered. This method supports paging.");
            billing_profiles0 = billing_profiles0.subcommand(mcmd);
        }
        {
            let mcmd =
                SubCommand::with_name("update").about("Updates an existing billing profile.");
            billing_profiles0 = billing_profiles0.subcommand(mcmd);
        }
        let mut billing_rates0 = SubCommand::with_name("billing_rates")
            .setting(AppSettings::ColoredHelp)
            .about("methods: list");
        {
            let mcmd = SubCommand::with_name("list")
                .about("Retrieves a list of billing rates. This method supports paging.");
            billing_rates0 = billing_rates0.subcommand(mcmd);
        }
        ...
        app = app.subcommand(billing_rates0);
        app = app.subcommand(billing_profiles0);
        app = app.subcommand(billing_assignments0);
        app = app.subcommand(advertisers0);
        app = app.subcommand(advertiser_landing_pages0);
        app = app.subcommand(advertiser_invoices0);
...
use google_dfareporting4 as api;
