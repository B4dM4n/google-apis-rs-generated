...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for ListReposResponse {
    ...
    pub mod projects {
        ...
        pub mod repos {
            ...
            impl<'a> ReposActions<'a> {
                ...
                #[doc = "Creates a repo in the given project with the given name. If the named repository already exists, `CreateRepo` returns `ALREADY_EXISTS`."]
                pub fn create(
                    &self,
                ...
                #[doc = "Returns all repos belonging to a project. The sizes of the repos are not set by ListRepos. To get the size of a repo, use GetRepo."]
                ...
                #[doc = "Synchronize a connected repo. The response contains SyncRepoMetadata in the metadata field."]
                pub fn sync(
                    &self,
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `repos` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_repos<T>(
                    self,
                    ...
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_repos_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `repos` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_repos_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::Repo, crate::Error>> + 'a
                {
                    self.stream_repos_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `repos` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_repos_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::Repo, crate::Error>> + 'a
                {
                    self.stream_repos_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `repos` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_repos_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListReposResponse, crate::Error>,
                > + 'a {
