...
pub mod schemas {
    ...
    pub struct Webfont {
        ...
        pub last_modified: ::std::option::Option<String>,
    ...
    impl ::google_field_selector::ToFieldType for Webfont {
    ...
    impl ::google_field_selector::ToFieldType for WebfontList {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
impl Client {
    ...
    pub fn webfonts(&self) -> crate::resources::webfonts::WebfontsActions {
        crate::resources::webfonts::WebfontsActions {
...
pub mod resources {
    pub mod webfonts {
        pub mod params {
            ...
            impl ListSort {
                pub fn as_str(self) -> &'static str {
                    match self {
                        ...
                        ListSort::SortUndefined => "SORT_UNDEFINED",
            ...
            impl ::std::str::FromStr for ListSort {
                ...
                fn from_str(s: &str) -> ::std::result::Result<ListSort, ()> {
                    Ok(match s {
                        ...
                        "SORT_UNDEFINED" => ListSort::SortUndefined,
            ...
            impl ::google_field_selector::FieldSelector for ListSort {
                fn fields() -> Vec<::google_field_selector::Field> {
                    Vec::new()
                }
            }
            impl ::google_field_selector::ToFieldType for ListSort {
                fn field_type() -> ::google_field_selector::FieldType {
                    ::google_field_selector::FieldType::Leaf
                }
            }
        }
        pub struct WebfontsActions<'a> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
        }
        impl<'a> WebfontsActions<'a> {
            fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                self.auth
            }
        ...
        pub struct ListRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            sort: ::std::option::Option<crate::resources::webfonts::params::ListSort>,
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn sort(mut self, value: crate::resources::webfonts::params::ListSort) -> Self {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::WebfontList, crate::Error> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://webfonts.googleapis.com/".to_owned();
                output.push_str("v1/webfonts");
                output
            }
            async fn _request(
                &self,
