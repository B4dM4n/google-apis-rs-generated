...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("gkehub1_alpha2")
...
use google_gkehub1_alpha2 as api;
