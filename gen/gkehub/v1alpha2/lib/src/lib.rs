...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for InitializeHubRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for InitializeHubRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct InitializeHubResponse {
        #[doc = "Name of the Hub default service identity, in the format: service-@gcp-sa-gkehub.iam.gserviceaccount.com The service account has `roles/gkehub.serviceAgent` in the Hub project."]
        #[serde(
            rename = "serviceIdentity",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub service_identity: ::std::option::Option<String>,
        #[doc = "The Workload Identity Pool used for Workload Identity-enabled clusters registered with this Hub. Format: `.hub.id.goog`"]
        #[serde(
            rename = "workloadIdentityPool",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for InitializeHubResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for InitializeHubResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
        ...
        pub mod locations {
            ...
            pub mod global {
                ...
                impl<'a> GlobalActions<'a> {
                    ...
                    #[doc = "Actions that can be performed on the memberships resource"]                    pub fn memberships (& self) -> crate :: resources :: projects :: locations :: global :: memberships :: MembershipsActions{
                        crate :: resources :: projects :: locations :: global :: memberships :: MembershipsActions { reqwest : & self . reqwest , auth : self . auth_ref () , }
                    }
                }
                pub mod memberships {
                    pub mod params {}
                    ...
                    #[doc = "Created via [MembershipsActions::initialize_hub()](struct.MembershipsActions.html#method.initialize_hub)"]
                    #[derive(Debug, Clone)]
                    pub struct InitializeHubRequestBuilder<'a> {
                        pub(crate) reqwest: &'a ::reqwest::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                        request: crate::schemas::InitializeHubRequest,
                        project: String,
                    ...
                    impl<'a> InitializeHubRequestBuilder<'a> {
                        #[doc = "OAuth access token."]
                        pub fn access_token(mut self, value: impl Into<String>) -> Self {
                            self.access_token = Some(value.into());
                            self
                        ...
                        pub async fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::InitializeHubResponse, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>).await
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
