        ...
        pub mod locations {
            ...
            pub mod fleets {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn iter_fleets<T>(self) -> crate::iter::PageItemIter<Self, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                    {
                        ...
                        self.iter_fleets_with_fields(fields)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_fleets_with_default_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::Fleet>
                    {
                        self.iter_fleets_with_fields(None::<String>)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    ...
                    #[doc = r" resources."]
                    pub fn iter_fleets_with_all_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::Fleet>
                    {
                        self.iter_fleets_with_fields(Some("*"))
                    }
                    pub fn iter_fleets_with_fields<T, F>(
                        mut self,
                        fields: Option<F>,
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        crate::iter::PageItemIter::new(self, "fleets")
                    }
                    ...
                    pub fn iter_with_default_fields(
                        self,
                    ) -> crate::iter::PageIter<Self, crate::schemas::ListFleetsResponse>
                    {
        ...
        pub mod locations {
            ...
            pub mod features {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn iter_with_default_fields(
                        self,
                    ) -> crate::iter::PageIter<Self, crate::schemas::ListFeaturesResponse>
                    {
                        self.iter_with_fields(None::<&str>)
                    }
                    pub fn iter_with_all_fields(
            ...
            pub mod memberships {
                ...
                pub struct GenerateConnectManifestRequestBuilder<'a> {
                    ...
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    name: String,
                    image_pull_secret_content: Option<::google_api_bytes::Bytes>,
                    is_upgrade: Option<bool>,
                    namespace: Option<String>,
                    proxy: Option<::google_api_bytes::Bytes>,
                ...
                impl<'a> ListAdminRequestBuilder<'a> {
                    ...
                    #[doc = r" populated fields in the yielded items will be determined by the"]
                    #[doc = r" `FieldSelector` implementation."]
                    pub fn iter_admin_cluster_memberships<T>(
                        self,
                    ) -> crate::iter::PageItemIter<Self, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                    {
                        ...
                        self.iter_admin_cluster_memberships_with_fields(fields)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_admin_cluster_memberships_with_default_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::Membership>
                    {
                        self.iter_admin_cluster_memberships_with_fields(None::<String>)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be all fields available. This should"]
                    ...
                    #[doc = r" all fields can be expensive both in bandwidth and server"]
                    #[doc = r" resources."]
                    pub fn iter_admin_cluster_memberships_with_all_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::Membership>
                    {
                        self.iter_admin_cluster_memberships_with_fields(Some("*"))
                    }
                    pub fn iter_admin_cluster_memberships_with_fields<T, F>(
                        mut self,
                        fields: Option<F>,
                    ) -> crate::iter::PageItemIter<Self, T>
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        crate::iter::PageItemIter::new(self, "adminClusterMemberships")
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are chosen by the caller of this"]
                    #[doc = r" method and must implement `Deserialize` and `FieldSelector`. The"]
                ...
                impl<'a> crate::iter::IterableMethod for ListAdminRequestBuilder<'a> {
                    fn set_page_token(&mut self, value: String) {
                        self.page_token = value.into();
                    }
                    fn execute<T>(&mut self) -> Result<T, crate::Error>
