...
pub mod schemas {
    ...
    pub struct CloudAuditLoggingFeatureSpec {
        #[doc = "Service account that should be allowlisted to send the audit logs; eg cloudauditlogging@gcp-project.iam.gserviceaccount.com. These accounts must already exist, but do not need to have any permissions granted to them. The customer’s entitlements will be checked prior to allowlisting (i.e. the customer must be an Anthos customer.)"]
        #[serde(
            rename = "allowlistedServiceAccounts",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub allowlisted_service_accounts: ::std::option::Option<Vec<String>>,
    }
    impl ::google_field_selector::FieldSelector for CloudAuditLoggingFeatureSpec {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudAuditLoggingFeatureSpec {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct CloudBuildMembershipSpec {
        ...
        pub security_policy:
            ::std::option::Option<crate::schemas::CloudBuildMembershipSpecSecurityPolicy>,
    ...
    impl ::google_field_selector::FieldSelector for CloudBuildMembershipSpec {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudBuildMembershipSpec {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum CloudBuildMembershipSpecSecurityPolicy {
    ...
    impl CloudBuildMembershipSpecSecurityPolicy {
        pub fn as_str(self) -> &'static str {
            match self {
                CloudBuildMembershipSpecSecurityPolicy::NonPrivileged => "NON_PRIVILEGED",
                CloudBuildMembershipSpecSecurityPolicy::Privileged => "PRIVILEGED",
                CloudBuildMembershipSpecSecurityPolicy::SecurityPolicyUnspecified => {
                    "SECURITY_POLICY_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for CloudBuildMembershipSpecSecurityPolicy {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for CloudBuildMembershipSpecSecurityPolicy {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<CloudBuildMembershipSpecSecurityPolicy, ()> {
            Ok(match s {
                "NON_PRIVILEGED" => CloudBuildMembershipSpecSecurityPolicy::NonPrivileged,
                "PRIVILEGED" => CloudBuildMembershipSpecSecurityPolicy::Privileged,
                "SECURITY_POLICY_UNSPECIFIED" => {
                    CloudBuildMembershipSpecSecurityPolicy::SecurityPolicyUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for CloudBuildMembershipSpecSecurityPolicy {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for CloudBuildMembershipSpecSecurityPolicy {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for CloudBuildMembershipSpecSecurityPolicy {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for CloudBuildMembershipSpecSecurityPolicy {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudBuildMembershipSpecSecurityPolicy {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct CommonFeatureSpec {
        ...
        #[doc = "Cloud Audit Logging-specific spec."]
        #[serde(
            rename = "cloudauditlogging",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub cloudauditlogging: ::std::option::Option<crate::schemas::CloudAuditLoggingFeatureSpec>,
        ...
        #[doc = "Workload Certificate spec."]
        #[serde(
            rename = "workloadcertificate",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub workloadcertificate: ::std::option::Option<crate::schemas::FeatureSpec>,
    }
    ...
    pub struct CommonFeatureState {
        ...
        pub servicemesh: ::std::option::Option<crate::schemas::ServiceMeshFeatureState>,
    ...
    pub struct FeatureSpec {
        #[doc = "Specifies default membership spec. Users can override the default in the member_configs for each member."]
        #[serde(
            rename = "defaultConfig",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub default_config: ::std::option::Option<crate::schemas::MembershipSpec>,
        #[doc = "Immutable. Specifies CA configuration."]
        #[serde(
            rename = "provisionGoogleCa",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub provision_google_ca:
            ::std::option::Option<crate::schemas::FeatureSpecProvisionGoogleCa>,
    }
    impl ::google_field_selector::FieldSelector for FeatureSpec {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for FeatureSpec {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum FeatureSpecProvisionGoogleCa {
        #[doc = "Disable default Google managed CA."]
        Disabled,
        #[doc = "Use default Google managed CA."]
        Enabled,
        #[doc = "Disable default Google managed CA."]
        GoogleCaProvisioningUnspecified,
    }
    impl FeatureSpecProvisionGoogleCa {
        pub fn as_str(self) -> &'static str {
            match self {
                FeatureSpecProvisionGoogleCa::Disabled => "DISABLED",
                FeatureSpecProvisionGoogleCa::Enabled => "ENABLED",
                FeatureSpecProvisionGoogleCa::GoogleCaProvisioningUnspecified => {
                    "GOOGLE_CA_PROVISIONING_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for FeatureSpecProvisionGoogleCa {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for FeatureSpecProvisionGoogleCa {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<FeatureSpecProvisionGoogleCa, ()> {
            Ok(match s {
                "DISABLED" => FeatureSpecProvisionGoogleCa::Disabled,
                "ENABLED" => FeatureSpecProvisionGoogleCa::Enabled,
                "GOOGLE_CA_PROVISIONING_UNSPECIFIED" => {
                    FeatureSpecProvisionGoogleCa::GoogleCaProvisioningUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for FeatureSpecProvisionGoogleCa {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for FeatureSpecProvisionGoogleCa {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for FeatureSpecProvisionGoogleCa {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for FeatureSpecProvisionGoogleCa {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for FeatureSpecProvisionGoogleCa {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Fleet {
        #[doc = "Output only. When the Fleet was created."]
        #[serde(
            rename = "createTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub create_time: ::std::option::Option<String>,
        #[doc = "Output only. When the Fleet was deleted."]
        #[serde(
            rename = "deleteTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub delete_time: ::std::option::Option<String>,
        #[doc = "Optional. A user-assigned display name of the Fleet. When present, it must be between 4 to 30 characters. Allowed characters are: lowercase and uppercase letters, numbers, hyphen, single-quote, double-quote, space, and exclamation point. Example: `Production Fleet`"]
        #[serde(
            rename = "displayName",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. The full, unique resource name of this fleet in the format of `projects/{project}/locations/{location}/fleets/{fleet}`. Each GCP project can have at most one fleet resource, named “default”."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub name: ::std::option::Option<String>,
        #[doc = "Output only. State of the namespace resource."]
        #[serde(
            rename = "state",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub state: ::std::option::Option<crate::schemas::FleetLifecycleState>,
        #[doc = "Output only. Google-generated UUID for this resource. This is unique across all Fleet resources. If a Fleet resource is deleted and another resource with the same name is created, it gets a different uid."]
        #[serde(
            rename = "uid",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. When the Fleet was last updated."]
        #[serde(
            rename = "updateTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for Fleet {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for Fleet {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct FleetLifecycleState {
        #[doc = "Output only. The current state of the Fleet resource."]
        #[serde(
            rename = "code",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub code: ::std::option::Option<crate::schemas::FleetLifecycleStateCode>,
    }
    impl ::google_field_selector::FieldSelector for FleetLifecycleState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for FleetLifecycleState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum FleetLifecycleStateCode {
        #[doc = "The code is not set."]
        CodeUnspecified,
        #[doc = "The fleet is being created."]
        Creating,
        #[doc = "The fleet is being deleted."]
        Deleting,
        #[doc = "The fleet active."]
        Ready,
        #[doc = "The fleet is being updated."]
        Updating,
    }
    impl FleetLifecycleStateCode {
        pub fn as_str(self) -> &'static str {
            match self {
                FleetLifecycleStateCode::CodeUnspecified => "CODE_UNSPECIFIED",
                FleetLifecycleStateCode::Creating => "CREATING",
                FleetLifecycleStateCode::Deleting => "DELETING",
                FleetLifecycleStateCode::Ready => "READY",
                FleetLifecycleStateCode::Updating => "UPDATING",
            }
        }
    }
    impl ::std::convert::AsRef<str> for FleetLifecycleStateCode {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for FleetLifecycleStateCode {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<FleetLifecycleStateCode, ()> {
            Ok(match s {
                "CODE_UNSPECIFIED" => FleetLifecycleStateCode::CodeUnspecified,
                "CREATING" => FleetLifecycleStateCode::Creating,
                "DELETING" => FleetLifecycleStateCode::Deleting,
                "READY" => FleetLifecycleStateCode::Ready,
                "UPDATING" => FleetLifecycleStateCode::Updating,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for FleetLifecycleStateCode {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for FleetLifecycleStateCode {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for FleetLifecycleStateCode {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for FleetLifecycleStateCode {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for FleetLifecycleStateCode {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ListAdminClusterMembershipsResponse {
        #[doc = "The list of matching Memberships of admin clusters."]
        #[serde(
            rename = "adminClusterMemberships",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub admin_cluster_memberships: ::std::option::Option<Vec<crate::schemas::Membership>>,
        #[doc = "A token to request the next page of resources from the `ListAdminClusterMemberships` method. The value of an empty string means that there are no more resources to return."]
        #[serde(
    ...
    impl ::google_field_selector::FieldSelector for ListAdminClusterMembershipsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListAdminClusterMembershipsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListAdminClusterMembershipsResponse {
    ...
    pub struct ListFleetsResponse {
        #[doc = "The list of matching fleets."]
        #[serde(
            rename = "fleets",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub fleets: ::std::option::Option<Vec<crate::schemas::Fleet>>,
        #[doc = "A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. The token is only valid for 1h."]
        #[serde(
            rename = "nextPageToken",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for ListFleetsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListFleetsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListFleetsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct MembershipFeatureSpec {
        ...
        pub cloudbuild: ::std::option::Option<crate::schemas::CloudBuildMembershipSpec>,
        ...
        pub workloadcertificate: ::std::option::Option<crate::schemas::MembershipSpec>,
    }
    ...
    pub struct MembershipSpec {
        #[doc = "Specifies workload certificate management."]
        #[serde(
            rename = "certificateManagement",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub certificate_management:
            ::std::option::Option<crate::schemas::MembershipSpecCertificateManagement>,
    }
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum MembershipSpecCertificateManagement {
        #[doc = "Disable workload certificate feature."]
        CertificateManagementUnspecified,
        #[doc = "Disable workload certificate feature."]
        Disabled,
        #[doc = "Enable workload certificate feature."]
        Enabled,
    }
    impl MembershipSpecCertificateManagement {
        pub fn as_str(self) -> &'static str {
            match self {
                MembershipSpecCertificateManagement::CertificateManagementUnspecified => {
                    "CERTIFICATE_MANAGEMENT_UNSPECIFIED"
                }
                MembershipSpecCertificateManagement::Disabled => "DISABLED",
                MembershipSpecCertificateManagement::Enabled => "ENABLED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for MembershipSpecCertificateManagement {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for MembershipSpecCertificateManagement {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<MembershipSpecCertificateManagement, ()> {
            Ok(match s {
                "CERTIFICATE_MANAGEMENT_UNSPECIFIED" => {
                    MembershipSpecCertificateManagement::CertificateManagementUnspecified
                }
                "DISABLED" => MembershipSpecCertificateManagement::Disabled,
                "ENABLED" => MembershipSpecCertificateManagement::Enabled,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for MembershipSpecCertificateManagement {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for MembershipSpecCertificateManagement {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for MembershipSpecCertificateManagement {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for MembershipSpecCertificateManagement {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MembershipSpecCertificateManagement {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ServiceMeshAnalysisMessage {
        #[doc = "A UI can combine these args with a template (based on message_base.type) to produce an internationalized message."]
        #[serde(
            rename = "args",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub args: ::std::option::Option<::std::collections::BTreeMap<String, ::serde_json::Value>>,
        #[doc = "A human readable description of what the error means. It is suitable for non-internationalize display purposes."]
        #[serde(
            rename = "description",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub description: ::std::option::Option<String>,
        #[doc = "Details common to all types of Istio and ServiceMesh analysis messages."]
        #[serde(
            rename = "messageBase",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub message_base: ::std::option::Option<crate::schemas::ServiceMeshAnalysisMessageBase>,
        #[doc = "A list of strings specifying the resource identifiers that were the cause of message generation. A “path” here may be: * MEMBERSHIP_ID if the cause is a specific member cluster * MEMBERSHIP_ID/(NAMESPACE/)?RESOURCETYPE/NAME if the cause is a resource in a cluster"]
        #[serde(
            rename = "resourcePaths",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub resource_paths: ::std::option::Option<Vec<String>>,
    }
    impl ::google_field_selector::FieldSelector for ServiceMeshAnalysisMessage {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ServiceMeshAnalysisMessage {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ServiceMeshAnalysisMessageBase {
        #[doc = "A url pointing to the Service Mesh or Istio documentation for this specific error type."]
        #[serde(
            rename = "documentationUrl",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub documentation_url: ::std::option::Option<String>,
        #[doc = "Represents how severe a message is."]
        #[serde(
            rename = "level",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub level: ::std::option::Option<crate::schemas::ServiceMeshAnalysisMessageBaseLevel>,
        #[doc = "Represents the specific type of a message."]
        #[serde(
            rename = "type",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub r#type: ::std::option::Option<crate::schemas::ServiceMeshType>,
    }
    impl ::google_field_selector::FieldSelector for ServiceMeshAnalysisMessageBase {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ServiceMeshAnalysisMessageBase {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum ServiceMeshAnalysisMessageBaseLevel {
        #[doc = "ERROR represents a misconfiguration that must be fixed."]
        Error,
        #[doc = "INFO represents an informational finding."]
        Info,
        #[doc = "Illegal. Same istio.analysis.v1alpha1.AnalysisMessageBase.Level.UNKNOWN."]
        LevelUnspecified,
        #[doc = "WARNING represents a misconfiguration that should be fixed."]
        Warning,
    }
    impl ServiceMeshAnalysisMessageBaseLevel {
        pub fn as_str(self) -> &'static str {
            match self {
                ServiceMeshAnalysisMessageBaseLevel::Error => "ERROR",
                ServiceMeshAnalysisMessageBaseLevel::Info => "INFO",
                ServiceMeshAnalysisMessageBaseLevel::LevelUnspecified => "LEVEL_UNSPECIFIED",
                ServiceMeshAnalysisMessageBaseLevel::Warning => "WARNING",
            }
        }
    }
    impl ::std::convert::AsRef<str> for ServiceMeshAnalysisMessageBaseLevel {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for ServiceMeshAnalysisMessageBaseLevel {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<ServiceMeshAnalysisMessageBaseLevel, ()> {
            Ok(match s {
                "ERROR" => ServiceMeshAnalysisMessageBaseLevel::Error,
                "INFO" => ServiceMeshAnalysisMessageBaseLevel::Info,
                "LEVEL_UNSPECIFIED" => ServiceMeshAnalysisMessageBaseLevel::LevelUnspecified,
                "WARNING" => ServiceMeshAnalysisMessageBaseLevel::Warning,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for ServiceMeshAnalysisMessageBaseLevel {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for ServiceMeshAnalysisMessageBaseLevel {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ServiceMeshAnalysisMessageBaseLevel {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ServiceMeshAnalysisMessageBaseLevel {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ServiceMeshAnalysisMessageBaseLevel {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq, Default, :: serde :: Deserialize, :: serde :: Serialize)]
    pub struct ServiceMeshFeatureState {
        #[doc = "Output only. Results of running Service Mesh analyzers."]
        #[serde(
            rename = "analysisMessages",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub analysis_messages:
            ::std::option::Option<Vec<crate::schemas::ServiceMeshAnalysisMessage>>,
    }
    impl ::google_field_selector::FieldSelector for ServiceMeshFeatureState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ServiceMeshFeatureState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ServiceMeshMembershipSpec {
        ...
        #[doc = "Determines which release channel to use for default injection and service mesh APIs."]
        #[serde(
        ...
        pub default_channel:
            ::std::option::Option<crate::schemas::ServiceMeshMembershipSpecDefaultChannel>,
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum ServiceMeshMembershipSpecDefaultChannel {
        #[doc = "Unspecified"]
        ChannelUnspecified,
        #[doc = "RAPID channel is offered on an early access basis for customers who want to test new releases."]
        Rapid,
        #[doc = "REGULAR channel is intended for production users who want to take advantage of new features."]
        Regular,
        #[doc = "STABLE channel includes versions that are known to be stable and reliable in production."]
        Stable,
    }
    impl ServiceMeshMembershipSpecDefaultChannel {
        pub fn as_str(self) -> &'static str {
            match self {
                ServiceMeshMembershipSpecDefaultChannel::ChannelUnspecified => {
                    "CHANNEL_UNSPECIFIED"
                }
                ServiceMeshMembershipSpecDefaultChannel::Rapid => "RAPID",
                ServiceMeshMembershipSpecDefaultChannel::Regular => "REGULAR",
                ServiceMeshMembershipSpecDefaultChannel::Stable => "STABLE",
            }
        }
    }
    impl ::std::convert::AsRef<str> for ServiceMeshMembershipSpecDefaultChannel {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for ServiceMeshMembershipSpecDefaultChannel {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<ServiceMeshMembershipSpecDefaultChannel, ()> {
            Ok(match s {
                "CHANNEL_UNSPECIFIED" => {
                    ServiceMeshMembershipSpecDefaultChannel::ChannelUnspecified
                }
                "RAPID" => ServiceMeshMembershipSpecDefaultChannel::Rapid,
                "REGULAR" => ServiceMeshMembershipSpecDefaultChannel::Regular,
                "STABLE" => ServiceMeshMembershipSpecDefaultChannel::Stable,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for ServiceMeshMembershipSpecDefaultChannel {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for ServiceMeshMembershipSpecDefaultChannel {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ServiceMeshMembershipSpecDefaultChannel {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ServiceMeshMembershipSpecDefaultChannel {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ServiceMeshMembershipSpecDefaultChannel {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ServiceMeshMembershipState {
        ...
        pub analysis_messages:
            ::std::option::Option<Vec<crate::schemas::ServiceMeshAnalysisMessage>>,
        #[doc = "The API version (i.e. Istio CRD version) for configuring service mesh in this cluster. This version is influenced by the `default_channel` field."]
        #[serde(
            rename = "configApiVersion",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub config_api_version: ::std::option::Option<String>,
    ...
    pub struct ServiceMeshType {
        #[doc = "A 7 character code matching `^IST[0-9]{4}$` or `^ASM[0-9]{4}$`, intended to uniquely identify the message type. (e.g. “IST0001” is mapped to the “InternalError” message type.)"]
        #[serde(
            rename = "code",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub code: ::std::option::Option<String>,
        #[doc = "A human-readable name for the message type. e.g. “InternalError”, “PodMissingProxy”. This should be the same for all messages of the same type. (This corresponds to the `name` field in open-source Istio.)"]
        #[serde(
            rename = "displayName",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for ServiceMeshType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ServiceMeshType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ValidateCreateMembershipRequest {
        #[doc = "Required. Membership resource to be created."]
        #[serde(
            rename = "membership",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Required. Client chosen membership id."]
        #[serde(
            rename = "membershipId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub membership_id: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for ValidateCreateMembershipRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ValidateCreateMembershipRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ValidateCreateMembershipResponse {
        #[doc = "Wraps all the validator results."]
        #[serde(
            rename = "validationResults",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub validation_results: ::std::option::Option<Vec<crate::schemas::ValidationResult>>,
    }
    impl ::google_field_selector::FieldSelector for ValidateCreateMembershipResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ValidateCreateMembershipResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ValidationResult {
        #[doc = "Additional information for the validation."]
        #[serde(
            rename = "result",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Whether the validation is passed or not."]
        #[serde(
            rename = "success",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Validator type to validate membership with."]
        #[serde(
            rename = "validator",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub validator: ::std::option::Option<crate::schemas::ValidationResultValidator>,
    }
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum ValidationResultValidator {
        #[doc = "CROSS_PROJECT_PERMISSION validator validates the cross-project P4SA binding is in place."]
        CrossProjectPermission,
        #[doc = "MEMBERSHIP_ID validator validates the membership_id is still available."]
        MembershipId,
        #[doc = "UNSPECIFIED validator."]
        ValidatorTypeUnspecified,
    }
    impl ValidationResultValidator {
        pub fn as_str(self) -> &'static str {
            match self {
                ValidationResultValidator::CrossProjectPermission => "CROSS_PROJECT_PERMISSION",
                ValidationResultValidator::MembershipId => "MEMBERSHIP_ID",
                ValidationResultValidator::ValidatorTypeUnspecified => "VALIDATOR_TYPE_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for ValidationResultValidator {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for ValidationResultValidator {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<ValidationResultValidator, ()> {
            Ok(match s {
                "CROSS_PROJECT_PERMISSION" => ValidationResultValidator::CrossProjectPermission,
                "MEMBERSHIP_ID" => ValidationResultValidator::MembershipId,
                "VALIDATOR_TYPE_UNSPECIFIED" => ValidationResultValidator::ValidatorTypeUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for ValidationResultValidator {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for ValidationResultValidator {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ValidationResultValidator {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ValidationResultValidator {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ValidationResultValidator {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub mod organizations {
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                #[doc = "Actions that can be performed on the fleets resource"]
                pub fn fleets(
                    &self,
                ) -> crate::resources::organizations::locations::fleets::FleetsActions
                {
                    crate::resources::organizations::locations::fleets::FleetsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            pub mod fleets {
                pub mod params {}
                pub struct FleetsActions<'a> {
                    pub(crate) reqwest: &'a reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                }
                impl<'a> FleetsActions<'a> {
                    fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                        self.auth
                    }
                    #[doc = "Returns all fleets within an organization or a project that the caller has access to."]
                ...
                #[doc = "Created via [FleetsActions::list()](struct.FleetsActions.html#method.list)"]
                #[derive(Debug, Clone)]
                ...
                impl<'a> ListRequestBuilder<'a> {
                    #[doc = "Optional. The maximum number of fleets to return. The service may return fewer than this value. If unspecified, at most 200 fleets will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000."]
                    pub fn page_size(mut self, value: i32) -> Self {
                        self.page_size = Some(value);
                        self
                    }
                    #[doc = "Optional. A page token, received from a previous `ListFleets` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListFleets` must match the call that provided the page token."]
                    ...
                    #[doc = "\nExecute the request and yield each item in the `fleets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_fleets<T>(
                        self,
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_fleets_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `fleets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_fleets_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Fleet, crate::Error>> + 'a
                    {
                        self.stream_fleets_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `fleets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_fleets_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Fleet, crate::Error>> + 'a
                    {
                        self.stream_fleets_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `fleets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_fleets_with_fields<T, F>(
                        mut self,
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        self.fields = Some({
                            let mut selector = concat!("nextPageToken,", "fleets").to_owned();
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListFleetsResponse, crate::Error>,
                    > + 'a {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ListFleetsResponse, crate::Error>
                    {
    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                pub fn fleets(
                    &self,
                ) -> crate::resources::projects::locations::fleets::FleetsActions {
                    crate::resources::projects::locations::fleets::FleetsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                    }
            ...
            pub mod fleets {
                ...
                impl<'a> FleetsActions<'a> {
                    ...
                    #[doc = "Removes a Fleet. There must be no memberships remaining in the Fleet."]
                    pub fn delete(&self, name: impl Into<String>) -> DeleteRequestBuilder {
                        DeleteRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    #[doc = "Returns the details of a fleet."]
                    pub fn get(&self, name: impl Into<String>) -> GetRequestBuilder {
                        GetRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                ...
                #[doc = "Created via [FleetsActions::create()](struct.FleetsActions.html#method.create)"]
                #[derive(Debug, Clone)]
                pub struct CreateRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                #[doc = "Created via [FleetsActions::delete()](struct.FleetsActions.html#method.delete)"]
                #[derive(Debug, Clone)]
                pub struct DeleteRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                #[doc = "Created via [FleetsActions::get()](struct.FleetsActions.html#method.get)"]
                #[derive(Debug, Clone)]
                pub struct GetRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                impl<'a> GetRequestBuilder<'a> {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::Fleet, crate::Error> {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    #[doc = r" selector of `*`. This will include every attribute of the"]
                ...
                #[doc = "Created via [FleetsActions::patch()](struct.FleetsActions.html#method.patch)"]
                #[derive(Debug, Clone)]
                pub struct PatchRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                impl<'a> PatchRequestBuilder<'a> {
                    #[doc = "Required. The fields to be updated;"]
                    pub fn update_mask(mut self, value: impl Into<String>) -> Self {
                        self.update_mask = Some(value.into());
                        self
                    }
            ...
            pub mod memberships {
                ...
                impl<'a> MembershipsActions<'a> {
                    ...
                    #[doc = "Lists Memberships of admin clusters in a given project and location. **This method is only used internally**."]
                    pub fn list_admin(&self, parent: impl Into<String>) -> ListAdminRequestBuilder {
                        ListAdminRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                            access_token: None,
                    ...
                    #[doc = "ValidateCreateMembership is a preflight check for CreateMembership. It checks the following: 1. Caller has the required `gkehub.memberships.create` permission. 2. The membership_id is still available."]
                    pub fn validate_create(
                        &self,
                        request: crate::schemas::ValidateCreateMembershipRequest,
                        parent: impl Into<String>,
                    ) -> ValidateCreateRequestBuilder {
                        ValidateCreateRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                            request,
                ...
                #[doc = "Created via [MembershipsActions::list_admin()](struct.MembershipsActions.html#method.list_admin)"]
                #[derive(Debug, Clone)]
                pub struct ListAdminRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    parent: String,
                    filter: ::std::option::Option<String>,
                ...
                impl<'a> ListAdminRequestBuilder<'a> {
                    #[doc = "Optional. Lists Memberships of admin clusters that match the filter expression."]
                    pub fn filter(mut self, value: impl Into<String>) -> Self {
                        self.filter = Some(value.into());
                        self
                    }
                    ...
                    #[doc = "Optional. Token returned by previous call to `ListAdminClusterMemberships` which specifies the position in the list from where to continue listing the resources."]
                    pub fn page_token(mut self, value: impl Into<String>) -> Self {
                        self.page_token = Some(value.into());
                        self
                    }
                    ...
                    #[doc = "\nExecute the request and yield each item in the `adminClusterMemberships` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_admin_cluster_memberships<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_admin_cluster_memberships_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `adminClusterMemberships` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_admin_cluster_memberships_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::Membership, crate::Error>,
                    > + 'a {
                        self.stream_admin_cluster_memberships_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `adminClusterMemberships` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_admin_cluster_memberships_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::Membership, crate::Error>,
                    > + 'a {
                        self.stream_admin_cluster_memberships_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `adminClusterMemberships` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_admin_cluster_memberships_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        struct Page<T> {
                            #[serde(rename = "nextPageToken")]
                            pub next_page_token: ::std::option::Option<String>,
                            #[serde(rename = "adminClusterMemberships")]
                            pub items: Vec<T>,
                        }
                        impl<T> crate::GetNextPageToken<String> for Page<T> {
                            fn next_page_token(&self) -> ::std::option::Option<String> {
                        ...
                        self.fields = Some({
                            let mut selector =
                                concat!("nextPageToken,", "adminClusterMemberships").to_owned();
                            let items_fields = fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                            if !items_fields.is_empty() {
                                selector.push_str("(");
                                selector.push_str(items_fields);
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<
                            crate::schemas::ListAdminClusterMembershipsResponse,
                            crate::Error,
                        >,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ListAdminClusterMembershipsResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str("/memberships:listAdmin");
                        output
                    }
                    async fn _request(
                        &self,
                ...
                #[async_trait::async_trait]
                impl<'a> crate::stream::StreamableMethod for ListAdminRequestBuilder<'a> {
                    type PageToken = String;
                    fn set_page_token(&mut self, value: String) {
                        self.page_token = value.into();
                    }
                ...
                #[doc = "Created via [MembershipsActions::validate_create()](struct.MembershipsActions.html#method.validate_create)"]
                #[derive(Debug, Clone)]
                pub struct ValidateCreateRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    request: crate::schemas::ValidateCreateMembershipRequest,
                    parent: String,
                ...
                impl<'a> ValidateCreateRequestBuilder<'a> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ValidateCreateMembershipResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str("/memberships:validateCreate");
                        output
                    }
                    async fn _request(
                        &self,
