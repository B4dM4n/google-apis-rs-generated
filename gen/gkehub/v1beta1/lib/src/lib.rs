...
pub mod schemas {
    ...
    pub struct GenerateExclusivityManifestResponse {
        #[doc = "The YAML manifest of the membership CR to apply if a new version of the CR is available. Empty if no update needs to be applied."]
        #[serde(
            rename = "crManifest",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub cr_manifest: ::std::option::Option<String>,
        #[doc = "The YAML manifest of the membership CRD to apply if a newer version of the CRD is available. Empty if no update needs to be applied."]
        #[serde(
            rename = "crdManifest",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub crd_manifest: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for GenerateExclusivityManifestResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GenerateExclusivityManifestResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Membership {
        ...
        #[doc = "Optional. Description of this membership, limited to 63 characters. Must match the regex: `a-zA-Z0-9*`"]
        #[serde(
            rename = "description",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Optional. The infrastructure type this Membership is running on."]
        #[serde(
            rename = "infrastructureType",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub infrastructure_type:
            ::std::option::Option<crate::schemas::MembershipInfrastructureType>,
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum MembershipInfrastructureType {
        #[doc = "No type was specified. Some Hub functionality may require a type be specified, and will not support Memberships with this value."]
        InfrastructureTypeUnspecified,
        #[doc = "Public cloud infrastructure."]
        MultiCloud,
        #[doc = "Private infrastructure that is owned or operated by customer. This includes GKE distributions such as GKE-OnPrem and GKE-OnBareMetal."]
        OnPrem,
    }
    impl MembershipInfrastructureType {
        pub fn as_str(self) -> &'static str {
            match self {
                MembershipInfrastructureType::InfrastructureTypeUnspecified => {
                    "INFRASTRUCTURE_TYPE_UNSPECIFIED"
                }
                MembershipInfrastructureType::MultiCloud => "MULTI_CLOUD",
                MembershipInfrastructureType::OnPrem => "ON_PREM",
            }
        }
    }
    impl ::std::convert::AsRef<str> for MembershipInfrastructureType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for MembershipInfrastructureType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<MembershipInfrastructureType, ()> {
            Ok(match s {
                "INFRASTRUCTURE_TYPE_UNSPECIFIED" => {
                    MembershipInfrastructureType::InfrastructureTypeUnspecified
                }
                "MULTI_CLOUD" => MembershipInfrastructureType::MultiCloud,
                "ON_PREM" => MembershipInfrastructureType::OnPrem,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for MembershipInfrastructureType {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for MembershipInfrastructureType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for MembershipInfrastructureType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for MembershipInfrastructureType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MembershipInfrastructureType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct MembershipState {
        ...
        #[doc = "This field is never set by the Hub Service."]
        #[serde(
            rename = "description",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct ValidateExclusivityResponse {
        #[doc = "The validation result. * `OK` means that exclusivity is validated, assuming the manifest produced by GenerateExclusivityManifest is successfully applied. * `ALREADY_EXISTS` means that the Membership CRD is already owned by another Hub. See `status.message` for more information."]
        #[serde(
            rename = "status",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for ValidateExclusivityResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ValidateExclusivityResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
        ...
        pub mod locations {
            ...
            pub mod memberships {
                ...
                impl<'a> MembershipsActions<'a> {
                    ...
                    pub fn generate_connect_manifest(
                        ...
                        GenerateConnectManifestRequestBuilder {
                            ...
                            connect_agent_namespace: None,
                            connect_agent_proxy: None,
                    ...
                    #[doc = "ValidateExclusivity validates the state of exclusivity in the cluster. The validation does not depend on an existing Hub membership resource."]
                    pub fn validate_exclusivity(
                        &self,
                        parent: impl Into<String>,
                    ) -> ValidateExclusivityRequestBuilder {
                        ValidateExclusivityRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                            access_token: None,
                ...
                pub struct GenerateConnectManifestRequestBuilder<'a> {
                    ...
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    name: String,
                    connect_agent_name: ::std::option::Option<String>,
                    connect_agent_namespace: ::std::option::Option<String>,
                    connect_agent_proxy: ::std::option::Option<::google_api_bytes::Bytes>,
                ...
                impl<'a> GenerateConnectManifestRequestBuilder<'a> {
                    #[doc = "Do not set."]
                    pub fn connect_agent_name(mut self, value: impl Into<String>) -> Self {
                        self.connect_agent_name = Some(value.into());
                        self
                    }
                    ...
                    pub fn connect_agent_namespace(mut self, value: impl Into<String>) -> Self {
                        self.connect_agent_namespace = Some(value.into());
                        self
                    }
                    ...
                    pub fn connect_agent_proxy(mut self, value: impl Into<Vec<u8>>) -> Self {
                        let v: Vec<u8> = value.into();
                        self.connect_agent_proxy = Some(v.into());
                        self
                    }
                    ...
                    async fn _request(
                        ...
                        let mut req = self.reqwest.request(::reqwest::Method::GET, path);
                        req = req.query(&[("connectAgent.name", &self.connect_agent_name)]);
                        req =
                            req.query(&[("connectAgent.namespace", &self.connect_agent_namespace)]);
                        req = req.query(&[("connectAgent.proxy", &self.connect_agent_proxy)]);
                        req = req
                ...
                #[doc = "Created via [MembershipsActions::generate_exclusivity_manifest()](struct.MembershipsActions.html#method.generate_exclusivity_manifest)"]
                #[derive(Debug, Clone)]
                pub struct GenerateExclusivityManifestRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    name: String,
                    cr_manifest: ::std::option::Option<String>,
                    crd_manifest: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> GenerateExclusivityManifestRequestBuilder<'a> {
                    #[doc = "Optional. The YAML manifest of the membership CR retrieved by `kubectl get memberships membership`. Leave empty if the resource does not exist."]
                    pub fn cr_manifest(mut self, value: impl Into<String>) -> Self {
                        self.cr_manifest = Some(value.into());
                        self
                    }
                    #[doc = "Optional. The YAML manifest of the membership CRD retrieved by `kubectl get customresourcedefinitions membership`. Leave empty if the resource does not exist."]
                    pub fn crd_manifest(mut self, value: impl Into<String>) -> Self {
                        self.crd_manifest = Some(value.into());
                        self
                    }
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::GenerateExclusivityManifestResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str(":generateExclusivityManifest");
                        output
                    }
                    async fn _request(
                        &self,
                        ...
                        let mut req = self.reqwest.request(::reqwest::Method::GET, path);
                        req = req.query(&[("crManifest", &self.cr_manifest)]);
                        req = req.query(&[("crdManifest", &self.crd_manifest)]);
                        req = req.query(&[("access_token", &self.access_token)]);
                        req = req.query(&[("alt", &self.alt)]);
                        req = req.query(&[("callback", &self.callback)]);
                        req = req.query(&[("fields", &self.fields)]);
                ...
                impl<'a> PatchRequestBuilder<'a> {
                    ...
                    #[doc = "Required. Mask of fields to update. At least one field path must be specified in this mask."]
                ...
                #[doc = "Created via [MembershipsActions::validate_exclusivity()](struct.MembershipsActions.html#method.validate_exclusivity)"]
                #[derive(Debug, Clone)]
                pub struct ValidateExclusivityRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    parent: String,
                    cr_manifest: ::std::option::Option<String>,
                    intended_membership: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> ValidateExclusivityRequestBuilder<'a> {
                    #[doc = "Optional. The YAML of the membership CR in the cluster. Empty if the membership CR does not exist."]
                    pub fn cr_manifest(mut self, value: impl Into<String>) -> Self {
                        self.cr_manifest = Some(value.into());
                        self
                    }
                    #[doc = "Required. The intended membership name under the `parent`. This method only does validation in anticipation of a CreateMembership call with the same name."]
                    pub fn intended_membership(mut self, value: impl Into<String>) -> Self {
                        self.intended_membership = Some(value.into());
                        self
                    }
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ValidateExclusivityResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str("/memberships:validateExclusivity");
                        output
                    }
                    async fn _request(
                        &self,
                        ...
                        let mut req = self.reqwest.request(::reqwest::Method::GET, path);
                        req = req.query(&[("crManifest", &self.cr_manifest)]);
                        req = req.query(&[("intendedMembership", &self.intended_membership)]);
                        req = req.query(&[("access_token", &self.access_token)]);
                        req = req.query(&[("alt", &self.alt)]);
                        req = req.query(&[("callback", &self.callback)]);
                        req = req.query(&[("fields", &self.fields)]);
