        ...
        pub mod locations {
            ...
            pub mod memberships {
                ...
                pub struct GenerateConnectManifestRequestBuilder<'a> {
                    ...
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    name: String,
                    connect_agent_name: Option<String>,
                    connect_agent_namespace: Option<String>,
                    connect_agent_proxy: Option<::google_api_bytes::Bytes>,
                ...
                pub struct GenerateExclusivityManifestRequestBuilder<'a> {
                    ...
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    name: String,
                    cr_manifest: Option<String>,
                    crd_manifest: Option<String>,
                    access_token: Option<String>,
                    alt: Option<crate::params::Alt>,
                    callback: Option<String>,
                    fields: Option<String>,
                ...
                pub struct ValidateExclusivityRequestBuilder<'a> {
                    ...
                    parent: String,
                    cr_manifest: Option<String>,
                    intended_membership: Option<String>,
                    access_token: Option<String>,
                    alt: Option<crate::params::Alt>,
                    callback: Option<String>,
                    fields: Option<String>,
