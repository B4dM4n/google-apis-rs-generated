...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        let mut node_pools3 = SubCommand::with_name("node_pools")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: complete_upgrade, create, delete, get, list, rollback, set_autoscaling, set_management, set_size and update");
        {
            let mcmd = SubCommand::with_name("complete_upgrade").about(
