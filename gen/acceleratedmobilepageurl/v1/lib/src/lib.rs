...
pub mod schemas {
    ...
    impl ::google_field_selector::ToFieldType for AmpUrl {
    ...
    impl ::google_field_selector::ToFieldType for AmpUrlError {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl AmpUrlErrorErrorCode {
        pub fn as_str(self) -> &'static str {
            match self {
                AmpUrlErrorErrorCode::ApplicationError => "APPLICATION_ERROR",
                AmpUrlErrorErrorCode::ErrorCodeUnspecified => "ERROR_CODE_UNSPECIFIED",
                AmpUrlErrorErrorCode::InputUrlNotFound => "INPUT_URL_NOT_FOUND",
                AmpUrlErrorErrorCode::NoAmpUrl => "NO_AMP_URL",
    ...
    impl ::serde::Serialize for AmpUrlErrorErrorCode {
    ...
    impl<'de> ::serde::Deserialize<'de> for AmpUrlErrorErrorCode {
    ...
    impl ::google_field_selector::FieldSelector for AmpUrlErrorErrorCode {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AmpUrlErrorErrorCode {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for BatchGetAmpUrlsRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::serde::Serialize for BatchGetAmpUrlsRequestLookupStrategy {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for BatchGetAmpUrlsRequestLookupStrategy {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for BatchGetAmpUrlsRequestLookupStrategy {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BatchGetAmpUrlsRequestLookupStrategy {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for BatchGetAmpUrlsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
impl Client {
    ...
    #[doc = "Actions that can be performed on the amp_urls resource"]
    pub fn amp_urls(&self) -> crate::resources::amp_urls::AmpUrlsActions {
        crate::resources::amp_urls::AmpUrlsActions {
...
pub mod resources {
    pub mod amp_urls {
        pub mod params {}
        pub struct AmpUrlsActions<'a> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
        }
        impl<'a> AmpUrlsActions<'a> {
            fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                self.auth
            }
        ...
        impl<'a> BatchGetRequestBuilder<'a> {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::BatchGetAmpUrlsResponse, crate::Error> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://acceleratedmobilepageurl.googleapis.com/".to_owned();
