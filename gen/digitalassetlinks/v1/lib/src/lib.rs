...
pub mod schemas {
    ...
    pub struct BulkCheckRequest {
        ...
        #[doc = "List of statements to check. For each statement, you can omit a field if the corresponding default\\_\\* field below was supplied. Minimum 1 statement; maximum 1,000 statements. Any additional statements will be ignored."]
        #[serde(
            rename = "statements",
            default,
            skip_serializing_if = "std::option::Option::is_none"
...
pub mod resources {
    pub mod assetlinks {
        ...
        pub struct CheckRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            relation: ::std::option::Option<String>,
            source_android_app_certificate_sha_256_fingerprint: ::std::option::Option<String>,
            source_android_app_package_name: ::std::option::Option<String>,
            source_web_site: ::std::option::Option<String>,
            target_android_app_certificate_sha_256_fingerprint: ::std::option::Option<String>,
            target_android_app_package_name: ::std::option::Option<String>,
            target_web_site: ::std::option::Option<String>,
            access_token: ::std::option::Option<String>,
            alt: ::std::option::Option<crate::params::Alt>,
            callback: ::std::option::Option<String>,
            fields: ::std::option::Option<String>,
