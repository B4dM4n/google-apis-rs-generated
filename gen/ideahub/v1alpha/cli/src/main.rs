...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("ideahub1_alpha")
        ...
        app = app.subcommand(ideas0);

        Self { app }
    }
}
use google_ideahub1_alpha as api;
