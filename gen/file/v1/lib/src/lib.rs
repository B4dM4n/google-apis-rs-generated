...
pub mod schemas {
    ...
    pub struct Backup {
        ...
        #[doc = "The resource name of the source Filestore instance, in the format `projects/{project_number}/locations/{location_id}/instances/{instance_id}`, used to create this backup."]
        #[serde(
    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            pub mod instances {
                ...
                impl<'a> DeleteRequestBuilder<'a> {
                    #[doc = "If set to true, all snapshots of the instance will also be deleted. (Otherwise, the request will only work if the instance has no snapshots.)"]
