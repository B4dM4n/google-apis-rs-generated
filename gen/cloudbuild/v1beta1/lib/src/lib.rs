...
pub mod schemas {
    ...
    pub struct WorkerConfig {
        #[doc = "Size of the disk attached to the worker, in GB. See [Worker pool config file](https://cloud.google.com/cloud-build/docs/custom-workers/worker-pool-config-file). Specify a value of up to 1000. If `0` is specified, Cloud Build will use a standard disk size."]
        #[serde(
            rename = "diskSizeGb",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[serde(with = "crate::parsed_string")]
        pub disk_size_gb: ::std::option::Option<i64>,
        #[doc = "Machine type of a worker, such as `n1-standard-1`. See [Worker pool config file](https://cloud.google.com/cloud-build/docs/custom-workers/worker-pool-config-file). If left blank, Cloud Build will use `n1-standard-1`."]
        #[serde(
            rename = "machineType",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "If true, workers are created without any public address, which prevents network egress to public IPs."]
        #[serde(
            rename = "noExternalIp",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub no_external_ip: ::std::option::Option<bool>,
    }
        ...
        pub mod locations {
            ...
            pub mod worker_pools {
                ...
                impl<'a> WorkerPoolsActions<'a> {
                    ...
                    #[doc = "Creates a `WorkerPool` to run the builds, and returns the new worker pool. NOTE: As of now, this method returns an `Operation` that is always complete."]
                    pub fn create(
                        &self,
                    ...
                    #[doc = "Deletes a `WorkerPool`. NOTE: As of now, this method returns an `Operation` that is always complete."]
                    ...
                    #[doc = "Lists `WorkerPool`s in the given project."]
                    ...
                    #[doc = "Updates a `WorkerPool`. NOTE: As of now, this method returns an `Operation` that is always complete."]
                    pub fn patch(
                        &self,
                        request: crate::schemas::WorkerPool,
                        name: impl Into<String>,
                ...
                impl<'a> DeleteRequestBuilder<'a> {
                    #[doc = "Optional. If this is provided, it must match the server's etag on the workerpool for the request to be processed."]
                ...
                impl<'a> PatchRequestBuilder<'a> {
                    #[doc = "A mask specifying which fields in `WorkerPool` to update."]
