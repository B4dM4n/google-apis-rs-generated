...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        let mut addresses0 = SubCommand::with_name("addresses")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, insert, list, r#move, set_labels and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("aggregated_list")
        ...
        {
            let mcmd =
                SubCommand::with_name("r#move").about("Moves the specified address resource.");
            addresses0 = addresses0.subcommand(mcmd);
        }
        {
        ...
        let mut backend_buckets0 = SubCommand::with_name("backend_buckets")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_signed_url_key, delete, delete_signed_url_key, get, get_iam_policy, insert, list, patch, set_edge_security_policy, set_iam_policy, test_iam_permissions and update");
        {
        ...
        let mut backend_services0 = SubCommand::with_name("backend_services")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_signed_url_key, aggregated_list, delete, delete_signed_url_key, get, get_health, get_iam_policy, insert, list, patch, set_edge_security_policy, set_iam_policy, set_security_policy, test_iam_permissions and update");
        {
            let mcmd = SubCommand::with_name("add_signed_url_key").about(
        ...
        {
            let mcmd = SubCommand::with_name("set_security_policy").about("Sets the Google Cloud Armor security policy for the specified backend service. For more information, see Google Cloud Armor Overview");
            backend_services0 = backend_services0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        {
            let mcmd = SubCommand::with_name("update").about("Updates the specified BackendService resource with the data included in the request. For more information, see Backend services overview.");
            backend_services0 = backend_services0.subcommand(mcmd);
        }
        ...
        let mut disks0 = SubCommand::with_name("disks")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_resource_policies, aggregated_list, bulk_insert, create_snapshot, delete, get, get_iam_policy, insert, list, remove_resource_policies, resize, set_iam_policy, set_labels, start_async_replication, stop_async_replication, stop_group_async_replication, test_iam_permissions and update");
        {
        ...
        {
            let mcmd = SubCommand::with_name("bulk_insert").about("Bulk create a set of disks.");
            disks0 = disks0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("start_async_replication")
                .about("Starts asynchronous replication. Must be invoked on the primary disk.");
            disks0 = disks0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("stop_async_replication").about("Stops asynchronous replication. Can be invoked either on the primary or on the secondary disk.");
            disks0 = disks0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("stop_group_async_replication").about("Stops asynchronous replication for a consistency group of disks. Can be invoked either in the primary or secondary scope.");
            disks0 = disks0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        {
            let mcmd = SubCommand::with_name("update").about("Updates the specified disk with the data included in the request. The update is performed only on selected fields included as part of update-mask. Only the following fields can be modified: user_license.");
            disks0 = disks0.subcommand(mcmd);
        }
        ...
        let mut firewall_policies0 = SubCommand::with_name("firewall_policies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_association, add_rule, clone_rules, delete, get, get_association, get_iam_policy, get_rule, insert, list, list_associations, r#move, patch, patch_rule, remove_association, remove_rule, set_iam_policy and test_iam_permissions");
        {
        ...
        {
            let mcmd = SubCommand::with_name("get").about("Returns the specified firewall policy.");
            firewall_policies0 = firewall_policies0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd =
                SubCommand::with_name("r#move").about("Moves the specified firewall policy.");
            firewall_policies0 = firewall_policies0.subcommand(mcmd);
        }
        {
        ...
        let mut future_reservations0 = SubCommand::with_name("future_reservations")
            .setting(AppSettings::ColoredHelp)
            .about("methods: aggregated_list, cancel, delete, get, insert, list and update");
        {
            let mcmd = SubCommand::with_name("aggregated_list")
                .about("Retrieves an aggregated list of future reservations.");
            future_reservations0 = future_reservations0.subcommand(mcmd);
        }
        {
            let mcmd =
                SubCommand::with_name("cancel").about("Cancel the specified future reservation.");
            future_reservations0 = future_reservations0.subcommand(mcmd);
        }
        {
            let mcmd =
                SubCommand::with_name("delete").about("Deletes the specified future reservation.");
            future_reservations0 = future_reservations0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
                .about("Retrieves information about the specified future reservation.");
            future_reservations0 = future_reservations0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("insert").about("Creates a new Future Reservation.");
            future_reservations0 = future_reservations0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("A list of all the future reservations that have been configured for the specified project in specified zone.");
            future_reservations0 = future_reservations0.subcommand(mcmd);
        }
        {
            let mcmd =
                SubCommand::with_name("update").about("Updates the specified future reservation.");
            future_reservations0 = future_reservations0.subcommand(mcmd);
        }
        let mut global_addresses0 = SubCommand::with_name("global_addresses")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, get_owner_instance, insert, list, r#move, set_labels and test_iam_permissions");
        {
            let mcmd =
                SubCommand::with_name("delete").about("Deletes the specified address resource.");
        ...
        }
        {
            let mcmd = SubCommand::with_name("r#move")
                .about("Moves the specified address resource from one project to another project.");
            global_addresses0 = global_addresses0.subcommand(mcmd);
        }
        {
        ...
        let mut instance_group_manager_resize_requests0 =
            SubCommand::with_name("instance_group_manager_resize_requests")
                .setting(AppSettings::ColoredHelp)
                .about("methods: delete, get, insert and list");
        {
            let mcmd =
                SubCommand::with_name("delete").about("Deletes the specified resize request.");
            instance_group_manager_resize_requests0 =
                instance_group_manager_resize_requests0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
                .about("Returns all of the details about the specified resize request.");
            instance_group_manager_resize_requests0 =
                instance_group_manager_resize_requests0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("insert").about("Creates a new resize request that starts provisioning VMs immediately or queues VM creation.");
            instance_group_manager_resize_requests0 =
                instance_group_manager_resize_requests0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Retrieves a list of resize requests that are contained in the managed instance group.");
            instance_group_manager_resize_requests0 =
                instance_group_manager_resize_requests0.subcommand(mcmd);
        }
        let mut instance_group_managers0 = SubCommand::with_name("instance_group_managers")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: abandon_instances, aggregated_list, apply_updates_to_instances, create_instances, delete, delete_instances, delete_per_instance_configs, get, insert, list, list_errors, list_managed_instances, list_per_instance_configs, patch, patch_per_instance_configs, recreate_instances, resize, resize_advanced, resume_instances, set_auto_healing_policies, set_instance_template, set_target_pools, start_instances, stop_instances, suspend_instances, test_iam_permissions, update and update_per_instance_configs");
        {
        ...
        {
            let mcmd = SubCommand::with_name("list_errors").about("Lists all errors thrown by actions on instances for a given managed instance group. The filter and orderBy query parameters are not supported.");
            instance_group_managers0 = instance_group_managers0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("resize_advanced").about("Resizes the managed instance group with advanced configuration options like disabling creation retries. This is an extended version of the resize method. If you increase the size of the instance group, the group creates new instances using the current instance template. If you decrease the size, the group deletes instances. The resize operation is marked DONE when the resize actions are scheduled even if the group has not yet added or deleted any instances. You must separately verify the status of the creating, creatingWithoutRetries, or deleting actions with the get or listmanagedinstances method. If the group is part of a backend service that has enabled connection draining, it can take up to 60 seconds after the connection draining duration has elapsed before the VM instance is removed or deleted.");
            instance_group_managers0 = instance_group_managers0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("resume_instances").about("Flags the specified instances in the managed instance group to be resumed. This method increases the targetSize and decreases the targetSuspendedSize of the managed instance group by the number of instances that you resume. The resumeInstances operation is marked DONE if the resumeInstances request is successful. The underlying actions take additional time. You must separately verify the status of the RESUMING action with the listmanagedinstances method. In this request, you can only specify instances that are suspended. For example, if an instance was previously suspended using the suspendInstances method, it can be resumed using the resumeInstances method. If a health check is attached to the managed instance group, the specified instances will be verified as healthy after they are resumed. You can specify a maximum of 1000 instances with this method per request.");
            instance_group_managers0 = instance_group_managers0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_auto_healing_policies").about("Motifies the autohealing policy for the instances in this managed instance group. [Deprecated] This method is deprecated. Use instanceGroupManagers.patch instead.");
            instance_group_managers0 = instance_group_managers0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("list_instances").about("Lists the instances in the specified instance group. The orderBy query parameter is not supported. The filter query parameter is supported, but only for expressions that use `eq` (equal) or `ne` (not equal) operators.");
            instance_groups0 = instance_groups0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("aggregated_list").about("Retrieves the list of all InstanceTemplates resources, regional and global, available to the specified project.");
        ...
        {
            let mcmd = SubCommand::with_name("bulk_insert").about("Creates multiple instances. Count specifies the number of instances to create. For more information, see About bulk creation of VMs.");
            instances0 = instances0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("perform_maintenance")
                .about("Perform a manual maintenance on the instance.");
            instances0 = instances0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("remove_resource_policies")
        ...
        let mut instant_snapshots0 = SubCommand::with_name("instant_snapshots")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, export, get, get_iam_policy, insert, list, set_iam_policy, set_labels and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("aggregated_list")
                .about("Retrieves an aggregated list of instantSnapshots.");
            instant_snapshots0 = instant_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes the specified InstantSnapshot resource. Keep in mind that deleting a single instantSnapshot might not necessarily delete all the data on that instantSnapshot. If any data on the instantSnapshot that is marked for deletion is needed for subsequent instantSnapshots, the data will be moved to the next corresponding instantSnapshot. For more information, see Deleting instantSnapshots.");
            instant_snapshots0 = instant_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("export").about("Export the changed blocks between two instant snapshots to a customer's bucket in the user specified format.");
            instant_snapshots0 = instant_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
                .about("Returns the specified InstantSnapshot resource in the specified zone.");
            instant_snapshots0 = instant_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get_iam_policy").about("Gets the access control policy for a resource. May be empty if no such policy or resource exists.");
        ...
        }
        {
            let mcmd = SubCommand::with_name("insert")
                .about("Creates an instant snapshot in the specified zone.");
            instant_snapshots0 = instant_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Retrieves the list of InstantSnapshot resources contained within the specified zone.");
            instant_snapshots0 = instant_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy.");
        ...
        {
            let mcmd = SubCommand::with_name("set_labels").about("Sets the labels on a instantSnapshot in the given zone. To learn more about labels, read the Labeling Resources documentation.");
            instant_snapshots0 = instant_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        let mut interconnect_remote_locations0 =
            SubCommand::with_name("interconnect_remote_locations")
                .setting(AppSettings::ColoredHelp)
                .about("methods: get, list and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("get").about("Returns the details for the specified interconnect remote location. Gets a list of available interconnect remote locations by making a list() request.");
            interconnect_remote_locations0 = interconnect_remote_locations0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Retrieves the list of interconnect remote locations available to the specified project.");
            interconnect_remote_locations0 = interconnect_remote_locations0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        let mut interconnects0 = SubCommand::with_name("interconnects")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, get_diagnostics, get_iam_policy, get_macsec_config, insert, list, patch, set_iam_policy, set_labels and test_iam_permissions");
        {
        ...
        {
            let mcmd = SubCommand::with_name("get_macsec_config")
                .about("Returns the interconnectMacsecConfig for the specified Interconnect.");
            interconnects0 = interconnects0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("insert").about("Creates an Interconnect in the specified project using the data included in the request.");
            interconnects0 = interconnects0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list")
                .about("Retrieves the list of Interconnects available to the specified project.");
            interconnects0 = interconnects0.subcommand(mcmd);
        }
        {
        ...
        let mut network_attachments0 = SubCommand::with_name("network_attachments")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, get_iam_policy, insert, list, set_iam_policy and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("aggregated_list").about("Retrieves the list of all NetworkAttachment resources, regional and global, available to the specified project.");
            network_attachments0 = network_attachments0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("delete")
                .about("Deletes the specified NetworkAttachment in the given scope");
            network_attachments0 = network_attachments0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
                .about("Returns the specified NetworkAttachment resource in the given scope.");
            network_attachments0 = network_attachments0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get_iam_policy").about("Gets the access control policy for a resource. May be empty if no such policy or resource exists.");
        ...
        {
            let mcmd = SubCommand::with_name("insert").about("Creates a NetworkAttachment in the specified project in the given scope using the parameters that are included in the request.");
            network_attachments0 = network_attachments0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list")
                .about("Lists the NetworkAttachments for a project in the given scope.");
            network_attachments0 = network_attachments0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy.");
        ...
        let mut node_groups0 = SubCommand::with_name("node_groups")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_nodes, aggregated_list, delete, delete_nodes, get, get_iam_policy, insert, list, list_nodes, patch, set_iam_policy, set_node_template, simulate_maintenance_event and test_iam_permissions");
        {
        ...
        }
        {
            let mcmd = SubCommand::with_name("simulate_maintenance_event")
                .about("Simulates maintenance event on specified nodes from the node group.");
            node_groups0 = node_groups0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        let mut public_advertised_prefixes0 = SubCommand::with_name("public_advertised_prefixes")
            .setting(AppSettings::ColoredHelp)
            .about("methods: announce, delete, get, insert, list, patch and withdraw");
        {
            let mcmd = SubCommand::with_name("announce")
                .about("Announces the specified PublicAdvertisedPrefix");
        ...
        {
            let mcmd = SubCommand::with_name("withdraw")
                .about("Withdraws the specified PublicAdvertisedPrefix");
            public_advertised_prefixes0 = public_advertised_prefixes0.subcommand(mcmd);
        }
        let mut public_delegated_prefixes0 = SubCommand::with_name("public_delegated_prefixes")
            .setting(AppSettings::ColoredHelp)
            .about(
                "methods: aggregated_list, announce, delete, get, insert, list, patch and withdraw",
            );
        {
        ...
        {
            let mcmd = SubCommand::with_name("announce")
                .about("Announces the specified PublicDelegatedPrefix in the given region.");
            public_delegated_prefixes0 = public_delegated_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("delete")
        ...
        {
            let mcmd = SubCommand::with_name("withdraw")
                .about("Withdraws the specified PublicDelegatedPrefix in the given region.");
            public_delegated_prefixes0 = public_delegated_prefixes0.subcommand(mcmd);
        }
        ...
        let mut region_backend_services0 = SubCommand::with_name("region_backend_services")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, get_health, get_iam_policy, insert, list, patch, set_iam_policy, set_security_policy, test_iam_permissions and update");
        {
            let mcmd = SubCommand::with_name("delete")
        ...
        let mut region_commitments0 = SubCommand::with_name("region_commitments")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, get, insert, list, test_iam_permissions, update and update_reservations");
        {
            let mcmd = SubCommand::with_name("aggregated_list")
        ...
        let mut region_disks0 = SubCommand::with_name("region_disks")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_resource_policies, bulk_insert, create_snapshot, delete, get, get_iam_policy, insert, list, remove_resource_policies, resize, set_iam_policy, set_labels, start_async_replication, stop_async_replication, stop_group_async_replication, test_iam_permissions and update");
        {
        ...
        {
            let mcmd = SubCommand::with_name("update").about("Update the specified disk with the data included in the request. Update is performed only on selected fields included as part of update-mask. Only the following fields can be modified: user_license.");
            region_disks0 = region_disks0.subcommand(mcmd);
        }
        let mut region_health_check_services0 = SubCommand::with_name(
            "region_health_check_services",
        )
        .setting(AppSettings::ColoredHelp)
        .about(
            "methods: aggregated_list, delete, get, insert, list, patch and test_iam_permissions",
        );
        {
            let mcmd = SubCommand::with_name("aggregated_list").about("Retrieves the list of all HealthCheckService resources, regional and global, available to the specified project.");
        ...
        {
            let mcmd = SubCommand::with_name("list_errors").about("Lists all errors thrown by actions on instances for a given regional managed instance group. The filter and orderBy query parameters are not supported.");
            region_instance_group_managers0 = region_instance_group_managers0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list_managed_instances").about("Lists the instances in the managed instance group and instances that are scheduled to be created. The list includes any current actions that the group has scheduled for its instances. The orderBy query parameter is not supported. The `pageToken` query parameter is supported only in the alpha and beta API and only if the group's `listManagedInstancesResults` field is set to `PAGINATED`.");
            region_instance_group_managers0 = region_instance_group_managers0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list_per_instance_configs").about("Lists all of the per-instance configurations defined for the managed instance group. The orderBy query parameter is not supported.");
        ...
        {
            let mcmd = SubCommand::with_name("set_auto_healing_policies").about("Modifies the autohealing policy for the instances in this managed instance group. [Deprecated] This method is deprecated. Use regionInstanceGroupManagers.patch instead.");
            region_instance_group_managers0 = region_instance_group_managers0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("list_instances").about("Lists the instances in the specified instance group and displays information about the named ports. Depending on the specified options, this method can list all instances or only the instances that are running. The orderBy query parameter is not supported.");
            region_instance_groups0 = region_instance_groups0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_named_ports")
        ...
        let mut region_instance_templates0 = SubCommand::with_name("region_instance_templates")
            .setting(AppSettings::ColoredHelp)
            .about("methods: delete, get, insert and list");
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes the specified instance template. Deleting an instance template is permanent and cannot be undone.");
            region_instance_templates0 = region_instance_templates0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get").about("Returns the specified instance template. Gets a list of available instance templates by making a list() request.");
            region_instance_templates0 = region_instance_templates0.subcommand(mcmd);
        ...
        {
            let mcmd = SubCommand::with_name("insert").about("Creates an instance template in the specified project and region using the global instance template whose URL is included in the request.");
            region_instance_templates0 = region_instance_templates0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Retrieves a list of instance templates that are contained within the specified project and region.");
            region_instance_templates0 = region_instance_templates0.subcommand(mcmd);
        }
        ...
        let mut region_instant_snapshots0 = SubCommand::with_name("region_instant_snapshots")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, export, get, get_iam_policy, insert, list, set_iam_policy, set_labels and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes the specified InstantSnapshot resource. Keep in mind that deleting a single instantSnapshot might not necessarily delete all the data on that instantSnapshot. If any data on the instantSnapshot that is marked for deletion is needed for subsequent instantSnapshots, the data will be moved to the next corresponding instantSnapshot. For more information, see Deleting instantSnapshots.");
            region_instant_snapshots0 = region_instant_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("export").about("Export the changed blocks between two instant snapshots to a customer's bucket in the user specified format.");
            region_instant_snapshots0 = region_instant_snapshots0.subcommand(mcmd);
        ...
        {
            let mcmd = SubCommand::with_name("get")
                .about("Returns the specified InstantSnapshot resource in the specified region.");
            region_instant_snapshots0 = region_instant_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get_iam_policy").about("Gets the access control policy for a resource. May be empty if no such policy or resource exists.");
        ...
        {
            let mcmd = SubCommand::with_name("insert")
                .about("Creates an instant snapshot in the specified region.");
            region_instant_snapshots0 = region_instant_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Retrieves the list of InstantSnapshot resources contained within the specified region.");
            region_instant_snapshots0 = region_instant_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy.");
        ...
        {
            let mcmd = SubCommand::with_name("set_labels").about("Sets the labels on a instantSnapshot in the given region. To learn more about labels, read the Labeling Resources documentation.");
            region_instant_snapshots0 = region_instant_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        let mut region_network_endpoint_groups0 = SubCommand::with_name("region_network_endpoint_groups")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: attach_network_endpoints, delete, detach_network_endpoints, get, insert, list and list_network_endpoints");
        {
            let mcmd = SubCommand::with_name("attach_network_endpoints").about(
        ...
        let mut region_notification_endpoints0 =
            SubCommand::with_name("region_notification_endpoints")
                .setting(AppSettings::ColoredHelp)
                .about(
                    "methods: aggregated_list, delete, get, insert, list and test_iam_permissions",
                );
        {
            let mcmd = SubCommand::with_name("aggregated_list").about("Retrieves the list of all NotificationEndpoint resources, regional and global, available to the specified project.");
        ...
        let mut region_security_policies0 = SubCommand::with_name("region_security_policies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_rule, delete, get, get_rule, insert, list, patch, patch_rule and remove_rule");
        {
            let mcmd =
                SubCommand::with_name("add_rule").about("Inserts a rule into a security policy.");
        ...
        {
            let mcmd = SubCommand::with_name("patch").about("Patches the specified policy with the data included in the request. To clear fields in the rule, leave the fields empty and specify them in the updateMask. This cannot be used to be update the rules in the policy. Please use the per rule methods like addRule, patchRule, and removeRule instead.");
            region_security_policies0 = region_security_policies0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("patch_rule").about("Patches a rule at the specified priority. To clear fields in the rule, leave the fields empty and specify them in the updateMask.");
            region_security_policies0 = region_security_policies0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("remove_rule")
        ...
        let mut region_ssl_policies0 = SubCommand::with_name("region_ssl_policies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, insert, list, list_available_features, patch and test_iam_permissions");
        {
            ...
            region_ssl_policies0 = region_ssl_policies0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
        ...
        {
            let mcmd = SubCommand::with_name("insert").about("Creates a new policy in the specified project and region using the data included in the request.");
            region_ssl_policies0 = region_ssl_policies0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Lists all the SSL policies that have been configured for the specified project and region.");
            region_ssl_policies0 = region_ssl_policies0.subcommand(mcmd);
        }
        {
        ...
        let mut region_target_https_proxies0 = SubCommand::with_name("region_target_https_proxies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, insert, list, patch, set_ssl_certificates, set_url_map and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("delete")
        ...
        let mut region_target_tcp_proxies0 = SubCommand::with_name("region_target_tcp_proxies")
            .setting(AppSettings::ColoredHelp)
            .about("methods: delete, get, insert, list and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("delete")
                .about("Deletes the specified TargetTcpProxy resource.");
            region_target_tcp_proxies0 = region_target_tcp_proxies0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
                .about("Returns the specified TargetTcpProxy resource.");
            region_target_tcp_proxies0 = region_target_tcp_proxies0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("insert").about("Creates a TargetTcpProxy resource in the specified project and region using the data included in the request.");
            region_target_tcp_proxies0 = region_target_tcp_proxies0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Retrieves a list of TargetTcpProxy resources available to the specified project in a given region.");
            region_target_tcp_proxies0 = region_target_tcp_proxies0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        {
            let mcmd =
                SubCommand::with_name("patch").about("Modify the specified resource policy.");
            resource_policies0 = resource_policies0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy.");
        ...
        let mut security_policies0 = SubCommand::with_name("security_policies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_rule, aggregated_list, delete, get, get_rule, insert, list, list_preconfigured_expression_sets, patch, patch_rule, remove_rule, set_labels and test_iam_permissions");
        {
            let mcmd =
                SubCommand::with_name("add_rule").about("Inserts a rule into a security policy.");
        ...
        let mut ssl_policies0 = SubCommand::with_name("ssl_policies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, insert, list, list_available_features, patch and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("aggregated_list").about("Retrieves the list of all SslPolicy resources, regional and global, available to the specified project.");
        ...
        {
            let mcmd = SubCommand::with_name("list_usable")
                .about("Retrieves an aggregated list of all usable subnetworks in the project.");
            subnetworks0 = subnetworks0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("patch").about("Patches the specified subnetwork with the data included in the request. Only certain fields can be updated with a patch request as indicated in the field descriptions. You must specify the current fingerprint of the subnetwork resource being patched.");
            subnetworks0 = subnetworks0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy.");
        ...
        let mut target_http_proxies0 = SubCommand::with_name("target_http_proxies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, insert, list, patch, set_url_map and test_iam_permissions");
        {
        ...
        let mut target_https_proxies0 = SubCommand::with_name("target_https_proxies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, insert, list, patch, set_certificate_map, set_quic_override, set_ssl_certificates, set_ssl_policy, set_url_map and test_iam_permissions");
        {
        ...
        let mut target_tcp_proxies0 = SubCommand::with_name("target_tcp_proxies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, insert, list, set_backend_service, set_proxy_header and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("aggregated_list").about("Retrieves the list of all TargetTcpProxy resources, regional and global, available to the specified project.");
        ...
        let mut zone_queued_resources0 = SubCommand::with_name("zone_queued_resources")
            .setting(AppSettings::ColoredHelp)
            .about("methods: aggregated_list, cancel, delete, get, insert and list");
        {
            let mcmd = SubCommand::with_name("aggregated_list").about("Retrieves an aggregated list of all of the queued resources in a project across all zones.");
            zone_queued_resources0 = zone_queued_resources0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes a QueuedResource. For a QueuedResource in ACCEPTED state, call cancel on the resource before deleting, to make sure no VMs have been provisioned and may require cleaning up. For a QueuedResource in PROVISIONING state the request to delete is registered for execution following the provisioning.");
            zone_queued_resources0 = zone_queued_resources0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
                .about("Returns the specified QueuedResource resource.");
            zone_queued_resources0 = zone_queued_resources0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("insert").about("Creates a QueuedResource.");
            zone_queued_resources0 = zone_queued_resources0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list")
                .about("Retrieves the list of QueuedResource resources.");
            zone_queued_resources0 = zone_queued_resources0.subcommand(mcmd);
        }
        ...
        app = app.subcommand(zone_queued_resources0);
        ...
        app = app.subcommand(region_instant_snapshots0);
        app = app.subcommand(region_instances0);
        app = app.subcommand(region_instance_templates0);
        ...
        app = app.subcommand(network_attachments0);
        ...
        app = app.subcommand(interconnect_remote_locations0);
        app = app.subcommand(interconnect_locations0);
        app = app.subcommand(interconnect_attachments0);
        app = app.subcommand(instant_snapshots0);
        ...
        app = app.subcommand(instance_group_manager_resize_requests0);
        ...
        app = app.subcommand(future_reservations0);
        app = app.subcommand(forwarding_rules0);
        app = app.subcommand(firewalls0);
        app = app.subcommand(firewall_policies0);
