...
pub mod schemas {
    ...
    pub struct CloudSqlConnectionProfile {
        ...
        pub cloud_sql_id: ::std::option::Option<String>,
        ...
        pub private_ip: ::std::option::Option<String>,
        ...
        pub public_ip: ::std::option::Option<String>,
        ...
        pub settings: ::std::option::Option<crate::schemas::CloudSqlSettings>,
    }
    impl ::google_field_selector::FieldSelector for CloudSqlConnectionProfile {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudSqlConnectionProfile {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct CloudSqlSettings {
        ...
        pub activation_policy:
            ::std::option::Option<crate::schemas::CloudSqlSettingsActivationPolicy>,
        ...
        pub data_disk_type: ::std::option::Option<crate::schemas::CloudSqlSettingsDataDiskType>,
        ...
        pub database_flags: ::std::option::Option<::std::collections::BTreeMap<String, String>>,
        ...
        pub database_version:
            ::std::option::Option<crate::schemas::CloudSqlSettingsDatabaseVersion>,
        ...
        pub ip_config: ::std::option::Option<crate::schemas::SqlIpConfig>,
        ...
        #[serde(
            rename = "rootPasswordSet",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub root_password_set: ::std::option::Option<bool>,
        ...
        pub source_id: ::std::option::Option<String>,
        ...
        #[doc = "The tier (or machine type) for this instance, for example: `db-n1-standard-1` (MySQL instances) or `db-custom-1-3840` (PostgreSQL instances). For more information, see [Cloud SQL Instance Settings](https://cloud.google.com/sql/docs/mysql/instance-settings)."]
        #[serde(
            rename = "tier",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for CloudSqlSettings {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudSqlSettings {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum CloudSqlSettingsActivationPolicy {
    ...
    impl CloudSqlSettingsActivationPolicy {
        pub fn as_str(self) -> &'static str {
            match self {
                CloudSqlSettingsActivationPolicy::Always => "ALWAYS",
                CloudSqlSettingsActivationPolicy::Never => "NEVER",
                CloudSqlSettingsActivationPolicy::SqlActivationPolicyUnspecified => {
                    "SQL_ACTIVATION_POLICY_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for CloudSqlSettingsActivationPolicy {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for CloudSqlSettingsActivationPolicy {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<CloudSqlSettingsActivationPolicy, ()> {
            Ok(match s {
                "ALWAYS" => CloudSqlSettingsActivationPolicy::Always,
                "NEVER" => CloudSqlSettingsActivationPolicy::Never,
                "SQL_ACTIVATION_POLICY_UNSPECIFIED" => {
                    CloudSqlSettingsActivationPolicy::SqlActivationPolicyUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for CloudSqlSettingsActivationPolicy {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for CloudSqlSettingsActivationPolicy {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for CloudSqlSettingsActivationPolicy {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for CloudSqlSettingsActivationPolicy {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudSqlSettingsActivationPolicy {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum CloudSqlSettingsDataDiskType {
        #[doc = "HDD disk."]
        PdHdd,
        #[doc = "SSD disk."]
        PdSsd,
    ...
    impl CloudSqlSettingsDataDiskType {
        pub fn as_str(self) -> &'static str {
            match self {
                CloudSqlSettingsDataDiskType::PdHdd => "PD_HDD",
                CloudSqlSettingsDataDiskType::PdSsd => "PD_SSD",
                CloudSqlSettingsDataDiskType::SqlDataDiskTypeUnspecified => {
                    "SQL_DATA_DISK_TYPE_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for CloudSqlSettingsDataDiskType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for CloudSqlSettingsDataDiskType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<CloudSqlSettingsDataDiskType, ()> {
            Ok(match s {
                "PD_HDD" => CloudSqlSettingsDataDiskType::PdHdd,
                "PD_SSD" => CloudSqlSettingsDataDiskType::PdSsd,
                "SQL_DATA_DISK_TYPE_UNSPECIFIED" => {
                    CloudSqlSettingsDataDiskType::SqlDataDiskTypeUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for CloudSqlSettingsDataDiskType {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for CloudSqlSettingsDataDiskType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for CloudSqlSettingsDataDiskType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for CloudSqlSettingsDataDiskType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudSqlSettingsDataDiskType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum CloudSqlSettingsDatabaseVersion {
        #[doc = "MySQL 5.6."]
        Mysql56,
        #[doc = "MySQL 5.7."]
        Mysql57,
    ...
    impl CloudSqlSettingsDatabaseVersion {
        pub fn as_str(self) -> &'static str {
            match self {
                CloudSqlSettingsDatabaseVersion::Mysql56 => "MYSQL_5_6",
                CloudSqlSettingsDatabaseVersion::Mysql57 => "MYSQL_5_7",
                CloudSqlSettingsDatabaseVersion::Mysql80 => "MYSQL_8_0",
                CloudSqlSettingsDatabaseVersion::Postgres10 => "POSTGRES_10",
    ...
    impl ::std::convert::AsRef<str> for CloudSqlSettingsDatabaseVersion {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for CloudSqlSettingsDatabaseVersion {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<CloudSqlSettingsDatabaseVersion, ()> {
            Ok(match s {
                "MYSQL_5_6" => CloudSqlSettingsDatabaseVersion::Mysql56,
                "MYSQL_5_7" => CloudSqlSettingsDatabaseVersion::Mysql57,
                "MYSQL_8_0" => CloudSqlSettingsDatabaseVersion::Mysql80,
                "POSTGRES_10" => CloudSqlSettingsDatabaseVersion::Postgres10,
    ...
    impl ::std::fmt::Display for CloudSqlSettingsDatabaseVersion {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for CloudSqlSettingsDatabaseVersion {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for CloudSqlSettingsDatabaseVersion {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for CloudSqlSettingsDatabaseVersion {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudSqlSettingsDatabaseVersion {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ConnectionProfile {
        ...
        pub cloudsql: ::std::option::Option<crate::schemas::CloudSqlConnectionProfile>,
        ...
        #[doc = "A PostgreSQL database connection profile."]
        #[serde(
            rename = "postgresql",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub postgresql: ::std::option::Option<crate::schemas::PostgreSqlConnectionProfile>,
        ...
        pub provider: ::std::option::Option<crate::schemas::ConnectionProfileProvider>,
        ...
        pub state: ::std::option::Option<crate::schemas::ConnectionProfileState>,
    ...
    impl ConnectionProfileProvider {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                ConnectionProfileProvider::Rds => "RDS",
            }
        }
    }
    impl ::std::convert::AsRef<str> for ConnectionProfileProvider {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for ConnectionProfileProvider {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<ConnectionProfileProvider, ()> {
            Ok(match s {
                ...
                "RDS" => ConnectionProfileProvider::Rds,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for ConnectionProfileProvider {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for ConnectionProfileProvider {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ConnectionProfileProvider {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ConnectionProfileProvider {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ConnectionProfileProvider {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum ConnectionProfileState {
    ...
    impl ConnectionProfileState {
        pub fn as_str(self) -> &'static str {
            match self {
                ConnectionProfileState::Creating => "CREATING",
                ConnectionProfileState::Deleted => "DELETED",
                ConnectionProfileState::Deleting => "DELETING",
                ConnectionProfileState::Draft => "DRAFT",
                ConnectionProfileState::Failed => "FAILED",
                ConnectionProfileState::Ready => "READY",
                ConnectionProfileState::StateUnspecified => "STATE_UNSPECIFIED",
                ConnectionProfileState::Updating => "UPDATING",
            }
        }
    }
    impl ::std::convert::AsRef<str> for ConnectionProfileState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for ConnectionProfileState {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<ConnectionProfileState, ()> {
            Ok(match s {
                "CREATING" => ConnectionProfileState::Creating,
                "DELETED" => ConnectionProfileState::Deleted,
                "DELETING" => ConnectionProfileState::Deleting,
                "DRAFT" => ConnectionProfileState::Draft,
                "FAILED" => ConnectionProfileState::Failed,
                "READY" => ConnectionProfileState::Ready,
                "STATE_UNSPECIFIED" => ConnectionProfileState::StateUnspecified,
                "UPDATING" => ConnectionProfileState::Updating,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for ConnectionProfileState {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for ConnectionProfileState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ConnectionProfileState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ConnectionProfileState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ConnectionProfileState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct DatabaseType {
        ...
        pub engine: ::std::option::Option<crate::schemas::DatabaseTypeEngine>,
        #[doc = "The database provider."]
        #[serde(
            rename = "provider",
            default,
        ...
        pub provider: ::std::option::Option<crate::schemas::DatabaseTypeProvider>,
    }
    impl ::google_field_selector::FieldSelector for DatabaseType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DatabaseType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum DatabaseTypeEngine {
        #[doc = "The source database engine of the migration job is unknown."]
        DatabaseEngineUnspecified,
        #[doc = "The source engine is MySQL."]
        Mysql,
        #[doc = "The source engine is PostgreSQL."]
        Postgresql,
    }
    impl DatabaseTypeEngine {
        pub fn as_str(self) -> &'static str {
            match self {
                DatabaseTypeEngine::DatabaseEngineUnspecified => "DATABASE_ENGINE_UNSPECIFIED",
                DatabaseTypeEngine::Mysql => "MYSQL",
                DatabaseTypeEngine::Postgresql => "POSTGRESQL",
            }
        }
    }
    impl ::std::convert::AsRef<str> for DatabaseTypeEngine {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for DatabaseTypeEngine {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<DatabaseTypeEngine, ()> {
            Ok(match s {
                "DATABASE_ENGINE_UNSPECIFIED" => DatabaseTypeEngine::DatabaseEngineUnspecified,
                "MYSQL" => DatabaseTypeEngine::Mysql,
                "POSTGRESQL" => DatabaseTypeEngine::Postgresql,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for DatabaseTypeEngine {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for DatabaseTypeEngine {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for DatabaseTypeEngine {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for DatabaseTypeEngine {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DatabaseTypeEngine {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl DatabaseTypeProvider {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                DatabaseTypeProvider::Rds => "RDS",
            }
        }
    }
    impl ::std::convert::AsRef<str> for DatabaseTypeProvider {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for DatabaseTypeProvider {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<DatabaseTypeProvider, ()> {
            Ok(match s {
                ...
                "RDS" => DatabaseTypeProvider::Rds,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for DatabaseTypeProvider {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for DatabaseTypeProvider {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for DatabaseTypeProvider {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for DatabaseTypeProvider {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    ...
    pub struct GenerateSshScriptRequest {
        ...
        pub vm: ::std::option::Option<String>,
        #[doc = "The VM creation configuration"]
        #[serde(
            rename = "vmCreationConfig",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub vm_creation_config: ::std::option::Option<crate::schemas::VmCreationConfig>,
        ...
        #[serde(
            rename = "vmSelectionConfig",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub vm_selection_config: ::std::option::Option<crate::schemas::VmSelectionConfig>,
    }
    impl ::google_field_selector::FieldSelector for GenerateSshScriptRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GenerateSshScriptRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudClouddmsV1OperationMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudClouddmsV1OperationMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ListMigrationJobsResponse {
        ...
        #[serde(
            rename = "migrationJobs",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub migration_jobs: ::std::option::Option<Vec<crate::schemas::MigrationJob>>,
        #[doc = "A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages."]
        #[serde(
            rename = "nextPageToken",
            default,
    ...
    impl ::google_field_selector::FieldSelector for ListMigrationJobsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListMigrationJobsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken for ListMigrationJobsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct MigrationJob {
        ...
        #[serde(
            rename = "destinationDatabase",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub destination_database: ::std::option::Option<crate::schemas::DatabaseType>,
        ...
        pub dump_path: ::std::option::Option<String>,
        ...
        pub phase: ::std::option::Option<crate::schemas::MigrationJobPhase>,
        ...
        pub r#type: ::std::option::Option<crate::schemas::MigrationJobType>,
        #[doc = "The details needed to communicate to the source over Reverse SSH tunnel connectivity."]
        #[serde(
            rename = "reverseSshConnectivity",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub reverse_ssh_connectivity: ::std::option::Option<crate::schemas::ReverseSshConnectivity>,
        ...
        pub source_database: ::std::option::Option<crate::schemas::DatabaseType>,
        ...
        pub state: ::std::option::Option<crate::schemas::MigrationJobState>,
        #[doc = "static ip connectivity data (default, no additional details needed)."]
        #[serde(
            rename = "staticIpConnectivity",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub static_ip_connectivity: ::std::option::Option<crate::schemas::StaticIpConnectivity>,
        ...
        #[serde(
            rename = "vpcPeeringConnectivity",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub vpc_peering_connectivity: ::std::option::Option<crate::schemas::VpcPeeringConnectivity>,
    }
    impl ::google_field_selector::FieldSelector for MigrationJob {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MigrationJob {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl MigrationJobPhase {
        pub fn as_str(self) -> &'static str {
            match self {
                MigrationJobPhase::Cdc => "CDC",
                MigrationJobPhase::FullDump => "FULL_DUMP",
                MigrationJobPhase::PhaseUnspecified => "PHASE_UNSPECIFIED",
                MigrationJobPhase::PreparingTheDump => "PREPARING_THE_DUMP",
                MigrationJobPhase::PromoteInProgress => "PROMOTE_IN_PROGRESS",
                MigrationJobPhase::WaitingForSourceWritesToStop => {
                    "WAITING_FOR_SOURCE_WRITES_TO_STOP"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for MigrationJobPhase {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for MigrationJobPhase {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<MigrationJobPhase, ()> {
            Ok(match s {
                "CDC" => MigrationJobPhase::Cdc,
                "FULL_DUMP" => MigrationJobPhase::FullDump,
                "PHASE_UNSPECIFIED" => MigrationJobPhase::PhaseUnspecified,
                "PREPARING_THE_DUMP" => MigrationJobPhase::PreparingTheDump,
                "PROMOTE_IN_PROGRESS" => MigrationJobPhase::PromoteInProgress,
                "WAITING_FOR_SOURCE_WRITES_TO_STOP" => {
                    MigrationJobPhase::WaitingForSourceWritesToStop
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for MigrationJobPhase {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for MigrationJobPhase {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for MigrationJobPhase {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for MigrationJobPhase {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MigrationJobPhase {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl MigrationJobType {
        pub fn as_str(self) -> &'static str {
            match self {
                MigrationJobType::Continuous => "CONTINUOUS",
                MigrationJobType::OneTime => "ONE_TIME",
                MigrationJobType::TypeUnspecified => "TYPE_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for MigrationJobType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for MigrationJobType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<MigrationJobType, ()> {
            Ok(match s {
                "CONTINUOUS" => MigrationJobType::Continuous,
                "ONE_TIME" => MigrationJobType::OneTime,
                "TYPE_UNSPECIFIED" => MigrationJobType::TypeUnspecified,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::serde::Serialize for MigrationJobType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for MigrationJobType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for MigrationJobType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MigrationJobType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl MigrationJobState {
        pub fn as_str(self) -> &'static str {
            match self {
                MigrationJobState::Completed => "COMPLETED",
                MigrationJobState::Creating => "CREATING",
                MigrationJobState::Deleted => "DELETED",
                MigrationJobState::Deleting => "DELETING",
                MigrationJobState::Draft => "DRAFT",
                MigrationJobState::Failed => "FAILED",
                MigrationJobState::Maintenance => "MAINTENANCE",
                MigrationJobState::NotStarted => "NOT_STARTED",
                MigrationJobState::Restarting => "RESTARTING",
                MigrationJobState::Resuming => "RESUMING",
                MigrationJobState::Running => "RUNNING",
                MigrationJobState::Starting => "STARTING",
                MigrationJobState::StateUnspecified => "STATE_UNSPECIFIED",
                MigrationJobState::Stopped => "STOPPED",
                MigrationJobState::Stopping => "STOPPING",
                MigrationJobState::Updating => "UPDATING",
            }
        }
    }
    impl ::std::convert::AsRef<str> for MigrationJobState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for MigrationJobState {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<MigrationJobState, ()> {
            Ok(match s {
                "COMPLETED" => MigrationJobState::Completed,
                "CREATING" => MigrationJobState::Creating,
                "DELETED" => MigrationJobState::Deleted,
                "DELETING" => MigrationJobState::Deleting,
                "DRAFT" => MigrationJobState::Draft,
                "FAILED" => MigrationJobState::Failed,
                "MAINTENANCE" => MigrationJobState::Maintenance,
                "NOT_STARTED" => MigrationJobState::NotStarted,
                "RESTARTING" => MigrationJobState::Restarting,
                "RESUMING" => MigrationJobState::Resuming,
                "RUNNING" => MigrationJobState::Running,
                "STARTING" => MigrationJobState::Starting,
                "STATE_UNSPECIFIED" => MigrationJobState::StateUnspecified,
                "STOPPED" => MigrationJobState::Stopped,
                "STOPPING" => MigrationJobState::Stopping,
                "UPDATING" => MigrationJobState::Updating,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for MigrationJobState {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for MigrationJobState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for MigrationJobState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for MigrationJobState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MigrationJobState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct MigrationJobVerificationError {
        ...
        pub error_code:
            ::std::option::Option<crate::schemas::MigrationJobVerificationErrorErrorCode>,
        #[doc = "Output only. A specific detailed error message, if supplied by the engine."]
        #[serde(
            rename = "errorDetailMessage",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub error_detail_message: ::std::option::Option<String>,
    ...
    impl ::google_field_selector::FieldSelector for MigrationJobVerificationError {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MigrationJobVerificationError {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum MigrationJobVerificationErrorErrorCode {
        #[doc = "We failed to authenticate to one of the connection profile."]
        AuthenticationFailure,
        #[doc = "Migration is already running at the time of restart request."]
        ...
        #[doc = "Invalid RDS logical replication."]
        ...
        #[doc = "The table definition is not support due to missing primary key or replica identity."]
        UnsupportedTableDefinition,
        #[doc = "The versions of the source and the destination are incompatible."]
        VersionIncompatibility,
    }
    impl MigrationJobVerificationErrorErrorCode {
        pub fn as_str(self) -> &'static str {
            match self {
                MigrationJobVerificationErrorErrorCode::AuthenticationFailure => {
                    "AUTHENTICATION_FAILURE"
                }
                MigrationJobVerificationErrorErrorCode::CantRestartRunningMigration => {
                    "CANT_RESTART_RUNNING_MIGRATION"
                }
                MigrationJobVerificationErrorErrorCode::ConnectionFailure => "CONNECTION_FAILURE",
                MigrationJobVerificationErrorErrorCode::ConnectionProfileTypesIncompatibility => {
                    "CONNECTION_PROFILE_TYPES_INCOMPATIBILITY"
                }
                MigrationJobVerificationErrorErrorCode::ErrorCodeUnspecified => {
                    "ERROR_CODE_UNSPECIFIED"
                }
                MigrationJobVerificationErrorErrorCode::InsufficientMaxReplicationSlots => {
                    "INSUFFICIENT_MAX_REPLICATION_SLOTS"
                }
                MigrationJobVerificationErrorErrorCode::InsufficientMaxWalSenders => {
                    "INSUFFICIENT_MAX_WAL_SENDERS"
                }
                MigrationJobVerificationErrorErrorCode::InsufficientMaxWorkerProcesses => {
                    "INSUFFICIENT_MAX_WORKER_PROCESSES"
                }
                MigrationJobVerificationErrorErrorCode::InvalidConnectionProfileConfig => {
                    "INVALID_CONNECTION_PROFILE_CONFIG"
                }
                MigrationJobVerificationErrorErrorCode::InvalidRdsLogicalReplication => {
                    "INVALID_RDS_LOGICAL_REPLICATION"
                }
                MigrationJobVerificationErrorErrorCode::InvalidSharedPreloadLibrary => {
                    "INVALID_SHARED_PRELOAD_LIBRARY"
                }
                MigrationJobVerificationErrorErrorCode::InvalidWalLevel => "INVALID_WAL_LEVEL",
                MigrationJobVerificationErrorErrorCode::NoPglogicalInstalled => {
                    "NO_PGLOGICAL_INSTALLED"
                }
                MigrationJobVerificationErrorErrorCode::PglogicalNodeAlreadyExists => {
                    "PGLOGICAL_NODE_ALREADY_EXISTS"
                }
                MigrationJobVerificationErrorErrorCode::UnsupportedDefiner => "UNSUPPORTED_DEFINER",
                MigrationJobVerificationErrorErrorCode::UnsupportedExtensions => {
                    "UNSUPPORTED_EXTENSIONS"
                }
                MigrationJobVerificationErrorErrorCode::UnsupportedGtidMode => {
                    "UNSUPPORTED_GTID_MODE"
                }
                MigrationJobVerificationErrorErrorCode::UnsupportedMigrationType => {
                    "UNSUPPORTED_MIGRATION_TYPE"
                }
                MigrationJobVerificationErrorErrorCode::UnsupportedTableDefinition => {
                    "UNSUPPORTED_TABLE_DEFINITION"
                }
                MigrationJobVerificationErrorErrorCode::VersionIncompatibility => {
                    "VERSION_INCOMPATIBILITY"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for MigrationJobVerificationErrorErrorCode {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for MigrationJobVerificationErrorErrorCode {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<MigrationJobVerificationErrorErrorCode, ()> {
            Ok(match s {
                "AUTHENTICATION_FAILURE" => {
                    MigrationJobVerificationErrorErrorCode::AuthenticationFailure
                }
                ...
                "CONNECTION_FAILURE" => MigrationJobVerificationErrorErrorCode::ConnectionFailure,
                "CONNECTION_PROFILE_TYPES_INCOMPATIBILITY" => {
                    MigrationJobVerificationErrorErrorCode::ConnectionProfileTypesIncompatibility
                }
                "ERROR_CODE_UNSPECIFIED" => {
                ...
                "INVALID_WAL_LEVEL" => MigrationJobVerificationErrorErrorCode::InvalidWalLevel,
                "NO_PGLOGICAL_INSTALLED" => {
                    MigrationJobVerificationErrorErrorCode::NoPglogicalInstalled
                }
                "PGLOGICAL_NODE_ALREADY_EXISTS" => {
                ...
                "UNSUPPORTED_DEFINER" => MigrationJobVerificationErrorErrorCode::UnsupportedDefiner,
                "UNSUPPORTED_EXTENSIONS" => {
                    MigrationJobVerificationErrorErrorCode::UnsupportedExtensions
                }
                "UNSUPPORTED_GTID_MODE" => {
    ...
    impl ::std::fmt::Display for MigrationJobVerificationErrorErrorCode {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for MigrationJobVerificationErrorErrorCode {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for MigrationJobVerificationErrorErrorCode {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for MigrationJobVerificationErrorErrorCode {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MigrationJobVerificationErrorErrorCode {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct MySqlConnectionProfile {
        ...
        pub password_set: ::std::option::Option<bool>,
        ...
        pub ssl: ::std::option::Option<crate::schemas::SslConfig>,
    ...
    impl ::google_field_selector::FieldSelector for MySqlConnectionProfile {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MySqlConnectionProfile {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct PostgreSqlConnectionProfile {
        ...
        pub cloud_sql_id: ::std::option::Option<String>,
        #[doc = "Required. The IP or hostname of the source PostgreSQL database."]
        #[serde(
            rename = "host",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub password_set: ::std::option::Option<bool>,
        #[doc = "Required. The network port of the source PostgreSQL database."]
        #[serde(
            rename = "port",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for PostgreSqlConnectionProfile {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PostgreSqlConnectionProfile {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for PromoteMigrationJobRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PromoteMigrationJobRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for RestartMigrationJobRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for RestartMigrationJobRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for ResumeMigrationJobRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ResumeMigrationJobRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for ReverseSshConnectivity {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ReverseSshConnectivity {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for SqlAclEntry {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SqlAclEntry {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SqlIpConfig {
        ...
        pub authorized_networks: ::std::option::Option<Vec<crate::schemas::SqlAclEntry>>,
    ...
    impl ::google_field_selector::FieldSelector for SqlIpConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SqlIpConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for SshScript {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SshScript {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SslConfig {
        ...
        pub r#type: ::std::option::Option<crate::schemas::SslConfigType>,
    }
    impl ::google_field_selector::FieldSelector for SslConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SslConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum SslConfigType {
    ...
    impl SslConfigType {
        pub fn as_str(self) -> &'static str {
            match self {
                SslConfigType::ServerClient => "SERVER_CLIENT",
                SslConfigType::ServerOnly => "SERVER_ONLY",
                SslConfigType::SslTypeUnspecified => "SSL_TYPE_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for SslConfigType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for SslConfigType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<SslConfigType, ()> {
            Ok(match s {
                "SERVER_CLIENT" => SslConfigType::ServerClient,
                "SERVER_ONLY" => SslConfigType::ServerOnly,
                "SSL_TYPE_UNSPECIFIED" => SslConfigType::SslTypeUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for SslConfigType {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for SslConfigType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for SslConfigType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for SslConfigType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SslConfigType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for StartMigrationJobRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for StartMigrationJobRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for StaticIpConnectivity {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for StaticIpConnectivity {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for StopMigrationJobRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for StopMigrationJobRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for VerifyMigrationJobRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for VerifyMigrationJobRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct VmCreationConfig {
        ...
        #[serde(
            rename = "vmMachineType",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub vm_machine_type: ::std::option::Option<String>,
        ...
        pub vm_zone: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for VmCreationConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for VmCreationConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for VmSelectionConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for VmSelectionConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for VpcPeeringConnectivity {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for VpcPeeringConnectivity {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                pub fn migration_jobs(
                    &self,
                ) -> crate::resources::projects::locations::migration_jobs::MigrationJobsActions
                {
                    crate::resources::projects::locations::migration_jobs::MigrationJobsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            impl<'a> GetRequestBuilder<'a> {
                ...
                fn _path(&self) -> String {
                    let mut output = "https://datamigration.googleapis.com/".to_owned();
                    output.push_str("v1/");
                    {
            ...
            pub mod connection_profiles {
                ...
                impl<'a> ConnectionProfilesActions<'a> {
                    ...
                    #[doc = "Deletes a single Database Migration Service connection profile. A connection profile can only be deleted if it is not in use by any active migration jobs."]
                ...
                #[doc = "Created via [ConnectionProfilesActions::get_iam_policy()](struct.ConnectionProfilesActions.html#method.get_iam_policy)"]
                #[derive(Debug, Clone)]
                ...
                #[doc = "Created via [ConnectionProfilesActions::set_iam_policy()](struct.ConnectionProfilesActions.html#method.set_iam_policy)"]
                #[derive(Debug, Clone)]
                ...
                #[doc = "Created via [ConnectionProfilesActions::test_iam_permissions()](struct.ConnectionProfilesActions.html#method.test_iam_permissions)"]
                #[derive(Debug, Clone)]
            ...
            pub mod migration_jobs {
                pub mod params {}
                pub struct MigrationJobsActions<'a> {
                    pub(crate) reqwest: &'a reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                }
                impl<'a> MigrationJobsActions<'a> {
                    fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                        self.auth
                    }
                    ...
                    pub fn create(
                        &self,
                        request: crate::schemas::MigrationJob,
                        parent: impl Into<String>,
                    ) -> CreateRequestBuilder {
                        CreateRequestBuilder {
                            reqwest: &self.reqwest,
                    ...
                    #[doc = "Generate a SSH configuration script to configure the reverse SSH connectivity."]
                    pub fn generate_ssh_script(
                        &self,
                        request: crate::schemas::GenerateSshScriptRequest,
                        migration_job: impl Into<String>,
                    ) -> GenerateSshScriptRequestBuilder {
                        GenerateSshScriptRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                            request,
                            ...
                            upload_type: None,
                            xgafv: None,
                            migration_job: migration_job.into(),
                        }
                    }
                    ...
                    #[doc = "Promote a migration job, stopping replication to the destination and promoting the destination to be a standalone database."]
                    pub fn promote(
                        &self,
                        request: crate::schemas::PromoteMigrationJobRequest,
                        name: impl Into<String>,
                    ...
                    #[doc = "Restart a stopped or failed migration job, resetting the destination instance to its original state and starting the migration process from scratch."]
                    pub fn restart(
                        &self,
                        request: crate::schemas::RestartMigrationJobRequest,
                        name: impl Into<String>,
                    ...
                    #[doc = "Resume a migration job that is currently stopped and is resumable (was stopped during CDC phase)."]
                    pub fn resume(
                        &self,
                        request: crate::schemas::ResumeMigrationJobRequest,
                        name: impl Into<String>,
                    ...
                    pub fn start(
                        &self,
                        request: crate::schemas::StartMigrationJobRequest,
                        name: impl Into<String>,
                    ) -> StartRequestBuilder {
                        StartRequestBuilder {
                            reqwest: &self.reqwest,
                    ...
                    pub fn stop(
                        &self,
                        request: crate::schemas::StopMigrationJobRequest,
                        name: impl Into<String>,
                    ) -> StopRequestBuilder {
                        StopRequestBuilder {
                            reqwest: &self.reqwest,
                    ...
                    #[doc = "Verify a migration job, making sure the destination can reach the source and that all configuration and prerequisites are met."]
                    pub fn verify(
                        &self,
                        request: crate::schemas::VerifyMigrationJobRequest,
                        name: impl Into<String>,
                ...
                #[doc = "Created via [MigrationJobsActions::create()](struct.MigrationJobsActions.html#method.create)"]
                #[derive(Debug, Clone)]
                pub struct CreateRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    request: crate::schemas::MigrationJob,
                    parent: String,
                    migration_job_id: ::std::option::Option<String>,
                    request_id: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    pub fn migration_job_id(mut self, value: impl Into<String>) -> Self {
                        self.migration_job_id = Some(value.into());
                        self
                    }
                    #[doc = "A unique id used to identify the request. If the server receives two requests with the same id, then the second request will be ignored. It is recommended to always set this value to a UUID. The id must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). The maximum length is 40 characters."]
                    pub fn request_id(mut self, value: impl Into<String>) -> Self {
                    ...
                    async fn _request(
                        ...
                        let mut req = self.reqwest.request(::reqwest::Method::POST, path);
                        req = req.query(&[("migrationJobId", &self.migration_job_id)]);
                        req = req.query(&[("requestId", &self.request_id)]);
                        req = req.query(&[("access_token", &self.access_token)]);
                        req = req.query(&[("alt", &self.alt)]);
                        req = req.query(&[("callback", &self.callback)]);
                ...
                #[doc = "Created via [MigrationJobsActions::delete()](struct.MigrationJobsActions.html#method.delete)"]
                #[derive(Debug, Clone)]
                pub struct DeleteRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                #[doc = "Created via [MigrationJobsActions::generate_ssh_script()](struct.MigrationJobsActions.html#method.generate_ssh_script)"]
                #[derive(Debug, Clone)]
                pub struct GenerateSshScriptRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    request: crate::schemas::GenerateSshScriptRequest,
                ...
                impl<'a> GenerateSshScriptRequestBuilder<'a> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::SshScript, crate::Error> {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    #[doc = r" selector of `*`. This will include every attribute of the"]
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str("v1/");
                        {
                            let var_as_str = &self.migration_job;
                            output.extend(::percent_encoding::utf8_percent_encode(
                                &var_as_str,
                                crate::RESERVED,
                            ));
                        }
                        output.push_str(":generateSshScript");
                        output
                    }
                    async fn _request(
                        &self,
                ...
                #[doc = "Created via [MigrationJobsActions::get()](struct.MigrationJobsActions.html#method.get)"]
                #[derive(Debug, Clone)]
                pub struct GetRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                impl<'a> GetRequestBuilder<'a> {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::MigrationJob, crate::Error> {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    #[doc = r" selector of `*`. This will include every attribute of the"]
                ...
                #[doc = "Created via [MigrationJobsActions::get_iam_policy()](struct.MigrationJobsActions.html#method.get_iam_policy)"]
                #[derive(Debug, Clone)]
                pub struct GetIamPolicyRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                #[doc = "Created via [MigrationJobsActions::list()](struct.MigrationJobsActions.html#method.list)"]
                #[derive(Debug, Clone)]
                pub struct ListRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `migrationJobs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_migration_jobs<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_migration_jobs_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `migrationJobs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_migration_jobs_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::MigrationJob, crate::Error>,
                    > + 'a {
                        self.stream_migration_jobs_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `migrationJobs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_migration_jobs_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::MigrationJob, crate::Error>,
                    > + 'a {
                        self.stream_migration_jobs_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `migrationJobs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_migration_jobs_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        self.fields = Some({
                            let mut selector =
                                concat!("nextPageToken,", "migrationJobs").to_owned();
                            let items_fields = fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                            if !items_fields.is_empty() {
                                selector.push_str("(");
                                selector.push_str(items_fields);
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListMigrationJobsResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ListMigrationJobsResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                #[doc = "Created via [MigrationJobsActions::patch()](struct.MigrationJobsActions.html#method.patch)"]
                #[derive(Debug, Clone)]
                pub struct PatchRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                #[doc = "Created via [MigrationJobsActions::promote()](struct.MigrationJobsActions.html#method.promote)"]
                #[derive(Debug, Clone)]
                pub struct PromoteRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    request: crate::schemas::PromoteMigrationJobRequest,
                    name: String,
                ...
                impl<'a> PromoteRequestBuilder<'a> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                ...
                #[doc = "Created via [MigrationJobsActions::restart()](struct.MigrationJobsActions.html#method.restart)"]
                #[derive(Debug, Clone)]
                ...
                #[doc = "Created via [MigrationJobsActions::resume()](struct.MigrationJobsActions.html#method.resume)"]
                #[derive(Debug, Clone)]
                ...
                #[doc = "Created via [MigrationJobsActions::set_iam_policy()](struct.MigrationJobsActions.html#method.set_iam_policy)"]
                #[derive(Debug, Clone)]
                pub struct SetIamPolicyRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                #[doc = "Created via [MigrationJobsActions::start()](struct.MigrationJobsActions.html#method.start)"]
                #[derive(Debug, Clone)]
                ...
                #[doc = "Created via [MigrationJobsActions::stop()](struct.MigrationJobsActions.html#method.stop)"]
                #[derive(Debug, Clone)]
                ...
                #[doc = "Created via [MigrationJobsActions::test_iam_permissions()](struct.MigrationJobsActions.html#method.test_iam_permissions)"]
                #[derive(Debug, Clone)]
                pub struct TestIamPermissionsRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                #[doc = "Created via [MigrationJobsActions::verify()](struct.MigrationJobsActions.html#method.verify)"]
                #[derive(Debug, Clone)]
