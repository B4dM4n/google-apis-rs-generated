...
pub mod schemas {
    ...
    pub struct CloudSqlSettings {
        ...
        #[doc = "The Google Cloud Platform zone where your Cloud SQL database instance is located."]
        #[serde(
            rename = "zone",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudClouddmsV1Beta1OperationMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudClouddmsV1Beta1OperationMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl crate::GetNextPageToken<String> for ListMigrationJobsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub enum MigrationJobVerificationErrorErrorCode {
        ...
        #[doc = "The source has tables with limited support. E.g. PostgreSQL tables without primary keys."]
    ...
    impl MigrationJobVerificationErrorErrorCode {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                MigrationJobVerificationErrorErrorCode::TablesWithLimitedSupport => {
