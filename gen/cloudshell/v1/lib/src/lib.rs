...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for AddPublicKeyMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AddPublicKeyMetadata {
    ...
    impl ::google_field_selector::FieldSelector for AddPublicKeyRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AddPublicKeyRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for AddPublicKeyResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AddPublicKeyResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for AuthorizeEnvironmentMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AuthorizeEnvironmentMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for AuthorizeEnvironmentResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AuthorizeEnvironmentResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for CreateEnvironmentMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CreateEnvironmentMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for DeleteEnvironmentMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DeleteEnvironmentMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Environment {
        ...
        pub public_keys: ::std::option::Option<Vec<String>>,
    ...
    impl ::std::str::FromStr for EnvironmentState {
        ...
        fn from_str(s: &str) -> ::std::result::Result<EnvironmentState, ()> {
            Ok(match s {
                ...
                "SUSPENDED" => EnvironmentState::Suspended,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for RemovePublicKeyMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for RemovePublicKeyMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for RemovePublicKeyRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for RemovePublicKeyRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for RemovePublicKeyResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for RemovePublicKeyResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub mod users {
        ...
        pub mod environments {
            ...
            impl<'a> EnvironmentsActions<'a> {
                ...
                #[doc = "Adds a public SSH key to an environment, allowing clients with the corresponding private key to connect to that environment via SSH. If a key with the same content already exists, this will error with ALREADY_EXISTS."]
                pub fn add_public_key(
                    &self,
                    request: crate::schemas::AddPublicKeyRequest,
                    environment: impl Into<String>,
                ) -> AddPublicKeyRequestBuilder {
                    AddPublicKeyRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                        request,
                ...
                #[doc = "Sends OAuth credentials to a running environment on behalf of a user. When this completes, the environment will be authorized to run various Google Cloud command line tools without requiring the user to manually authenticate."]
                pub fn authorize(
                    &self,
                ...
                #[doc = "Removes a public SSH key from an environment. Clients will no longer be able to connect to the environment using the corresponding private key. If a key with the same content is not present, this will error with NOT_FOUND."]
                pub fn remove_public_key(
                    &self,
                    request: crate::schemas::RemovePublicKeyRequest,
                    environment: impl Into<String>,
                ) -> RemovePublicKeyRequestBuilder {
                    RemovePublicKeyRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                        request,
                ...
                #[doc = "Starts an existing environment, allowing clients to connect to it. The returned operation will contain an instance of StartEnvironmentMetadata in its metadata field. Users can wait for the environment to start by polling this operation via GetOperation. Once the environment has finished starting and is ready to accept connections, the operation will contain a StartEnvironmentResponse in its response field."]
                pub fn start(
                    &self,
            ...
            #[doc = "Created via [EnvironmentsActions::add_public_key()](struct.EnvironmentsActions.html#method.add_public_key)"]
            #[derive(Debug, Clone)]
            pub struct AddPublicKeyRequestBuilder<'a> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                request: crate::schemas::AddPublicKeyRequest,
                environment: String,
            ...
            impl<'a> AddPublicKeyRequestBuilder<'a> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
            ...
            #[doc = "Created via [EnvironmentsActions::remove_public_key()](struct.EnvironmentsActions.html#method.remove_public_key)"]
            #[derive(Debug, Clone)]
            pub struct RemovePublicKeyRequestBuilder<'a> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                request: crate::schemas::RemovePublicKeyRequest,
                environment: String,
            ...
            impl<'a> RemovePublicKeyRequestBuilder<'a> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
                ...
                fn _path(&self) -> String {
                    ...
                    output.push_str(":removePublicKey");
                    output
                }
                async fn _request(
                    &self,
