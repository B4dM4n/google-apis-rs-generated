...
pub mod schemas {
    ...
    pub struct DisableServiceRequest {
        ...
        #[serde(
            rename = "checkIfServiceHasUsage",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub check_if_service_has_usage:
            ::std::option::Option<crate::schemas::DisableServiceRequestCheckIfServiceHasUsage>,
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum DisableServiceRequestCheckIfServiceHasUsage {
    ...
    impl DisableServiceRequestCheckIfServiceHasUsage {
        pub fn as_str(self) -> &'static str {
            match self {
                DisableServiceRequestCheckIfServiceHasUsage::Check => "CHECK",
                DisableServiceRequestCheckIfServiceHasUsage::CheckIfServiceHasUsageUnspecified => {
                    "CHECK_IF_SERVICE_HAS_USAGE_UNSPECIFIED"
                }
                DisableServiceRequestCheckIfServiceHasUsage::Skip => "SKIP",
            }
        }
    }
    impl ::std::convert::AsRef<str> for DisableServiceRequestCheckIfServiceHasUsage {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for DisableServiceRequestCheckIfServiceHasUsage {
        type Err = ();
        fn from_str(
            s: &str,
        ) -> ::std::result::Result<DisableServiceRequestCheckIfServiceHasUsage, ()> {
            Ok(match s {
                "CHECK" => DisableServiceRequestCheckIfServiceHasUsage::Check,
                "CHECK_IF_SERVICE_HAS_USAGE_UNSPECIFIED" => {
                    DisableServiceRequestCheckIfServiceHasUsage::CheckIfServiceHasUsageUnspecified
                }
                "SKIP" => DisableServiceRequestCheckIfServiceHasUsage::Skip,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for DisableServiceRequestCheckIfServiceHasUsage {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for DisableServiceRequestCheckIfServiceHasUsage {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for DisableServiceRequestCheckIfServiceHasUsage {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for DisableServiceRequestCheckIfServiceHasUsage {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DisableServiceRequestCheckIfServiceHasUsage {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    ...
    pub mod services {
        ...
        impl<'a> ServicesActions<'a> {
            ...
            #[doc = "Enable multiple services on a project. The operation is atomic: if enabling any service fails, then the entire batch fails, and no state changes occur. To enable a single service, use the `EnableService` method instead."]
            pub fn batch_enable(
                &self,
            ...
            #[doc = "Returns the service configurations and enabled states for a given list of services."]
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn stream_services_with_default_fields(
                ...
                Item = Result<crate::schemas::GoogleApiServiceusageV1Service, crate::Error>,
            > + 'a {
