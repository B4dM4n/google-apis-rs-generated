...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        let mut agent_pools1 = SubCommand::with_name("agent_pools")
            .setting(AppSettings::ColoredHelp)
            .about("methods: create, delete, get, list and patch");
        {
            let mcmd = SubCommand::with_name("create").about("Creates an agent pool resource.");
            agent_pools1 = agent_pools1.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes an agent pool.");
            agent_pools1 = agent_pools1.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get").about("Gets an agent pool.");
            agent_pools1 = agent_pools1.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Lists agent pools.");
            agent_pools1 = agent_pools1.subcommand(mcmd);
        }
        {
            let mcmd =
                SubCommand::with_name("patch").about("Updates an existing agent pool resource.");
            agent_pools1 = agent_pools1.subcommand(mcmd);
        }
        projects0 = projects0.subcommand(agent_pools1);
