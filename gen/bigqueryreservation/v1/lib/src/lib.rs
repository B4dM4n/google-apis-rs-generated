...
pub mod schemas {
    ...
    pub enum AssignmentJobType {
        #[doc = "Background jobs that BigQuery runs for the customers in the background."]
        Background,
    ...
    impl AssignmentJobType {
        pub fn as_str(self) -> &'static str {
            match self {
                AssignmentJobType::Background => "BACKGROUND",
    ...
    impl ::std::str::FromStr for AssignmentJobType {
        ...
        fn from_str(s: &str) -> ::std::result::Result<AssignmentJobType, ()> {
            Ok(match s {
                "BACKGROUND" => AssignmentJobType::Background,
    ...
    pub struct Autoscale {
        #[doc = "Output only. The slot capacity added to this reservation when autoscale happens. Will be between \\[0, max_slots\\]."]
        #[serde(
            rename = "currentSlots",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct CapacityCommitment {
        ...
        #[doc = "Edition of the capacity commitment."]
        #[serde(
            rename = "edition",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub edition: ::std::option::Option<crate::schemas::CapacityCommitmentEdition>,
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum CapacityCommitmentEdition {
        #[doc = "Default value, only for legacy reservations and capacity commitments."]
        EditionUnspecified,
        #[doc = "Enterprise edition."]
        Enterprise,
    }
    impl CapacityCommitmentEdition {
        pub fn as_str(self) -> &'static str {
            match self {
                CapacityCommitmentEdition::EditionUnspecified => "EDITION_UNSPECIFIED",
                CapacityCommitmentEdition::Enterprise => "ENTERPRISE",
            }
        }
    }
    impl ::std::convert::AsRef<str> for CapacityCommitmentEdition {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for CapacityCommitmentEdition {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<CapacityCommitmentEdition, ()> {
            Ok(match s {
                "EDITION_UNSPECIFIED" => CapacityCommitmentEdition::EditionUnspecified,
                "ENTERPRISE" => CapacityCommitmentEdition::Enterprise,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for CapacityCommitmentEdition {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for CapacityCommitmentEdition {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for CapacityCommitmentEdition {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for CapacityCommitmentEdition {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CapacityCommitmentEdition {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl CapacityCommitmentPlan {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                CapacityCommitmentPlan::None => "NONE",
    ...
    impl ::std::str::FromStr for CapacityCommitmentPlan {
        ...
        fn from_str(s: &str) -> ::std::result::Result<CapacityCommitmentPlan, ()> {
            Ok(match s {
                ...
                "NONE" => CapacityCommitmentPlan::None,
    ...
    impl CapacityCommitmentRenewalPlan {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                CapacityCommitmentRenewalPlan::None => "NONE",
    ...
    impl ::std::str::FromStr for CapacityCommitmentRenewalPlan {
        ...
        fn from_str(s: &str) -> ::std::result::Result<CapacityCommitmentRenewalPlan, ()> {
            Ok(match s {
                ...
                "NONE" => CapacityCommitmentRenewalPlan::None,
    ...
    impl crate::GetNextPageToken<String> for ListAssignmentsResponse {
    ...
    impl crate::GetNextPageToken<String> for ListCapacityCommitmentsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct Reservation {
        #[doc = "The configuration parameters for the auto scaling feature. Note this is an alpha feature."]
        #[serde(
            rename = "autoscale",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Job concurrency target which sets a soft upper bound on the number of jobs that can run concurrently in this reservation. This is a soft target due to asynchronous nature of the system and various optimizations for small queries. Default value is 0 which means that concurrency target will be automatically computed by the system. NOTE: this field is exposed as `target_job_concurrency` in the Information Schema, DDL and BQ CLI."]
        #[serde(
            rename = "concurrency",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Edition of the reservation."]
        #[serde(
            rename = "edition",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub edition: ::std::option::Option<crate::schemas::ReservationEdition>,
    ...
    impl ReservationEdition {
        pub fn as_str(self) -> &'static str {
            match self {
                ReservationEdition::EditionUnspecified => "EDITION_UNSPECIFIED",
                ReservationEdition::Enterprise => "ENTERPRISE",
            }
        }
    }
    impl ::std::convert::AsRef<str> for ReservationEdition {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for ReservationEdition {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<ReservationEdition, ()> {
            Ok(match s {
                "EDITION_UNSPECIFIED" => ReservationEdition::EditionUnspecified,
                "ENTERPRISE" => ReservationEdition::Enterprise,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::serde::Serialize for ReservationEdition {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ReservationEdition {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ReservationEdition {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ReservationEdition {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for SearchAllAssignmentsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SearchAllAssignmentsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for SearchAllAssignmentsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for SearchAssignmentsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                #[doc = "Deprecated: Looks up assignments for a specified resource for a particular region. If the request is about a project: 1. Assignments created on the project will be returned if they exist. 2. Otherwise assignments created on the closest ancestor will be returned. 3. Assignments for different JobTypes will all be returned. The same logic applies if the request is about a folder. If the request is about an organization, then assignments created on the organization will be returned (organization doesn’t have ancestors). Comparing to ListAssignments, there are some behavior differences: 1. permission on the assignee will be verified in this API. 2. Hierarchy lookup (project->folder->organization) happens in this API. 3. Parent here is `projects/*/locations/*`, instead of `projects/*/locations/*reservations/*`. **Note** “-” cannot be used for projects nor locations."]
            ...
            #[doc = "Created via [LocationsActions::search_all_assignments()](struct.LocationsActions.html#method.search_all_assignments)"]
            #[derive(Debug, Clone)]
            pub struct SearchAllAssignmentsRequestBuilder<'a> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                parent: String,
            ...
            impl<'a> SearchAllAssignmentsRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `assignments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_assignments<T>(
                    self,
                    ...
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_assignments_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `assignments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_assignments_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::Assignment, crate::Error>> + 'a
                {
                    self.stream_assignments_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `assignments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_assignments_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::Assignment, crate::Error>> + 'a
                {
                    self.stream_assignments_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `assignments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_assignments_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::SearchAllAssignmentsResponse, crate::Error>,
                > + 'a {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::SearchAllAssignmentsResponse, crate::Error>
                {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                fn _path(&self) -> String {
                    ...
                    output.push_str(":searchAllAssignments");
                    output
                }
                async fn _request(
                    &self,
            ...
            impl<'a> crate::stream::StreamableMethod for SearchAllAssignmentsRequestBuilder<'a> {
            ...
            impl<'a> SearchAssignmentsRequestBuilder<'a> {
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::SearchAssignmentsResponse, crate::Error>,
                > + 'a {
                    self.stream_with_fields(None::<&str>)
                }
                #[doc = r" Execute the request and yield the returned value. If the response contains a"]
            ...
            #[async_trait::async_trait]
            impl<'a> crate::stream::StreamableMethod for SearchAssignmentsRequestBuilder<'a> {
                type PageToken = String;
                fn set_page_token(&mut self, value: String) {
                    self.page_token = value.into();
                }
            ...
            pub mod capacity_commitments {
                ...
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::CapacityCommitment,
                    parent: String,
                    capacity_commitment_id: ::std::option::Option<String>,
                    enforce_single_admin_project_per_org: ::std::option::Option<bool>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `capacityCommitments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_capacity_commitments<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_capacity_commitments_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `capacityCommitments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_capacity_commitments_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::CapacityCommitment, crate::Error>,
                    > + 'a {
                        self.stream_capacity_commitments_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `capacityCommitments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_capacity_commitments_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::CapacityCommitment, crate::Error>,
                    > + 'a {
                        self.stream_capacity_commitments_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `capacityCommitments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_capacity_commitments_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<
                            crate::schemas::ListCapacityCommitmentsResponse,
                            crate::Error,
                        >,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
            ...
            pub mod reservations {
                ...
                pub mod assignments {
                    ...
                    pub struct CreateRequestBuilder<'a> {
                        ...
                        request: crate::schemas::Assignment,
                        parent: String,
                        assignment_id: ::std::option::Option<String>,
                        access_token: ::std::option::Option<String>,
                        alt: ::std::option::Option<crate::params::Alt>,
                        callback: ::std::option::Option<String>,
                        fields: ::std::option::Option<String>,
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        pub fn stream_assignments_with_default_fields(
                            ...
                            Item = Result<crate::schemas::Assignment, crate::Error>,
                        > + 'a {
                            self.stream_assignments_with_fields(None::<String>)
                        }
                        #[doc = "\nExecute the request and yield each item in the `assignments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                        ...
                        pub fn stream_with_default_fields(
                            ...
                            Item = Result<crate::schemas::ListAssignmentsResponse, crate::Error>,
                        > + 'a {
                            self.stream_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the request and yield the returned value. If the response contains a"]
