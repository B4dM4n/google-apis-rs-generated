...
pub mod scopes {
    #[doc = "View and manage your AdSense host data and associated accounts\n\n`https://www.googleapis.com/auth/adsensehost`"]
    pub const ADSENSEHOST: &str = "https://www.googleapis.com/auth/adsensehost";
}
pub mod schemas {
    #[derive(
        Debug,
    ...
    impl ::google_field_selector::ToFieldType for AdClients {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for AdClients {
    ...
    impl ::google_field_selector::ToFieldType for AdCode {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for AdStyle {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for AdStyleColors {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for AdStyleFont {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for AdUnitContentAdsSettings {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for AdUnitContentAdsSettingsBackupOption {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for AdUnitMobileContentAdsSettings {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for AdUnits {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for AdUnits {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for AssociationSession {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for CustomChannels {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for CustomChannels {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for ReportHeadersItems {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for UrlChannels {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for UrlChannels {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
...
impl Client {
    ...
    pub fn adclients(&self) -> crate::resources::adclients::AdclientsActions {
    ...
    pub fn customchannels(&self) -> crate::resources::customchannels::CustomchannelsActions {
    ...
    pub fn urlchannels(&self) -> crate::resources::urlchannels::UrlchannelsActions {
...
pub mod resources {
    pub mod accounts {
        ...
        impl<'a> AccountsActions<'a> {
            ...
            pub fn list(&self, filter_ad_client_id: impl Into<Vec<String>>) -> ListRequestBuilder {
                ListRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    alt: None,
            ...
            pub fn adunits(&self) -> crate::resources::accounts::adunits::AdunitsActions {
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            async fn _request(
                ...
                let mut req = self.reqwest.request(::reqwest::Method::GET, path);
                for value in &self.filter_ad_client_id {
                    req = req.query(&[("filterAdClientId", value)]);
                }
                req = req.query(&[("alt", &self.alt)]);
                req = req.query(&[("fields", &self.fields)]);
                req = req.query(&[("key", &self.key)]);
        ...
        pub mod adclients {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn stream_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::AdClients, crate::Error>> + 'a
                {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::AdClients, crate::Error> {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
        ...
        pub mod adunits {
            ...
            pub struct GetAdCodeRequestBuilder<'a> {
                ...
                ad_client_id: String,
                ad_unit_id: String,
                host_custom_channel_id: ::std::option::Option<Vec<String>>,
                alt: ::std::option::Option<crate::params::Alt>,
                fields: ::std::option::Option<String>,
                key: ::std::option::Option<String>,
                oauth_token: ::std::option::Option<String>,
            ...
            impl<'a> GetAdCodeRequestBuilder<'a> {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::AdCode, crate::Error> {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
                ...
                async fn _request(
                    ...
                    let mut req = self.reqwest.request(::reqwest::Method::GET, path);
                    for value in self.host_custom_channel_id.iter().flatten() {
                        req = req.query(&[("hostCustomChannelId", value)]);
                    }
                    req = req.query(&[("alt", &self.alt)]);
                    req = req.query(&[("fields", &self.fields)]);
                    req = req.query(&[("key", &self.key)]);
            ...
            pub struct ListRequestBuilder<'a> {
                ...
                account_id: String,
                ad_client_id: String,
                include_inactive: ::std::option::Option<bool>,
                max_results: ::std::option::Option<u32>,
                page_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                fields: ::std::option::Option<String>,
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn stream_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::AdUnits, crate::Error>> + 'a
                {
                    self.stream_with_fields(None::<&str>)
                }
                #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::AdUnits, crate::Error> {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            impl<'a> PatchRequestBuilder<'a> {
                ...
                async fn _request(
                    ...
                    req = req.query(&[("adUnitId", &self.ad_unit_id)]);
                    req = req.query(&[("alt", &self.alt)]);
                    req = req.query(&[("fields", &self.fields)]);
                    req = req.query(&[("key", &self.key)]);
                    req = req.query(&[("oauth_token", &self.oauth_token)]);
        ...
        pub mod reports {
            ...
            pub struct GenerateRequestBuilder<'a> {
                ...
                start_date: String,
                end_date: String,
                dimension: ::std::option::Option<Vec<String>>,
                filter: ::std::option::Option<Vec<String>>,
                locale: ::std::option::Option<String>,
                max_results: ::std::option::Option<u32>,
                metric: ::std::option::Option<Vec<String>>,
                sort: ::std::option::Option<Vec<String>>,
            ...
            impl<'a> GenerateRequestBuilder<'a> {
                ...
                async fn _request(
                    ...
                    for value in self.dimension.iter().flatten() {
                        req = req.query(&[("dimension", value)]);
                    }
                    ...
                    req = req.query(&[("maxResults", &self.max_results)]);
                    for value in self.metric.iter().flatten() {
                        req = req.query(&[("metric", value)]);
                    }
                    for value in self.sort.iter().flatten() {
                        req = req.query(&[("sort", value)]);
                    }
    ...
    pub mod adclients {
        ...
        impl<'a> AdclientsActions<'a> {
            ...
            pub fn get(&self, ad_client_id: impl Into<String>) -> GetRequestBuilder {
                GetRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    alt: None,
    ...
    pub mod associationsessions {
        pub mod params {
            ...
            impl ::google_field_selector::FieldSelector for StartProductCodeItems {
                fn fields() -> Vec<::google_field_selector::Field> {
                    Vec::new()
                }
            }
            impl ::google_field_selector::ToFieldType for StartProductCodeItems {
                fn field_type() -> ::google_field_selector::FieldType {
                    ::google_field_selector::FieldType::Leaf
                }
            }
        }
        pub struct AssociationsessionsActions<'a> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
        }
        impl<'a> AssociationsessionsActions<'a> {
            fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                self.auth
            }
            ...
            pub fn verify(&self, token: impl Into<String>) -> VerifyRequestBuilder {
        ...
        pub struct StartRequestBuilder<'a> {
            ...
            user_locale: ::std::option::Option<String>,
            website_locale: ::std::option::Option<String>,
            alt: ::std::option::Option<crate::params::Alt>,
            fields: ::std::option::Option<String>,
            key: ::std::option::Option<String>,
            oauth_token: ::std::option::Option<String>,
        ...
        impl<'a> StartRequestBuilder<'a> {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::AssociationSession, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            async fn _request(
                ...
                let mut req = self.reqwest.request(::reqwest::Method::GET, path);
                for value in &self.product_code {
                    req = req.query(&[("productCode", value)]);
                }
                req = req.query(&[("websiteUrl", &self.website_url)]);
                req = req.query(&[("callbackUrl", &self.callback_url)]);
                req = req.query(&[("userLocale", &self.user_locale)]);
                req = req.query(&[("websiteLocale", &self.website_locale)]);
                req = req.query(&[("alt", &self.alt)]);
                req = req.query(&[("fields", &self.fields)]);
                req = req.query(&[("key", &self.key)]);
                req = req.query(&[("oauth_token", &self.oauth_token)]);
    ...
    pub mod customchannels {
        ...
        impl<'a> CustomchannelsActions<'a> {
            ...
            pub fn list(&self, ad_client_id: impl Into<String>) -> ListRequestBuilder {
                ListRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    alt: None,
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn stream_items_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::CustomChannel, crate::Error>> + 'a
            {
                self.stream_items_with_fields(None::<String>)
            }
            #[doc = "\nExecute the request and yield each item in the `items` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            ...
            pub fn stream_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::CustomChannels, crate::Error>> + 'a
            {
                self.stream_with_fields(None::<&str>)
            }
            #[doc = r" Execute the request and yield the returned value. If the response contains a"]
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::CustomChannels, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
        ...
        impl<'a> PatchRequestBuilder<'a> {
            ...
            async fn _request(
                ...
                let mut req = self.reqwest.request(::reqwest::Method::PATCH, path);
                req = req.query(&[("customChannelId", &self.custom_channel_id)]);
                req = req.query(&[("alt", &self.alt)]);
                req = req.query(&[("fields", &self.fields)]);
                req = req.query(&[("key", &self.key)]);
                req = req.query(&[("oauth_token", &self.oauth_token)]);
    ...
    pub mod urlchannels {
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn stream_items_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::UrlChannel, crate::Error>> + 'a
            {
                self.stream_items_with_fields(None::<String>)
            }
            #[doc = "\nExecute the request and yield each item in the `items` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            ...
            pub fn stream_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::UrlChannels, crate::Error>> + 'a
            {
                self.stream_with_fields(None::<&str>)
            }
            #[doc = r" Execute the request and yield the returned value. If the response contains a"]
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::UrlChannels, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
