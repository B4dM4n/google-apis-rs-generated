...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for ResetInstanceResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ResetInstanceResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
        ...
        pub mod locations {
            ...
            pub mod instances {
                ...
                impl<'a> InstancesActions<'a> {
                    ...
                    #[doc = "Perform an ungraceful, hard reset on a machine (equivalent to shutting the power off, and then turning it back on)."]
                    pub fn reset_instance(
                        &self,
                        request: crate::schemas::ResetInstanceRequest,
                        instance: impl Into<String>,
                    ) -> ResetInstanceRequestBuilder {
                        ResetInstanceRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                            request,
                ...
                #[doc = "Created via [InstancesActions::reset_instance()](struct.InstancesActions.html#method.reset_instance)"]
                #[derive(Debug, Clone)]
                pub struct ResetInstanceRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    request: crate::schemas::ResetInstanceRequest,
                    instance: String,
                ...
                impl<'a> ResetInstanceRequestBuilder<'a> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ResetInstanceResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
