...
pub mod schemas {
    ...
    impl ::google_field_selector::ToFieldType for ApplicationDataTransfer {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for ApplicationTransferParam {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for ApplicationsListResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for DataTransfer {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for DataTransfersListResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
impl Client {
    ...
    pub fn transfers(&self) -> crate::resources::transfers::TransfersActions {
        crate::resources::transfers::TransfersActions {
            reqwest: &self.reqwest,
            auth: self.auth_ref(),
        }
    }
...
pub mod resources {
    pub mod applications {
        ...
        impl<'a> ApplicationsActions<'a> {
            ...
            pub fn get(&self, application_id: i64) -> GetRequestBuilder {
                GetRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    access_token: None,
        ...
        impl<'a> GetRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str("admin/datatransfer/v1/applications/");
                {
                    let var_as_string = self.application_id.to_string();
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            #[doc = "\nExecute the request and yield each item in the `applications` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
            pub fn stream_applications<T>(
                self,
                ...
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
            {
                ...
                self.stream_applications_with_fields(fields)
            }
            #[doc = "\nExecute the request and yield each item in the `applications` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
            pub fn stream_applications_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::Application, crate::Error>> + 'a
            {
                self.stream_applications_with_fields(None::<String>)
            }
            #[doc = "\nExecute the request and yield each item in the `applications` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            pub fn stream_applications_with_all_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::Application, crate::Error>> + 'a
            {
                self.stream_applications_with_fields(Some("*"))
            }
            #[doc = "\nExecute the request and yield each item in the `applications` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
            pub fn stream_applications_with_fields<T, F>(
                mut self,
                fields: ::std::option::Option<F>,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
                ...
                F: AsRef<str>,
            {
                ...
                self.fields = Some({
                    let mut selector = concat!("nextPageToken,", "applications").to_owned();
            ...
            pub fn stream_with_default_fields(
                ...
                Item = Result<crate::schemas::ApplicationsListResponse, crate::Error>,
            > + 'a {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::ApplicationsListResponse, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
    ...
    pub mod transfers {
        ...
        impl<'a> TransfersActions<'a> {
            ...
            pub fn get(&self, data_transfer_id: impl Into<String>) -> GetRequestBuilder {
                GetRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    access_token: None,
        ...
        impl<'a> GetRequestBuilder<'a> {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::DataTransfer, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            fn _path(&self) -> String {
                let mut output = "https://admin.googleapis.com/".to_owned();
                output.push_str("admin/datatransfer/v1/transfers/");
                {
                    let var_as_str = &self.data_transfer_id;
                    output.extend(::percent_encoding::utf8_percent_encode(
                        &var_as_str,
                        crate::SIMPLE,
                    ));
        ...
        pub struct ListRequestBuilder<'a> {
            ...
            customer_id: ::std::option::Option<String>,
            max_results: ::std::option::Option<i32>,
            new_owner_user_id: ::std::option::Option<String>,
            old_owner_user_id: ::std::option::Option<String>,
            page_token: ::std::option::Option<String>,
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn new_owner_user_id(mut self, value: impl Into<String>) -> Self {
                self.new_owner_user_id = Some(value.into());
                self
            }
            #[doc = "Source user’s profile ID."]
            pub fn old_owner_user_id(mut self, value: impl Into<String>) -> Self {
            ...
            #[doc = "\nExecute the request and yield each item in the `dataTransfers` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
            pub fn stream_data_transfers<T>(
                self,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
            {
                ...
                self.stream_data_transfers_with_fields(fields)
            }
            #[doc = "\nExecute the request and yield each item in the `dataTransfers` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
            pub fn stream_data_transfers_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::DataTransfer, crate::Error>> + 'a
            {
                self.stream_data_transfers_with_fields(None::<String>)
            }
            #[doc = "\nExecute the request and yield each item in the `dataTransfers` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            pub fn stream_data_transfers_with_all_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::DataTransfer, crate::Error>> + 'a
            {
                self.stream_data_transfers_with_fields(Some("*"))
            }
            #[doc = "\nExecute the request and yield each item in the `dataTransfers` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
            pub fn stream_data_transfers_with_fields<T, F>(
                mut self,
                fields: ::std::option::Option<F>,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
                ...
                F: AsRef<str>,
            {
                ...
                self.fields = Some({
                    let mut selector = concat!("nextPageToken,", "dataTransfers").to_owned();
                    let items_fields = fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                    if !items_fields.is_empty() {
                        selector.push_str("(");
                        selector.push_str(items_fields);
            ...
            pub fn stream_with_default_fields(
                ...
                Item = Result<crate::schemas::DataTransfersListResponse, crate::Error>,
            > + 'a {
                self.stream_with_fields(None::<&str>)
            }
            #[doc = r" Execute the request and yield the returned value. If the response contains a"]
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::DataTransfersListResponse, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            async fn _request(
                ...
                req = req.query(&[("customerId", &self.customer_id)]);
                req = req.query(&[("maxResults", &self.max_results)]);
                req = req.query(&[("newOwnerUserId", &self.new_owner_user_id)]);
                req = req.query(&[("oldOwnerUserId", &self.old_owner_user_id)]);
                req = req.query(&[("pageToken", &self.page_token)]);
