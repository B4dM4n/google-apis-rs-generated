...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for Activities {
    ...
    impl crate::GetNextPageToken<String> for UsageReports {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
...
pub mod resources {
    pub mod activities {
        ...
        pub struct ListRequestBuilder<'a> {
            ...
            user_key: String,
            application_name: crate::resources::activities::params::ListApplicationName,
            actor_ip_address: ::std::option::Option<String>,
            customer_id: ::std::option::Option<String>,
            end_time: ::std::option::Option<String>,
            event_name: ::std::option::Option<String>,
            filters: ::std::option::Option<String>,
            group_id_filter: ::std::option::Option<String>,
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn stream_items_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::Activity, crate::Error>> + 'a
            {
            ...
            pub fn stream_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::Activities, crate::Error>> + 'a
            {
    ...
    pub mod customer_usage_reports {
        ...
        pub struct GetRequestBuilder<'a> {
            ...
            customer_id: ::std::option::Option<String>,
            page_token: ::std::option::Option<String>,
            parameters: ::std::option::Option<String>,
            access_token: ::std::option::Option<String>,
            alt: ::std::option::Option<crate::params::Alt>,
            callback: ::std::option::Option<String>,
            fields: ::std::option::Option<String>,
        ...
        impl<'a> GetRequestBuilder<'a> {
            ...
            #[doc = "\nExecute the request and yield each item in the `usageReports` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
            pub fn stream_usage_reports<T>(
                self,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
            {
                ...
                self.stream_usage_reports_with_fields(fields)
            }
            #[doc = "\nExecute the request and yield each item in the `usageReports` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
            pub fn stream_usage_reports_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::UsageReport, crate::Error>> + 'a
            {
                self.stream_usage_reports_with_fields(None::<String>)
            }
            #[doc = "\nExecute the request and yield each item in the `usageReports` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            pub fn stream_usage_reports_with_all_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::UsageReport, crate::Error>> + 'a
            {
                self.stream_usage_reports_with_fields(Some("*"))
            }
            #[doc = "\nExecute the request and yield each item in the `usageReports` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
            pub fn stream_usage_reports_with_fields<T, F>(
                mut self,
                fields: ::std::option::Option<F>,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
            ...
            pub fn stream_warnings_with_default_fields(
                ...
                Item = Result<crate::schemas::UsageReportsWarningsItems, crate::Error>,
            > + 'a {
            ...
            pub fn stream_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::UsageReports, crate::Error>> + 'a
            {
                self.stream_with_fields(None::<&str>)
            }
            #[doc = r" Execute the request and yield the returned value. If the response contains a"]
