...
pub mod schemas {
    ...
    impl ::google_field_selector::ToFieldType for LicenseAssignment {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for LicenseAssignmentInsert {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for LicenseAssignmentList {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for LicenseAssignmentList {
...
impl Client {
    ...
    #[doc = "Actions that can be performed on the license_assignments resource"]
    pub fn license_assignments(
        &self,
    ) -> crate::resources::license_assignments::LicenseAssignmentsActions {
        crate::resources::license_assignments::LicenseAssignmentsActions {
    ...
    pub mod license_assignments {
        ...
        impl<'a> LicenseAssignmentsActions<'a> {
            ...
            pub fn list_for_product_and_sku(
                ...
                sku_id: impl Into<String>,
                customer_id: impl Into<String>,
            ) -> ListForProductAndSkuRequestBuilder {
                ListForProductAndSkuRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    access_token: None,
        ...
        impl<'a> DeleteRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://licensing.googleapis.com/".to_owned();
                output.push_str("apps/licensing/v1/product/");
                {
        ...
        impl<'a> GetRequestBuilder<'a> {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::LicenseAssignment, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
        ...
        impl<'a> ListForProductRequestBuilder<'a> {
            ...
            pub fn stream_items_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::LicenseAssignment, crate::Error>>
                   + 'a {
            ...
            pub fn stream_with_default_fields(
                ...
                Item = Result<crate::schemas::LicenseAssignmentList, crate::Error>,
            > + 'a {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::LicenseAssignmentList, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
        ...
        impl<'a> crate::stream::StreamableMethod for ListForProductRequestBuilder<'a> {
        ...
        #[async_trait::async_trait]
        impl<'a> crate::stream::StreamableMethod for ListForProductAndSkuRequestBuilder<'a> {
            type PageToken = String;
            fn set_page_token(&mut self, value: String) {
                self.page_token = value.into();
            }
