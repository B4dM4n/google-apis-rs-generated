...
pub mod scopes {
    ...
    #[doc = "View monetary and non-monetary YouTube Analytics reports for your YouTube content\n\n`https://www.googleapis.com/auth/yt-analytics-monetary.readonly`"]
    pub const YT_ANALYTICS_MONETARY_READONLY: &str =
        "https://www.googleapis.com/auth/yt-analytics-monetary.readonly";
    #[doc = "View YouTube Analytics reports for your YouTube content\n\n`https://www.googleapis.com/auth/yt-analytics.readonly`"]
    pub const YT_ANALYTICS_READONLY: &str = "https://www.googleapis.com/auth/yt-analytics.readonly";
}
pub mod schemas {
    #[derive(
        Debug,
    ...
    impl ::google_field_selector::ToFieldType for EmptyResponse {
    ...
    impl ErrorProtoLocationType {
        pub fn as_str(self) -> &'static str {
            match self {
                ErrorProtoLocationType::Other => "OTHER",
    ...
    impl ::serde::Serialize for ErrorProtoLocationType {
    ...
    impl<'de> ::serde::Deserialize<'de> for ErrorProtoLocationType {
    ...
    impl ::google_field_selector::FieldSelector for ErrorProtoLocationType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ErrorProtoLocationType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ErrorsCode {
        pub fn as_str(self) -> &'static str {
            match self {
                ErrorsCode::BadRequest => "BAD_REQUEST",
                ErrorsCode::Conflict => "CONFLICT",
                ErrorsCode::Forbidden => "FORBIDDEN",
                ErrorsCode::Gone => "GONE",
                ErrorsCode::InternalError => "INTERNAL_ERROR",
                ErrorsCode::NotFound => "NOT_FOUND",
    ...
    impl ::google_field_selector::FieldSelector for ErrorsCode {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ErrorsCode {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for GroupContentDetails {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for GroupItem {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for GroupItemResource {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for GroupSnippet {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for ListGroupItemsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for ResultTableColumnHeader {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
impl Client {
    ...
    #[doc = "Actions that can be performed on the group_items resource"]
    pub fn group_items(&self) -> crate::resources::group_items::GroupItemsActions {
        crate::resources::group_items::GroupItemsActions {
...
pub mod resources {
    pub mod group_items {
        pub mod params {}
        pub struct GroupItemsActions<'a> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
        }
        impl<'a> GroupItemsActions<'a> {
            fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                self.auth
            }
            #[doc = "Removes an item from a group."]
            ...
            #[doc = "Creates a group item."]
            pub fn insert(&self, request: crate::schemas::GroupItem) -> InsertRequestBuilder {
            ...
            #[doc = "Returns a collection of group items that match the API request parameters."]
        ...
        pub struct DeleteRequestBuilder<'a> {
            ...
            on_behalf_of_content_owner: ::std::option::Option<String>,
        ...
        impl<'a> DeleteRequestBuilder<'a> {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::EmptyResponse, crate::Error> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://youtubeanalytics.googleapis.com/".to_owned();
        ...
        pub struct InsertRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            request: crate::schemas::GroupItem,
            on_behalf_of_content_owner: ::std::option::Option<String>,
            access_token: ::std::option::Option<String>,
            alt: ::std::option::Option<crate::params::Alt>,
            callback: ::std::option::Option<String>,
        ...
        impl<'a> InsertRequestBuilder<'a> {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::GroupItem, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::ListGroupItemsResponse, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
    ...
    pub mod groups {
        ...
        impl<'a> GroupsActions<'a> {
            ...
            #[doc = "Modifies a group. For example, you could change a group’s title."]
            pub fn update(&self, request: crate::schemas::Group) -> UpdateRequestBuilder {
    ...
    pub mod reports {
        ...
        impl<'a> ReportsActions<'a> {
            ...
            #[doc = "Retrieve your YouTube Analytics reports."]
            pub fn query(&self) -> QueryRequestBuilder {
                QueryRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    access_token: None,
        ...
        pub struct QueryRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            currency: ::std::option::Option<String>,
            dimensions: ::std::option::Option<String>,
            end_date: ::std::option::Option<String>,
            filters: ::std::option::Option<String>,
            ids: ::std::option::Option<String>,
            include_historical_channel_data: ::std::option::Option<bool>,
            max_results: ::std::option::Option<i32>,
            metrics: ::std::option::Option<String>,
        ...
        impl<'a> QueryRequestBuilder<'a> {
            ...
            #[doc = "Identifies the YouTube channel or content owner for which you are retrieving YouTube Analytics data. - To request data for a YouTube user, set the `ids` parameter value to `channel==CHANNEL_ID`, where `CHANNEL_ID` specifies the unique YouTube channel ID. - To request data for a YouTube CMS content owner, set the `ids` parameter value to `contentOwner==OWNER_NAME`, where `OWNER_NAME` is the CMS name of the content owner. required: true, pattern: \\[a-zA-Z\\]+==\\[a-zA-Z0-9\\_+-\\]+"]
