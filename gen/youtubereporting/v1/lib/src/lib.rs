...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for ListReportTypesResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
...
pub mod resources {
    pub mod jobs {
        ...
        pub struct ListRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            include_system_managed: ::std::option::Option<bool>,
            on_behalf_of_content_owner: ::std::option::Option<String>,
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn stream_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::ListJobsResponse, crate::Error>> + 'a
            {
            ...
            async fn _request(
                ...
                let mut req = self.reqwest.request(::reqwest::Method::GET, path);
                req = req.query(&[("includeSystemManaged", &self.include_system_managed)]);
                req = req.query(&[("onBehalfOfContentOwner", &self.on_behalf_of_content_owner)]);
        ...
        pub mod reports {
            ...
            impl<'a> ReportsActions<'a> {
                ...
                #[doc = "Lists reports created by a specific job. Returns NOT_FOUND if the job does not exist."]
            ...
            pub struct ListRequestBuilder<'a> {
                ...
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                job_id: String,
                created_after: ::std::option::Option<String>,
                on_behalf_of_content_owner: ::std::option::Option<String>,
                page_size: ::std::option::Option<i32>,
                page_token: ::std::option::Option<String>,
                start_time_at_or_after: ::std::option::Option<String>,
                start_time_before: ::std::option::Option<String>,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
                fields: ::std::option::Option<String>,
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                async fn _request(
                    ...
                    let mut req = self.reqwest.request(::reqwest::Method::GET, path);
                    req = req.query(&[("createdAfter", &self.created_after)]);
                    req =
                        req.query(&[("onBehalfOfContentOwner", &self.on_behalf_of_content_owner)]);
                    req = req.query(&[("pageSize", &self.page_size)]);
                    req = req.query(&[("pageToken", &self.page_token)]);
                    req = req.query(&[("startTimeAtOrAfter", &self.start_time_at_or_after)]);
                    req = req.query(&[("startTimeBefore", &self.start_time_before)]);
                    req = req.query(&[("access_token", &self.access_token)]);
                    req = req.query(&[("alt", &self.alt)]);
                    req = req.query(&[("callback", &self.callback)]);
                    req = req.query(&[("fields", &self.fields)]);
    ...
    pub mod media {
        ...
        impl<'a> MediaActions<'a> {
            ...
            #[doc = "Method for media download. Download is supported on the URI `/v1/media/{+name}?alt=media`."]
    ...
    pub mod report_types {
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            #[doc = "\nExecute the request and yield each item in the `reportTypes` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
            pub fn stream_report_types<T>(
                self,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
            {
                ...
                self.stream_report_types_with_fields(fields)
            }
            #[doc = "\nExecute the request and yield each item in the `reportTypes` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
            pub fn stream_report_types_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::ReportType, crate::Error>> + 'a
            {
                self.stream_report_types_with_fields(None::<String>)
            }
            #[doc = "\nExecute the request and yield each item in the `reportTypes` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
            pub fn stream_report_types_with_all_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::ReportType, crate::Error>> + 'a
            {
                self.stream_report_types_with_fields(Some("*"))
            }
            #[doc = "\nExecute the request and yield each item in the `reportTypes` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
            pub fn stream_report_types_with_fields<T, F>(
                mut self,
                fields: ::std::option::Option<F>,
            ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
            where
            ...
            pub fn stream_with_default_fields(
                ...
                Item = Result<crate::schemas::ListReportTypesResponse, crate::Error>,
            > + 'a {
                self.stream_with_fields(None::<&str>)
            }
            #[doc = r" Execute the request and yield the returned value. If the response contains a"]
