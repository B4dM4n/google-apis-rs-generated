...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for GoogleCloudMlV1ListJobsResponse {
    ...
    impl crate::GetNextPageToken<String> for GoogleCloudMlV1ListLocationsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for GoogleCloudMlV1ListModelsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken<String> for GoogleCloudMlV1ListVersionsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct GoogleCloudMlV1Model {
        ...
        pub etag: ::std::option::Option<::google_api_bytes::Bytes>,
        #[doc = "Optional. One or more labels that you can add, to organize your models. Each label is a key-value pair, where both the key and the value are arbitrary strings that you supply. For more information, see the documentation on using labels. Note that this field is not updatable for mls1\\* models."]
        #[serde(
            rename = "labels",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct GoogleCloudMlV1Version {
        ...
        #[doc = "Optional. One or more labels that you can add, to organize your model versions. Each label is a key-value pair, where both the key and the value are arbitrary strings that you supply. For more information, see the documentation on using labels. Note that this field is not updatable for mls1\\* models."]
        #[serde(
            rename = "labels",
            default,
            skip_serializing_if = "std::option::Option::is_none"
...
pub mod resources {
    pub mod projects {
        ...
        impl<'a> ProjectsActions<'a> {
            ...
            #[doc = "Performs explanation on the data in the request. {% dynamic include “/ai-platform/includes/\\_\\_\\_explain-request” %} "]
            pub fn explain(
                &self,
            ...
            #[doc = "Performs online prediction on the data in the request. {% dynamic include “/ai-platform/includes/\\_\\_\\_predict-request” %} "]
            pub fn predict(
                &self,
        ...
        pub mod jobs {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn stream_jobs_with_default_fields(
                    ...
                    Item = Result<crate::schemas::GoogleCloudMlV1Job, crate::Error>,
                > + 'a {
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::GoogleCloudMlV1ListJobsResponse, crate::Error>,
                > + 'a {
        ...
        pub mod locations {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn stream_locations_with_default_fields(
                    ...
                    Item = Result<crate::schemas::GoogleCloudMlV1Location, crate::Error>,
                > + 'a {
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<
                        crate::schemas::GoogleCloudMlV1ListLocationsResponse,
                        crate::Error,
                    >,
                > + 'a {
                    self.stream_with_fields(None::<&str>)
            ...
            pub mod studies {
                ...
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::GoogleCloudMlV1Study,
                    parent: String,
                    study_id: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
        ...
        pub mod models {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn stream_models_with_default_fields(
                    ...
                    Item = Result<crate::schemas::GoogleCloudMlV1Model, crate::Error>,
                > + 'a {
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::GoogleCloudMlV1ListModelsResponse, crate::Error>,
                > + 'a {
                    self.stream_with_fields(None::<&str>)
                }
                #[doc = r" Execute the request and yield the returned value. If the response contains a"]
            ...
            pub mod versions {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn stream_versions_with_default_fields(
                        ...
                        Item = Result<crate::schemas::GoogleCloudMlV1Version, crate::Error>,
                    > + 'a {
