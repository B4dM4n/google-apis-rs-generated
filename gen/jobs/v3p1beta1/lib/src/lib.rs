...
pub mod resources {
    pub mod projects {
        ...
        pub struct CompleteRequestBuilder<'a> {
            ...
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            name: String,
            company_name: ::std::option::Option<String>,
            language_code: ::std::option::Option<String>,
            language_codes: ::std::option::Option<Vec<String>>,
            page_size: ::std::option::Option<i32>,
            query: ::std::option::Option<String>,
            r#type: ::std::option::Option<crate::resources::projects::params::CompleteType>,
            scope: ::std::option::Option<crate::resources::projects::params::CompleteScope>,
        ...
        pub mod jobs {
            ...
            pub struct ListRequestBuilder<'a> {
                ...
                job_view:
                    ::std::option::Option<crate::resources::projects::jobs::params::ListJobView>,
                page_size: ::std::option::Option<i32>,
                page_token: ::std::option::Option<String>,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
