...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for BatchCreateJobsRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BatchCreateJobsRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct BatchCreateJobsResponse {
        ...
        pub job_results: ::std::option::Option<Vec<crate::schemas::JobResult>>,
    }
    impl ::google_field_selector::FieldSelector for BatchCreateJobsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BatchCreateJobsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for BatchDeleteJobsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BatchDeleteJobsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for BatchUpdateJobsRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BatchUpdateJobsRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for BatchUpdateJobsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BatchUpdateJobsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ClientEvent {
        ...
        pub event_notes: ::std::option::Option<String>,
    ...
    pub struct Company {
        ...
        #[doc = "This field is deprecated. Please set the searchability of the custom attribute in the Job.custom_attributes going forward. A list of keys of filterable Job.custom_attributes, whose corresponding `string_values` are used in keyword searches. Jobs with `string_values` under these specified field keys are returned if any of the values match the search keyword. Custom field values with parenthesis, brackets and special symbols are not searchable as-is, and those keyword queries must be surrounded by quotes."]
        #[serde(
    ...
    pub struct CustomAttribute {
        ...
        #[serde(
            rename = "keywordSearchable",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub keyword_searchable: ::std::option::Option<bool>,
    ...
    pub struct Job {
        ...
        pub company: ::std::option::Option<String>,
    ...
    impl ::google_field_selector::FieldSelector for JobResult {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for JobResult {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ListTenantsResponse {
        ...
        pub tenants: ::std::option::Option<Vec<crate::schemas::Tenant>>,
    }
    impl ::google_field_selector::FieldSelector for ListTenantsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListTenantsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListTenantsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct Location {
        ...
        pub radius_miles: ::std::option::Option<f64>,
    }
    ...
    pub struct LocationFilter {
        ...
        pub lat_lng: ::std::option::Option<crate::schemas::LatLng>,
        #[doc = "CLDR region code of the country/region. This field may be used in two ways: 1) If telecommute preference is not set, this field is used address ambiguity of the user-input address. For example, “Liverpool” may refer to “Liverpool, NY, US” or “Liverpool, UK”. This region code biases the address resolution toward a specific country or territory. If this field is not set, address resolution is biased toward the United States by default. 2) If telecommute preference is set to TELECOMMUTE_ALLOWED, the telecommute location filter will be limited to the region specified in this field. If this field is not set, the telecommute job locations will not be See https://unicode-org.github.io/cldr-staging/charts/latest/supplemental/territory_information.html for details. Example: “CH” for Switzerland."]
        #[serde(
            rename = "regionCode",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct RequestMetadata {
        ...
        #[serde(
            rename = "allowMissingIds",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub allow_missing_ids: ::std::option::Option<bool>,
    ...
    pub struct SearchJobsRequest {
        ...
        pub max_page_size: ::std::option::Option<i32>,
    ...
    pub struct SpellingCorrection {
        ...
        #[serde(
            rename = "correctedHtml",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub corrected_html: ::std::option::Option<String>,
    ...
    impl ::google_field_selector::FieldSelector for Tenant {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for Tenant {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub mod projects {
        ...
        pub mod tenants {
            pub mod params {
                ...
                impl CompleteQueryType {
                    pub fn as_str(self) -> &'static str {
                        match self {
                            CompleteQueryType::Combined => "COMBINED",
                            CompleteQueryType::CompanyName => "COMPANY_NAME",
                            CompleteQueryType::CompletionTypeUnspecified => {
                                "COMPLETION_TYPE_UNSPECIFIED"
                            }
                            CompleteQueryType::JobTitle => "JOB_TITLE",
                        }
                    }
                }
                impl ::std::convert::AsRef<str> for CompleteQueryType {
                    fn as_ref(&self) -> &str {
                        self.as_str()
                    }
                }
                impl ::std::str::FromStr for CompleteQueryType {
                    type Err = ();
                    fn from_str(s: &str) -> ::std::result::Result<CompleteQueryType, ()> {
                        Ok(match s {
                            "COMBINED" => CompleteQueryType::Combined,
                            "COMPANY_NAME" => CompleteQueryType::CompanyName,
                            "COMPLETION_TYPE_UNSPECIFIED" => {
                                CompleteQueryType::CompletionTypeUnspecified
                            }
                            "JOB_TITLE" => CompleteQueryType::JobTitle,
                            _ => return Err(()),
                        })
                    }
                }
                impl ::std::fmt::Display for CompleteQueryType {
                    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                        f.write_str(self.as_str())
                    }
                }
                impl ::serde::Serialize for CompleteQueryType {
                    fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
                    where
                        S: ::serde::ser::Serializer,
                    {
                ...
                impl<'de> ::serde::Deserialize<'de> for CompleteQueryType {
                    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
                    where
                        D: ::serde::de::Deserializer<'de>,
                    {
                ...
                impl ::google_field_selector::FieldSelector for CompleteQueryType {
                    fn fields() -> Vec<::google_field_selector::Field> {
                        Vec::new()
                    }
                }
                impl ::google_field_selector::ToFieldType for CompleteQueryType {
                    fn field_type() -> ::google_field_selector::FieldType {
                        ::google_field_selector::FieldType::Leaf
                    }
                }
                #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
                pub enum CompleteQueryScope {
                    #[doc = "Default value."]
                ...
                impl CompleteQueryScope {
                    pub fn as_str(self) -> &'static str {
                        match self {
                            CompleteQueryScope::CompletionScopeUnspecified => {
                                "COMPLETION_SCOPE_UNSPECIFIED"
                            }
                            CompleteQueryScope::Public => "PUBLIC",
                            CompleteQueryScope::Tenant => "TENANT",
                        }
                    }
                }
                impl ::std::convert::AsRef<str> for CompleteQueryScope {
                    fn as_ref(&self) -> &str {
                        self.as_str()
                    }
                }
                impl ::std::str::FromStr for CompleteQueryScope {
                    type Err = ();
                    fn from_str(s: &str) -> ::std::result::Result<CompleteQueryScope, ()> {
                        Ok(match s {
                            "COMPLETION_SCOPE_UNSPECIFIED" => {
                                CompleteQueryScope::CompletionScopeUnspecified
                            }
                            "PUBLIC" => CompleteQueryScope::Public,
                            "TENANT" => CompleteQueryScope::Tenant,
                            _ => return Err(()),
                        })
                    }
                }
                impl ::std::fmt::Display for CompleteQueryScope {
                    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                        f.write_str(self.as_str())
                    }
                }
                impl ::serde::Serialize for CompleteQueryScope {
                    fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
                    where
                        S: ::serde::ser::Serializer,
                    {
                ...
                impl<'de> ::serde::Deserialize<'de> for CompleteQueryScope {
                    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
                    where
                        D: ::serde::de::Deserializer<'de>,
                    {
                ...
                impl ::google_field_selector::FieldSelector for CompleteQueryScope {
                    fn fields() -> Vec<::google_field_selector::Field> {
                        Vec::new()
                    }
                }
                impl ::google_field_selector::ToFieldType for CompleteQueryScope {
                    fn field_type() -> ::google_field_selector::FieldType {
                        ::google_field_selector::FieldType::Leaf
                    }
                }
            ...
            impl<'a> TenantsActions<'a> {
                ...
                pub fn client_events(
                    &self,
                ) -> crate::resources::projects::tenants::client_events::ClientEventsActions
                {
                    crate::resources::projects::tenants::client_events::ClientEventsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                ...
                pub fn companies(
                    &self,
                ) -> crate::resources::projects::tenants::companies::CompaniesActions
                {
                    crate::resources::projects::tenants::companies::CompaniesActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                ...
                pub fn jobs(&self) -> crate::resources::projects::tenants::jobs::JobsActions {
                    crate::resources::projects::tenants::jobs::JobsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                    }
                }
            }
            #[doc = "Created via [TenantsActions::complete_query()](struct.TenantsActions.html#method.complete_query)"]
            #[derive(Debug, Clone)]
            pub struct CompleteQueryRequestBuilder<'a> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                tenant: String,
                company: ::std::option::Option<String>,
                language_codes: ::std::option::Option<Vec<String>>,
                page_size: ::std::option::Option<i32>,
                query: ::std::option::Option<String>,
                r#type: ::std::option::Option<
                    crate::resources::projects::tenants::params::CompleteQueryType,
                >,
                scope: ::std::option::Option<
                    crate::resources::projects::tenants::params::CompleteQueryScope,
                >,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
            ...
            impl<'a> CompleteQueryRequestBuilder<'a> {
                ...
                pub fn r#type(
                    mut self,
                    value: crate::resources::projects::tenants::params::CompleteQueryType,
                ) -> Self {
                ...
                pub fn scope(
                    mut self,
                    value: crate::resources::projects::tenants::params::CompleteQueryScope,
                ) -> Self {
                ...
                async fn _request(
                    ...
                    let mut req = self.reqwest.request(::reqwest::Method::GET, path);
                    req = req.query(&[("company", &self.company)]);
            ...
            impl<'a> CreateRequestBuilder<'a> {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::Tenant, crate::Error> {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `tenants` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_tenants<T>(
                    self,
                    ...
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_tenants_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `tenants` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_tenants_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::Tenant, crate::Error>> + 'a
                {
                    self.stream_tenants_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `tenants` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_tenants_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::Tenant, crate::Error>> + 'a
                {
                    self.stream_tenants_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `tenants` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_tenants_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListTenantsResponse, crate::Error>,
                > + 'a {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::ListTenantsResponse, crate::Error> {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            pub mod client_events {
                ...
                impl<'a> ClientEventsActions<'a> {
                    ...
                    pub fn create(
                        &self,
                        request: crate::schemas::ClientEvent,
                        parent: impl Into<String>,
                    ) -> CreateRequestBuilder {
                        CreateRequestBuilder {
                            reqwest: &self.reqwest,
            ...
            pub mod companies {
                ...
                pub struct ListRequestBuilder<'a> {
                    ...
                    page_size: ::std::option::Option<i32>,
                    page_token: ::std::option::Option<String>,
                    require_open_jobs: ::std::option::Option<bool>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `companies` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_companies<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_companies_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `companies` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_companies_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Company, crate::Error>> + 'a
                    {
                        self.stream_companies_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `companies` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_companies_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Company, crate::Error>> + 'a
                    {
                        self.stream_companies_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `companies` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_companies_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListCompaniesResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
            ...
            pub mod jobs {
                ...
                impl<'a> JobsActions<'a> {
                    ...
                    pub fn batch_create(
                        &self,
                        request: crate::schemas::BatchCreateJobsRequest,
                        parent: impl Into<String>,
                    ...
                    pub fn batch_update(
                        &self,
                        request: crate::schemas::BatchUpdateJobsRequest,
                        parent: impl Into<String>,
                ...
                #[doc = "Created via [JobsActions::batch_create()](struct.JobsActions.html#method.batch_create)"]
                #[derive(Debug, Clone)]
                ...
                impl<'a> BatchCreateRequestBuilder<'a> {
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str("/jobs:batchCreate");
                        output
                    }
                    async fn _request(
                        &self,
                ...
                #[doc = "Created via [JobsActions::batch_update()](struct.JobsActions.html#method.batch_update)"]
                #[derive(Debug, Clone)]
                ...
                impl<'a> BatchUpdateRequestBuilder<'a> {
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str("/jobs:batchUpdate");
                        output
                    }
                    async fn _request(
                        &self,
                ...
                pub struct ListRequestBuilder<'a> {
                    ...
                    job_view: ::std::option::Option<
                        crate::resources::projects::tenants::jobs::params::ListJobView,
                    >,
                    page_size: ::std::option::Option<i32>,
                    page_token: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn job_view(
                        mut self,
                        value: crate::resources::projects::tenants::jobs::params::ListJobView,
                    ) -> Self {
