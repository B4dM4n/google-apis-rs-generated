    ...
    impl OperationMetadataState {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                OperationMetadataState::Succeeded => "SUCCEEDED",
