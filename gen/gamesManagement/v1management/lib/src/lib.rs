...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for HiddenPlayerList {
    ...
    pub mod applications {
        ...
        impl<'a> ListHiddenRequestBuilder<'a> {
            ...
            pub fn stream_items_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::HiddenPlayer, crate::Error>> + 'a
            {
            ...
            pub fn stream_with_default_fields(
                self,
            ) -> impl ::futures::Stream<Item = Result<crate::schemas::HiddenPlayerList, crate::Error>> + 'a
            {
        ...
        impl<'a> crate::stream::StreamableMethod for ListHiddenRequestBuilder<'a> {
