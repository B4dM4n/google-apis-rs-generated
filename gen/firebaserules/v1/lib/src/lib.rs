...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for ListRulesetsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct Release {
        ...
        pub name: ::std::option::Option<String>,
        #[doc = "Required. Name of the `Ruleset` referred to by this `Release`. The `Ruleset` must exist for the `Release` to be created."]
        #[serde(
            rename = "rulesetName",
            default,
            skip_serializing_if = "std::option::Option::is_none"
...
pub mod resources {
    pub mod projects {
        ...
        impl<'a> ProjectsActions<'a> {
            ...
            pub fn releases(&self) -> crate::resources::projects::releases::ReleasesActions {
            ...
            pub fn rulesets(&self) -> crate::resources::projects::rulesets::RulesetsActions {
        ...
        impl<'a> TestRequestBuilder<'a> {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::TestRulesetResponse, crate::Error> {
        ...
        pub mod releases {
            ...
            pub struct GetExecutableRequestBuilder<'a> {
                ...
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                name: String,
                executable_version: ::std::option::Option<
            ...
            impl<'a> GetExecutableRequestBuilder<'a> {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::GetReleaseExecutableResponse, crate::Error>
                {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
        ...
        pub mod rulesets {
            ...
            impl<'a> CreateRequestBuilder<'a> {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::Ruleset, crate::Error> {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `rulesets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_rulesets<T>(
                    self,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_rulesets_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `rulesets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_rulesets_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::Ruleset, crate::Error>> + 'a
                {
                    self.stream_rulesets_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `rulesets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_rulesets_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::Ruleset, crate::Error>> + 'a
                {
                    self.stream_rulesets_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `rulesets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_rulesets_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListRulesetsResponse, crate::Error>,
                > + 'a {
                    self.stream_with_fields(None::<&str>)
                }
                #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::ListRulesetsResponse, crate::Error> {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
