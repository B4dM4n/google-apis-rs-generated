...
pub mod schemas {
    ...
    impl GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems {
        pub fn as_str(self) -> &'static str {
            match self { GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: ExplicitContentDetection => "EXPLICIT_CONTENT_DETECTION" , GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: FaceDetection => "FACE_DETECTION" , GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: FeatureUnspecified => "FEATURE_UNSPECIFIED" , GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: LabelDetection => "LABEL_DETECTION" , GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: LogoRecognition => "LOGO_RECOGNITION" , GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: ObjectTracking => "OBJECT_TRACKING" , GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: PersonDetection => "PERSON_DETECTION" , GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: ShotChangeDetection => "SHOT_CHANGE_DETECTION" , GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: SpeechTranscription => "SPEECH_TRANSCRIPTION" , GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: TextDetection => "TEXT_DETECTION" , }
        }
    }
    ...
    impl ::std::str::FromStr for GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems {
        ...
        fn from_str(
            ...
            (),
        > {
            Ok (match s { "EXPLICIT_CONTENT_DETECTION" => GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: ExplicitContentDetection , "FACE_DETECTION" => GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: FaceDetection , "FEATURE_UNSPECIFIED" => GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: FeatureUnspecified , "LABEL_DETECTION" => GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: LabelDetection , "LOGO_RECOGNITION" => GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: LogoRecognition , "OBJECT_TRACKING" => GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: ObjectTracking , "PERSON_DETECTION" => GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: PersonDetection , "SHOT_CHANGE_DETECTION" => GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: ShotChangeDetection , "SPEECH_TRANSCRIPTION" => GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: SpeechTranscription , "TEXT_DETECTION" => GoogleCloudVideointelligenceV1Beta2AnnotateVideoRequestFeaturesItems :: TextDetection , _ => return Err (()) , })
        }
    }
    ...
    impl ::google_field_selector::FieldSelector
        for GoogleCloudVideointelligenceV1Beta2FaceDetectionConfig
    {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    ...
    impl ::google_field_selector::FieldSelector
        for GoogleCloudVideointelligenceV1Beta2PersonDetectionConfig
    {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    ...
    pub struct GoogleCloudVideointelligenceV1Beta2VideoContext {
        ...
        pub face_detection_config: ::std::option::Option<
            crate::schemas::GoogleCloudVideointelligenceV1Beta2FaceDetectionConfig,
        >,
        ...
        pub person_detection_config: ::std::option::Option<
            crate::schemas::GoogleCloudVideointelligenceV1Beta2PersonDetectionConfig,
        >,
