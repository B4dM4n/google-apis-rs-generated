...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for ApplySoftwareUpdateRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ApplySoftwareUpdateRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudMemcacheV1Beta2LocationMetadata {
        ...
        pub available_zones: ::std::option::Option<
            ::std::collections::BTreeMap<
                String,
                crate::schemas::GoogleCloudMemcacheV1Beta2ZoneMetadata,
            >,
        >,
    }
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudMemcacheV1Beta2MaintenancePolicy {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudMemcacheV1Beta2MaintenancePolicy {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudMemcacheV1Beta2ZoneMetadata {}
    impl ::google_field_selector::FieldSelector for GoogleCloudMemcacheV1Beta2ZoneMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudMemcacheV1Beta2ZoneMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Instance {
        ...
        pub maintenance_policy:
            ::std::option::Option<crate::schemas::GoogleCloudMemcacheV1Beta2MaintenancePolicy>,
    ...
    pub struct RescheduleMaintenanceRequest {
        ...
        #[doc = "Timestamp when the maintenance shall be rescheduled to if reschedule_type=SPECIFIC_TIME, in RFC 3339 format, for example `2012-11-15T16:19:00.094Z`."]
        #[serde(
            rename = "scheduleTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub mod locations {
            ...
            pub mod instances {
                ...
                impl<'a> InstancesActions<'a> {
                    ...
                    pub fn apply_software_update(
                        &self,
                        request: crate::schemas::ApplySoftwareUpdateRequest,
                        instance: impl Into<String>,
                    ) -> ApplySoftwareUpdateRequestBuilder {
                        ApplySoftwareUpdateRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                            request,
                ...
                #[doc = "Created via [InstancesActions::apply_software_update()](struct.InstancesActions.html#method.apply_software_update)"]
                #[derive(Debug, Clone)]
                pub struct ApplySoftwareUpdateRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    request: crate::schemas::ApplySoftwareUpdateRequest,
                    instance: String,
                ...
                impl<'a> ApplySoftwareUpdateRequestBuilder<'a> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str(":applySoftwareUpdate");
                        output
                    }
                    async fn _request(
                        &self,
