    ...
    fn default() -> Self {
            ...
            .about("methods: get_config and update_config");
        {
            let mcmd = SubCommand::with_name("get_config")
                .about("Retrieve an Identity Toolkit project configuration.");
            projects0 = projects0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("update_config")
                .about("Update an Identity Toolkit project configuration.");
            projects0 = projects0.subcommand(mcmd);
        }
        ...
        {
            let mcmd = SubCommand::with_name("start").about("Step one of the MFA enrollment process. In SMS case, this sends an SMS verification code to the user.");
            mfa_enrollment1 = mfa_enrollment1.subcommand(mcmd);
        }
        {
        ...
        let mut identity_platform1 = SubCommand::with_name("identity_platform")
            .setting(AppSettings::ColoredHelp)
            .about("methods: initialize_auth");
        {
            let mcmd = SubCommand::with_name("initialize_auth").about("Initialize Identity Platform for a Cloud project. Identity Platform is an end-to-end authentication system for third-party users to access your apps and services. These could include mobile/web apps, games, APIs and beyond. This is the publicly available variant of EnableIdentityPlatform that is only available to billing-enabled projects.");
            identity_platform1 = identity_platform1.subcommand(mcmd);
        }
        ...
        {
            let mcmd = SubCommand::with_name("get_iam_policy").about("Gets the access control policy for a resource. An error is returned if the resource does not exist. An empty policy is returned if the resource exists but does not have a policy set on it. Caller must have the right Google IAM permission on the resource.");
            tenants1 = tenants1.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("List tenants under the given agent project. Requires read permission on the Agent project.");
            tenants1 = tenants1.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("patch")
        ...
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy for a resource. If the policy exists, it is replaced. Caller must have the right Google IAM permission on the resource.");
            tenants1 = tenants1.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions").about("Returns the caller's permissions on a resource. An error is returned if the resource does not exist. A caller is not required to have Google IAM permission to make this request.");
            tenants1 = tenants1.subcommand(mcmd);
        }
        ...
        projects0 = projects0.subcommand(identity_platform1);
