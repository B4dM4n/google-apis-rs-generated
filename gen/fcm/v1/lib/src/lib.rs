...
pub mod scopes {
    ...
    #[doc = "Send messages and manage messaging subscriptions for your Firebase applications\n\n`https://www.googleapis.com/auth/firebase.messaging`"]
    pub const FIREBASE_MESSAGING: &str = "https://www.googleapis.com/auth/firebase.messaging";
}
pub mod schemas {
    #[derive(
    ...
    pub struct AndroidNotification {
        ...
        #[doc = "If set, display notifications delivered to the device will be handled by the app instead of the proxy."]
        #[serde(
            rename = "bypassProxyNotification",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub bypass_proxy_notification: ::std::option::Option<bool>,
    ...
    pub struct ApnsConfig {
        ...
        #[doc = "HTTP request headers defined in Apple Push Notification Service. Refer to [APNs request headers](https://developer.apple.com/documentation/usernotifications/setting_up_a_remote_notification_server/sending_notification_requests_to_apns) for supported headers such as `apns-expiration` and `apns-priority`. The backend sets a default value for `apns-expiration` of 30 days and a default value for `apns-priority` of 10 if not explicitly set."]
        #[serde(
            rename = "headers",
            default,
            skip_serializing_if = "std::option::Option::is_none"
