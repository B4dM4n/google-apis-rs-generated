...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("datastream1_alpha1")
            .setting(clap::AppSettings::ColoredHelp)
            .author("Sebastian Thiel <byronimo@gmail.com>")
            .version("0.1.0-20230114")
            .about("")
        ...
        {
            let mcmd = SubCommand::with_name("discover").about("Use this method to discover a connection profile. The discover API call exposes the data objects and metadata belonging to the profile. Typically, a request returns children data objects under a parent data object that's optionally supplied in the request.");
            connection_profiles2 = connection_profiles2.subcommand(mcmd);
        }
        {
        ...
        let mut streams2 = SubCommand::with_name("streams")
            .setting(AppSettings::ColoredHelp)
            .about("methods: create, delete, fetch_errors, get, list and patch");
        {
        ...
        {
            let mcmd = SubCommand::with_name("fetch_errors")
                .about("Use this method to fetch any errors associated with a stream.");
            streams2 = streams2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
        ...
        let mut routes3 = SubCommand::with_name("routes")
            ...
            .about("methods: create, delete, get and list");
        {
            let mcmd = SubCommand::with_name("create").about("Use this method to create a route for a private connectivity in a project and location.");
        ...
        {
            let mcmd = SubCommand::with_name("list").about("Use this method to list routes created for a private connectivity in a project and location.");
            routes3 = routes3.subcommand(mcmd);
        }
        let mut objects3 = SubCommand::with_name("objects")
            .setting(AppSettings::ColoredHelp)
            .about("methods: get, list, start_backfill_job and stop_backfill_job");
        {
            let mcmd = SubCommand::with_name("get")
        ...
        }
        {
            let mcmd = SubCommand::with_name("start_backfill_job")
                .about("Starts backfill job for the specified stream object.");
            objects3 = objects3.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("stop_backfill_job")
                .about("Stops the backfill job for the specified stream object.");
            objects3 = objects3.subcommand(mcmd);
        }
...
use google_datastream1_alpha1 as api;
