...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("workflows1_beta")
        ...
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes a workflow with the specified name. This method also cancels and deletes all running executions of the workflow.");
            workflows2 = workflows2.subcommand(mcmd);
        }
        {
...
use google_workflows1_beta as api;
