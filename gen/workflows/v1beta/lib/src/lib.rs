        ...
        pub mod locations {
            ...
            pub mod workflows {
                ...
                impl<'a> WorkflowsActions<'a> {
                    ...
                    #[doc = "Creates a new workflow. If a workflow with the specified name already exists in the specified project and location, the long running operation will return ALREADY_EXISTS error."]
                    pub fn create(
                        &self,
                    ...
                    #[doc = "Updates an existing workflow. Running this method has no impact on already running executions of the workflow. A new revision of the workflow may be created as a result of a successful update operation. In that case, such revision will be used in new workflow executions."]
                    pub fn patch(
                        &self,
                        request: crate::schemas::Workflow,
