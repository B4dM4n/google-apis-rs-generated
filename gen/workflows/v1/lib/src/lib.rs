...
pub mod schemas {
    ...
    pub struct ListWorkflowsResponse {
        ...
        #[doc = "The workflows that match the request."]
        #[serde(
            rename = "workflows",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub workflows: ::std::option::Option<Vec<crate::schemas::Workflow>>,
    }
    impl ::google_field_selector::FieldSelector for ListWorkflowsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListWorkflowsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListWorkflowsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct Workflow {
        #[doc = "Output only. The timestamp for when the workflow was created."]
        #[serde(
            rename = "createTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub name: ::std::option::Option<String>,
        #[doc = "Output only. The timestamp for the latest revision of the workflow’s creation."]
        #[serde(
        ...
        #[doc = "Workflow code to be executed. The size limit is 128KB."]
        #[serde(
            rename = "sourceContents",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub source_contents: ::std::option::Option<String>,
        ...
        pub state: ::std::option::Option<crate::schemas::WorkflowState>,
        #[doc = "Output only. The timestamp for when the workflow was last updated."]
        #[serde(
            rename = "updateTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for Workflow {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for Workflow {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl WorkflowState {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                WorkflowState::StateUnspecified => "STATE_UNSPECIFIED",
            }
        }
    }
    ...
    impl ::std::str::FromStr for WorkflowState {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<WorkflowState, ()> {
            Ok(match s {
                "ACTIVE" => WorkflowState::Active,
                "STATE_UNSPECIFIED" => WorkflowState::StateUnspecified,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::serde::Serialize for WorkflowState {
    ...
    impl ::google_field_selector::FieldSelector for WorkflowState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for WorkflowState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                #[doc = "Actions that can be performed on the workflows resource"]
                pub fn workflows(
                    &self,
                ) -> crate::resources::projects::locations::workflows::WorkflowsActions
                {
                    crate::resources::projects::locations::workflows::WorkflowsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            impl<'a> GetRequestBuilder<'a> {
                ...
                fn _path(&self) -> String {
                    let mut output = "https://workflows.googleapis.com/".to_owned();
                    output.push_str("v1/");
                    {
            ...
            pub mod workflows {
                pub mod params {}
                pub struct WorkflowsActions<'a> {
                    pub(crate) reqwest: &'a reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                }
                impl<'a> WorkflowsActions<'a> {
                    fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                        self.auth
                    }
                    #[doc = "Creates a new workflow. If a workflow with the specified name already exists in the specified project and location, the long running operation returns a ALREADY_EXISTS error."]
                    pub fn create(
                        &self,
                        request: crate::schemas::Workflow,
                    ...
                    #[doc = "Deletes a workflow with the specified name. This method also cancels and deletes all running executions of the workflow."]
                    pub fn delete(&self, name: impl Into<String>) -> DeleteRequestBuilder {
                        DeleteRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    #[doc = "Lists workflows in a given project and location. The default order is not specified."]
                    ...
                    #[doc = "Updates an existing workflow. Running this method has no impact on already running executions of the workflow. A new revision of the workflow might be created as a result of a successful update operation. In that case, the new revision is used in new workflow executions."]
                    pub fn patch(
                        &self,
                        request: crate::schemas::Workflow,
                ...
                #[doc = "Created via [WorkflowsActions::create()](struct.WorkflowsActions.html#method.create)"]
                #[derive(Debug, Clone)]
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::Workflow,
                    parent: String,
                    workflow_id: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    async fn _request(
                        ...
                        req = req.query(&[("workflowId", &self.workflow_id)]);
                        req = req.query(&[("access_token", &self.access_token)]);
                        req = req.query(&[("alt", &self.alt)]);
                        req = req.query(&[("callback", &self.callback)]);
                        req = req.query(&[("fields", &self.fields)]);
                ...
                #[doc = "Created via [WorkflowsActions::delete()](struct.WorkflowsActions.html#method.delete)"]
                #[derive(Debug, Clone)]
                pub struct DeleteRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                #[doc = "Created via [WorkflowsActions::get()](struct.WorkflowsActions.html#method.get)"]
                #[derive(Debug, Clone)]
                pub struct GetRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                impl<'a> GetRequestBuilder<'a> {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::Workflow, crate::Error> {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    #[doc = r" selector of `*`. This will include every attribute of the"]
                ...
                #[doc = "Created via [WorkflowsActions::list()](struct.WorkflowsActions.html#method.list)"]
                #[derive(Debug, Clone)]
                pub struct ListRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "Comma-separated list of fields that specify the order of the results. Default sorting order for a field is ascending. To specify descending order for a field, append a “desc” suffix. If not specified, the results are returned in an unspecified order."]
                    pub fn order_by(mut self, value: impl Into<String>) -> Self {
                        self.order_by = Some(value.into());
                        self
                    }
                    #[doc = "Maximum number of workflows to return per call. The service might return fewer than this value even if not at the end of the collection. If a value is not specified, a default value of 500 is used. The maximum permitted value is 1000 and values greater than 1000 are coerced down to 1000."]
                    pub fn page_size(mut self, value: i32) -> Self {
                        self.page_size = Some(value);
                        self
                    }
                    ...
                    #[doc = "\nExecute the request and yield each item in the `workflows` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_workflows<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_workflows_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `workflows` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_workflows_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Workflow, crate::Error>> + 'a
                    {
                        self.stream_workflows_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `workflows` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_workflows_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Workflow, crate::Error>> + 'a
                    {
                        self.stream_workflows_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `workflows` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_workflows_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        self.fields = Some({
                            let mut selector = concat!("nextPageToken,", "workflows").to_owned();
                            let items_fields = fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                            if !items_fields.is_empty() {
                                selector.push_str("(");
                                selector.push_str(items_fields);
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListWorkflowsResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ListWorkflowsResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                #[doc = "Created via [WorkflowsActions::patch()](struct.WorkflowsActions.html#method.patch)"]
                #[derive(Debug, Clone)]
