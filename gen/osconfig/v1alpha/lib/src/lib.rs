        ...
        pub mod locations {
            ...
            pub mod instance_os_policies_compliances {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn iter_instance_os_policies_compliances<T>(
                        self,
                        ...
                        T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                    {
                        ...
                        self.iter_instance_os_policies_compliances_with_fields(fields)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_instance_os_policies_compliances_with_default_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::InstanceOSPoliciesCompliance>
                    {
                        self.iter_instance_os_policies_compliances_with_fields(None::<String>)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    ...
                    #[doc = r" resources."]
                    pub fn iter_instance_os_policies_compliances_with_all_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::InstanceOSPoliciesCompliance>
                    {
                        self.iter_instance_os_policies_compliances_with_fields(Some("*"))
                    }
                    pub fn iter_instance_os_policies_compliances_with_fields<T, F>(
                        mut self,
                        fields: Option<F>,
                    ) -> crate::iter::PageItemIter<Self, T>
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        crate::iter::PageItemIter::new(self, "instanceOsPoliciesCompliances")
                    }
            ...
            pub mod instances {
                ...
                pub mod inventories {
                    ...
                    #[derive(Debug, Clone)]
                    pub struct GetRequestBuilder < 'a > { pub (crate) reqwest : & 'a :: reqwest :: blocking :: Client , pub (crate) auth : & 'a dyn :: google_api_auth :: GetAccessToken , name : String , view : Option < crate :: resources :: projects :: locations :: instances :: inventories :: params :: GetView > , access_token : Option < String > , alt : Option < crate :: params :: Alt > , callback : Option < String > , fields : Option < String > , key : Option < String > , oauth_token : Option < String > , pretty_print : Option < bool > , quota_user : Option < String > , upload_protocol : Option < String > , upload_type : Option < String > , xgafv : Option < crate :: params :: Xgafv > , }
                    impl<'a> GetRequestBuilder<'a> {
                    ...
                    #[derive(Debug, Clone)]
                    pub struct ListRequestBuilder < 'a > { pub (crate) reqwest : & 'a :: reqwest :: blocking :: Client , pub (crate) auth : & 'a dyn :: google_api_auth :: GetAccessToken , parent : String , filter : Option < String > , page_size : Option < i32 > , page_token : Option < String > , view : Option < crate :: resources :: projects :: locations :: instances :: inventories :: params :: ListView > , access_token : Option < String > , alt : Option < crate :: params :: Alt > , callback : Option < String > , fields : Option < String > , key : Option < String > , oauth_token : Option < String > , pretty_print : Option < bool > , quota_user : Option < String > , upload_protocol : Option < String > , upload_type : Option < String > , xgafv : Option < crate :: params :: Xgafv > , }
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        #[doc = r" populated fields in the yielded items will be determined by the"]
                        #[doc = r" `FieldSelector` implementation."]
                        pub fn iter_inventories<T>(self) -> crate::iter::PageItemIter<Self, T>
                        where
                            T: ::serde::de::DeserializeOwned
                                + ::google_field_selector::FieldSelector,
                        {
                            ...
                            self.iter_inventories_with_fields(fields)
                        }
                        #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                        #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                        #[doc = r" fields in `#items_type` will be the default fields populated by"]
                        #[doc = r" the server."]
                        pub fn iter_inventories_with_default_fields(
                            self,
                        ) -> crate::iter::PageItemIter<Self, crate::schemas::Inventory>
                        {
                            self.iter_inventories_with_fields(None::<String>)
                        }
                        #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                        #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                        #[doc = r" fields in `#items_type` will be all fields available. This should"]
                        ...
                        #[doc = r" all fields can be expensive both in bandwidth and server"]
                        #[doc = r" resources."]
                        pub fn iter_inventories_with_all_fields(
                            self,
                        ) -> crate::iter::PageItemIter<Self, crate::schemas::Inventory>
                        {
                            self.iter_inventories_with_fields(Some("*"))
                        }
                        pub fn iter_inventories_with_fields<T, F>(
                            mut self,
                            fields: Option<F>,
                        ) -> crate::iter::PageItemIter<Self, T>
                        where
                            ...
                            F: AsRef<str>,
                        {
                            ...
                            crate::iter::PageItemIter::new(self, "inventories")
                        }
                        pub fn iter<T>(self) -> crate::iter::PageIter<Self, T>
                        where
                            T: ::serde::de::DeserializeOwned
                        ...
                        pub fn iter_with_default_fields(
                            self,
                        ) -> crate::iter::PageIter<Self, crate::schemas::ListInventoriesResponse>
                        {
                            self.iter_with_fields(None::<&str>)
                        }
                        pub fn iter_with_all_fields(
                ...
                pub mod os_policy_assignments {
                    ...
                    pub mod reports {
                        ...
                        impl<'a> ListRequestBuilder<'a> {
                            ...
                            #[doc = r" populated fields in the yielded items will be determined by the"]
                            #[doc = r" `FieldSelector` implementation."]
                            pub fn iter_os_policy_assignment_reports<T>(
                                self,
                            ) -> crate::iter::PageItemIter<Self, T>
                            where
                                T: ::serde::de::DeserializeOwned
                                    + ::google_field_selector::FieldSelector,
                            {
                                ...
                                self.iter_os_policy_assignment_reports_with_fields(fields)
                            }
                            #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                            #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                            #[doc = r" fields in `#items_type` will be the default fields populated by"]
                            #[doc = r" the server."]
                            pub fn iter_os_policy_assignment_reports_with_default_fields(
                                self,
                            ) -> crate::iter::PageItemIter<
                                Self,
                                crate::schemas::OspolicyAssignmentReport,
                            > {
                                self.iter_os_policy_assignment_reports_with_fields(None::<String>)
                            }
                            #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                            #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                            #[doc = r" fields in `#items_type` will be all fields available. This should"]
                            ...
                            #[doc = r" all fields can be expensive both in bandwidth and server"]
                            #[doc = r" resources."]
                            pub fn iter_os_policy_assignment_reports_with_all_fields(
                                self,
                            ) -> crate::iter::PageItemIter<
                                Self,
                                crate::schemas::OspolicyAssignmentReport,
                            > {
                                self.iter_os_policy_assignment_reports_with_fields(Some("*"))
                            }
                            pub fn iter_os_policy_assignment_reports_with_fields<T, F>(
                                mut self,
                                fields: Option<F>,
                            ) -> crate::iter::PageItemIter<Self, T>
                            where
                                ...
                                F: AsRef<str>,
                            {
                                ...
                                crate::iter::PageItemIter::new(self, "osPolicyAssignmentReports")
                            }
                            pub fn iter<T>(self) -> crate::iter::PageIter<Self, T>
                            where
                                T: ::serde::de::DeserializeOwned
                ...
                pub mod vulnerability_reports {
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        #[doc = r" populated fields in the yielded items will be determined by the"]
                        #[doc = r" `FieldSelector` implementation."]
                        pub fn iter_vulnerability_reports<T>(
                            self,
                        ) -> crate::iter::PageItemIter<Self, T>
                        where
                            T: ::serde::de::DeserializeOwned
                                + ::google_field_selector::FieldSelector,
                        {
                            ...
                            self.iter_vulnerability_reports_with_fields(fields)
                        }
                        #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                        #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                        #[doc = r" fields in `#items_type` will be the default fields populated by"]
                        #[doc = r" the server."]
                        pub fn iter_vulnerability_reports_with_default_fields(
                            self,
                        ) -> crate::iter::PageItemIter<Self, crate::schemas::VulnerabilityReport>
                        {
                            self.iter_vulnerability_reports_with_fields(None::<String>)
                        }
                        #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                        #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                        #[doc = r" fields in `#items_type` will be all fields available. This should"]
                        ...
                        #[doc = r" all fields can be expensive both in bandwidth and server"]
                        #[doc = r" resources."]
                        pub fn iter_vulnerability_reports_with_all_fields(
                            self,
                        ) -> crate::iter::PageItemIter<Self, crate::schemas::VulnerabilityReport>
                        {
                            self.iter_vulnerability_reports_with_fields(Some("*"))
                        }
                        pub fn iter_vulnerability_reports_with_fields<T, F>(
                            mut self,
                            fields: Option<F>,
                        ) -> crate::iter::PageItemIter<Self, T>
                        where
                            ...
                            F: AsRef<str>,
                        {
                            ...
                            crate::iter::PageItemIter::new(self, "vulnerabilityReports")
                        }
                        pub fn iter<T>(self) -> crate::iter::PageIter<Self, T>
                        where
                            T: ::serde::de::DeserializeOwned
            ...
            pub mod os_policy_assignments {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = r" populated fields in the yielded items will be determined by the"]
                    #[doc = r" `FieldSelector` implementation."]
                    pub fn iter_os_policy_assignments<T>(self) -> crate::iter::PageItemIter<Self, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                    {
                        let fields = ::google_field_selector::to_string::<T>();
                        ...
                        self.iter_os_policy_assignments_with_fields(fields)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_os_policy_assignments_with_default_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::OspolicyAssignment>
                    {
                        self.iter_os_policy_assignments_with_fields(None::<String>)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be all fields available. This should"]
                    ...
                    #[doc = r" all fields can be expensive both in bandwidth and server"]
                    #[doc = r" resources."]
                    pub fn iter_os_policy_assignments_with_all_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::OspolicyAssignment>
                    {
                        self.iter_os_policy_assignments_with_fields(Some("*"))
                    }
                    pub fn iter_os_policy_assignments_with_fields<T, F>(
                        mut self,
                        fields: Option<F>,
                    ) -> crate::iter::PageItemIter<Self, T>
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        crate::iter::PageItemIter::new(self, "osPolicyAssignments")
                    }
                    pub fn iter<T>(self) -> crate::iter::PageIter<Self, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                    ...
                    pub fn iter_with_default_fields(
                        self,
                    ) -> crate::iter::PageIter<Self, crate::schemas::ListOSPolicyAssignmentsResponse>
                    {
                        self.iter_with_fields(None::<&str>)
                    }
                    pub fn iter_with_all_fields(
                ...
                impl<'a> crate::iter::IterableMethod for ListRevisionsRequestBuilder<'a> {
                    fn set_page_token(&mut self, value: String) {
                        self.page_token = value.into();
                    }
                    fn execute<T>(&mut self) -> Result<T, crate::Error>
