...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("osconfig1_alpha")
        ...
        let mut locations1 = SubCommand::with_name("locations")
                        .setting(AppSettings::ColoredHelp)
                        .about("sub-resources: instance_os_policies_compliances, instances and os_policy_assignments");
        let mut instance_os_policies_compliances2 =
            SubCommand::with_name("instance_os_policies_compliances")
                .setting(AppSettings::ColoredHelp)
                .about("methods: get and list");
        {
            ...
            instance_os_policies_compliances2 = instance_os_policies_compliances2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("List OS policies compliance data for all Compute Engine VM instances in the specified zone.");
            instance_os_policies_compliances2 = instance_os_policies_compliances2.subcommand(mcmd);
        }
        ...
        locations1 = locations1.subcommand(instance_os_policies_compliances2);
...
use google_osconfig1_alpha as api;
