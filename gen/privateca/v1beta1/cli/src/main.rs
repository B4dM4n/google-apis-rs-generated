...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("privateca1_beta1")
        ...
        let mut certificate_authorities2 = SubCommand::with_name("certificate_authorities")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: activate, create, disable, enable, fetch, get, get_iam_policy, list, patch, restore, schedule_delete, set_iam_policy and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("activate").about("Activate a CertificateAuthority that is in state PENDING_ACTIVATION and is of type SUBORDINATE. After the parent Certificate Authority signs a certificate signing request from FetchCertificateAuthorityCsr, this method can complete the activation process.");
            certificate_authorities2 = certificate_authorities2.subcommand(mcmd);
        }
        {
        ...
        }
        {
            let mcmd = SubCommand::with_name("restore")
                .about("Restore a CertificateAuthority that is scheduled for deletion.");
            certificate_authorities2 = certificate_authorities2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("schedule_delete")
                .about("Schedule a CertificateAuthority for deletion.");
            certificate_authorities2 = certificate_authorities2.subcommand(mcmd);
        }
        {
        ...
        let mut reusable_configs2 = SubCommand::with_name("reusable_configs")
            .setting(AppSettings::ColoredHelp)
            .about("methods: get, get_iam_policy, list, set_iam_policy and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("get").about("Returns a ReusableConfig.");
            reusable_configs2 = reusable_configs2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get_iam_policy").about("Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.");
            reusable_configs2 = reusable_configs2.subcommand(mcmd);
        ...
        {
            let mcmd = SubCommand::with_name("list").about("Lists ReusableConfigs.");
            reusable_configs2 = reusable_configs2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.");
        ...
        let mut certificate_revocation_lists3 = SubCommand::with_name(
        ...
        );
        {
            ...
            certificate_revocation_lists3 = certificate_revocation_lists3.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get_iam_policy").about("Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.");
            certificate_revocation_lists3 = certificate_revocation_lists3.subcommand(mcmd);
        ...
        {
            let mcmd = SubCommand::with_name("create").about("Create a new Certificate in a given Project, Location from a particular CertificateAuthority.");
        ...
        certificate_authorities2 = certificate_authorities2.subcommand(certificates3);
        certificate_authorities2 =
            certificate_authorities2.subcommand(certificate_revocation_lists3);
        locations1 = locations1.subcommand(reusable_configs2);
        locations1 = locations1.subcommand(operations2);
        locations1 = locations1.subcommand(certificate_authorities2);
...
use google_privateca1_beta1 as api;
