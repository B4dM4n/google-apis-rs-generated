...
pub mod schemas {
    ...
    impl crate::GetNextPageToken for GoogleExampleLibraryagentV1ListBooksResponse {
    ...
    impl crate::GetNextPageToken for GoogleExampleLibraryagentV1ListShelvesResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
