...
pub mod scopes {
    ...
    #[doc = "View your Google Compute Engine resources\n\n`https://www.googleapis.com/auth/compute.readonly`"]
...
pub mod schemas {
    ...
    impl ::google_field_selector::ToFieldType for ImportSshPublicKeyResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for LoginProfile {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for LoginProfile {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for PosixAccount {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for PosixAccountOperatingSystemType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PosixAccountOperatingSystemType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    pub mod users {
        pub mod params {
            #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
            pub enum GetLoginProfileOperatingSystemType {
                #[doc = "Linux user account information."]
                Linux,
                #[doc = "The operating system type associated with the user account information is unspecified."]
                OperatingSystemTypeUnspecified,
            ...
            impl GetLoginProfileOperatingSystemType {
                pub fn as_str(self) -> &'static str {
                    match self {
                        GetLoginProfileOperatingSystemType::Linux => "LINUX",
                        GetLoginProfileOperatingSystemType::OperatingSystemTypeUnspecified => {
                            "OPERATING_SYSTEM_TYPE_UNSPECIFIED"
                        }
                        GetLoginProfileOperatingSystemType::Windows => "WINDOWS",
                    }
                }
            }
            impl ::std::convert::AsRef<str> for GetLoginProfileOperatingSystemType {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
            impl ::std::str::FromStr for GetLoginProfileOperatingSystemType {
                type Err = ();
                fn from_str(
                    s: &str,
                ) -> ::std::result::Result<GetLoginProfileOperatingSystemType, ()> {
                    Ok(match s {
                        "LINUX" => GetLoginProfileOperatingSystemType::Linux,
                        "OPERATING_SYSTEM_TYPE_UNSPECIFIED" => {
                            GetLoginProfileOperatingSystemType::OperatingSystemTypeUnspecified
                        }
                        "WINDOWS" => GetLoginProfileOperatingSystemType::Windows,
                        _ => return Err(()),
                    })
                }
            }
            impl ::std::fmt::Display for GetLoginProfileOperatingSystemType {
                fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                    f.write_str(self.as_str())
                }
            }
            impl ::serde::Serialize for GetLoginProfileOperatingSystemType {
                fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
                where
                    S: ::serde::ser::Serializer,
                {
            ...
            impl<'de> ::serde::Deserialize<'de> for GetLoginProfileOperatingSystemType {
                fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
                where
                    D: ::serde::de::Deserializer<'de>,
                {
            ...
            impl ::google_field_selector::FieldSelector for GetLoginProfileOperatingSystemType {
                fn fields() -> Vec<::google_field_selector::Field> {
                    Vec::new()
                }
            }
            impl ::google_field_selector::ToFieldType for GetLoginProfileOperatingSystemType {
                fn field_type() -> ::google_field_selector::FieldType {
                    ::google_field_selector::FieldType::Leaf
                }
            }
        ...
        impl<'a> UsersActions<'a> {
            ...
            #[doc = "Retrieves the profile information used for logging in to a virtual machine on Google Compute Engine."]
            ...
            pub fn projects(&self) -> crate::resources::users::projects::ProjectsActions {
        ...
        pub struct GetLoginProfileRequestBuilder<'a> {
            ...
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            name: String,
            operating_system_type: ::std::option::Option<
                crate::resources::users::params::GetLoginProfileOperatingSystemType,
            >,
            project_id: ::std::option::Option<String>,
            system_id: ::std::option::Option<String>,
            view: ::std::option::Option<crate::resources::users::params::GetLoginProfileView>,
        ...
        impl<'a> GetLoginProfileRequestBuilder<'a> {
            #[doc = "The type of operating system associated with the account."]
            pub fn operating_system_type(
                mut self,
                value: crate::resources::users::params::GetLoginProfileOperatingSystemType,
            ) -> Self {
                self.operating_system_type = Some(value);
                self
            }
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::LoginProfile, crate::Error> {
            ...
            async fn _request(
                ...
                req = req.query(&[("operatingSystemType", &self.operating_system_type)]);
        ...
        pub struct ImportSshPublicKeyRequestBuilder<'a> {
            ...
            parent: String,
            project_id: ::std::option::Option<String>,
            view: ::std::option::Option<crate::resources::users::params::ImportSshPublicKeyView>,
            access_token: ::std::option::Option<String>,
            alt: ::std::option::Option<crate::params::Alt>,
            callback: ::std::option::Option<String>,
            fields: ::std::option::Option<String>,
        ...
        impl<'a> ImportSshPublicKeyRequestBuilder<'a> {
            #[doc = "The project ID of the Google Cloud Platform project."]
            pub fn project_id(mut self, value: impl Into<String>) -> Self {
                self.project_id = Some(value.into());
                self
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::ImportSshPublicKeyResponse, crate::Error> {
                self.execute_with_fields(None::<&str>).await
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
        ...
        pub mod projects {
            pub mod params {
                #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
                pub enum DeleteOperatingSystemType {
                    #[doc = "Linux user account information."]
                    Linux,
                    #[doc = "The operating system type associated with the user account information is unspecified."]
                    OperatingSystemTypeUnspecified,
                ...
                impl DeleteOperatingSystemType {
                    pub fn as_str(self) -> &'static str {
                        match self {
                            DeleteOperatingSystemType::Linux => "LINUX",
                            DeleteOperatingSystemType::OperatingSystemTypeUnspecified => {
                                "OPERATING_SYSTEM_TYPE_UNSPECIFIED"
                            }
                            DeleteOperatingSystemType::Windows => "WINDOWS",
                        }
                    }
                }
                impl ::std::convert::AsRef<str> for DeleteOperatingSystemType {
                    fn as_ref(&self) -> &str {
                        self.as_str()
                    }
                }
                impl ::std::str::FromStr for DeleteOperatingSystemType {
                    type Err = ();
                    fn from_str(s: &str) -> ::std::result::Result<DeleteOperatingSystemType, ()> {
                        Ok(match s {
                            "LINUX" => DeleteOperatingSystemType::Linux,
                            "OPERATING_SYSTEM_TYPE_UNSPECIFIED" => {
                                DeleteOperatingSystemType::OperatingSystemTypeUnspecified
                            }
                            "WINDOWS" => DeleteOperatingSystemType::Windows,
                            _ => return Err(()),
                        })
                    }
                }
                impl ::std::fmt::Display for DeleteOperatingSystemType {
                    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                        f.write_str(self.as_str())
                    }
                }
                impl ::serde::Serialize for DeleteOperatingSystemType {
                    fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
                    where
                        S: ::serde::ser::Serializer,
                    {
                ...
                impl<'de> ::serde::Deserialize<'de> for DeleteOperatingSystemType {
                    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
                    where
                        D: ::serde::de::Deserializer<'de>,
                    {
                ...
                impl ::google_field_selector::FieldSelector for DeleteOperatingSystemType {
                    fn fields() -> Vec<::google_field_selector::Field> {
                        Vec::new()
                    }
                }
                impl ::google_field_selector::ToFieldType for DeleteOperatingSystemType {
                    fn field_type() -> ::google_field_selector::FieldType {
                        ::google_field_selector::FieldType::Leaf
                    }
                }
            ...
            pub struct DeleteRequestBuilder<'a> {
                ...
                name: String,
                operating_system_type: ::std::option::Option<
                    crate::resources::users::projects::params::DeleteOperatingSystemType,
                >,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
            ...
            impl<'a> DeleteRequestBuilder<'a> {
                ...
                pub fn operating_system_type(
                    mut self,
                    value: crate::resources::users::projects::params::DeleteOperatingSystemType,
                ) -> Self {
                    self.operating_system_type = Some(value);
                    self
                }
        ...
        pub mod ssh_public_keys {
            pub mod params {}
            pub struct SshPublicKeysActions<'a> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            }
            impl<'a> SshPublicKeysActions<'a> {
                fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                    self.auth
                }
                ...
                #[doc = "Updates an SSH public key and returns the profile information. This method supports patch semantics."]
                pub fn patch(
                    &self,
                    request: crate::schemas::SshPublicKey,
                    name: impl Into<String>,
