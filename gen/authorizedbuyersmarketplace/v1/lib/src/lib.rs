    ...
    pub mod bidders {
        ...
        pub mod finalized_deals {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn iter_finalized_deals<T>(self) -> crate::iter::PageItemIter<Self, T>
                where
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                {
                    ...
                    self.iter_finalized_deals_with_fields(fields)
                }
                #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_finalized_deals_with_default_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::FinalizedDeal>
                {
                    self.iter_finalized_deals_with_fields(None::<String>)
                }
                #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                ...
                #[doc = r" resources."]
                pub fn iter_finalized_deals_with_all_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::FinalizedDeal>
                {
                    self.iter_finalized_deals_with_fields(Some("*"))
                }
                pub fn iter_finalized_deals_with_fields<T, F>(
                    mut self,
                    fields: Option<F>,
                    ...
                    F: AsRef<str>,
                {
                    ...
                    crate::iter::PageItemIter::new(self, "finalizedDeals")
                }
                ...
                pub fn iter_with_default_fields(
                    self,
                ) -> crate::iter::PageIter<Self, crate::schemas::ListFinalizedDealsResponse>
                {
    ...
    pub mod buyers {
        ...
        pub mod auction_packages {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_auction_packages<T>(self) -> crate::iter::PageItemIter<Self, T>
                where
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                {
                    let fields = ::google_field_selector::to_string::<T>();
                    ...
                    self.iter_auction_packages_with_fields(fields)
                }
                #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_auction_packages_with_default_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::AuctionPackage>
                {
                    self.iter_auction_packages_with_fields(None::<String>)
                }
                #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                #[doc = r" fields in `#items_type` will be all fields available. This should"]
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_auction_packages_with_all_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::AuctionPackage>
                {
                    self.iter_auction_packages_with_fields(Some("*"))
                }
                pub fn iter_auction_packages_with_fields<T, F>(
                    mut self,
                    fields: Option<F>,
                ) -> crate::iter::PageItemIter<Self, T>
                where
                    ...
                    F: AsRef<str>,
                {
                    ...
                    crate::iter::PageItemIter::new(self, "auctionPackages")
                }
                pub fn iter<T>(self) -> crate::iter::PageIter<Self, T>
                where
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                ...
                pub fn iter_with_default_fields(
                    self,
                ) -> crate::iter::PageIter<Self, crate::schemas::ListAuctionPackagesResponse>
                {
                    self.iter_with_fields(None::<&str>)
                }
                pub fn iter_with_all_fields(
        ...
        pub mod clients {
            ...
            pub mod users {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = r" populated fields in the yielded items will be determined by the"]
                    #[doc = r" `FieldSelector` implementation."]
                    pub fn iter_client_users<T>(self) -> crate::iter::PageItemIter<Self, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                    {
                        let fields = ::google_field_selector::to_string::<T>();
                        ...
                        self.iter_client_users_with_fields(fields)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_client_users_with_default_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::ClientUser>
                    {
                        self.iter_client_users_with_fields(None::<String>)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be all fields available. This should"]
                    ...
                    #[doc = r" all fields can be expensive both in bandwidth and server"]
                    #[doc = r" resources."]
                    pub fn iter_client_users_with_all_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::ClientUser>
                    {
                        self.iter_client_users_with_fields(Some("*"))
                    }
                    pub fn iter_client_users_with_fields<T, F>(
                        mut self,
                        fields: Option<F>,
                    ) -> crate::iter::PageItemIter<Self, T>
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        crate::iter::PageItemIter::new(self, "clientUsers")
                    }
                    pub fn iter<T>(self) -> crate::iter::PageIter<Self, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
        ...
        pub mod proposals {
            ...
            pub mod deals {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = r" populated fields in the yielded items will be determined by the"]
                    #[doc = r" `FieldSelector` implementation."]
                    pub fn iter_deals<T>(self) -> crate::iter::PageItemIter<Self, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                    {
                        let fields = ::google_field_selector::to_string::<T>();
                        ...
                        self.iter_deals_with_fields(fields)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_deals_with_default_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::Deal> {
                        self.iter_deals_with_fields(None::<String>)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be all fields available. This should"]
                    ...
                    #[doc = r" all fields can be expensive both in bandwidth and server"]
                    #[doc = r" resources."]
                    pub fn iter_deals_with_all_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::Deal> {
                        self.iter_deals_with_fields(Some("*"))
                    }
                    pub fn iter_deals_with_fields<T, F>(
                        mut self,
                        fields: Option<F>,
                    ) -> crate::iter::PageItemIter<Self, T>
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        crate::iter::PageItemIter::new(self, "deals")
                    }
                    pub fn iter<T>(self) -> crate::iter::PageIter<Self, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                    ...
                    pub fn iter_with_default_fields(
                        self,
                    ) -> crate::iter::PageIter<Self, crate::schemas::ListDealsResponse>
                    {
                        self.iter_with_fields(None::<&str>)
                    }
                    pub fn iter_with_all_fields(
