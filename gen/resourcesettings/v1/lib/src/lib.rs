...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for GoogleCloudResourcesettingsV1ListSettingsResponse {
    ...
    pub mod folders {
        ...
        pub mod settings {
            ...
            pub struct GetRequestBuilder<'a> {
                ...
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                name: String,
                view: ::std::option::Option<crate::resources::folders::settings::params::GetView>,
            ...
            pub struct ListRequestBuilder<'a> {
                ...
                view: ::std::option::Option<crate::resources::folders::settings::params::ListView>,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
                fields: ::std::option::Option<String>,
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `settings` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_settings<T>(
                    self,
                    ...
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_settings_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `settings` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_settings_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<
                    Item = Result<
                    ...
                    >,
                > + 'a {
                    self.stream_settings_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `settings` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_settings_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<
                    Item = Result<
                        crate::schemas::GoogleCloudResourcesettingsV1Setting,
                    ...
                    >,
                > + 'a {
                    self.stream_settings_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `settings` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_settings_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
        ...
        pub mod settings {
            ...
            pub struct GetRequestBuilder<'a> {
                ...
                view: ::std::option::Option<
                    crate::resources::organizations::settings::params::GetView,
                >,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
            ...
            pub struct ListRequestBuilder<'a> {
                ...
                page_token: ::std::option::Option<String>,
                view: ::std::option::Option<
                    crate::resources::organizations::settings::params::ListView,
                >,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
    ...
    pub mod projects {
        ...
        pub mod settings {
            ...
            pub struct GetRequestBuilder<'a> {
                ...
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                name: String,
                view: ::std::option::Option<crate::resources::projects::settings::params::GetView>,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
                fields: ::std::option::Option<String>,
            ...
            pub struct ListRequestBuilder<'a> {
                ...
                page_size: ::std::option::Option<i32>,
                page_token: ::std::option::Option<String>,
                view: ::std::option::Option<crate::resources::projects::settings::params::ListView>,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
                fields: ::std::option::Option<String>,
