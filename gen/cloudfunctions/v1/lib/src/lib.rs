...
pub mod schemas {
    ...
    impl ::google_field_selector::ToFieldType for CallFunctionRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for CallFunctionResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct CloudFunction {
        ...
        pub build_worker_pool: ::std::option::Option<String>,
        ...
        pub vpc_connector_egress_settings:
            ::std::option::Option<crate::schemas::CloudFunctionVpcConnectorEgressSettings>,
    }
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum CloudFunctionIngressSettings {
    ...
    impl CloudFunctionIngressSettings {
        pub fn as_str(self) -> &'static str {
            match self {
                CloudFunctionIngressSettings::AllowAll => "ALLOW_ALL",
                CloudFunctionIngressSettings::AllowInternalAndGclb => "ALLOW_INTERNAL_AND_GCLB",
                CloudFunctionIngressSettings::AllowInternalOnly => "ALLOW_INTERNAL_ONLY",
                CloudFunctionIngressSettings::IngressSettingsUnspecified => {
                    "INGRESS_SETTINGS_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for CloudFunctionIngressSettings {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for CloudFunctionIngressSettings {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<CloudFunctionIngressSettings, ()> {
            Ok(match s {
                "ALLOW_ALL" => CloudFunctionIngressSettings::AllowAll,
                "ALLOW_INTERNAL_AND_GCLB" => CloudFunctionIngressSettings::AllowInternalAndGclb,
                "ALLOW_INTERNAL_ONLY" => CloudFunctionIngressSettings::AllowInternalOnly,
                "INGRESS_SETTINGS_UNSPECIFIED" => {
                    CloudFunctionIngressSettings::IngressSettingsUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for CloudFunctionIngressSettings {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for CloudFunctionIngressSettings {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for CloudFunctionIngressSettings {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for CloudFunctionIngressSettings {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudFunctionIngressSettings {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for CloudFunctionStatus {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudFunctionStatus {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum CloudFunctionVpcConnectorEgressSettings {
    ...
    impl CloudFunctionVpcConnectorEgressSettings {
        pub fn as_str(self) -> &'static str {
            match self {
                CloudFunctionVpcConnectorEgressSettings::AllTraffic => "ALL_TRAFFIC",
                CloudFunctionVpcConnectorEgressSettings::PrivateRangesOnly => "PRIVATE_RANGES_ONLY",
                CloudFunctionVpcConnectorEgressSettings::VpcConnectorEgressSettingsUnspecified => {
                    "VPC_CONNECTOR_EGRESS_SETTINGS_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for CloudFunctionVpcConnectorEgressSettings {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for CloudFunctionVpcConnectorEgressSettings {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<CloudFunctionVpcConnectorEgressSettings, ()> {
            Ok(match s {
                "ALL_TRAFFIC" => CloudFunctionVpcConnectorEgressSettings::AllTraffic,
                "PRIVATE_RANGES_ONLY" => CloudFunctionVpcConnectorEgressSettings::PrivateRangesOnly,
                "VPC_CONNECTOR_EGRESS_SETTINGS_UNSPECIFIED" => {
                    CloudFunctionVpcConnectorEgressSettings::VpcConnectorEgressSettingsUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for CloudFunctionVpcConnectorEgressSettings {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for CloudFunctionVpcConnectorEgressSettings {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for CloudFunctionVpcConnectorEgressSettings {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for CloudFunctionVpcConnectorEgressSettings {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CloudFunctionVpcConnectorEgressSettings {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for FailurePolicy {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct HttpsTrigger {
        ...
        pub security_level: ::std::option::Option<crate::schemas::HttpsTriggerSecurityLevel>,
    ...
    impl ::google_field_selector::ToFieldType for HttpsTrigger {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum HttpsTriggerSecurityLevel {
    ...
    impl HttpsTriggerSecurityLevel {
        pub fn as_str(self) -> &'static str {
            match self {
                HttpsTriggerSecurityLevel::SecureAlways => "SECURE_ALWAYS",
                HttpsTriggerSecurityLevel::SecureOptional => "SECURE_OPTIONAL",
                HttpsTriggerSecurityLevel::SecurityLevelUnspecified => "SECURITY_LEVEL_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for HttpsTriggerSecurityLevel {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for HttpsTriggerSecurityLevel {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<HttpsTriggerSecurityLevel, ()> {
            Ok(match s {
                "SECURE_ALWAYS" => HttpsTriggerSecurityLevel::SecureAlways,
                "SECURE_OPTIONAL" => HttpsTriggerSecurityLevel::SecureOptional,
                "SECURITY_LEVEL_UNSPECIFIED" => HttpsTriggerSecurityLevel::SecurityLevelUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for HttpsTriggerSecurityLevel {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for HttpsTriggerSecurityLevel {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for HttpsTriggerSecurityLevel {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for HttpsTriggerSecurityLevel {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for HttpsTriggerSecurityLevel {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for Retry {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for SourceRepository {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
        ...
        pub mod locations {
            ...
            pub mod functions {
                ...
                impl<'a> FunctionsActions<'a> {
                    ...
                    #[doc = "Synchronously invokes a deployed Cloud Function. To be used for testing purposes as very limited traffic is allowed. For more information on the actual limits, refer to [Rate Limits](https://cloud.google.com/functions/quotas#rate_limits)."]
                    pub fn call(
                        &self,
                        request: crate::schemas::CallFunctionRequest,
                    ...
                    pub fn create(
                        &self,
                        request: crate::schemas::CloudFunction,
                    ...
                    #[doc = "Returns a signed URL for downloading deployed function source code. The URL is only valid for a limited period and should be used within minutes after generation. For more information about the signed URL usage see: https://cloud.google.com/storage/docs/access-control/signed-urls"]
                    ...
                    #[doc = "Gets the IAM access control policy for a function. Returns an empty policy if the function exists and does not have a policy set."]
                    ...
                    #[doc = "Sets the IAM access control policy on the specified function. Replaces any existing policy."]
                    ...
                    #[doc = "Tests the specified permissions against the IAM access control policy for a function. If the function does not exist, this will return an empty set of permissions, not a NOT_FOUND error."]
                ...
                impl<'a> CallRequestBuilder<'a> {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::CallFunctionResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                impl<'a> GetRequestBuilder<'a> {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::CloudFunction, crate::Error> {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    #[doc = r" selector of `*`. This will include every attribute of the"]
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn stream_functions_with_default_fields(
                        ...
                        Item = Result<crate::schemas::CloudFunction, crate::Error>,
                    > + 'a {
