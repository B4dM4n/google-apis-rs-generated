...
pub mod schemas {
    ...
    pub struct BuildConfig {
        #[doc = "Output only. The Cloud Build name of the latest successful deployment of the function."]
        #[serde(
            rename = "build",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Specifies one of the Google provided buildpack stacks."]
        #[serde(
            rename = "buildpackStack",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub buildpack_stack: ::std::option::Option<String>,
        #[doc = "Optional. Docker Registry to use for this deployment. This configuration is only applicable to 1st Gen functions, 2nd Gen functions can only use Artifact Registry. If `docker_repository` field is specified, this field will be automatically set as `ARTIFACT_REGISTRY`. If unspecified, it currently defaults to `CONTAINER_REGISTRY`. This field may be overridden by the backend for eligible deployments."]
        #[serde(
            rename = "dockerRegistry",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub docker_registry: ::std::option::Option<crate::schemas::BuildConfigDockerRegistry>,
        ...
        #[doc = "User-provided build-time environment variables for the function"]
        #[serde(
        ...
        #[doc = "The location of the function source code."]
        #[serde(
            rename = "source",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for BuildConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BuildConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum BuildConfigDockerRegistry {
    ...
    impl BuildConfigDockerRegistry {
        pub fn as_str(self) -> &'static str {
            match self {
                BuildConfigDockerRegistry::ArtifactRegistry => "ARTIFACT_REGISTRY",
                BuildConfigDockerRegistry::ContainerRegistry => "CONTAINER_REGISTRY",
                BuildConfigDockerRegistry::DockerRegistryUnspecified => {
                    "DOCKER_REGISTRY_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for BuildConfigDockerRegistry {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for BuildConfigDockerRegistry {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<BuildConfigDockerRegistry, ()> {
            Ok(match s {
                "ARTIFACT_REGISTRY" => BuildConfigDockerRegistry::ArtifactRegistry,
                "CONTAINER_REGISTRY" => BuildConfigDockerRegistry::ContainerRegistry,
                "DOCKER_REGISTRY_UNSPECIFIED" => {
                    BuildConfigDockerRegistry::DockerRegistryUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for BuildConfigDockerRegistry {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for BuildConfigDockerRegistry {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for BuildConfigDockerRegistry {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for BuildConfigDockerRegistry {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BuildConfigDockerRegistry {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct EventFilter {
        ...
        #[doc = "Optional. The operator used for matching the events with the value of the filter. If not specified, only events that have an exact key-value pair specified in the filter are matched. The only allowed value is `match-path-pattern`."]
        #[serde(
            rename = "operator",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct EventTrigger {
        #[doc = "Optional. The name of the channel associated with the trigger in `projects/{project}/locations/{location}/channels/{channel}` format. You must provide a channel to receive events from Eventarc SaaS partners."]
        #[serde(
            rename = "channel",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Criteria used to filter events."]
        #[serde(
            rename = "eventFilters",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Required. The type of event to observe. For example: `google.cloud.audit.log.v1.written` or `google.cloud.pubsub.topic.v1.messagePublished`."]
        #[serde(
            rename = "eventType",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Optional. The name of a Pub/Sub topic in the same project that will be used as the transport topic for the event delivery. Format: `projects/{project}/topics/{topic}`. This is only valid for events of type `google.cloud.pubsub.topic.v1.messagePublished`. The topic provided here will not be deleted at function deletion."]
        #[serde(
            rename = "pubsubTopic",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Optional. If unset, then defaults to ignoring failures (i.e. not retrying them)."]
        #[serde(
            rename = "retryPolicy",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub retry_policy: ::std::option::Option<crate::schemas::EventTriggerRetryPolicy>,
        #[doc = "Optional. The email of the trigger’s service account. The service account must have permission to invoke Cloud Run services, the permission is `run.routes.invoke`. If empty, defaults to the Compute Engine default service account: `{project_number}-compute@developer.gserviceaccount.com`."]
        #[serde(
        ...
        #[doc = "Output only. The resource name of the Eventarc trigger. The format of this field is `projects/{project}/locations/{region}/triggers/{trigger}`."]
        #[serde(
            rename = "trigger",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub trigger: ::std::option::Option<String>,
        #[doc = "The region that the trigger will be in. The trigger will only receive events originating in this region. It can be the same region as the function, a different region or multi-region, or the global region. If not provided, defaults to the same region as the function."]
        #[serde(
            rename = "triggerRegion",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub trigger_region: ::std::option::Option<String>,
    }
    ...
    impl ::google_field_selector::ToFieldType for EventTrigger {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum EventTriggerRetryPolicy {
        #[doc = "Do not retry."]
        RetryPolicyDoNotRetry,
        #[doc = "Retry on any failure, retry up to 7 days with an exponential backoff (capped at 10 seconds)."]
        RetryPolicyRetry,
        #[doc = "Not specified."]
        RetryPolicyUnspecified,
    }
    impl EventTriggerRetryPolicy {
        pub fn as_str(self) -> &'static str {
            match self {
                EventTriggerRetryPolicy::RetryPolicyDoNotRetry => "RETRY_POLICY_DO_NOT_RETRY",
                EventTriggerRetryPolicy::RetryPolicyRetry => "RETRY_POLICY_RETRY",
                EventTriggerRetryPolicy::RetryPolicyUnspecified => "RETRY_POLICY_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for EventTriggerRetryPolicy {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for EventTriggerRetryPolicy {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<EventTriggerRetryPolicy, ()> {
            Ok(match s {
                "RETRY_POLICY_DO_NOT_RETRY" => EventTriggerRetryPolicy::RetryPolicyDoNotRetry,
                "RETRY_POLICY_RETRY" => EventTriggerRetryPolicy::RetryPolicyRetry,
                "RETRY_POLICY_UNSPECIFIED" => EventTriggerRetryPolicy::RetryPolicyUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for EventTriggerRetryPolicy {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for EventTriggerRetryPolicy {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for EventTriggerRetryPolicy {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for EventTriggerRetryPolicy {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for EventTriggerRetryPolicy {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Function {
        #[doc = "Describes the Build step of the function that builds a container from the given source."]
        #[serde(
            rename = "buildConfig",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub build_config: ::std::option::Option<crate::schemas::BuildConfig>,
        ...
        pub description: ::std::option::Option<String>,
        #[doc = "Describe whether the function is 1st Gen or 2nd Gen."]
        #[serde(
            rename = "environment",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub environment: ::std::option::Option<crate::schemas::FunctionEnvironment>,
        #[doc = "An Eventarc trigger managed by Google Cloud Functions that fires events in response to a condition in another service."]
        #[serde(
            rename = "eventTrigger",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Describes the Service being deployed. Currently deploys services to Cloud Run (fully managed)."]
        #[serde(
            rename = "serviceConfig",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub service_config: ::std::option::Option<crate::schemas::ServiceConfig>,
        #[doc = "Output only. State of the function."]
        #[serde(
            rename = "state",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub state: ::std::option::Option<crate::schemas::FunctionState>,
        #[doc = "Output only. State Messages for this Cloud Function."]
        #[serde(
        ...
        pub state_messages:
            ::std::option::Option<Vec<crate::schemas::GoogleCloudFunctionsV2StateMessage>>,
    ...
    impl ::google_field_selector::FieldSelector for Function {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for Function {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl FunctionEnvironment {
        pub fn as_str(self) -> &'static str {
            match self {
                FunctionEnvironment::EnvironmentUnspecified => "ENVIRONMENT_UNSPECIFIED",
                FunctionEnvironment::Gen1 => "GEN_1",
                FunctionEnvironment::Gen2 => "GEN_2",
            }
        }
    }
    impl ::std::convert::AsRef<str> for FunctionEnvironment {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for FunctionEnvironment {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<FunctionEnvironment, ()> {
            Ok(match s {
                "ENVIRONMENT_UNSPECIFIED" => FunctionEnvironment::EnvironmentUnspecified,
                "GEN_1" => FunctionEnvironment::Gen1,
                "GEN_2" => FunctionEnvironment::Gen2,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for FunctionEnvironment {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for FunctionEnvironment {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for FunctionEnvironment {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for FunctionEnvironment {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for FunctionEnvironment {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub enum FunctionState {
        ...
        Deploying,
        #[doc = "Function deployment failed and the function is not serving."]
        Failed,
    ...
    impl FunctionState {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                FunctionState::Deploying => "DEPLOYING",
                FunctionState::Failed => "FAILED",
                FunctionState::StateUnspecified => "STATE_UNSPECIFIED",
                FunctionState::Unknown => "UNKNOWN",
            }
        }
    }
    impl ::std::convert::AsRef<str> for FunctionState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for FunctionState {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<FunctionState, ()> {
            Ok(match s {
                "ACTIVE" => FunctionState::Active,
                "DELETING" => FunctionState::Deleting,
                "DEPLOYING" => FunctionState::Deploying,
                "FAILED" => FunctionState::Failed,
                "STATE_UNSPECIFIED" => FunctionState::StateUnspecified,
                "UNKNOWN" => FunctionState::Unknown,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::serde::Serialize for FunctionState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for FunctionState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for FunctionState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for FunctionState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for GenerateDownloadUrlRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GenerateDownloadUrlRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for GenerateDownloadUrlResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for GenerateUploadUrlRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudFunctionsV2OperationMetadata {
        ...
        pub stages: ::std::option::Option<Vec<crate::schemas::GoogleCloudFunctionsV2Stage>>,
        #[doc = "Human-readable status of the operation, if any."]
        #[serde(
            rename = "statusDetail",
            default,
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudFunctionsV2OperationMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudFunctionsV2OperationMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudFunctionsV2Stage {
        ...
        pub name: ::std::option::Option<crate::schemas::GoogleCloudFunctionsV2StageName>,
        #[doc = "Resource of the Stage"]
        #[serde(
            rename = "resource",
            default,
        ...
        pub state: ::std::option::Option<crate::schemas::GoogleCloudFunctionsV2StageState>,
        #[doc = "State messages from the current Stage."]
        #[serde(
            rename = "stateMessages",
            default,
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudFunctionsV2Stage {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudFunctionsV2Stage {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum GoogleCloudFunctionsV2StageName {
        #[doc = "Artifact Regsitry Stage"]
        ArtifactRegistry,
        #[doc = "Build Stage"]
        Build,
    ...
    impl GoogleCloudFunctionsV2StageName {
        pub fn as_str(self) -> &'static str {
            match self {
                GoogleCloudFunctionsV2StageName::ArtifactRegistry => "ARTIFACT_REGISTRY",
                GoogleCloudFunctionsV2StageName::Build => "BUILD",
                GoogleCloudFunctionsV2StageName::NameUnspecified => "NAME_UNSPECIFIED",
                GoogleCloudFunctionsV2StageName::Service => "SERVICE",
                GoogleCloudFunctionsV2StageName::ServiceRollback => "SERVICE_ROLLBACK",
                GoogleCloudFunctionsV2StageName::Trigger => "TRIGGER",
                GoogleCloudFunctionsV2StageName::TriggerRollback => "TRIGGER_ROLLBACK",
            }
        }
    }
    impl ::std::convert::AsRef<str> for GoogleCloudFunctionsV2StageName {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for GoogleCloudFunctionsV2StageName {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<GoogleCloudFunctionsV2StageName, ()> {
            Ok(match s {
                "ARTIFACT_REGISTRY" => GoogleCloudFunctionsV2StageName::ArtifactRegistry,
                "BUILD" => GoogleCloudFunctionsV2StageName::Build,
                "NAME_UNSPECIFIED" => GoogleCloudFunctionsV2StageName::NameUnspecified,
                "SERVICE" => GoogleCloudFunctionsV2StageName::Service,
                "SERVICE_ROLLBACK" => GoogleCloudFunctionsV2StageName::ServiceRollback,
                "TRIGGER" => GoogleCloudFunctionsV2StageName::Trigger,
                "TRIGGER_ROLLBACK" => GoogleCloudFunctionsV2StageName::TriggerRollback,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for GoogleCloudFunctionsV2StageName {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for GoogleCloudFunctionsV2StageName {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for GoogleCloudFunctionsV2StageName {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudFunctionsV2StageName {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudFunctionsV2StageName {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum GoogleCloudFunctionsV2StageState {
        #[doc = "Stage has completed."]
        Complete,
        #[doc = "Stage is in progress."]
        InProgress,
    ...
    impl GoogleCloudFunctionsV2StageState {
        pub fn as_str(self) -> &'static str {
            match self {
                GoogleCloudFunctionsV2StageState::Complete => "COMPLETE",
                GoogleCloudFunctionsV2StageState::InProgress => "IN_PROGRESS",
                GoogleCloudFunctionsV2StageState::NotStarted => "NOT_STARTED",
                GoogleCloudFunctionsV2StageState::StateUnspecified => "STATE_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for GoogleCloudFunctionsV2StageState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for GoogleCloudFunctionsV2StageState {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<GoogleCloudFunctionsV2StageState, ()> {
            Ok(match s {
                "COMPLETE" => GoogleCloudFunctionsV2StageState::Complete,
                "IN_PROGRESS" => GoogleCloudFunctionsV2StageState::InProgress,
                "NOT_STARTED" => GoogleCloudFunctionsV2StageState::NotStarted,
                "STATE_UNSPECIFIED" => GoogleCloudFunctionsV2StageState::StateUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for GoogleCloudFunctionsV2StageState {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for GoogleCloudFunctionsV2StageState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for GoogleCloudFunctionsV2StageState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudFunctionsV2StageState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudFunctionsV2StageState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudFunctionsV2StateMessage {
        ...
        pub severity:
            ::std::option::Option<crate::schemas::GoogleCloudFunctionsV2StateMessageSeverity>,
    }
    impl ::google_field_selector::FieldSelector for GoogleCloudFunctionsV2StateMessage {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudFunctionsV2StateMessage {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum GoogleCloudFunctionsV2StateMessageSeverity {
        #[doc = "ERROR-level severity."]
        Error,
        #[doc = "INFO-level severity."]
        Info,
    ...
    impl GoogleCloudFunctionsV2StateMessageSeverity {
        pub fn as_str(self) -> &'static str {
            match self {
                GoogleCloudFunctionsV2StateMessageSeverity::Error => "ERROR",
                GoogleCloudFunctionsV2StateMessageSeverity::Info => "INFO",
                GoogleCloudFunctionsV2StateMessageSeverity::SeverityUnspecified => {
                    "SEVERITY_UNSPECIFIED"
                }
                GoogleCloudFunctionsV2StateMessageSeverity::Warning => "WARNING",
            }
        }
    }
    impl ::std::convert::AsRef<str> for GoogleCloudFunctionsV2StateMessageSeverity {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for GoogleCloudFunctionsV2StateMessageSeverity {
        type Err = ();
        fn from_str(
            s: &str,
        ) -> ::std::result::Result<GoogleCloudFunctionsV2StateMessageSeverity, ()> {
            Ok(match s {
                "ERROR" => GoogleCloudFunctionsV2StateMessageSeverity::Error,
                "INFO" => GoogleCloudFunctionsV2StateMessageSeverity::Info,
                "SEVERITY_UNSPECIFIED" => {
                    GoogleCloudFunctionsV2StateMessageSeverity::SeverityUnspecified
                }
                "WARNING" => GoogleCloudFunctionsV2StateMessageSeverity::Warning,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for GoogleCloudFunctionsV2StateMessageSeverity {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for GoogleCloudFunctionsV2StateMessageSeverity {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for GoogleCloudFunctionsV2StateMessageSeverity {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudFunctionsV2StateMessageSeverity {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudFunctionsV2StateMessageSeverity {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ListFunctionsResponse {
        ...
        pub functions: ::std::option::Option<Vec<crate::schemas::Function>>,
    ...
    impl ::google_field_selector::ToFieldType for ListFunctionsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListFunctionsResponse {
    ...
    pub struct ListRuntimesResponse {
        #[doc = "The runtimes that match the request."]
        #[serde(
            rename = "runtimes",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl OperationMetadataV1Type {
        pub fn as_str(self) -> &'static str {
            match self {
                OperationMetadataV1Type::CreateFunction => "CREATE_FUNCTION",
                OperationMetadataV1Type::DeleteFunction => "DELETE_FUNCTION",
    ...
    impl ::serde::Serialize for OperationMetadataV1Type {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for OperationMetadataV1Type {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for OperationMetadataV1Type {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for OperationMetadataV1Type {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct RepoSource {
        ...
        #[doc = "Directory, relative to the source root, in which to run the build. This must be a relative path. If a step’s `dir` is specified and is an absolute path, this value is ignored for that step’s execution. eg. helloworld (no leading slash allowed)"]
        #[serde(
            rename = "dir",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct Runtime {
        #[doc = "The user facing name, eg ‘Go 1.13’, ‘Node.js 12’, etc."]
        #[serde(
            rename = "displayName",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub display_name: ::std::option::Option<String>,
        #[doc = "The environment for the runtime."]
        #[serde(
            rename = "environment",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "The name of the runtime, e.g., ‘go113’, ‘nodejs12’, etc."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub name: ::std::option::Option<String>,
        #[doc = "The stage of life this runtime is in, e.g., BETA, GA, etc."]
        #[serde(
            rename = "stage",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub stage: ::std::option::Option<crate::schemas::RuntimeStage>,
        #[doc = "Warning messages, e.g., a deprecation warning."]
        #[serde(
            rename = "warnings",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl RuntimeEnvironment {
        pub fn as_str(self) -> &'static str {
            match self {
                RuntimeEnvironment::EnvironmentUnspecified => "ENVIRONMENT_UNSPECIFIED",
                RuntimeEnvironment::Gen1 => "GEN_1",
                RuntimeEnvironment::Gen2 => "GEN_2",
            }
        }
    }
    ...
    impl ::std::str::FromStr for RuntimeEnvironment {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<RuntimeEnvironment, ()> {
            Ok(match s {
                "ENVIRONMENT_UNSPECIFIED" => RuntimeEnvironment::EnvironmentUnspecified,
                "GEN_1" => RuntimeEnvironment::Gen1,
                "GEN_2" => RuntimeEnvironment::Gen2,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::serde::Serialize for RuntimeEnvironment {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for RuntimeEnvironment {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    pub enum RuntimeStage {
        #[doc = "The runtime is in the Alpha stage."]
        Alpha,
        #[doc = "The runtime is in the Beta stage."]
        Beta,
        #[doc = "The runtime is no longer supported."]
        Decommissioned,
        #[doc = "The runtime is deprecated."]
        Deprecated,
        #[doc = "The runtime is in development."]
        Development,
        #[doc = "The runtime is generally available."]
        Ga,
        #[doc = "Not specified."]
    ...
    impl RuntimeStage {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                RuntimeStage::Ga => "GA",
                RuntimeStage::RuntimeStageUnspecified => "RUNTIME_STAGE_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for RuntimeStage {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for RuntimeStage {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<RuntimeStage, ()> {
            Ok(match s {
                "ALPHA" => RuntimeStage::Alpha,
                "BETA" => RuntimeStage::Beta,
                "DECOMMISSIONED" => RuntimeStage::Decommissioned,
                "DEPRECATED" => RuntimeStage::Deprecated,
                "DEVELOPMENT" => RuntimeStage::Development,
                "GA" => RuntimeStage::Ga,
                "RUNTIME_STAGE_UNSPECIFIED" => RuntimeStage::RuntimeStageUnspecified,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::serde::Serialize for RuntimeStage {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for RuntimeStage {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for RuntimeStage {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for RuntimeStage {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SecretEnvVar {
        ...
        #[doc = "Project identifier (preferably project number but can also be the project ID) of the project that contains the secret. If not set, it is assumed that the secret is in the same project as the function."]
        #[serde(
            rename = "projectId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct ServiceConfig {
        #[doc = "Whether 100% of traffic is routed to the latest revision. On CreateFunction and UpdateFunction, when set to true, the revision being deployed will serve 100% of traffic, ignoring any traffic split settings, if any. On GetFunction, true will be returned if the latest revision is serving 100% of traffic."]
        #[serde(
            rename = "allTrafficOnLatestRevision",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub all_traffic_on_latest_revision: ::std::option::Option<bool>,
        #[doc = "The number of CPUs used in a single container instance. Default value is calculated from available memory. Supports the same values as Cloud Run, see https://cloud.google.com/run/docs/reference/rest/v1/Container#resourcerequirements Example: “1” indicates 1 vCPU"]
        #[serde(
            rename = "availableCpu",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub available_cpu: ::std::option::Option<String>,
        #[doc = "The amount of memory available for a function. Defaults to 256M. Supported units are k, M, G, Mi, Gi. If no unit is supplied the value is interpreted as bytes. See https://github.com/kubernetes/kubernetes/blob/master/staging/src/k8s.io/apimachinery/pkg/api/resource/quantity.go a full description."]
        #[serde(
            rename = "availableMemory",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub available_memory: ::std::option::Option<String>,
        ...
        #[serde(
            rename = "ingressSettings",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub ingress_settings: ::std::option::Option<crate::schemas::ServiceConfigIngressSettings>,
        ...
        #[doc = "Sets the maximum number of concurrent requests that each instance can receive. Defaults to 1."]
        #[serde(
        ...
        #[doc = "Output only. The name of service revision."]
        #[serde(
            rename = "revision",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Security level configure whether the function only accepts https. This configuration is only applicable to 1st Gen functions with Http trigger. By default https is optional for 1st Gen functions; 2nd Gen functions are https ONLY."]
        #[serde(
            rename = "securityLevel",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub security_level: ::std::option::Option<crate::schemas::ServiceConfigSecurityLevel>,
        #[doc = "Output only. Name of the service associated with a Function. The format of this field is `projects/{project}/locations/{region}/services/{service}`"]
        #[serde(
            rename = "service",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub service: ::std::option::Option<String>,
        #[doc = "The email of the service’s service account. If empty, defaults to `{project_number}-compute@developer.gserviceaccount.com`."]
        #[serde(
            rename = "serviceAccountEmail",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. URI of the Service deployed."]
        #[serde(
            rename = "uri",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "The Serverless VPC Access connector that this cloud function can connect to. The format of this field is `projects/*/locations/*/connectors/*`."]
        #[serde(
            rename = "vpcConnector",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[serde(
            rename = "vpcConnectorEgressSettings",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub vpc_connector_egress_settings:
            ::std::option::Option<crate::schemas::ServiceConfigVpcConnectorEgressSettings>,
    }
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum ServiceConfigIngressSettings {
    ...
    impl ServiceConfigIngressSettings {
        pub fn as_str(self) -> &'static str {
            match self {
                ServiceConfigIngressSettings::AllowAll => "ALLOW_ALL",
                ServiceConfigIngressSettings::AllowInternalAndGclb => "ALLOW_INTERNAL_AND_GCLB",
                ServiceConfigIngressSettings::AllowInternalOnly => "ALLOW_INTERNAL_ONLY",
                ServiceConfigIngressSettings::IngressSettingsUnspecified => {
                    "INGRESS_SETTINGS_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for ServiceConfigIngressSettings {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for ServiceConfigIngressSettings {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<ServiceConfigIngressSettings, ()> {
            Ok(match s {
                "ALLOW_ALL" => ServiceConfigIngressSettings::AllowAll,
                "ALLOW_INTERNAL_AND_GCLB" => ServiceConfigIngressSettings::AllowInternalAndGclb,
                "ALLOW_INTERNAL_ONLY" => ServiceConfigIngressSettings::AllowInternalOnly,
                "INGRESS_SETTINGS_UNSPECIFIED" => {
                    ServiceConfigIngressSettings::IngressSettingsUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for ServiceConfigIngressSettings {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for ServiceConfigIngressSettings {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ServiceConfigIngressSettings {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ServiceConfigIngressSettings {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ServiceConfigIngressSettings {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum ServiceConfigSecurityLevel {
    ...
    impl ServiceConfigSecurityLevel {
        pub fn as_str(self) -> &'static str {
            match self {
                ServiceConfigSecurityLevel::SecureAlways => "SECURE_ALWAYS",
                ServiceConfigSecurityLevel::SecureOptional => "SECURE_OPTIONAL",
                ServiceConfigSecurityLevel::SecurityLevelUnspecified => {
                    "SECURITY_LEVEL_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for ServiceConfigSecurityLevel {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for ServiceConfigSecurityLevel {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<ServiceConfigSecurityLevel, ()> {
            Ok(match s {
                "SECURE_ALWAYS" => ServiceConfigSecurityLevel::SecureAlways,
                "SECURE_OPTIONAL" => ServiceConfigSecurityLevel::SecureOptional,
                "SECURITY_LEVEL_UNSPECIFIED" => {
                    ServiceConfigSecurityLevel::SecurityLevelUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for ServiceConfigSecurityLevel {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for ServiceConfigSecurityLevel {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ServiceConfigSecurityLevel {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ServiceConfigSecurityLevel {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ServiceConfigSecurityLevel {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum ServiceConfigVpcConnectorEgressSettings {
    ...
    impl ServiceConfigVpcConnectorEgressSettings {
        pub fn as_str(self) -> &'static str {
            match self {
                ServiceConfigVpcConnectorEgressSettings::AllTraffic => "ALL_TRAFFIC",
                ServiceConfigVpcConnectorEgressSettings::PrivateRangesOnly => "PRIVATE_RANGES_ONLY",
                ServiceConfigVpcConnectorEgressSettings::VpcConnectorEgressSettingsUnspecified => {
                    "VPC_CONNECTOR_EGRESS_SETTINGS_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for ServiceConfigVpcConnectorEgressSettings {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for ServiceConfigVpcConnectorEgressSettings {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<ServiceConfigVpcConnectorEgressSettings, ()> {
            Ok(match s {
                "ALL_TRAFFIC" => ServiceConfigVpcConnectorEgressSettings::AllTraffic,
                "PRIVATE_RANGES_ONLY" => ServiceConfigVpcConnectorEgressSettings::PrivateRangesOnly,
                "VPC_CONNECTOR_EGRESS_SETTINGS_UNSPECIFIED" => {
                    ServiceConfigVpcConnectorEgressSettings::VpcConnectorEgressSettingsUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for ServiceConfigVpcConnectorEgressSettings {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for ServiceConfigVpcConnectorEgressSettings {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ServiceConfigVpcConnectorEgressSettings {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ServiceConfigVpcConnectorEgressSettings {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ServiceConfigVpcConnectorEgressSettings {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                #[doc = "Actions that can be performed on the functions resource"]
                pub fn functions(
                    &self,
                ) -> crate::resources::projects::locations::functions::FunctionsActions
                {
                    crate::resources::projects::locations::functions::FunctionsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                fn _path(&self) -> String {
                    let mut output = "https://cloudfunctions.googleapis.com/".to_owned();
                    output.push_str("v2/");
                    {
            ...
            pub mod functions {
                pub mod params {}
                pub struct FunctionsActions<'a> {
                    pub(crate) reqwest: &'a reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                }
                impl<'a> FunctionsActions<'a> {
                    fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                        self.auth
                    }
                    #[doc = "Creates a new function. If a function with the given name already exists in the specified project, the long running operation will return `ALREADY_EXISTS` error."]
                    pub fn create(
                        &self,
                        request: crate::schemas::Function,
                    ...
                    #[doc = "Deletes a function with the given name from the specified project. If the given function is used by some trigger, the trigger will be updated to remove this function."]
                    ...
                    #[doc = "Returns a signed URL for downloading deployed function source code. The URL is only valid for a limited period and should be used within 30 minutes of generation. For more information about the signed URL usage see: https://cloud.google.com/storage/docs/access-control/signed-urls"]
                    pub fn generate_download_url(
                        &self,
                        request: crate::schemas::GenerateDownloadUrlRequest,
                    ...
                    #[doc = "Returns a signed URL for uploading a function source code. For more information about the signed URL usage see: https://cloud.google.com/storage/docs/access-control/signed-urls. Once the function source code upload is complete, the used signed URL should be provided in CreateFunction or UpdateFunction request as a reference to the function source code. When uploading source code to the generated signed URL, please follow these restrictions: * Source file type should be a zip file. * No credentials should be attached - the signed URLs provide access to the target bucket using internal service identity; if credentials were attached, the identity from the credentials would be used, but that identity does not have permissions to upload files to the URL. When making a HTTP PUT request, these two headers need to be specified: * `content-type: application/zip` And this header SHOULD NOT be specified: * `Authorization: Bearer YOUR_TOKEN`"]
                    pub fn generate_upload_url(
                        &self,
                        request: crate::schemas::GenerateUploadUrlRequest,
                        parent: impl Into<String>,
                ...
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::Function,
                    parent: String,
                    function_id: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    #[doc = "The ID to use for the function, which will become the final component of the function’s resource name. This value should be 4-63 characters, and valid characters are /a-z-/."]
                    pub fn function_id(mut self, value: impl Into<String>) -> Self {
                    ...
                    async fn _request(
                        ...
                        req = req.query(&[("functionId", &self.function_id)]);
                        req = req.query(&[("access_token", &self.access_token)]);
                        req = req.query(&[("alt", &self.alt)]);
                        req = req.query(&[("callback", &self.callback)]);
                        req = req.query(&[("fields", &self.fields)]);
                ...
                impl<'a> GenerateDownloadUrlRequestBuilder<'a> {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::GenerateDownloadUrlResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                impl<'a> GenerateUploadUrlRequestBuilder<'a> {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::GenerateUploadUrlResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str("/functions:generateUploadUrl");
                        output
                    }
                    async fn _request(
                        &self,
                ...
                impl<'a> GetRequestBuilder<'a> {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::Function, crate::Error> {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    #[doc = r" selector of `*`. This will include every attribute of the"]
                ...
                #[doc = "Created via [FunctionsActions::get_iam_policy()](struct.FunctionsActions.html#method.get_iam_policy)"]
                #[derive(Debug, Clone)]
                ...
                impl<'a> ListRequestBuilder<'a> {
                    #[doc = "The filter for Functions that match the filter expression, following the syntax outlined in https://google.aip.dev/160."]
                    pub fn filter(mut self, value: impl Into<String>) -> Self {
                        self.filter = Some(value.into());
                        self
                    }
                    #[doc = "The sorting order of the resources returned. Value should be a comma separated list of fields. The default sorting oder is ascending. See https://google.aip.dev/132#ordering."]
                    ...
                    #[doc = "\nExecute the request and yield each item in the `functions` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_functions<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_functions_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `functions` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_functions_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Function, crate::Error>> + 'a
                    {
                        self.stream_functions_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `functions` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_functions_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Function, crate::Error>> + 'a
                    {
                        self.stream_functions_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `functions` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_functions_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        self.fields = Some({
                            let mut selector = concat!("nextPageToken,", "functions").to_owned();
                            let items_fields = fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                            if !items_fields.is_empty() {
                                selector.push_str("(");
                                selector.push_str(items_fields);
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListFunctionsResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ListFunctionsResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                #[doc = "Created via [FunctionsActions::patch()](struct.FunctionsActions.html#method.patch)"]
                #[derive(Debug, Clone)]
                ...
                impl<'a> PatchRequestBuilder<'a> {
                    #[doc = "The list of fields to be updated. If no field mask is provided, all provided fields in the request will be updated."]
                ...
                #[doc = "Created via [FunctionsActions::set_iam_policy()](struct.FunctionsActions.html#method.set_iam_policy)"]
                #[derive(Debug, Clone)]
                ...
                #[doc = "Created via [FunctionsActions::test_iam_permissions()](struct.FunctionsActions.html#method.test_iam_permissions)"]
                #[derive(Debug, Clone)]
            ...
            pub mod runtimes {
                ...
                impl<'a> ListRequestBuilder<'a> {
                    #[doc = "The filter for Runtimes that match the filter expression, following the syntax outlined in https://google.aip.dev/160."]
                    pub fn filter(mut self, value: impl Into<String>) -> Self {
                        self.filter = Some(value.into());
                        self
                    }
