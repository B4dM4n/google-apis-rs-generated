...
pub mod schemas {
    ...
    pub struct Abnfgrammar {
        #[doc = "All declarations and rules of an ABNF grammar broken up into multiple strings that will end up concatenated."]
        #[serde(
            rename = "abnfStrings",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub abnf_strings: ::std::option::Option<Vec<String>>,
    }
    impl ::google_field_selector::FieldSelector for Abnfgrammar {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for Abnfgrammar {
    ...
    pub struct CreateCustomClassRequest {
        #[doc = "Required. The custom class to create."]
        #[serde(
            rename = "customClass",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for CreateCustomClassRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CreateCustomClassRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct CreatePhraseSetRequest {
        #[doc = "Required. The phrase set to create."]
        #[serde(
            rename = "phraseSet",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub phrase_set_id: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for CreatePhraseSetRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CreatePhraseSetRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for ListCustomClassesResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListCustomClassesResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListCustomClassesResponse {
    ...
    impl ::google_field_selector::FieldSelector for ListPhraseSetResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListPhraseSetResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListPhraseSetResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    pub struct LongRunningRecognizeRequest {
        ...
        #[doc = "Optional. Specifies an optional destination for the recognition results."]
        #[serde(
            rename = "outputConfig",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct LongRunningRecognizeResponse {
        ...
        #[doc = "The ID associated with the request. This is a unique ID specific only to the given request."]
        #[serde(
            rename = "requestId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Provides information on speech adaptation behavior in response"]
        #[serde(
            rename = "speechAdaptationInfo",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub speech_adaptation_info: ::std::option::Option<crate::schemas::SpeechAdaptationInfo>,
    ...
    pub struct RecognitionConfig {
        ...
        #[doc = "The number of channels in the input audio data. ONLY set this for MULTI-CHANNEL recognition. Valid values for LINEAR16, OGG_OPUS and FLAC are `1`-`8`. Valid value for MULAW, AMR, AMR_WB and SPEEX_WITH_HEADER_BYTE is only `1`. If `0` or omitted, defaults to one channel (mono). Note: We only recognize the first channel by default. To perform independent recognition on each channel set `enable_separate_recognition_per_channel` to ‘true’."]
        #[serde(
    ...
    pub struct RecognizeResponse {
        ...
        pub results: ::std::option::Option<Vec<crate::schemas::SpeechRecognitionResult>>,
        #[doc = "Provides information on adaptation behavior in response"]
        #[serde(
            rename = "speechAdaptationInfo",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct SpeechAdaptation {
        #[doc = "Augmented Backus-Naur form (ABNF) is a standardized grammar notation comprised by a set of derivation rules. See specifications: https://www.w3.org/TR/speech-grammar"]
        #[serde(
            rename = "abnfGrammar",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub abnf_grammar: ::std::option::Option<crate::schemas::Abnfgrammar>,
        ...
        pub custom_classes: ::std::option::Option<Vec<crate::schemas::CustomClass>>,
        #[doc = "A collection of phrase set resource names to use."]
        #[serde(
            rename = "phraseSetReferences",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub phrase_set_references: ::std::option::Option<Vec<String>>,
    ...
    pub struct SpeechAdaptationInfo {
        #[doc = "Whether there was a timeout when applying speech adaptation. If true, adaptation had no effect in the response transcript."]
        #[serde(
            rename = "adaptationTimeout",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub adaptation_timeout: ::std::option::Option<bool>,
        #[doc = "If set, returns a message specifying which part of the speech adaptation request timed out."]
        #[serde(
            rename = "timeoutMessage",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub timeout_message: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for SpeechAdaptationInfo {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SpeechAdaptationInfo {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct TranscriptOutputConfig {
        #[doc = "Specifies a Cloud Storage URI for the recognition results. Must be specified in the format: `gs://bucket_name/object_name`, and the bucket must already exist."]
        #[serde(
            rename = "gcsUri",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for TranscriptOutputConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for TranscriptOutputConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                #[doc = "Actions that can be performed on the custom_classes resource"]
                pub fn custom_classes(
                    &self,
                ) -> crate::resources::projects::locations::custom_classes::CustomClassesActions
                {
                    crate::resources::projects::locations::custom_classes::CustomClassesActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                ...
                #[doc = "Actions that can be performed on the phrase_sets resource"]
                pub fn phrase_sets(
                    &self,
                ) -> crate::resources::projects::locations::phrase_sets::PhraseSetsActions
                {
                    crate::resources::projects::locations::phrase_sets::PhraseSetsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            pub mod custom_classes {
                pub mod params {}
                pub struct CustomClassesActions<'a> {
                    pub(crate) reqwest: &'a reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                }
                impl<'a> CustomClassesActions<'a> {
                    fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                        self.auth
                    }
                    ...
                    pub fn create(
                        &self,
                        request: crate::schemas::CreateCustomClassRequest,
                    ...
                    pub fn patch(
                        &self,
                        request: crate::schemas::CustomClass,
                ...
                #[doc = "Created via [CustomClassesActions::create()](struct.CustomClassesActions.html#method.create)"]
                #[derive(Debug, Clone)]
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::CustomClass, crate::Error> {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    #[doc = r" selector of `*`. This will include every attribute of the"]
                ...
                #[doc = "Created via [CustomClassesActions::delete()](struct.CustomClassesActions.html#method.delete)"]
                #[derive(Debug, Clone)]
                ...
                #[doc = "Created via [CustomClassesActions::get()](struct.CustomClassesActions.html#method.get)"]
                #[derive(Debug, Clone)]
                pub struct GetRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                #[doc = "Created via [CustomClassesActions::list()](struct.CustomClassesActions.html#method.list)"]
                #[derive(Debug, Clone)]
                pub struct ListRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    #[doc = "The maximum number of custom classes to return. The service may return fewer than this value. If unspecified, at most 50 custom classes will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000."]
                    pub fn page_size(mut self, value: i32) -> Self {
                        self.page_size = Some(value);
                        self
                    }
                    #[doc = "A page token, received from a previous `ListCustomClass` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListCustomClass` must match the call that provided the page token."]
                    pub fn page_token(mut self, value: impl Into<String>) -> Self {
                        self.page_token = Some(value.into());
                        self
                    }
                    ...
                    #[doc = "\nExecute the request and yield each item in the `customClasses` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_custom_classes<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_custom_classes_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `customClasses` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_custom_classes_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::CustomClass, crate::Error>,
                    > + 'a {
                        self.stream_custom_classes_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `customClasses` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_custom_classes_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::CustomClass, crate::Error>,
                    > + 'a {
                        self.stream_custom_classes_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `customClasses` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_custom_classes_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        self.fields = Some({
                            let mut selector =
                                concat!("nextPageToken,", "customClasses").to_owned();
                            let items_fields = fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                            if !items_fields.is_empty() {
                                selector.push_str("(");
                                selector.push_str(items_fields);
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListCustomClassesResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ListCustomClassesResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                #[doc = "Created via [CustomClassesActions::patch()](struct.CustomClassesActions.html#method.patch)"]
                #[derive(Debug, Clone)]
            ...
            pub mod phrase_sets {
                pub mod params {}
                pub struct PhraseSetsActions<'a> {
                    pub(crate) reqwest: &'a reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                }
                impl<'a> PhraseSetsActions<'a> {
                    fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                        self.auth
                    }
                    #[doc = "Create a set of phrase hints. Each item in the set can be a single word or a multi-word phrase. The items in the PhraseSet are favored by the recognition model when you send a call that includes the PhraseSet."]
                    pub fn create(
                        &self,
                        request: crate::schemas::CreatePhraseSetRequest,
                        parent: impl Into<String>,
                    ) -> CreateRequestBuilder {
                        CreateRequestBuilder {
                            reqwest: &self.reqwest,
                    ...
                    pub fn patch(
                        &self,
                        request: crate::schemas::PhraseSet,
                        name: impl Into<String>,
                    ) -> PatchRequestBuilder {
                        PatchRequestBuilder {
                            reqwest: &self.reqwest,
                ...
                #[doc = "Created via [PhraseSetsActions::create()](struct.PhraseSetsActions.html#method.create)"]
                #[derive(Debug, Clone)]
                pub struct CreateRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::PhraseSet, crate::Error> {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    #[doc = r" selector of `*`. This will include every attribute of the"]
                ...
                #[doc = "Created via [PhraseSetsActions::delete()](struct.PhraseSetsActions.html#method.delete)"]
                #[derive(Debug, Clone)]
                pub struct DeleteRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                #[doc = "Created via [PhraseSetsActions::get()](struct.PhraseSetsActions.html#method.get)"]
                #[derive(Debug, Clone)]
                pub struct GetRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                #[doc = "Created via [PhraseSetsActions::list()](struct.PhraseSetsActions.html#method.list)"]
                #[derive(Debug, Clone)]
                pub struct ListRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    #[doc = "The maximum number of phrase sets to return. The service may return fewer than this value. If unspecified, at most 50 phrase sets will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000."]
                    pub fn page_size(mut self, value: i32) -> Self {
                        self.page_size = Some(value);
                        self
                    }
                    #[doc = "A page token, received from a previous `ListPhraseSet` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListPhraseSet` must match the call that provided the page token."]
                    pub fn page_token(mut self, value: impl Into<String>) -> Self {
                        self.page_token = Some(value.into());
                        self
                    }
                    ...
                    #[doc = "\nExecute the request and yield each item in the `phraseSets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_phrase_sets<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_phrase_sets_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `phraseSets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_phrase_sets_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::PhraseSet, crate::Error>>
                           + 'a {
                        self.stream_phrase_sets_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `phraseSets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_phrase_sets_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::PhraseSet, crate::Error>>
                           + 'a {
                        self.stream_phrase_sets_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `phraseSets` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_phrase_sets_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        ...
                        F: AsRef<str>,
                    {
                        ...
                        self.fields = Some({
                            let mut selector = concat!("nextPageToken,", "phraseSets").to_owned();
                            let items_fields = fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                            if !items_fields.is_empty() {
                                selector.push_str("(");
                                selector.push_str(items_fields);
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListPhraseSetResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                    ...
                    pub async fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ListPhraseSetResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>).await
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                #[doc = "Created via [PhraseSetsActions::patch()](struct.PhraseSetsActions.html#method.patch)"]
                #[derive(Debug, Clone)]
                pub struct PatchRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
