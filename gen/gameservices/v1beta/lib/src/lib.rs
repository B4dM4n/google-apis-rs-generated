...
pub mod schemas {
    ...
    impl ConditionIam {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                ConditionIam::CredsAssertion => "CREDS_ASSERTION",
    ...
    impl ::std::str::FromStr for ConditionIam {
        ...
        fn from_str(s: &str) -> ::std::result::Result<ConditionIam, ()> {
            Ok(match s {
                ...
                "CREDS_ASSERTION" => ConditionIam::CredsAssertion,
    ...
    impl crate::GetNextPageToken for ListGameServerClustersResponse {
    ...
    impl crate::GetNextPageToken for ListGameServerConfigsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken for ListGameServerDeploymentsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
    ...
    impl crate::GetNextPageToken for ListRealmsResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
        ...
        pub mod locations {
            ...
            pub mod game_server_deployments {
                ...
                impl<'a> GameServerDeploymentsActions<'a> {
                    ...
                    #[doc = "Retrieves information about the current state of the game server deployment. Gathers all the Agones fleets and Agones autoscalers, including fleets running an older version of the game server deployment."]
                    ...
                    #[doc = "Previews the game server deployment rollout. This API does not mutate the rollout resource."]
                ...
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::GameServerDeployment,
                    parent: String,
                    deployment_id: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    async fn _request(
                        ...
                        req = req.query(&[("deploymentId", &self.deployment_id)]);
                        req = req.query(&[("access_token", &self.access_token)]);
                        req = req.query(&[("alt", &self.alt)]);
                        req = req.query(&[("callback", &self.callback)]);
                        req = req.query(&[("fields", &self.fields)]);
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `gameServerDeployments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_game_server_deployments<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_game_server_deployments_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `gameServerDeployments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_game_server_deployments_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::GameServerDeployment, crate::Error>,
                    > + 'a {
                        self.stream_game_server_deployments_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `gameServerDeployments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_game_server_deployments_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<
                        Item = Result<crate::schemas::GameServerDeployment, crate::Error>,
                    > + 'a {
                        self.stream_game_server_deployments_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `gameServerDeployments` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_game_server_deployments_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                ...
                pub struct PreviewRolloutRequestBuilder<'a> {
                    ...
                    request: crate::schemas::GameServerDeploymentRollout,
                    name: String,
                    preview_time: ::std::option::Option<String>,
                    update_mask: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                ...
                pub mod configs {
                    ...
                    impl<'a> ConfigsActions<'a> {
                        ...
                        #[doc = "Creates a new game server config in a given project, location, and game server deployment. Game server configs are immutable, and are not applied until referenced in the game server deployment rollout resource."]
                        pub fn create(
                            &self,
                        ...
                        #[doc = "Lists game server configs in a given project, location, and game server deployment."]
                        pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                            ListRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        #[doc = "\nExecute the request and yield each item in the `gameServerConfigs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                        pub fn stream_game_server_configs<T>(
                            self,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                            T: ::serde::de::DeserializeOwned
                                ...
                                + 'a,
                        {
                            ...
                            self.stream_game_server_configs_with_fields(fields)
                        }
                        #[doc = "\nExecute the request and yield each item in the `gameServerConfigs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                        pub fn stream_game_server_configs_with_default_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::GameServerConfig, crate::Error>,
                        > + 'a {
                            self.stream_game_server_configs_with_fields(None::<String>)
                        }
                        #[doc = "\nExecute the request and yield each item in the `gameServerConfigs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                        pub fn stream_game_server_configs_with_all_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::GameServerConfig, crate::Error>,
                        > + 'a {
                            self.stream_game_server_configs_with_fields(Some("*"))
                        }
                        #[doc = "\nExecute the request and yield each item in the `gameServerConfigs` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                        pub fn stream_game_server_configs_with_fields<T, F>(
                            mut self,
                            fields: ::std::option::Option<F>,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
            ...
            pub mod realms {
                ...
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::Realm,
                    parent: String,
                    realm_id: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    async fn _request(
                        ...
                        let mut req = self.reqwest.request(::reqwest::Method::POST, path);
                        req = req.query(&[("realmId", &self.realm_id)]);
                        req = req.query(&[("access_token", &self.access_token)]);
                        req = req.query(&[("alt", &self.alt)]);
                        req = req.query(&[("callback", &self.callback)]);
                        req = req.query(&[("fields", &self.fields)]);
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = "\nExecute the request and yield each item in the `realms` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                    pub fn stream_realms<T>(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                        T: ::serde::de::DeserializeOwned
                            ...
                            + 'a,
                    {
                        ...
                        self.stream_realms_with_fields(fields)
                    }
                    #[doc = "\nExecute the request and yield each item in the `realms` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                    pub fn stream_realms_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Realm, crate::Error>> + 'a
                    {
                        self.stream_realms_with_fields(None::<String>)
                    }
                    #[doc = "\nExecute the request and yield each item in the `realms` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                    pub fn stream_realms_with_all_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::Realm, crate::Error>> + 'a
                    {
                        self.stream_realms_with_fields(Some("*"))
                    }
                    #[doc = "\nExecute the request and yield each item in the `realms` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                    pub fn stream_realms_with_fields<T, F>(
                        mut self,
                        fields: ::std::option::Option<F>,
                    ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                    where
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::ListRealmsResponse, crate::Error>,
                    > + 'a {
                        self.stream_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the request and yield the returned value. If the response contains a"]
                ...
                pub mod game_server_clusters {
                    ...
                    impl<'a> GameServerClustersActions<'a> {
                        ...
                        #[doc = "Previews creation of a new game server cluster in a given project and location."]
                    ...
                    pub struct CreateRequestBuilder<'a> {
                        ...
                        request: crate::schemas::GameServerCluster,
                        parent: String,
                        game_server_cluster_id: ::std::option::Option<String>,
                        access_token: ::std::option::Option<String>,
                        alt: ::std::option::Option<crate::params::Alt>,
                        callback: ::std::option::Option<String>,
                        fields: ::std::option::Option<String>,
                    ...
                    #[derive(Debug, Clone)]
                    pub struct ListRequestBuilder < 'a > { pub (crate) reqwest : & 'a :: reqwest :: Client , pub (crate) auth : & 'a dyn :: google_api_auth :: GetAccessToken , parent : String , filter : :: std :: option :: Option < String > , order_by : :: std :: option :: Option < String > , page_size : :: std :: option :: Option < i32 > , page_token : :: std :: option :: Option < String > , view : :: std :: option :: Option < crate :: resources :: projects :: locations :: realms :: game_server_clusters :: params :: ListView > , access_token : :: std :: option :: Option < String > , alt : :: std :: option :: Option < crate :: params :: Alt > , callback : :: std :: option :: Option < String > , fields : :: std :: option :: Option < String > , key : :: std :: option :: Option < String > , oauth_token : :: std :: option :: Option < String > , pretty_print : :: std :: option :: Option < bool > , quota_user : :: std :: option :: Option < String > , upload_protocol : :: std :: option :: Option < String > , upload_type : :: std :: option :: Option < String > , xgafv : :: std :: option :: Option < crate :: params :: Xgafv > , }
                    impl<'a> ListRequestBuilder<'a> {
                        #[doc = "Optional. The filter to apply to list results (see [Filtering](https://google.aip.dev/160))."]
                        pub fn filter(mut self, value: impl Into<String>) -> Self {
                            self.filter = Some(value.into());
                        ...
                        #[doc = "\nExecute the request and yield each item in the `gameServerClusters` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                        pub fn stream_game_server_clusters<T>(
                            self,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                            T: ::serde::de::DeserializeOwned
                                ...
                                + 'a,
                        {
                            ...
                            self.stream_game_server_clusters_with_fields(fields)
                        }
                        #[doc = "\nExecute the request and yield each item in the `gameServerClusters` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                        pub fn stream_game_server_clusters_with_default_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::GameServerCluster, crate::Error>,
                        > + 'a {
                            self.stream_game_server_clusters_with_fields(None::<String>)
                        }
                        #[doc = "\nExecute the request and yield each item in the `gameServerClusters` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                        pub fn stream_game_server_clusters_with_all_fields(
                            self,
                        ) -> impl ::futures::Stream<
                            Item = Result<crate::schemas::GameServerCluster, crate::Error>,
                        > + 'a {
                            self.stream_game_server_clusters_with_fields(Some("*"))
                        }
                        #[doc = "\nExecute the request and yield each item in the `gameServerClusters` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                        pub fn stream_game_server_clusters_with_fields<T, F>(
                            mut self,
                            fields: ::std::option::Option<F>,
                        ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                        where
                    ...
                    #[derive(Debug, Clone)]
                    pub struct PreviewCreateRequestBuilder < 'a > { pub (crate) reqwest : & 'a :: reqwest :: Client , pub (crate) auth : & 'a dyn :: google_api_auth :: GetAccessToken , request : crate :: schemas :: GameServerCluster , parent : String , game_server_cluster_id : :: std :: option :: Option < String > , preview_time : :: std :: option :: Option < String > , view : :: std :: option :: Option < crate :: resources :: projects :: locations :: realms :: game_server_clusters :: params :: PreviewCreateView > , access_token : :: std :: option :: Option < String > , alt : :: std :: option :: Option < crate :: params :: Alt > , callback : :: std :: option :: Option < String > , fields : :: std :: option :: Option < String > , key : :: std :: option :: Option < String > , oauth_token : :: std :: option :: Option < String > , pretty_print : :: std :: option :: Option < bool > , quota_user : :: std :: option :: Option < String > , upload_protocol : :: std :: option :: Option < String > , upload_type : :: std :: option :: Option < String > , xgafv : :: std :: option :: Option < crate :: params :: Xgafv > , }
