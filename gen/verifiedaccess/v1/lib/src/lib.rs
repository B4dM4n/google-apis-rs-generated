#![doc = "# Resources and Methods\n* [challenge](resources/challenge/struct.ChallengeActions.html)\n  * [*create*](resources/challenge/struct.CreateRequestBuilder.html), [*verify*](resources/challenge/struct.VerifyRequestBuilder.html)\n"]
pub mod scopes {
...
pub mod schemas {
    ...
    pub struct Challenge {
        ...
        pub alternative_challenge: ::std::option::Option<crate::schemas::SignedData>,
        ...
        pub challenge: ::std::option::Option<crate::schemas::SignedData>,
    }
    ...
    impl ::google_field_selector::FieldSelector for SignedData {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SignedData {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct VerifyChallengeResponseResult {
        ...
        pub verification_output: ::std::option::Option<String>,
    }
...
pub mod resources {
    pub mod challenge {
        ...
        impl<'a> ChallengeActions<'a> {
            ...
            #[doc = "CreateChallenge API"]
            pub fn create(&self, request: crate::schemas::Empty) -> CreateRequestBuilder {
            ...
            #[doc = "VerifyChallengeResponse API"]
            pub fn verify(
                &self,
        ...
        #[doc = "Created via [ChallengeActions::create()](struct.ChallengeActions.html#method.create)"]
        #[derive(Debug, Clone)]
        ...
        impl<'a> VerifyRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://verifiedaccess.googleapis.com/".to_owned();
                output.push_str("v1/challenge:verify");
                output
            }
            async fn _request(
                &self,
