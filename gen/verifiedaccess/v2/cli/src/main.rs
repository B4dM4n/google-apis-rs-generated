...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("verifiedaccess2")
        ...
        let mut challenge0 = SubCommand::with_name("challenge")
            ...
            .about("methods: generate and verify");
        {
            let mcmd = SubCommand::with_name("generate").about("Generates a new challenge.");
            challenge0 = challenge0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("verify").about("Verifies the challenge response.");
            challenge0 = challenge0.subcommand(mcmd);
        }
...
use google_verifiedaccess2 as api;
