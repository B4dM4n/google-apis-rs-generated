...
#![doc = "# Resources and Methods\n* [projects](resources/projects/struct.ProjectsActions.html)\n  * [locations](resources/projects/locations/struct.LocationsActions.html)\n    * [*get*](resources/projects/locations/struct.GetRequestBuilder.html), [*list*](resources/projects/locations/struct.ListRequestBuilder.html)\n    * [endpoints](resources/projects/locations/endpoints/struct.EndpointsActions.html)\n      * [*create*](resources/projects/locations/endpoints/struct.CreateRequestBuilder.html), [*delete*](resources/projects/locations/endpoints/struct.DeleteRequestBuilder.html), [*get*](resources/projects/locations/endpoints/struct.GetRequestBuilder.html), [*getIamPolicy*](resources/projects/locations/endpoints/struct.GetIamPolicyRequestBuilder.html), [*list*](resources/projects/locations/endpoints/struct.ListRequestBuilder.html), [*patch*](resources/projects/locations/endpoints/struct.PatchRequestBuilder.html), [*setIamPolicy*](resources/projects/locations/endpoints/struct.SetIamPolicyRequestBuilder.html), [*testIamPermissions*](resources/projects/locations/endpoints/struct.TestIamPermissionsRequestBuilder.html)\n    * [operations](resources/projects/locations/operations/struct.OperationsActions.html)\n      * [*cancel*](resources/projects/locations/operations/struct.CancelRequestBuilder.html), [*delete*](resources/projects/locations/operations/struct.DeleteRequestBuilder.html), [*get*](resources/projects/locations/operations/struct.GetRequestBuilder.html), [*list*](resources/projects/locations/operations/struct.ListRequestBuilder.html)\n"]
pub mod scopes {
...
pub mod schemas {
    ...
    pub struct Endpoint {
        ...
        #[doc = "User-provided description of the endpoint"]
        #[serde(
            rename = "description",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. The fully qualified URL of the endpoint’s ILB Forwarding Rule."]
        #[serde(
            rename = "endpointForwardingRule",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub endpoint_forwarding_rule: ::std::option::Option<String>,
        #[doc = "Output only. The IP address of the IDS Endpoint’s ILB."]
        #[serde(
            rename = "endpointIp",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub endpoint_ip: ::std::option::Option<String>,
        #[doc = "The labels of the endpoint."]
        #[serde(
            rename = "labels",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. The name of the endpoint."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Required. The fully qualified URL of the network to which the IDS Endpoint is attached."]
        #[serde(
            rename = "network",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Required. Lowest threat severity that this endpoint will alert on."]
        #[serde(
            rename = "severity",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub severity: ::std::option::Option<crate::schemas::EndpointSeverity>,
        #[doc = "Output only. Current state of the endpoint."]
        #[serde(
            rename = "state",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub state: ::std::option::Option<crate::schemas::EndpointState>,
        #[doc = "List of threat IDs to be excepted from generating alerts."]
        #[serde(
            rename = "threatExceptions",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub threat_exceptions: ::std::option::Option<Vec<String>>,
        #[doc = "Whether the endpoint should report traffic logs in addition to threat logs."]
        #[serde(
            rename = "trafficLogs",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub traffic_logs: ::std::option::Option<bool>,
    ...
    pub enum EndpointSeverity {
        #[doc = "Critical severity alerts."]
        Critical,
        #[doc = "High severity alerts."]
        High,
        #[doc = "Informational alerts."]
        Informational,
        #[doc = "Low severity alerts."]
        Low,
        #[doc = "Medium severity alerts."]
        Medium,
        #[doc = "Not set."]
        SeverityUnspecified,
    }
    impl EndpointSeverity {
        pub fn as_str(self) -> &'static str {
            match self {
                EndpointSeverity::Critical => "CRITICAL",
                EndpointSeverity::High => "HIGH",
                EndpointSeverity::Informational => "INFORMATIONAL",
                EndpointSeverity::Low => "LOW",
                EndpointSeverity::Medium => "MEDIUM",
                EndpointSeverity::SeverityUnspecified => "SEVERITY_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for EndpointSeverity {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for EndpointSeverity {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<EndpointSeverity, ()> {
            Ok(match s {
                "CRITICAL" => EndpointSeverity::Critical,
                "HIGH" => EndpointSeverity::High,
                "INFORMATIONAL" => EndpointSeverity::Informational,
                "LOW" => EndpointSeverity::Low,
                "MEDIUM" => EndpointSeverity::Medium,
                "SEVERITY_UNSPECIFIED" => EndpointSeverity::SeverityUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for EndpointSeverity {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for EndpointSeverity {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for EndpointSeverity {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for EndpointSeverity {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for EndpointSeverity {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub enum EndpointState {
        ...
        #[doc = "Being deleted."]
        Deleting,
        #[doc = "Active and ready for traffic."]
        Ready,
        #[doc = "Not set."]
        StateUnspecified,
        #[doc = "Being updated."]
    ...
    impl EndpointState {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                EndpointState::StateUnspecified => "STATE_UNSPECIFIED",
    ...
    impl ::std::str::FromStr for EndpointState {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<EndpointState, ()> {
            Ok(match s {
                "CREATING" => EndpointState::Creating,
                "DELETING" => EndpointState::Deleting,
                "READY" => EndpointState::Ready,
                "STATE_UNSPECIFIED" => EndpointState::StateUnspecified,
    ...
    impl ::serde::Serialize for EndpointState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl ::google_field_selector::FieldSelector for EndpointState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for EndpointState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ListEndpointsResponse {
        #[doc = "The list of endpoints response."]
        #[serde(
            rename = "endpoints",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                pub fn endpoints(
                    &self,
                ) -> crate::resources::projects::locations::endpoints::EndpointsActions
                {
                    crate::resources::projects::locations::endpoints::EndpointsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            impl<'a> GetRequestBuilder<'a> {
                ...
                fn _path(&self) -> String {
                    let mut output = "https://ids.googleapis.com/".to_owned();
                    output.push_str("v1/");
                    {
            ...
            pub mod endpoints {
                ...
                impl<'a> EndpointsActions<'a> {
                    ...
                    #[doc = "Updates the parameters of a single Endpoint."]
                    pub fn patch(
                        &self,
                        request: crate::schemas::Endpoint,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    #[doc = "Required. The endpoint identifier. This will be part of the endpoint’s resource name. This value must start with a lowercase letter followed by up to 62 lowercase letters, numbers, or hyphens, and cannot end with a hyphen. Values that do not match this pattern will trigger an INVALID_ARGUMENT error."]
                    pub fn endpoint_id(mut self, value: impl Into<String>) -> Self {
                        self.endpoint_id = Some(value.into());
                        self
                    }
                    #[doc = "An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and t he request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000)."]
                ...
                #[doc = "Created via [EndpointsActions::get_iam_policy()](struct.EndpointsActions.html#method.get_iam_policy)"]
                #[derive(Debug, Clone)]
                ...
                impl<'a> ListRequestBuilder<'a> {
                    #[doc = "Optional. The filter expression, following the syntax outlined in https://google.aip.dev/160."]
                    pub fn filter(mut self, value: impl Into<String>) -> Self {
                        self.filter = Some(value.into());
                        self
                    }
                    ...
                    #[doc = "Optional. The maximum number of endpoints to return. The service may return fewer than this value."]
                    pub fn page_size(mut self, value: i32) -> Self {
                        self.page_size = Some(value);
                        self
                    }
                    #[doc = "Optional. A page token, received from a previous `ListEndpoints` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListEndpoints` must match the call that provided the page token."]
                    pub fn page_token(mut self, value: impl Into<String>) -> Self {
                        self.page_token = Some(value.into());
                        self
                    }
                ...
                #[doc = "Created via [EndpointsActions::set_iam_policy()](struct.EndpointsActions.html#method.set_iam_policy)"]
                #[derive(Debug, Clone)]
                ...
                #[doc = "Created via [EndpointsActions::test_iam_permissions()](struct.EndpointsActions.html#method.test_iam_permissions)"]
                #[derive(Debug, Clone)]
