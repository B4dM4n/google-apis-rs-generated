...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes a single Endpoint.");
            endpoints2 = endpoints2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get").about("Gets details of a single Endpoint.");
            endpoints2 = endpoints2.subcommand(mcmd);
        }
        {
        ...
        locations1 = locations1.subcommand(endpoints2);
