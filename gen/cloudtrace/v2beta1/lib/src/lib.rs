...
pub mod schemas {
    ...
    pub struct ListTraceSinksResponse {
        ...
        pub sinks: ::std::option::Option<Vec<crate::schemas::TraceSink>>,
    }
    impl ::google_field_selector::FieldSelector for ListTraceSinksResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListTraceSinksResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    impl crate::GetNextPageToken<String> for ListTraceSinksResponse {
    ...
    pub struct OutputConfig {
        #[doc = "The destination for writing trace data. Supported formats include: “bigquery.googleapis.com/projects/\\[PROJECT_ID\\]/datasets/\\[DATASET\\]”"]
        #[serde(
            rename = "destination",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for TraceSink {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for TraceSink {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    pub mod projects {
        ...
        impl<'a> ProjectsActions<'a> {
            ...
            #[doc = "Actions that can be performed on the trace_sinks resource"]
            pub fn trace_sinks(
                &self,
            ) -> crate::resources::projects::trace_sinks::TraceSinksActions {
                crate::resources::projects::trace_sinks::TraceSinksActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
        ...
        pub mod trace_sinks {
            pub mod params {}
            pub struct TraceSinksActions<'a> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            }
            impl<'a> TraceSinksActions<'a> {
                fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                    self.auth
                }
                #[doc = "Creates a sink that exports trace spans to a destination. The export of newly-ingested traces begins immediately, unless the sink’s `writer_identity` is not permitted to write to the destination. A sink can export traces only from the resource owning the sink (the ‘parent’)."]
                pub fn create(
                    &self,
                    request: crate::schemas::TraceSink,
                ...
                #[doc = "Get a trace sink by name under the parent resource (GCP project)."]
                ...
                #[doc = "List all sinks for the parent resource (GCP project)."]
                ...
                #[doc = "Updates a sink. This method updates fields in the existing sink according to the provided update mask. The sink’s name cannot be changed nor any output-only fields (e.g. the writer_identity)."]
                pub fn patch(
                    &self,
                    request: crate::schemas::TraceSink,
            ...
            #[doc = "Created via [TraceSinksActions::create()](struct.TraceSinksActions.html#method.create)"]
            #[derive(Debug, Clone)]
            ...
            impl<'a> CreateRequestBuilder<'a> {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::TraceSink, crate::Error> {
            ...
            #[doc = "Created via [TraceSinksActions::delete()](struct.TraceSinksActions.html#method.delete)"]
            #[derive(Debug, Clone)]
            ...
            #[doc = "Created via [TraceSinksActions::get()](struct.TraceSinksActions.html#method.get)"]
            #[derive(Debug, Clone)]
            ...
            #[doc = "Created via [TraceSinksActions::list()](struct.TraceSinksActions.html#method.list)"]
            #[derive(Debug, Clone)]
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `sinks` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_sinks<T>(
                    self,
                    ...
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_sinks_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `sinks` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_sinks_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::TraceSink, crate::Error>> + 'a
                {
                    self.stream_sinks_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `sinks` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_sinks_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::TraceSink, crate::Error>> + 'a
                {
                    self.stream_sinks_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `sinks` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_sinks_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                    ...
                    F: AsRef<str>,
                {
                    ...
                    self.fields = Some({
                        let mut selector = concat!("nextPageToken,", "sinks").to_owned();
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListTraceSinksResponse, crate::Error>,
                > + 'a {
                ...
                pub async fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::ListTraceSinksResponse, crate::Error> {
                    self.execute_with_fields(None::<&str>).await
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            #[doc = "Created via [TraceSinksActions::patch()](struct.TraceSinksActions.html#method.patch)"]
            #[derive(Debug, Clone)]
