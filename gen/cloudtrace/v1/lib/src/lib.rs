...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for ListTracesResponse {
    ...
    pub mod projects {
        ...
        pub mod traces {
            ...
            pub struct ListRequestBuilder<'a> {
                ...
                view: ::std::option::Option<crate::resources::projects::traces::params::ListView>,
                access_token: ::std::option::Option<String>,
                alt: ::std::option::Option<crate::params::Alt>,
                callback: ::std::option::Option<String>,
                fields: ::std::option::Option<String>,
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "\nExecute the request and yield each item in the `traces` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the field given by the [`FieldSelector`] implementation from the server.\n\n[`FieldSelector`]: ::google_field_selector::FieldSelector\n"]
                pub fn stream_traces<T>(
                    self,
                    ...
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector + 'a,
                {
                    ...
                    self.stream_traces_with_fields(fields)
                }
                #[doc = "\nExecute the request and yield each item in the `traces` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests the default set of fields from the server.\n"]
                pub fn stream_traces_with_default_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::Trace, crate::Error>> + 'a
                {
                    self.stream_traces_with_fields(None::<String>)
                }
                #[doc = "\nExecute the request and yield each item in the `traces` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nRequests all fields from the server.\n"]
                pub fn stream_traces_with_all_fields(
                    self,
                ) -> impl ::futures::Stream<Item = Result<crate::schemas::Trace, crate::Error>> + 'a
                {
                    self.stream_traces_with_fields(Some("*"))
                }
                #[doc = "\nExecute the request and yield each item in the `traces` list. If the response contains a\n`nextPageToken`, the request is executed again with the new token. This process is\nrepeated until no page token is returned.\n\nOnly the given `fields` are requested from the server.\n"]
                pub fn stream_traces_with_fields<T, F>(
                    mut self,
                    fields: ::std::option::Option<F>,
                ) -> impl ::futures::Stream<Item = Result<T, crate::Error>> + 'a
                where
                ...
                pub fn stream_with_default_fields(
                    ...
                    Item = Result<crate::schemas::ListTracesResponse, crate::Error>,
                > + 'a {
