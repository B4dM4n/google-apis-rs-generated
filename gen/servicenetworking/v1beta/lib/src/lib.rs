...
pub mod schemas {
    ...
    pub struct ListConnectionsResponse {
        ...
        pub connections: ::std::option::Option<
            Vec<crate::schemas::GoogleCloudServicenetworkingV1BetaConnection>,
        >,
    }
...
pub mod resources {
    ...
    pub mod services {
        ...
        impl<'a> ServicesActions<'a> {
            ...
            #[doc = "Updates the allocated ranges that are assigned to a connection. The response from the `get` operation will be of type `Connection` if the operation successfully completes."]
