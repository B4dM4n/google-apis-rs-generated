...
pub mod schemas {
    ...
    impl crate::GetNextPageToken for GoogleFirestoreAdminV1Beta2ListFieldsResponse {
    ...
    impl crate::GetNextPageToken for GoogleFirestoreAdminV1Beta2ListIndexesResponse {
        fn next_page_token(&self) -> ::std::option::Option<String> {
            self.next_page_token.to_owned()
        }
    }
