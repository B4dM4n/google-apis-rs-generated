...
pub mod resources {
    ...
    pub mod case_classifications {
        ...
        impl<'a> SearchRequestBuilder<'a> {
            ...
            pub fn iter_case_classifications<T>(self) -> crate::iter::PageItemIter<Self, T>
            where
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
            {
                let fields = ::google_field_selector::to_string::<T>();
                ...
                self.iter_case_classifications_with_fields(fields)
            }
            #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
            #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
            #[doc = r" fields in `#items_type` will be the default fields populated by"]
            #[doc = r" the server."]
            pub fn iter_case_classifications_with_default_fields(
                self,
            ) -> crate::iter::PageItemIter<Self, crate::schemas::CaseClassification> {
                self.iter_case_classifications_with_fields(None::<String>)
            }
            #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
            #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
            ...
            #[doc = r" resources."]
            pub fn iter_case_classifications_with_all_fields(
                self,
            ) -> crate::iter::PageItemIter<Self, crate::schemas::CaseClassification> {
                self.iter_case_classifications_with_fields(Some("*"))
            }
            pub fn iter_case_classifications_with_fields<T, F>(
                mut self,
                fields: Option<F>,
                ...
                F: AsRef<str>,
            {
                ...
                crate::iter::PageItemIter::new(self, "caseClassifications")
            }
            ...
            pub fn iter_with_default_fields(
                self,
            ) -> crate::iter::PageIter<Self, crate::schemas::SearchCaseClassificationsResponse>
            {
    ...
    pub mod cases {
        ...
        impl<'a> CloseRequestBuilder<'a> {
            ...
            #[doc = r" fields, but it will not include every possible attribute of"]
            #[doc = r" the response resource."]
            pub fn execute_with_default_fields(self) -> Result<crate::schemas::Case, crate::Error> {
                self.execute_with_fields(None::<&str>)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
            #[doc = r" response resource and should be limited to use during"]
            #[doc = r" development or debugging."]
            pub fn execute_with_all_fields(self) -> Result<crate::schemas::Case, crate::Error> {
                self.execute_with_fields(Some("*"))
            }
            #[doc = r" Execute the given operation. This will use the `fields`"]
            #[doc = r" selector provided and will deserialize the response into"]
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            #[doc = r" populated fields in the yielded items will be determined by the"]
            #[doc = r" `FieldSelector` implementation."]
            pub fn iter_cases<T>(self) -> crate::iter::PageItemIter<Self, T>
            where
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
            {
                let fields = ::google_field_selector::to_string::<T>();
                ...
                self.iter_cases_with_fields(fields)
            }
            #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
            #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
            #[doc = r" fields in `#items_type` will be the default fields populated by"]
            #[doc = r" the server."]
            pub fn iter_cases_with_default_fields(
                self,
            ) -> crate::iter::PageItemIter<Self, crate::schemas::Case> {
                self.iter_cases_with_fields(None::<String>)
            }
            #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
            #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
            #[doc = r" fields in `#items_type` will be all fields available. This should"]
            ...
            #[doc = r" all fields can be expensive both in bandwidth and server"]
            #[doc = r" resources."]
            pub fn iter_cases_with_all_fields(
                self,
            ) -> crate::iter::PageItemIter<Self, crate::schemas::Case> {
                self.iter_cases_with_fields(Some("*"))
            }
            pub fn iter_cases_with_fields<T, F>(
                mut self,
                fields: Option<F>,
            ) -> crate::iter::PageItemIter<Self, T>
            where
                ...
                F: AsRef<str>,
            {
                ...
                crate::iter::PageItemIter::new(self, "cases")
            }
            pub fn iter<T>(self) -> crate::iter::PageIter<Self, T>
            where
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
            ...
            pub fn iter_with_default_fields(
                self,
            ) -> crate::iter::PageIter<Self, crate::schemas::ListCasesResponse> {
                self.iter_with_fields(None::<&str>)
            }
            pub fn iter_with_all_fields(
                self,
        ...
        impl<'a> SearchRequestBuilder<'a> {
            ...
            pub fn iter_with_default_fields(
                self,
            ) -> crate::iter::PageIter<Self, crate::schemas::SearchCasesResponse> {
                self.iter_with_fields(None::<&str>)
            }
            pub fn iter_with_all_fields(
                self,
        ...
        pub mod attachments {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn iter_attachments_with_default_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::Attachment> {
                ...
                pub fn iter_with_default_fields(
                    self,
                ) -> crate::iter::PageIter<Self, crate::schemas::ListAttachmentsResponse>
                {
                    self.iter_with_fields(None::<&str>)
                }
                pub fn iter_with_all_fields(
        ...
        pub mod comments {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn iter_with_default_fields(
                    self,
                ) -> crate::iter::PageIter<Self, crate::schemas::ListCommentsResponse>
                {
                    self.iter_with_fields(None::<&str>)
                }
                pub fn iter_with_all_fields(
