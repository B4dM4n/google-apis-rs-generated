...
pub mod schemas {
    ...
    pub struct Rule {
        #[doc = "DisjunctiveMatchStatements within a Rule. DisjunctiveMatchStatement OR’s all contained filters."]
        #[serde(
    ...
    pub struct RunQueryRequest {
        #[doc = "Report data range used to generate the report. If unspecified, the original parent query’s data range is used."]
        #[serde(
            rename = "dataRange",
            default,
            skip_serializing_if = "std::option::Option::is_none"
...
pub mod resources {
    pub mod queries {
        ...
        impl<'a> ListRequestBuilder<'a> {
            #[doc = "Name of a field used to order results. The default sorting order is ascending. To specify descending order for a field, append a “ desc“ suffix. For example “metadata.title desc”. Sorting is only supported for the following fields: * `queryId` * `metadata.title`"]
        ...
        pub mod reports {
            ...
            impl<'a> ListRequestBuilder<'a> {
                #[doc = "Name of a field used to order results. The default sorting order is ascending. To specify descending order for a field, append a “ desc“ suffix. For example “key.reportId desc”. Sorting is only supported for the following fields: * `key.reportId`"]
                pub fn order_by(mut self, value: impl Into<String>) -> Self {
                    self.order_by = Some(value.into());
                    self
                }
