    ...
    impl FilterPairType {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                FilterPairType::FilterPublisherTrafficSource => "FILTER_PUBLISHER_TRAFFIC_SOURCE",
                ...
                FilterPairType::FilterTrueviewTargetingExpansion => {
    ...
    impl ::std::str::FromStr for FilterPairType {
        ...
        fn from_str(s: &str) -> ::std::result::Result<FilterPairType, ()> {
            Ok(match s {
                ...
                "FILTER_PUBLISHER_TRAFFIC_SOURCE" => FilterPairType::FilterPublisherTrafficSource,
