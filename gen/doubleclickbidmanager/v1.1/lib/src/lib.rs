...
pub mod resources {
    pub mod queries {
        ...
        impl<'a> ListqueriesRequestBuilder<'a> {
            ...
            pub fn iter_queries<T>(self) -> crate::iter::PageItemIter<Self, T>
            where
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
            {
                let fields = ::google_field_selector::to_string::<T>();
                ...
                self.iter_queries_with_fields(fields)
            }
            #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
            #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
            #[doc = r" fields in `#items_type` will be the default fields populated by"]
            #[doc = r" the server."]
            pub fn iter_queries_with_default_fields(
                self,
            ) -> crate::iter::PageItemIter<Self, crate::schemas::Query> {
                self.iter_queries_with_fields(None::<String>)
            }
            #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
            #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
            ...
            #[doc = r" resources."]
            pub fn iter_queries_with_all_fields(
                self,
            ) -> crate::iter::PageItemIter<Self, crate::schemas::Query> {
                self.iter_queries_with_fields(Some("*"))
            }
            pub fn iter_queries_with_fields<T, F>(
                mut self,
                fields: Option<F>,
                ...
                F: AsRef<str>,
            {
                ...
                crate::iter::PageItemIter::new(self, "queries")
            }
            ...
            pub fn iter_with_default_fields(
                self,
            ) -> crate::iter::PageIter<Self, crate::schemas::ListQueriesResponse> {
        ...
        impl<'a> crate::iter::IterableMethod for ListqueriesRequestBuilder<'a> {
    ...
    pub mod reports {
        ...
        impl<'a> crate::iter::IterableMethod for ListreportsRequestBuilder<'a> {
            fn set_page_token(&mut self, value: String) {
                self.page_token = value.into();
            }
            fn execute<T>(&mut self) -> Result<T, crate::Error>
