...
pub mod schemas {
    ...
    impl crate::GetNextPageToken<String> for V2ListKeysResponse {
...
pub mod resources {
    pub mod keys {
        ...
        pub struct LookupKeyRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            key_string: ::std::option::Option<String>,
        ...
        pub mod locations {
            ...
            pub mod keys {
                ...
                pub struct CreateRequestBuilder<'a> {
                    ...
                    request: crate::schemas::V2Key,
                    parent: String,
                    key_id: ::std::option::Option<String>,
                    access_token: ::std::option::Option<String>,
                    alt: ::std::option::Option<crate::params::Alt>,
                    callback: ::std::option::Option<String>,
                    fields: ::std::option::Option<String>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn stream_keys_with_default_fields(
                        self,
                    ) -> impl ::futures::Stream<Item = Result<crate::schemas::V2Key, crate::Error>> + 'a
                    {
                    ...
                    pub fn stream_with_default_fields(
                        ...
                        Item = Result<crate::schemas::V2ListKeysResponse, crate::Error>,
                    > + 'a {
